// RUN: sycl-mlir-opt -convert-sycl-to-llvm='use-opaque-pointers=0' %s -o - | FileCheck %s
...
module attributes {gpu.container_module} {
  ...
  gpu.module @kernels {
    ...
    // CHECK-NEXT:        %[[VAL_0:.*]] = llvm.mlir.addressof @__spirv_BuiltInGlobalSize : !llvm.ptr<vector<3xi64>, 1>
    ...
    // CHECK-NEXT:        %[[VAL_16:.*]] = llvm.mlir.addressof @__spirv_BuiltInGlobalSize : !llvm.ptr<vector<3xi64>, 1>
    ...
    // CHECK-NEXT:        %[[VAL_32:.*]] = llvm.mlir.addressof @__spirv_BuiltInGlobalInvocationId : !llvm.ptr<vector<3xi64>, 1>
    ...
    // CHECK-NEXT:        %[[VAL_53:.*]] = llvm.mlir.addressof @__spirv_BuiltInGlobalInvocationId : !llvm.ptr<vector<3xi64>, 1>
    ...
    // CHECK-NEXT:        %[[VAL_69:.*]] = llvm.mlir.addressof @__spirv_BuiltInLocalInvocationId : !llvm.ptr<vector<3xi64>, 1>
    ...
    // CHECK-NEXT:        %[[VAL_95:.*]] = llvm.mlir.addressof @__spirv_BuiltInLocalInvocationId : !llvm.ptr<vector<3xi64>, 1>
    ...
    // CHECK-NEXT:        %[[VAL_111:.*]] = llvm.mlir.addressof @__spirv_BuiltInWorkgroupSize : !llvm.ptr<vector<3xi64>, 1>
    ...
    // CHECK-NEXT:        %[[VAL_137:.*]] = llvm.mlir.addressof @__spirv_BuiltInWorkgroupSize : !llvm.ptr<vector<3xi64>, 1>
    ...
    // CHECK-NEXT:        %[[VAL_153:.*]] = llvm.mlir.addressof @__spirv_BuiltInWorkgroupId : !llvm.ptr<vector<3xi64>, 1>
    ...
    // CHECK-NEXT:        %[[VAL_169:.*]] = llvm.mlir.addressof @__spirv_BuiltInWorkgroupId : !llvm.ptr<vector<3xi64>, 1>
    ...
    // CHECK-NEXT:        %[[VAL_194:.*]] = llvm.mlir.addressof @__spirv_BuiltInGlobalOffset : !llvm.ptr<vector<3xi64>, 1>
    ...
    // CHECK-NEXT:        %[[VAL_223:.*]] = llvm.mlir.addressof @__spirv_BuiltInGlobalOffset : !llvm.ptr<vector<3xi64>, 1>
    ...
    // CHECK-NEXT:        %[[VAL_226:.*]] = llvm.mlir.addressof @__spirv_BuiltInNumWorkgroups : !llvm.ptr<vector<3xi64>, 1>
    ...
    // CHECK-NEXT:        %[[VAL_247:.*]] = llvm.mlir.addressof @__spirv_BuiltInNumWorkgroups : !llvm.ptr<vector<3xi64>, 1>
