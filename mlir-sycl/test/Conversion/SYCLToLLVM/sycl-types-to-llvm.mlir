...
// CHECK: llvm.func @test_accessorSubscript(%arg0: !llvm.struct<"class.sycl::_V1::detail::accessor_common.AccessorSubscript{{.*}}", ([[ID_2]][[ARRAY_2]][[SUFFIX]], [[ACCESSOR_2]][[ACCESSORIMPLDEVICE_2]][[ID_2]][[ARRAY_2]][[SUFFIX]], [[RANGE_2]][[ARRAY_2]][[SUFFIX]], [[RANGE_2]][[ARRAY_2]][[SUFFIX]][[SUFFIX]], struct<(ptr<1>)>[[SUFFIX]]) 
...
// CHECK: llvm.func @test_atomic(%arg0: !llvm.[[ATOMIC1:struct<"class.sycl::_V1::atomic", \(ptr<3>\)>]], %arg1: !llvm.[[ATOMIC1:struct<"class.sycl::_V1::atomic.1", \(ptr<1>\)>]]) {
...
!sycl_kernel_handler = !sycl.kernel_handler<(!llvm.ptr<4>)>
// CHECK: llvm.func @test_kernel_handler(%arg0: !llvm.[[KERNEL_HANDLER:struct<"class.sycl::_V1::kernel_handler", \(ptr<4>\)>]]) {
func.func @test_kernel_handler(%arg0: !sycl_kernel_handler) {
  return
}
...
// CHECK: llvm.func @test_local_accessor(%arg0: !llvm.[[LOCAL_ACCESSOR:struct<"class.sycl::_V1::local_accessor.*", \(]][[LOCAL_ACCESSOR_BASE]][[LOCAL_ACCESSOR_BASE_DEVICE]][[RANGE_1]][[ARRAY_1]][[SUFFIX]], [[RANGE_1]][[ARRAY_1]][[SUFFIX]], [[ID_1]][[ARRAY_1]][[SUFFIX]][[SUFFIX]], ptr<3>
...
// CHECK: llvm.func @test_multi_ptr(%arg0: !llvm.[[ATOMIC1:struct<"class.sycl::_V1::multi_ptr", \(ptr<1>\)>]]) {
...
// CHECK: llvm.func @test_swizzled_vec(%arg0: !llvm.[[SWIZZLED_VEC:struct<"class.sycl::_V1::detail::SwizzleOp"]], (ptr<4>, [[GET_OP:struct<\(i8\)>]], [[GET_OP]][[SUFFIX]]) {
...
func.func @test_half(%arg0: !sycl_half) {
  return
}
