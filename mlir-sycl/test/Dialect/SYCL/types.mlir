...
!sycl_accessor_2_i32_r_ht = !sycl.accessor<[2, i32, read, host_task], (!sycl.accessor_impl_device<[2], (!sycl_id_2_, !sycl_range_2_, !sycl_range_2_)>, !llvm.struct<(ptr<1>)>)>
...
// CHECK: func @half(%arg0: !sycl_half) {
func.func @half(%arg0: !sycl_half) {
  return
}
