...
// CHECK-NEXT:      %[[VAL_5:.*]] = memref.reshape %[[VAL_3]](%[[VAL_4]]) : (memref<1x!sycl_accessor_2_i32_rw_gb>, memref<1xindex>) -> memref<?x!sycl_accessor_2_i32_rw_gb>
// CHECK-NEXT:      %[[VAL_6:.*]] = "polygeist.memref2pointer"(%[[VAL_5]]) : (memref<?x!sycl_accessor_2_i32_rw_gb>) -> !llvm.ptr<!sycl_accessor_2_i32_rw_gb>
...
// CHECK-NEXT:      memref.store %[[VAL_2]], %[[VAL_4]]{{\[}}%[[VAL_2]]] : memref<1xindex>
// CHECK-NEXT:      %[[VAL_5:.*]] = memref.reshape %[[VAL_3]](%[[VAL_4]]) : (memref<1x!sycl_range_2_>, memref<1xindex>) -> memref<?x!sycl_range_2_>
// CHECK-NEXT:      %[[VAL_6:.*]] = "polygeist.memref2pointer"(%[[VAL_5]]) : (memref<?x!sycl_range_2_>) -> !llvm.ptr<!sycl_range_2_>
...
// CHECK-NEXT:      %[[VAL_4:.*]] = memref.reshape %[[VAL_2]](%[[VAL_3]]) : (memref<1x!sycl_range_2_>, memref<1xindex>) -> memref<?x!sycl_range_2_>
// CHECK-NEXT:      %[[VAL_5:.*]] = "polygeist.memref2pointer"(%[[VAL_4]]) : (memref<?x!sycl_range_2_>) -> !llvm.ptr<!sycl_range_2_>
...
// CHECK-NEXT:      memref.store %[[VAL_1]], %[[VAL_3]]{{\[}}%[[VAL_1]]] : memref<1xindex>
// CHECK-NEXT:      %[[VAL_4:.*]] = memref.reshape %[[VAL_2]](%[[VAL_3]]) : (memref<1x!sycl_item_1_>, memref<1xindex>) -> memref<?x!sycl_item_1_>
// CHECK-NEXT:      %[[VAL_5:.*]] = "polygeist.memref2pointer"(%[[VAL_4]]) : (memref<?x!sycl_item_1_>) -> !llvm.ptr<!sycl_item_1_>
