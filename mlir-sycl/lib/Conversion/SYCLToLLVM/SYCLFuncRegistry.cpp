...
SYCLFuncDescriptor::FuncIdKind
SYCLFuncDescriptor::getFuncIdKind(FuncId funcId) {
  switch(funcId) {
  ...
  case FuncId::Range3CopyCtor:
    return FuncIdKind::RangeCtor;
  default:
    return FuncIdKind::Unknown;
  }
}

std::string SYCLFuncDescriptor::funcIdKindToName(FuncIdKind funcIdKind) {
  switch (funcIdKind) {
  case FuncIdKind::IdCtor:
    return "idCtor";
  case FuncIdKind::RangeCtor:
    return "rangeCtor";
  default:
    return "unknown";
  }
...
SYCLFuncDescriptor::FuncIdKind
SYCLFuncDescriptor::nameToFuncIdKind(Twine name) {
  if (name.str() == "idCtor")
    return FuncIdKind::IdCtor;
  if (name.str() == "rangeCtor")
    return FuncIdKind::RangeCtor;
  return FuncIdKind::Unknown;
}
...
SYCLFuncRegistry::getFuncId(SYCLFuncDescriptor::FuncIdKind funcIdKind,
  ...
  LLVM_DEBUG(llvm::dbgs() << "Looking up function of kind: "
                          << SYCLFuncDescriptor::funcIdKindToName(funcIdKind)
                          << "\n";);
...
SYCLFuncRegistry::SYCLFuncRegistry(ModuleOp &module, OpBuilder &builder)
  ...
  // clang-format off
  std::vector<SYCLFuncDescriptor> idDescriptors = {
      // sycl::id<1>::id()
      ...
      SYCLFuncDescriptor(SYCLFuncDescriptor::FuncId::Id1CtorSizeT,
      ...
      SYCLFuncDescriptor(SYCLFuncDescriptor::FuncId::Id2CtorSizeT,
      ...
      SYCLFuncDescriptor(SYCLFuncDescriptor::FuncId::Id3CtorSizeT,
      ...
      SYCLFuncDescriptor(SYCLFuncDescriptor::FuncId::Id1Ctor2SizeT,
      ...
      SYCLFuncDescriptor(SYCLFuncDescriptor::FuncId::Id2Ctor2SizeT,
      ...
      SYCLFuncDescriptor(SYCLFuncDescriptor::FuncId::Id3Ctor2SizeT,
      ...
      SYCLFuncDescriptor(SYCLFuncDescriptor::FuncId::Id1Ctor3SizeT,
      ...
      SYCLFuncDescriptor(SYCLFuncDescriptor::FuncId::Id2Ctor3SizeT,
      ...
      SYCLFuncDescriptor(SYCLFuncDescriptor::FuncId::Id3Ctor3SizeT,
  ...
  std::vector<SYCLFuncDescriptor> rangeDescriptors = {
      ...
      SYCLFuncDescriptor(SYCLFuncDescriptor::FuncId::Range2CtorSizeT,
      ...
      SYCLFuncDescriptor(SYCLFuncDescriptor::FuncId::Range3CtorSizeT,
      ...
      SYCLFuncDescriptor(SYCLFuncDescriptor::FuncId::Range1Ctor2SizeT,
      ...
      SYCLFuncDescriptor(SYCLFuncDescriptor::FuncId::Range2Ctor2SizeT,
      ...
      SYCLFuncDescriptor(SYCLFuncDescriptor::FuncId::Range3Ctor2SizeT,
      ...
      SYCLFuncDescriptor(SYCLFuncDescriptor::FuncId::Range1Ctor3SizeT,
      ...
      SYCLFuncDescriptor(SYCLFuncDescriptor::FuncId::Range2Ctor3SizeT,
      ...
      SYCLFuncDescriptor(SYCLFuncDescriptor::FuncId::Range3Ctor3SizeT,
  ...
  descriptors.reserve(idDescriptors.size() + rangeDescriptors.size());
  descriptors.insert(descriptors.end(), idDescriptors.begin(), idDescriptors.end());
  descriptors.insert(descriptors.end(), rangeDescriptors.begin(), rangeDescriptors.end());  
  ...
  for (SYCLFuncDescriptor &funcDesc : descriptors) {
    ...
    registry.emplace(funcDesc.funcId, funcDesc);
  }
}
