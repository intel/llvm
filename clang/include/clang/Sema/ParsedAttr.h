...
public:
  ...
  LangAS asOpenCLLangAS() const {
    ...
    case ParsedAttr::AT_OpenCLUSMDeviceAddressSpace:
      return LangAS::opencl_usm_device;
    case ParsedAttr::AT_OpenCLUSMHostAddressSpace:
      return LangAS::opencl_usm_host;
