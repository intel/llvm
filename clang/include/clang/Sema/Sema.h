...
public:
  ...
  /// Saves the return type used in the traits shim.
  void setAddressOfCast(QualType Type);
...
private:
  ...
  struct KernelDesc {
    ...
    // The type used for casting the free function address in the traits shim.
    QualType AddressOfCast;
