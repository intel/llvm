...
StringRef SYCL::gen::resolveGenDevice(StringRef DeviceName) {
  ...
  Device =
      llvm::StringSwitch<StringRef>(DeviceName)
          ...
          .Case("intel_gpu_adl_s", "intel_gpu_rpl_s", "adl_s")
          .Case("intel_gpu_adl_p", "adl_p")
          .Case("intel_gpu_adl_n", "adl_n")
          .Cases("intel_gpu_dg1", "intel_gpu_12_10_0", "dg1")
          .Case("intel_gpu_acm_g10", "intel_gpu_dg2_g10", "acm_g10")
          .Case("intel_gpu_acm_g11", "intel_gpu_dg2_g11", "acm_g11")
          .Case("intel_gpu_acm_g12", "intel_gpu_dg2_g12", "acm_g12")
