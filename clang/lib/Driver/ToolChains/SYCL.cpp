...
SmallString<64> SYCL::gen::getGenDeviceMacro(StringRef DeviceName) {
  ...
  StringRef Ext = llvm::StringSwitch<StringRef>(DeviceName)
                      ...
                      .Case("sm20", "NVIDIA_GPU_SM20")
                      .Case("sm30", "NVIDIA_GPU_SM30")
                      .Case("sm32", "NVIDIA_GPU_SM32")
                      .Case("sm35", "NVIDIA_GPU_SM35")
                      .Case("sm37", "NVIDIA_GPU_SM37")
                      .Case("sm50", "NVIDIA_GPU_SM50")
                      .Case("sm52", "NVIDIA_GPU_SM52")
                      .Case("sm53", "NVIDIA_GPU_SM53")
                      .Case("sm60", "NVIDIA_GPU_SM60")
                      .Case("sm61", "NVIDIA_GPU_SM61")
                      .Case("sm62", "NVIDIA_GPU_SM62")
                      .Case("sm70", "NVIDIA_GPU_SM70")
                      .Case("sm72", "NVIDIA_GPU_SM72")
                      .Case("sm75", "NVIDIA_GPU_SM75")
                      .Case("sm80", "NVIDIA_GPU_SM80")
                      .Case("sm86", "NVIDIA_GPU_SM86")
                      .Case("sm87", "NVIDIA_GPU_SM87")
                      .Case("sm89", "NVIDIA_GPU_SM89")
                      .Case("sm90", "NVIDIA_GPU_SM90")
                      .Default("");
  if (!Ext.empty()) {
