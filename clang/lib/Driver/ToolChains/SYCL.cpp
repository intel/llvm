...
StringRef SYCL::gen::resolveGenDevice(StringRef DeviceName) {
  ...
  Device =
      llvm::StringSwitch<StringRef>(DeviceName)
          ...
          .Case("nvidia_gpu_sm_88", "sm_88")
          .Case("nvidia_gpu_sm_89", "sm_89")
          .Case("nvidia_gpu_sm_90", "sm_90")
          .Case("nvidia_gpu_sm_90a", "sm_90a")
          .Case("nvidia_gpu_sm_100", "sm_100")
          .Case("nvidia_gpu_sm_100a", "sm_100a")
          .Case("nvidia_gpu_sm_100f", "sm_100f")
          .Case("nvidia_gpu_sm_101", "sm_101")
          .Case("nvidia_gpu_sm_101a", "sm_101a")
          .Case("nvidia_gpu_sm_101f", "sm_101f")
          .Case("nvidia_gpu_sm_103", "sm_103")
          .Case("nvidia_gpu_sm_103a", "sm_103a")
          .Case("nvidia_gpu_sm_103f", "sm_103f")
          .Case("nvidia_gpu_sm_110", "sm_110")
          .Case("nvidia_gpu_sm_110a", "sm_110a")
          .Case("nvidia_gpu_sm_110f", "sm_110f")
          .Case("nvidia_gpu_sm_120", "sm_120")
          .Case("nvidia_gpu_sm_120a", "sm_120a")
          .Case("nvidia_gpu_sm_120f", "sm_120f")
          .Case("nvidia_gpu_sm_121", "sm_121")
          .Case("nvidia_gpu_sm_121a", "sm_121a")
          .Case("nvidia_gpu_sm_121f", "sm_121f")
...
SmallString<64> SYCL::gen::getGenDeviceMacro(StringRef DeviceName) {
  ...
  StringRef Ext =
      llvm::StringSwitch<StringRef>(DeviceName)
          ...
          .Case("sm_88", "NVIDIA_GPU_SM_88")
          .Case("sm_89", "NVIDIA_GPU_SM_89")
          .Case("sm_90", "NVIDIA_GPU_SM_90")
          .Case("sm_90a", "NVIDIA_GPU_SM_90A")
          .Case("sm_100", "NVIDIA_GPU_SM_100")
          .Case("sm_100a", "NVIDIA_GPU_SM_100A")
          .Case("sm_100f", "NVIDIA_GPU_SM_100F")
          .Case("sm_101", "NVIDIA_GPU_SM_101")
          .Case("sm_101a", "NVIDIA_GPU_SM_101A")
          .Case("sm_101f", "NVIDIA_GPU_SM_101F")
          .Case("sm_103", "NVIDIA_GPU_SM_103")
          .Case("sm_103a", "NVIDIA_GPU_SM_103A")
          .Case("sm_103f", "NVIDIA_GPU_SM_103F")
          .Case("sm_110", "NVIDIA_GPU_SM_110")
          .Case("sm_110a", "NVIDIA_GPU_SM_110A")
          .Case("sm_110f", "NVIDIA_GPU_SM_110F")
          .Case("sm_120", "NVIDIA_GPU_SM_120")
          .Case("sm_120a", "NVIDIA_GPU_SM_120A")
          .Case("sm_120f", "NVIDIA_GPU_SM_120F")
          .Case("sm_121", "NVIDIA_GPU_SM_121")
          .Case("sm_121a", "NVIDIA_GPU_SM_121A")
          .Case("sm_121f", "NVIDIA_GPU_SM_121F")
