...
public:
  ...
  virtual llvm::Constant *EmitMemberFunctionPointer(const CXXMethodDecl *MD, bool AllowVirtual = true);
  ...
  virtual llvm::Constant *EmitMemberPointer(const APValue &MP, QualType MPT, bool AllowVirtual = false);
