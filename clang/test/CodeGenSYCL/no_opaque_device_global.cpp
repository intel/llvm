// RUN: %clang_cc1 -fsycl-is-device -internal-isystem %S/Inputs -triple spir64-unknown-unknown -disable-llvm-passes -fsycl-unique-prefix=THE_PREFIX -std=c++17 -no-opaque-pointers -emit-llvm %s -o - | FileCheck %s
#include "sycl.hpp"
