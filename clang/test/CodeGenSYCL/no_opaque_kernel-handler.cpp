...
// NONATIVESUPPORT: call void @{{.*}}__init_specialization_constants_buffer{{.*}}(%"class.sycl::_V1::kernel_handler"* noundef nonnull align 1 dereferenceable(1) %kh, i8* noundef %[[ADDRSPACECAST]])
