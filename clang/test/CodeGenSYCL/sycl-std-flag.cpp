...
// RUN: %clangxx  -fsycl  -fsyntax-only -sycl-std=2017 -DSYCL2017 %s
// RUN: %clangxx  -fsycl  -fsyntax-only -sycl-std=121 -DSYCL2017 %s
// RUN: %clangxx  -fsycl  -fsyntax-only -sycl-std=1.2.1 -DSYCL2017 %s
// RUN: %clangxx  -fsycl  -fsyntax-only -sycl-std=sycl-1.2.1 -DSYCL2017 %s
// RUN: %clangxx  -fsycl  -fsyntax-only -sycl-std=2020 -DSYCL2020 %s
