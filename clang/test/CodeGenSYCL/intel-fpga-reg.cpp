...
void scalars() {
  ...
  // CHECK-NEXT: [[V_A2:%.*]] = call i32 @llvm.annotation.i32(i32 [[V_A1]], [[BIFR_STR:ptr @.str,]]
...
void structs() {
  ...
  // CHECK: [[TMP_S4:%.*]] = call ptr addrspace(4) @llvm.ptr.annotation.p4(ptr addrspace(4) [[S2_ASCAST]], [[BIFR_STR]]
  ...
  // CHECK: [[TMP_S9:%.*]] = call ptr addrspace(4) @llvm.ptr.annotation.p4(ptr addrspace(4) [[REF_TMP_ASCAST]], [[BIFR_STR]]
...
void unions() {
  ...
  // CHECK-NEXT: [[TMP_U4:%.*]] = call ptr addrspace(4) @llvm.ptr.annotation.p4(ptr addrspace(4) [[REF_TMP2_ASCAST]], [[BIFR_STR]]
...
void classes() {
  ...
  // CHECK-NEXT: [[TMP_C4:%.*]] = call ptr addrspace(4) @llvm.ptr.annotation.p4(ptr addrspace(4) [[CB_ASCAST]], [[BIFR_STR]]
}
