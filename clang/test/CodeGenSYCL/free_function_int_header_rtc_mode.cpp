...
// CHECK-NORTC-NEXT:     sycl::detail::free_function_info_map::add(reinterpret_cast<const void*>(sycl::detail::kernel_args_sizes + 0), sycl::detail::kernel_names[0]);
// CHECK-NORTC-NEXT:     sycl::detail::free_function_info_map::add(reinterpret_cast<const void*>(sycl::detail::kernel_args_sizes + 1), sycl::detail::kernel_names[1]);
// CHECK-NORTC-NEXT:   }
// CHECK-NORTC-NEXT: };
