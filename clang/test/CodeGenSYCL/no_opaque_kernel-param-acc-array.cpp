...
// CHECK: [[MEM_RANGE1AS:%.*]] = addrspacecast %"struct.sycl::_V1::range"* [[MEM_RANGE1A]] to %"struct.sycl::_V1::range" addrspace(4)*
// CHECK: [[OFFSET1AS:%.*]] = addrspacecast %"struct.sycl::_V1::id"* [[OFFSET1A]] to %"struct.sycl::_V1::id" addrspace(4)*
// CHECK: [[ACC_RANGE2AS:%.*]] = addrspacecast %"struct.sycl::_V1::range"* [[ACC_RANGE2A]] to %"struct.sycl::_V1::range" addrspace(4)*
...
// CHECK: [[ACC_RANGE1:%.*]] = addrspacecast %"struct.sycl::_V1::range" addrspace(4)* [[ACC_RANGE1AS]] to %"struct.sycl::_V1::range"*
// CHECK: [[MEM_RANGE1:%.*]] = addrspacecast %"struct.sycl::_V1::range" addrspace(4)* [[MEM_RANGE1AS]] to %"struct.sycl::_V1::range"*
...
// CHECK: [[ACC_RANGE2:%.*]] = addrspacecast %"struct.sycl::_V1::range" addrspace(4)* [[ACC_RANGE2AS]] to %"struct.sycl::_V1::range"*
// CHECK: [[MEM_RANGE2:%.*]] = addrspacecast %"struct.sycl::_V1::range" addrspace(4)* [[MEM_RANGE2AS]] to %"struct.sycl::_V1::range"*
// CHECK: [[OFFSET2:%.*]] = addrspacecast %"struct.sycl::_V1::id" addrspace(4)* [[OFFSET2AS]] to %"struct.sycl::_V1::id"*
// CHECK: call spir_func void @{{.*}}__init{{.*}}(%"class.sycl::_V1::accessor" addrspace(4)* {{[^,]*}} [[INDEX2]], i32 addrspace(1)* noundef [[MEM_LOAD2]], %"struct.sycl::_V1::range"* noundef byval({{.*}}) align 4 [[ACC_RANGE2]], %"struct.sycl::_V1::range"* noundef byval({{.*}}) align 4 [[MEM_RANGE2]], %"struct.sycl::_V1::id"* noundef byval({{.*}}) align 4 [[OFFSET2]])
