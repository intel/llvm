...
// Two __init parameters, one with add_ir_attributes_kernel_parameter attribute.
// CHECK-DAG: define {{.*}}spir_kernel void @{{.*}}test_kernel5({{.*}}i32 addrspace({{.*}})* noundef %{{.*}}, {{.*}}float addrspace({{.*}})* {{.*}}"Prop1"="Property string"{{.*}}"Prop2"="1"{{.*}}"Prop3"="true"{{.*}}"Prop4"="2"{{.*}}"Prop5"{{.*}}"Prop6"{{.*}}"Prop7"="1"{{.*}} %{{.*}})
// CHECK-DAG: define {{.*}}spir_kernel void @{{.*}}test_kernel6({{.*}}i32 addrspace({{.*}})* noundef %{{.*}}, {{.*}}float addrspace({{.*}})* {{.*}}"Prop11"="Another property string"{{.*}}"Prop12"="2"{{.*}}"Prop13"="false"{{.*}}"Prop14"="1"{{.*}}"Prop15"{{.*}}"Prop16"{{.*}}"Prop17"="2"{{.*}} %{{.*}})
// CHECK-DAG: define {{.*}}spir_kernel void @{{.*}}test_kernel7({{.*}}i32 addrspace({{.*}})* noundef %{{.*}}, {{.*}}float addrspace({{.*}})* {{.*}}"Prop1"="Property string"{{.*}}"Prop11"="Another property string"{{.*}}"Prop12"="2"{{.*}}"Prop13"="false"{{.*}}"Prop14"="1"{{.*}}"Prop15"{{.*}}"Prop16"{{.*}}"Prop17"="2"{{.*}}"Prop2"="1"{{.*}}"Prop3"="true"{{.*}}"Prop4"="2"{{.*}}"Prop5"{{.*}}"Prop6"{{.*}}"Prop7"="1"{{.*}} %{{.*}})
// CHECK-DAG: define {{.*}}spir_kernel void @{{.*}}test_kernel8({{.*}}i32 addrspace({{.*}})* noundef %{{.*}}, {{.*}}float addrspace({{.*}})* {{.*}}"Prop1"="Property string"{{.*}}"Prop11"="Another property string"{{.*}}"Prop12"="2"{{.*}}"Prop13"="false"{{.*}}"Prop14"="1"{{.*}}"Prop15"{{.*}}"Prop16"{{.*}}"Prop17"="2"{{.*}}"Prop2"="1"{{.*}}"Prop3"="true"{{.*}}"Prop4"="2"{{.*}}"Prop5"{{.*}}"Prop6"{{.*}}"Prop7"="1"{{.*}} %{{.*}})
