...
int main() {
  ...
  sycl::ext::oneapi::experimental::spec_constant<bool, MyBoolConst> i1(false);
  sycl::ext::oneapi::experimental::spec_constant<char, MyInt8Const> i8(0);
  sycl::ext::oneapi::experimental::spec_constant<unsigned char, MyUInt8Const> ui8(0);
  sycl::ext::oneapi::experimental::spec_constant<short, MyInt16Const> i16(0);
  sycl::ext::oneapi::experimental::spec_constant<unsigned short, MyUInt16Const> ui16(0);
  sycl::ext::oneapi::experimental::spec_constant<int, MyInt32Const> i32(0);
  // Constant used twice, but there must be single entry in the int header,
  // otherwise compilation error would be issued.
  sycl::ext::oneapi::experimental::spec_constant<int, MyInt32Const> i32_1(0);
  sycl::ext::oneapi::experimental::spec_constant<unsigned int, MyUInt32Const> ui32(0);
  sycl::ext::oneapi::experimental::spec_constant<float, MyFloatConst> f32(0);
  sycl::ext::oneapi::experimental::spec_constant<double, MyDoubleConst> f64(0);
  // Kernel name can be used as a spec constant name
  sycl::ext::oneapi::experimental::spec_constant<int, SpecializedKernel> spec1(0);
  // Spec constant name can be declared within a namespace
  sycl::ext::oneapi::experimental::spec_constant<int, test::MySpecConstantWithinANamespace> spec2(0);
  ...
  sycl::kernel_single_task<SpecializedKernel>([=]() {
    *ptr = i1.get() +
