...
// CHECK: %struct.__generated_Agg = type { %struct.NoPointers, i32, ptr addrspace(1), %struct.__generated_Pointers.2 }
// CHECK: %struct.__generated_Pointers.2 = type { ptr addrspace(1), ptr addrspace(1) }
