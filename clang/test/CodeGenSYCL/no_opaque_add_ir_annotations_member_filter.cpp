...
// CHECK-NOT: @[[Prop4Name:.*]] = private unnamed_addr constant [6 x i8] c"Prop4\00", section "llvm.metadata"
// CHECK-NOT: @[[Prop6Name:.*]] = private unnamed_addr constant [6 x i8] c"Prop6\00", section "llvm.metadata"
// CHECK-NOT: @[{{.*}} = private unnamed_addr constant [5 x i8] c"true\00", section "llvm.metadata"
// CHECK-NOT: @{{.*}} = private unnamed_addr constant [2 x i8] c"2\00", section "llvm.metadata"
