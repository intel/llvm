...
// CHECK-NEXT:     return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim1()>::getFunctionName()});
// CHECK-NEXT:   }
// CHECK-NEXT: }
...
// CHECK-NEXT:   return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim2()>::getFunctionName()});
// CHECK-NEXT:   }
// CHECK-NEXT: }
...
// CHECK-NEXT:   return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim3()>::getFunctionName()});
// CHECK-NEXT:   }
// CHECK-NEXT: }
...
// CHECK-NEXT:   return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim4()>::getFunctionName()});
// CHECK-NEXT:   }
// CHECK-NEXT: }
...
// CHECK-NEXT:   return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim5()>::getFunctionName()});
// CHECK-NEXT: }
// CHECK-NEXT: }
...
// CHECK-NEXT:   return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim6()>::getFunctionName()});
// CHECK-NEXT: }
// CHECK-NEXT: }
...
// CHECK-NEXT:   return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim7()>::getFunctionName()});
// CHECK-NEXT: }
// CHECK-NEXT: }
...
// CHECK-NEXT:   return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim8()>::getFunctionName()});
// CHECK-NEXT: }
// CHECK-NEXT: }
...
// CHECK-NEXT:   return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim10()>::getFunctionName()});
// CHECK-NEXT:  }
// CHECK-NEXT:  }
...
// CHECK-NEXT:   return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim11()>::getFunctionName()});
// CHECK-NEXT:  }
// CHECK-NEXT:  } 
...
// CHECK-NEXT:  return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim12()>::getFunctionName()});
// CHECK-NEXT:  }
// CHECK-NEXT:  }
...
// CHECK-NEXT:   return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim13()>::getFunctionName()});
// CHECK-NEXT:  }
// CHECK-NEXT:  }
...
// CHECK-NEXT:   return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim14()>::getFunctionName()});
// CHECK-NEXT:  }
// CHECK-NEXT:  }
...
// CHECK-NEXT:   return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim15()>::getFunctionName()});
// CHECK-NEXT:  }
// CHECK-NEXT:  }
...
// CHECK-NEXT:   return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim17()>::getFunctionName()});
...
// CHECK-NEXT:   return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim18()>::getFunctionName()});
...
// CHECK-NEXT:   return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim19()>::getFunctionName()});
...
// CHECK-NEXT:  return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim20()>::getFunctionName()});
...
// CHECK-NEXT:  return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim21()>::getFunctionName()});
...
// CHECK-NEXT:   return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim22()>::getFunctionName()});
...
// CHECK-NEXT:   return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim23()>::getFunctionName()});
// CHECK-NEXT:  }
// CHECK-NEXT:  }
...
// CHECK-NEXT:   return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim24()>::getFunctionName()});
// CHECK-NEXT:  }
// CHECK-NEXT:  }
...
// CHECK-NEXT:   return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim25()>::getFunctionName()});
// CHECK-NEXT:  }
// CHECK-NEXT:  }
...
// CHECK-NEXT:   return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim26()>::getFunctionName()});
// CHECK-NEXT:  }
// CHECK-NEXT:  }
...
// CHECK-NEXT:   return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim27()>::getFunctionName()});
// CHECK-NEXT:  }
// CHECK-NEXT:  }
...
// CHECK-NEXT:   return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim29()>::getFunctionName()});
// CHECK-NEXT: }
// CHECK-NEXT: }
...
// CHECK-NEXT:   return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim30()>::getFunctionName()});
// CHECK-NEXT: }
// CHECK-NEXT: }
...
// CHECK-NEXT:   return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim31()>::getFunctionName()});
...
// CHECK-NEXT:   return sycl::detail::get_kernel_id_impl(std::string_view{sycl::detail::FreeFunctionInfoData<__sycl_shim32()>::getFunctionName()});
// CHECK-NEXT: }
// CHECK-NEXT: }
