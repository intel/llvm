...
// CHECK: define {{.*}} spir_func noundef i32 @_Z6squarei

// Function defined and used - symbols emitted
[[clang::sycl_external]] int squareUsed(int x) { return x*x; }
// CHECK: define {{.*}} spir_func noundef i32 @_Z10squareUsedi
...
// CHECK: define {{.*}} spir_func noundef i32 @_Z13squareInlinedi
...
// CHECK: define {{.*}} spir_func void @_Z9deviceUsev
...
// CHECK: define {{.*}} spir_func noundef i32 @_Z5func1i
...
// CHECK: define {{.*}} spir_func void @_ZN1B14BFunc1WithAttrEv
...
// CHECK: define {{.*}} spir_func void @_ZN1CD1Ev
};

// Function reachable from an unused function - definition emitted
int ret1() { return 1; }
[[clang::sycl_external]] int withAttr() { return ret1(); }
// CHECK: define {{.*}} spir_func noundef i32 @_Z8withAttrv
// CHECK: define {{.*}} spir_func noundef i32 @_Z4ret1v
...
// CHECK: define {{.*}} spir_func void @_Z6tFunc1IiEvT_

template <typename T>
[[clang::sycl_external]] void tFunc2(T arg) {}
template void tFunc2<int>(int arg);
// CHECK: define {{.*}} spir_func void @_Z6tFunc2IiEvT_
template<> void tFunc2<char>(char arg) {}
// CHECK: define {{.*}} spir_func void @_Z6tFunc2IcEvT_
template<> [[clang::sycl_external]] void  tFunc2<long>(long arg) {}
// CHECK: define {{.*}} spir_func void @_Z6tFunc2IlEvT_
