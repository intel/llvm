// NOTE: Assertions have been autogenerated by utils/update_cc_test_checks.py UTC_ARGS: --check-attributes --check-globals --version 3
...
// CHECK-SAME: ) #[[ATTR1:[0-9]+]] !srcloc [[META4:![0-9]+]] {
// CHECK-NEXT:  entry:
...
// CHECK-SAME: ) #[[ATTR1]] !srcloc [[META5:![0-9]+]] {
// CHECK-NEXT:  entry:
...
// CHECK: [[META1:![0-9]+]] = !{i32 1, i32 2}
// CHECK: [[META2:![0-9]+]] = !{i32 4, i32 100000}
// CHECK: [[META3:![0-9]+]] = !{i32 1454}
// CHECK: [[META4]] = !{i32 856}
// CHECK: [[META5]] = !{i32 1152}
//.
