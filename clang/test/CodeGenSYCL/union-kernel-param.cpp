// RUN: %clang_cc1 -fno-sycl-force-inline-kernel-lambda -fsycl-is-device -fsycl-decompose-functor -triple spir64-unknown-unknown -disable-llvm-passes -emit-llvm %s -o - | FileCheck %s
