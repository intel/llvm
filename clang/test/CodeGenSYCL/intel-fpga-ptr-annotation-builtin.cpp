...
// This test checks that using of __builtin_intel_fpga_sycl_ptr_annotation results in correct
...
void foo(float *A, int *B, State *C, State &D) {
  ...
  x = __builtin_intel_fpga_sycl_ptr_annotation(A, "testC", "testC", "testC", 0, 0, 0);
  ...
  x = __builtin_intel_fpga_sycl_ptr_annotation(A, "testD", "testD", "testD", 0, 0, 0);
  ...
  y = __builtin_intel_fpga_sycl_ptr_annotation(B, "testE", "testE", 0, 0);
  ...
  z = __builtin_intel_fpga_sycl_ptr_annotation(&D, "testF", "testF", "testF", "testF", 0, 0, TestVal1, TestVal2);
}
