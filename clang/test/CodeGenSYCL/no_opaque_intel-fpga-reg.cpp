...
void scalars() {
  ...
  // CHECK-NEXT: [[V_A2:%.*]] = call i32 @llvm.annotation.i32.p1i8(i32 [[V_A1]], [[BIFR_STR:i8 addrspace\(1\)\* getelementptr inbounds \(\[25 x i8\], \[25 x i8\] addrspace\(1\)\* @.str, i32 0, i32 0\),]]
  // CHECK-NEXT: store i32 [[V_A2]], i32 addrspace(4)* %b

  int c = __builtin_intel_fpga_reg(2.0f);
  // CHECK: [[V_CF1:%.*]] = call i32 @llvm.annotation.i32.p1i8(i32 1073741824, [[BIFR_STR]]
  ...
  // CHECK-NEXT: [[V_B3:%.*]] = call i32 @llvm.annotation.i32.p1i8(i32 [[V_B2]], [[BIFR_STR]]
  // CHECK-NEXT: [[V_B4:%.*]] = call i32 @llvm.annotation.i32.p1i8(i32 [[V_B3]], [[BIFR_STR]]
  ...
  // CHECK-NEXT: [[V_AB4:%.*]] = call i32 @llvm.annotation.i32.p1i8(i32 [[V_AB3]], [[BIFR_STR]]
  // CHECK-NEXT: [[V_AB5:%.*]] = call i32 @llvm.annotation.i32.p1i8(i32 [[V_AB4]], [[BIFR_STR]]
  // CHECK-NEXT: store i32 [[V_AB5]], i32 addrspace(4)* %e

  int f;
  f = __builtin_intel_fpga_reg(a);
  // CHECK: [[V_F1:%.*]] = load i32, i32 addrspace(4)* %a
  // CHECK-NEXT: [[V_F2:%.*]] = call i32 @llvm.annotation.i32.p1i8(i32 [[V_F1]], [[BIFR_STR]]
...
void structs() {
  ...
  // CHECK-NEXT: [[TMP_S4:%.*]] = call i8 addrspace(4)* @llvm.ptr.annotation.p4i8.p1i8(i8 addrspace(4)* [[TMP_S3]], [[BIFR_STR]]
  ...
  // CHECK-NEXT: [[TMP_S9:%.*]] = call i8 addrspace(4)* @llvm.ptr.annotation.p4i8.p1i8(i8 addrspace(4)* [[TMP_S8]], [[BIFR_STR]]
...
void unions() {
  ...
  // CHECK-NEXT: [[TMP_U4:%.*]] = call i8 addrspace(4)* @llvm.ptr.annotation.p4i8.p1i8(i8 addrspace(4)* [[TMP_U3]], [[BIFR_STR]]
...
void classes() {
  ...
  // CHECK-NEXT: [[TMP_C4:%.*]] = call i8 addrspace(4)* @llvm.ptr.annotation.p4i8.p1i8(i8 addrspace(4)* [[TMP_C3]], [[BIFR_STR]]
...
void pointers() {
  ...
  // CHECK-NEXT: [[TMP_P3:%[0-9]+]] = call i64 @llvm.annotation.i64.p1i8(i64 [[TMP_P2]], [[BIFR_STR]]
  ...
  // CHECK-NEXT: [[TMP_P6:%.*]] = call i64 @llvm.annotation.i64.p1i8(i64 [[TMP_P5]], [[BIFR_STR]]
  ...
  // CHECK-NEXT: [[TMP_P9:%.*]] = call i64 @llvm.annotation.i64.p1i8(i64 [[TMP_P8]], [[BIFR_STR]]
