...
void ivdep_array_no_safelen() {
  ...
  [[intel::ivdep(a)]] for (int i = 0; i != 10; ++i) {
    // CHECK:  %{{[0-9a-z]+}} = getelementptr inbounds [10 x i32], ptr addrspace(4) %[[ARRAY_A]].ascast, i64 0, i64 %{{[0-9a-z]+}}, !llvm.access.group ![[IDX_GROUP_ARR:[0-9]+]]
    a[i] = 0;
...
void ivdep_array_with_safelen() {
  ...
  [[intel::ivdep(a, 5)]] for (int i = 0; i != 10; ++i) {
    // CHECK:  %{{[0-9a-z]+}} = getelementptr inbounds [10 x i32], ptr addrspace(4) %[[ARRAY_A]].ascast, i64 0, i64 %{{[0-9a-z]+}}, !llvm.access.group ![[IDX_GROUP_ARR_SAFELEN:[0-9]+]]
    a[i] = 0;
    // CHECK:  %{{[0-9a-z]+}} = getelementptr inbounds [10 x i32], ptr addrspace(4) %[[ARRAY_B]].ascast, i64 0, i64 %{{[0-9a-z]+}}{{[[:space:]]}}
    b[i] = 0;
...
void ivdep_multiple_arrays() {
  ...
  [[intel::ivdep(d)]] for (int i = 0; i != 10; ++i) {
    // CHECK:  %{{[0-9a-z]+}} = getelementptr inbounds [10 x i32], ptr addrspace(4) %[[ARRAY_A]].ascast, i64 0, i64 %{{[0-9a-z]+}}, !llvm.access.group ![[IDX_GROUP_A_MUL_ARR:[0-9]+]]
    a[i] = 0;
    // CHECK:  %{{[0-9a-z]+}} = getelementptr inbounds [10 x i32], ptr addrspace(4) %[[ARRAY_B]].ascast, i64 0, i64 %{{[0-9a-z]+}}, !llvm.access.group ![[IDX_GROUP_B_MUL_ARR:[0-9]+]]
    b[i] = 0;
    // CHECK:  %{{[0-9a-z]+}} = getelementptr inbounds [10 x i32], ptr addrspace(4) %[[ARRAY_C]].ascast, i64 0, i64 %{{[0-9a-z]+}}, !llvm.access.group ![[IDX_GROUP_C_MUL_ARR:[0-9]+]]
    c[i] = 0;
    // CHECK:  %{{[0-9a-z]+}} = getelementptr inbounds [10 x i32], ptr addrspace(4) %[[ARRAY_D]].ascast, i64 0, i64 %{{[0-9a-z]+}}, !llvm.access.group ![[IDX_GROUP_D_MUL_ARR:[0-9]+]]
    d[i] = 0;
...
void ivdep_array_and_global() {
  ...
  [[intel::ivdep]]
  [[intel::ivdep(a)]] for (int i = 0; i != 10; ++i) {
    // CHECK: %{{[0-9a-z]+}} = getelementptr inbounds [10 x i32], ptr addrspace(4) %[[ARRAY_A]].ascast, i64 0, i64 %{{[0-9a-z]+}}, !llvm.access.group ![[IDX_GROUP_A_ARR_AND_GLOB:[0-9]+]]
    a[i] = 0;
    // CHECK: %{{[0-9a-z]+}} = getelementptr inbounds [10 x i32], ptr addrspace(4) %[[ARRAY_B]].ascast, i64 0, i64 %{{[0-9a-z]+}}, !llvm.access.group ![[IDX_GROUP_B_ARR_AND_GLOB:[0-9]+]]
    b[i] = 0;
...
void ivdep_array_and_inf_global() {
  ...
  [[intel::ivdep(a, 8)]] for (int i = 0; i != 10; ++i) {
    // CHECK: %{{[0-9a-z]+}} = getelementptr inbounds [10 x i32], ptr addrspace(4) %[[ARRAY_A]].ascast, i64 0, i64 %{{[0-9a-z]+}}, !llvm.access.group ![[IDX_GROUP_A_ARR_AND_INF_GLOB:[0-9]+]]
    a[i] = 0;
    // CHECK: %{{[0-9a-z]+}} = getelementptr inbounds [10 x i32], ptr addrspace(4) %[[ARRAY_B]].ascast, i64 0, i64 %{{[0-9a-z]+}}, !llvm.access.group ![[IDX_GROUP_B_ARR_AND_INF_GLOB:[0-9]+]]
    b[i] = 0;
...
void ivdep_array_and_greater_global() {
  ...
  [[intel::ivdep(9)]]
  [[intel::ivdep(a, 8)]] for (int i = 0; i != 10; ++i) {
    // CHECK: %{{[0-9a-z]+}} = getelementptr inbounds [10 x i32], ptr addrspace(4) %[[ARRAY_A]].ascast, i64 0, i64 %{{[0-9a-z]+}}, !llvm.access.group ![[IDX_GROUP_A_ARR_AND_GREAT_GLOB:[0-9]+]]
    a[i] = 0;
    // CHECK: %{{[0-9a-z]+}} = getelementptr inbounds [10 x i32], ptr addrspace(4) %[[ARRAY_B]].ascast, i64 0, i64 %{{[0-9a-z]+}}, !llvm.access.group ![[IDX_GROUP_B_ARR_AND_GREAT_GLOB:[0-9]+]]
    b[i] = 0;
...
void ivdep_mul_arrays_and_global() {
  ...
  [[intel::ivdep(c)]] for (int i = 0; i != 10; ++i) {
    // CHECK: %{{[0-9a-z]+}} = getelementptr inbounds [10 x i32], ptr addrspace(4) %[[ARRAY_A]].ascast, i64 0, i64 %{{[0-9a-z]+}}, !llvm.access.group ![[IDX_GROUP_A_MUL_ARR_AND_GLOB:[0-9]+]]
    a[i] = 0;
    // CHECK: %{{[0-9a-z]+}} = getelementptr inbounds [10 x i32], ptr addrspace(4) %[[ARRAY_B]].ascast, i64 0, i64 %{{[0-9a-z]+}}, !llvm.access.group ![[IDX_GROUP_B_MUL_ARR_AND_GLOB:[0-9]+]]
    b[i] = 0;
    // CHECK: %{{[0-9a-z]+}} = getelementptr inbounds [10 x i32], ptr addrspace(4) %[[ARRAY_C]].ascast, i64 0, i64 %{{[0-9a-z]+}}, !llvm.access.group ![[IDX_GROUP_C_MUL_ARR_AND_GLOB:[0-9]+]]
    c[i] = 0;
...
void ivdep_ptr() {
  ...
  // CHECK: %{{[0-9a-z]+}} = getelementptr inbounds i32, ptr addrspace(4) %[[PTR_LOAD]], i64 %{{[0-9a-z]+}}, !llvm.access.group ![[IDX_GROUP_PTR:[0-9]+]]
...
void ivdep_struct() {
  ...
  // CHECK: %{{[0-9a-z]+}} = getelementptr inbounds [10 x i32], ptr addrspace(4) %[[STRUCT_ARR]], i64 0, i64 %{{[0-9a-z]+}}, !llvm.access.group ![[IDX_GROUP_STRUCT_ARR:[0-9]+]]
  ...
  // CHECK: %{{[0-9a-z]+}} = getelementptr inbounds i32, ptr addrspace(4) %[[LOAD_STRUCT_PTR]], i64 %{{[0-9a-z]+}}, !llvm.access.group ![[IDX_GROUP_STRUCT_PTR:[0-9]+]]
...
// CHECK-DAG: ![[IVDEP_LEGACY_ARR_AND_GREAT_GLOB]] = !{!"llvm.loop.parallel_accesses_safelen", i32 9}
...
// CHECK-DAG: ![[IVDEP_LEGACY_MUL_ARR_AND_GLOB]] = !{!"llvm.loop.parallel_accesses_safelen", i32 5}
