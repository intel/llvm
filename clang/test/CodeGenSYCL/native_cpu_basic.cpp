...
// RUN: %clang_cc1 -fsycl-is-device  -D __SYCL_NATIVE_CPU__ -O2 -S -emit-llvm -internal-isystem %S/Inputs -fsycl-is-native-cpu -fsycl-int-header=%t.h -fsycl-int-footer=%t-footer.h -o %t.ll %s 
