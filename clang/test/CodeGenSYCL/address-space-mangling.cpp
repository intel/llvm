...
__attribute__((sycl_device)) void foo(int [[clang::sycl_global]] *);
__attribute__((sycl_device)) void foo(int [[clang::sycl_local]] *);
__attribute__((sycl_device)) void foo(int [[clang::sycl_private]] *);
__attribute__((sycl_device)) void foo(int [[clang::sycl_generic]] *);
__attribute__((sycl_device)) void foo(int [[clang::sycl_constant]] *);
