...
// RUN: touch %t.o
// RUN: not %clangxx --offload-new-driver --no-offloadlib -fsycl -Xsycl-target-frontend -DCOMPILE_FAIL=1 -c -o %t.o %s
// RUN: not ls %t.o
...
// RUN: touch %t.o
// RUN: not %clangxx --offload-new-driver --no-offloadlib -fsycl -DCOMPILE_FAIL=1 -c -o %t.o %s
// RUN: not ls %t.o
