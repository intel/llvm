...
// RUN: %clangxx -target x86_64-unknown-linux-gnu -fsycl -fno-sycl-device-lib -fintelfpga %t.a -ccc-print-phases 2>&1 \
...
// RUN: %clangxx -target x86_64-unknown-linux-gnu -fsycl -fno-sycl-device-lib -fintelfpga %t.a -### 2>&1 \
