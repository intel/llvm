...
// RUN:  not %clang -### -fopenmp=libomp -fopenmp-targets=  %s 2>&1 \
...
// RUN:  not %clang -### -ccc-print-phases -fopenmp=libomp -fopenmp-targets=powerpc64le-ibm-linux-gnu,powerpc64le-ibm-linux-gnu  %s 2>&1 \
