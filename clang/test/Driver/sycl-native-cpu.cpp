...
// RUN: %clangxx -fsycl -fsycl-targets=native_cpu -Werror -fno-profile-instr-generate -fprofile-instr-generate -fno-coverage-mapping -fcoverage-mapping -### %s -fno-sycl-libspirv 2>&1 | FileCheck %s --check-prefix=CHECK_COV_INVO
