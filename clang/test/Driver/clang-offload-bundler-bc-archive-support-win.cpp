...
// disabled_because_no_backtick_RUN: cmp %t_unbundled_A.o `cat %t_list1.txt`
// disabled_because_no_backtick_RUN: cmp %t_unbundled_B.o `cat %t_list2.txt`
// disabled_because_no_backtick_RUN: cmp %t1.bc           `cat %t_list3.txt`
// disabled_because_no_backtick_RUN: cmp %t2.bc           `cat %t_list4.txt`
// disabled_because_no_backtick_RUN: cmp %t3.bc           `cat %t_list5.txt`
...
// Backtick not supported on Windows
// disabled_because_no_backtick_RUN: cmp %t_unbundled_A.o `cat %t_listA.txt`
// disabled_because_no_backtick_RUN: cmp %t2.bc           `cat %t_listB.txt`
