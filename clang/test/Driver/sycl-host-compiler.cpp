...
// RUN: %clangxx -fsycl --offload-new-driver --no-offloadlib -fsycl-host-compiler=/some/dir/g++ %s -### 2>&1 \
...
// RUN: %clang_cl -fsycl --offload-new-driver --no-offloadlib -fsycl-host-compiler=/some/dir/cl %s -### 2>&1 \
...
// RUN: %clangxx -fsycl --offload-new-driver --no-offloadlib -fsycl-host-compiler=g++ -fsycl-host-compiler-options="-DFOO -DBAR" %s -### 2>&1 \
// RUN:  | FileCheck -check-prefix=HOST_OPTIONS %s
// HOST_OPTIONS: g++{{.*}} "-o" "[[HOSTOBJ:.+\.o]]"{{.*}} "-DFOO" "-DBAR"

// RUN: %clang_cl -fsycl --offload-new-driver --no-offloadlib -fsycl-host-compiler=cl -fsycl-host-compiler-options="/DFOO /DBAR /O2" %s -### 2>&1 \
// RUN:  | FileCheck -check-prefix=HOST_OPTIONS_CL %s
// HOST_OPTIONS_CL: cl{{.*}} "-Fo[[HOSTOBJ:.+\.obj]]"{{.*}} "/DFOO" "/DBAR" "/O2"

/// Object output check.
// RUN: %clangxx -fsycl --offload-new-driver --no-offloadlib -fsycl-host-compiler=g++ -c %s -### 2>&1 \
...
// RUN: %clang_cl -fsycl --offload-new-driver --no-offloadlib -fsycl-host-compiler=cl -c %s -### 2>&1 \
...
// RUN: not %clangxx -fsycl --offload-new-driver --no-offloadlib -fsycl-host-compiler= -c -### %s 2>&1 \
...
// RUN: not %clangxx -fsycl --offload-new-driver --no-offloadlib -fsycl-host-compiler=g++ -fsycl-unnamed-lambda -c -### %s 2>&1 \
...
// RUN: %clang_cl -### -fsycl-host-compiler=cl -fsycl --offload-new-driver --no-offloadlib %s 2>&1 | FileCheck -check-prefix=CHECK-ZC-CPLUSPLUS %s
// RUN: %clang_cl -### -fsycl-host-compiler=cl -fsycl --offload-new-driver --no-offloadlib -fsycl-host-compiler-options=/Zc:__cplusplus- %s 2>&1 | FileCheck -check-prefix=CHECK-ZC-CPLUSPLUS-MINUS %s
// RUN: %clang_cl -### %s 2>&1 | FileCheck -check-prefix=CHECK-NO-ZC-CPLUSPLUS %s
// RUN: %clang_cl -### -fsycl-host-compiler=g++ -fsycl --offload-new-driver --no-offloadlib %s 2>&1 | FileCheck -check-prefix=CHECK-NO-ZC-CPLUSPLUS %s
...
// RUN: %clangxx -### -fsycl-host-compiler=g++ -fsycl --offload-new-driver --no-offloadlib \
...
// RUN:   -fsycl-host-compiler-options=-DDUMMY_OPT --offload-new-driver --no-offloadlib \
// RUN:   %s 2>&1 \
