...
// RUN: clang-offload-bundler -type=o -targets=host-%itanium_abi_triple,sycl-spir64-unknown-unknown-sycldevice -inputs=%t.o,%t -outputs=%t.fat.o
// RUN: clang-offload-bundler -type=o -targets=host-%itanium_abi_triple,sycl-spir64-unknown-unknown -outputs=%t.host,%t.device -inputs=%t.fat.o -unbundle
// RUN: diff %t %t.device
