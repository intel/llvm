...
// CHK-FPGA-LINK: sycl-post-link{{.*}} "-O2" "-spec-const=default" "-device-globals" "-host-pipes" "-o" "[[OUTPUT2:.+\.table]]" "[[OUTPUT2_1]]"
...
// CHK-FPGA-LINK-WIN: sycl-post-link{{.*}} "-O2" "-spec-const=default" "-device-globals" "-host-pipes" "-o" "[[OUTPUT2:.+\.table]]" "[[OUTPUT2_1]]"
...
// CHK-FPGA: sycl-post-link{{.*}} "-O2" "-spec-const=default" "-device-globals" "-host-pipes" "-o" "[[OUTPUT3_TABLE:.+\.table]]" "[[OUTPUT2_BC]]"
...
// CHK-FPGA-AOCX-SRC: sycl-post-link{{.*}} "-O2" "-spec-const=default" "-device-globals" "-host-pipes" "-o" "[[POSTLINKOUT:.+\.table]]" "[[LLVMLINKOUT]]
...
// CHK-FPGA-AOCX-OBJ: sycl-post-link{{.*}} "-O2" "-spec-const=default" "-device-globals" "-host-pipes" "-o" "[[POSTLINKOUT:.+\.table]]" "[[LLVMLINKOUT]]
...
// CHK-FPGA-AOCX-OBJ2: sycl-post-link{{.*}} "-O2" "-spec-const=rt" "-device-globals" "-host-pipes" "-o" "[[POSTLINKOUT:.+\.table]]" "[[LLVMLINKOUT]]"
...
// CHK-FPGA-AOCX-OBJ2: sycl-post-link{{.*}} "-O2" "-spec-const=default" "-device-globals" "-host-pipes" "-o" "[[POSTLINKOUT2:.+\.table]]" "[[LLVMLINKOUT2]]"
