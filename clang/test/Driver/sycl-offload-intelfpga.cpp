...
// CHK-FPGA-LINK: clang-offload-bundler{{.*}} "-type=o" "-targets=fpga-fpga_aocx-intel-linux-sycldevice" "-inputs=[[INPUT:.+\.o]]" "-check-section"
// CHK-FPGA-LINK: clang-offload-bundler{{.*}} "-type=o" "-targets=fpga-fpga_aocr-intel-linux-sycldevice" "-inputs=[[INPUT]]" "-check-section"
// CHK-FPGA-LINK: clang-offload-bundler{{.*}} "-type=o" "-targets=host-x86_64-unknown-linux-gnu,sycl-spir64_fpga-unknown-linux-sycldevice" "-inputs=[[INPUT]]" "-outputs=[[OUTPUT1:.+\.o]],[[OUTPUT2:.+\.o]]" "-unbundle"
...
// CHK-FPGA-EARLY: clang-offload-bundler{{.*}} "-type=o" "-targets=fpga-fpga_aocr-intel-linux-sycldevice,host-x86_64-unknown-linux-gnu" "-outputs={{.*}}" "-inputs=[[OUTPUT5]],[[OUTPUT6]]"
// CHK-FPGA-IMAGE: clang-offload-bundler{{.*}} "-type=o" "-targets=fpga-fpga_aocx-intel-linux-sycldevice,host-x86_64-unknown-linux-gnu" "-outputs={{.*}}" "-inputs=[[OUTPUT5]],[[OUTPUT6]]"
...
// CHK-FPGA-LINK-PHASES-IMAGE: 3: backend-compiler, {2}, aocx, (device-sycl)
// CHK-FPGA-LINK-PHASES-EARLY: 3: backend-compiler, {2}, aocr, (device-sycl)
...
// CHK-FPGA-LINK-PHASES: 7: offload, "device-sycl (spir64_fpga-unknown-linux-sycldevice)" {6}, object
