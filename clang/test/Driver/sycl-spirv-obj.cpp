...
// RUN: %clangxx -target x86_64-unknown-linux-gnu -c -fsycl --offload-new-driver --no-offloadlib -fsycl-device-obj=spirv -### %s 2>&1 | \
...
// RUN: %clangxx -target x86_64-unknown-linux-gnu -c -fsycl --offload-new-driver --no-offloadlib -fsycl-device-obj=spirv -ccc-print-phases %s 2>&1 | \
...
// RUN: touch %t.o
// RUN: %clangxx -target x86_64-unknown-linux-gnu -fsycl --offload-new-driver --no-offloadlib -fsycl-device-obj=spirv -### %t.o 2>&1 | \
