...
// CHECK-DAG: warning: '-fno-sycl-libspirv' should not be used with target 'amdgpu9.08-amd-amdhsa'; libspirv is required for correct behavior [-Wunsafe-libspirv-not-linked]
