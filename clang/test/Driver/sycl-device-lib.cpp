...
// RUN:   | FileCheck %s -check-prefix=SYCL_DEVICE_LIB_UNBUNDLE_DEFAULT
// SYCL_DEVICE_LIB_UNBUNDLE_DEFAULT: clang-offload-bundler{{.*}} "-type=o" "-targets=sycl-spir64-unknown-unknown-sycldevice" "-inputs={{.*}}libsycl-cassert.o" "-outputs={{.*}}libsycl-cassert-{{.*}}.o" "-unbundle"
...
// RUN:   | FileCheck %s -check-prefix=SYCL_DEVICE_LIB_UNBUNDLE_WITH_FP64
// SYCL_DEVICE_LIB_UNBUNDLE_WITH_FP64: clang-offload-bundler{{.*}} "-type=o" "-targets=sycl-spir64-unknown-unknown-sycldevice" "-inputs={{.*}}libsycl-cassert.o" "-outputs={{.*}}libsycl-cassert-{{.*}}.o" "-unbundle"
...
// SYCL_DEVICE_LIB_UNBUNDLE_NO_LIBM: clang-offload-bundler{{.*}} "-type=o" "-targets=sycl-spir64-unknown-unknown-sycldevice" "-inputs={{.*}}libsycl-cassert.o" "-outputs={{.*}}libsycl-cassert-{{.*}}.o" "-unbundle"
...
// SYCL_LLVM_LINK_DEVICE_LIB-NEXT: clang-offload-bundler{{.*}} "-type=o" "-targets=sycl-spir64-unknown-unknown-sycldevice" "-inputs={{.*}}libsycl-cassert.o" "-outputs={{.*}}libsycl-cassert-{{.*}}.o" "-unbundle"
...
// RUN: touch libsycl-cassert.o
// RUN: %clangxx -fsycl libsycl-cassert.o -### 2>&1 \
