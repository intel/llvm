...
// CHECK-DEPRECATE: Section 'openmp-tg0': Image 1'-> File
// CHECK-DEPRECATE: Section 'sycl-tg1': Image 2'-> File
...
// CHECK-EXTRACT: Section 'openmp-tg0': Image 1'-> File
// CHECK-EXTRACT: Section 'sycl-tg1': Image 2'-> File
