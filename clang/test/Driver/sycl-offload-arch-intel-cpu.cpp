...
//
// RUN:  %clangxx --offload-new-driver --no-offloadlib -fsycl --offload-arch= %s -### 2>&1 \
// RUN:   | FileCheck --check-prefixes=TARGET-TRIPLE-DEFAULT,CLANG-OFFLOAD-PACKAGER-DEFAULT %s
// RUN:  %clang_cl --offload-new-driver --no-offloadlib -fsycl --offload-arch= %s -### 2>&1 \
// RUN:   | FileCheck --check-prefixes=TARGET-TRIPLE-DEFAULT,CLANG-OFFLOAD-PACKAGER-DEFAULT %s
...
//
// RUN: not %clangxx --offload-new-driver --no-offloadlib -fsycl --offload-arch=badArch %s -### 2>&1 \
// RUN:   | FileCheck -check-prefix=BAD-ARCH %s
// RUN: not %clang_cl --offload-new-driver --no-offloadlib -fsycl --offload-arch=badArch %s -### 2>&1 \
// RUN:   | FileCheck -check-prefix=BAD-ARCH %s
