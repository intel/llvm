...
// RUN:  %clangxx -fsycl --offload-new-driver --no-offloadlib -I cmdline/dir -include dummy.h %/s -### 2>&1 \
...
// RUN: %clangxx -fsycl --offload-new-driver --no-offloadlib -E %/s -### 2>&1 \
...
// RUN: touch %t.ii
// RUN:  %clangxx -fsycl --offload-new-driver --no-offloadlib %t.ii -### 2>&1 \
...
// RUN:  %clangxx -fsycl --offload-new-driver --no-offloadlib -fno-sycl-use-footer %s -### 2>&1 \
...
// RUN: %clangxx -fsycl --offload-new-driver --no-offloadlib -fno-sycl-instrument-device-code --no-offloadlib -fno-sycl-use-footer -target x86_64-unknown-linux-gnu %s -ccc-print-phases 2>&1 \
...
// RUN: %clangxx -fsycl --offload-new-driver --no-offloadlib -fno-sycl-instrument-device-code --no-offloadlib -target x86_64-unknown-linux-gnu %s -ccc-print-phases 2>&1 \
...
// RUN:  %clangxx -fsycl --offload-new-driver --no-offloadlib -fsycl-footer-path=dummy_dir %s -### 2>&1 \
...
// RUN:  %clangxx -fsycl --offload-new-driver --no-offloadlib -MD -c %s -### 2>&1 \
...
// RUN:  %clangxx -target x86_64-unknown-linux-gnu -fsycl --offload-new-driver --no-offloadlib -MD -c %s -ccc-print-phases 2>&1 \
...
// RUN:  %clangxx -fsycl --offload-new-driver --no-offloadlib -MD -c %s -o dummy -### 2>&1 \
