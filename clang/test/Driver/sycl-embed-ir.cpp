...
// CHECK-NV: [[LINK1:[0-9]+]]: linker, {[[IR]]}, ir, (device-sycl, sm_80)
// CHECK-NV: [[LINK2:[0-9]+]]: linker, {[[LINK1]], {{.*}}}, ir, (device-sycl, sm_80)
// CHECK-NV: [[POSTLINK:[0-9]+]]: sycl-post-link, {[[LINK2]]}, ir, (device-sycl, sm_80)
...
// CHECK-AMD: [[LINK1:[0-9]+]]: linker, {[[IR]]}, ir, (device-sycl, gfx1010)
// CHECK-AMD: [[POSTLINK:[0-9]+]]: sycl-post-link, {[[LINK1]]}, ir, (device-sycl, gfx1010)
