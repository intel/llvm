...
// CHK-CMDS-AOT-NV-EMBED-IR-NEXT: offload-wrapper: input: [[SYCLPOSTLINKOUT:.*]].table, output: [[WRAPPEROUT1:.*]]
...
// CHK-CMDS-AOT-AMD-EMBED-IR-NEXT: offload-wrapper: input: [[SYCLPOSTLINKOUT:.*]].table, output: [[WRAPPEROUT1:.*]]
