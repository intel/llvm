...
// RUN:  | FileCheck %s -check-prefixes=CHECK-CPU,CHECK-DEFAULT

// CHECK-DEFAULT: llvm-spirv{{.*}} "-o"
// CHECK-CPU: "-spirv-allow-unknown-intrinsics=llvm.genx.,llvm.fpbuiltin"
// CHECK-DEFAULT: "-spirv-ext=-all
...
// CHECK-DEFAULT-SAME:,+SPV_INTEL_subgroups
// CHECK-DEFAULT-SAME:,+SPV_INTEL_unstructured_loop_controls
// CHECK-DEFAULT-SAME:,+SPV_INTEL_function_pointers,+SPV_INTEL_kernel_attributes
// CHECK-DEFAULT-SAME:,+SPV_INTEL_inline_assembly
// CHECK-DEFAULT-SAME:,+SPV_INTEL_arbitrary_precision_integers
...
// CHECK-DEFAULT-SAME:,+SPV_EXT_arithmetic_fence
