...
// CHECK-SM50: "-cc1"{{.*}} "-D__SYCL_TARGET_NVIDIA_GPU_SM_50__" "-D__SYCL_ANY_DEVICE_HAS_ANY_ASPECT__=1" "-D__SYCL_ALL_DEVICES_HAVE_[[ASPECT:[a-z0-9_]+]]__=1"
// CHECK-SM60: "-cc1"{{.*}} "-D__SYCL_TARGET_NVIDIA_GPU_SM_60__" "-D__SYCL_ANY_DEVICE_HAS_ANY_ASPECT__=1" "-D__SYCL_ALL_DEVICES_HAVE_[[ASPECT]]__=1"
// CHECK-SM70: "-cc1"{{.*}} "-D__SYCL_TARGET_NVIDIA_GPU_SM_70__" "-D__SYCL_ANY_DEVICE_HAS_ANY_ASPECT__=1" "-D__SYCL_ALL_DEVICES_HAVE_[[ASPECT]]__=1"
// CHECK-SM80: "-cc1"{{.*}} "-D__SYCL_TARGET_NVIDIA_GPU_SM_80__" "-D__SYCL_ANY_DEVICE_HAS_ANY_ASPECT__=1" "-D__SYCL_ALL_DEVICES_HAVE_[[ASPECT]]__=1"
// CHECK-SM90: "-cc1"{{.*}} "-D__SYCL_TARGET_NVIDIA_GPU_SM_90__" "-D__SYCL_ANY_DEVICE_HAS_ANY_ASPECT__=1" "-D__SYCL_ALL_DEVICES_HAVE_[[ASPECT]]__=1"
