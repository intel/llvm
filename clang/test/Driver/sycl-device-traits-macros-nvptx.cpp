...
// RUN:   FileCheck %s --check-prefix=CHECK-SYCL-NVPTX-NVIDIA-CUDA-DEVICE-TRIPLE
// RUN: %clangxx -fsycl -fno-sycl-libspirv -nocudalib --no-cuda-version-check -fsycl-targets=nvidia_gpu_sm_88 -### %s 2>&1 | \
// RUN:   FileCheck %s --check-prefix=CHECK-SYCL-NVPTX-NVIDIA-CUDA-DEVICE-TRIPLE
...
// RUN:   FileCheck %s --check-prefix=CHECK-SYCL-NVPTX-NVIDIA-CUDA-DEVICE-TRIPLE
// RUN: %clangxx -fsycl -fno-sycl-libspirv -nocudalib --no-cuda-version-check -fsycl-targets=nvidia_gpu_sm_100 -### %s 2>&1 | \
// RUN:   FileCheck %s --check-prefix=CHECK-SYCL-NVPTX-NVIDIA-CUDA-DEVICE-TRIPLE
// RUN: %clangxx -fsycl -fno-sycl-libspirv -nocudalib --no-cuda-version-check -fsycl-targets=nvidia_gpu_sm_100a -### %s 2>&1 | \
// RUN:   FileCheck %s --check-prefix=CHECK-SYCL-NVPTX-NVIDIA-CUDA-DEVICE-TRIPLE
// RUN: %clangxx -fsycl -fno-sycl-libspirv -nocudalib --no-cuda-version-check -fsycl-targets=nvidia_gpu_sm_100f -### %s 2>&1 | \
// RUN:   FileCheck %s --check-prefix=CHECK-SYCL-NVPTX-NVIDIA-CUDA-DEVICE-TRIPLE
...
// RUN:   FileCheck %s --check-prefix=CHECK-SYCL-NVPTX-NVIDIA-CUDA-DEVICE-TRIPLE
// RUN: %clangxx -fsycl -fno-sycl-libspirv -nocudalib --no-cuda-version-check -fsycl-targets=nvidia_gpu_sm_103 -### %s 2>&1 | \
// RUN:   FileCheck %s --check-prefix=CHECK-SYCL-NVPTX-NVIDIA-CUDA-DEVICE-TRIPLE
// RUN: %clangxx -fsycl -fno-sycl-libspirv -nocudalib --no-cuda-version-check -fsycl-targets=nvidia_gpu_sm_103a -### %s 2>&1 | \
// RUN:   FileCheck %s --check-prefix=CHECK-SYCL-NVPTX-NVIDIA-CUDA-DEVICE-TRIPLE
// RUN: %clangxx -fsycl -fno-sycl-libspirv -nocudalib --no-cuda-version-check -fsycl-targets=nvidia_gpu_sm_103f -### %s 2>&1 | \
// RUN:   FileCheck %s --check-prefix=CHECK-SYCL-NVPTX-NVIDIA-CUDA-DEVICE-TRIPLE
// RUN: %clangxx -fsycl -fno-sycl-libspirv -nocudalib --no-cuda-version-check -fsycl-targets=nvidia_gpu_sm_110 -### %s 2>&1 | \
// RUN:   FileCheck %s --check-prefix=CHECK-SYCL-NVPTX-NVIDIA-CUDA-DEVICE-TRIPLE
// RUN: %clangxx -fsycl -fno-sycl-libspirv -nocudalib --no-cuda-version-check -fsycl-targets=nvidia_gpu_sm_110a -### %s 2>&1 | \
// RUN:   FileCheck %s --check-prefix=CHECK-SYCL-NVPTX-NVIDIA-CUDA-DEVICE-TRIPLE
// RUN: %clangxx -fsycl -fno-sycl-libspirv -nocudalib --no-cuda-version-check -fsycl-targets=nvidia_gpu_sm_110f -### %s 2>&1 | \
// RUN:   FileCheck %s --check-prefix=CHECK-SYCL-NVPTX-NVIDIA-CUDA-DEVICE-TRIPLE
// RUN: %clangxx -fsycl -fno-sycl-libspirv -nocudalib --no-cuda-version-check -fsycl-targets=nvidia_gpu_sm_120 -### %s 2>&1 | \
// RUN:   FileCheck %s --check-prefix=CHECK-SYCL-NVPTX-NVIDIA-CUDA-DEVICE-TRIPLE
// RUN: %clangxx -fsycl -fno-sycl-libspirv -nocudalib --no-cuda-version-check -fsycl-targets=nvidia_gpu_sm_120a -### %s 2>&1 | \
// RUN:   FileCheck %s --check-prefix=CHECK-SYCL-NVPTX-NVIDIA-CUDA-DEVICE-TRIPLE
// RUN: %clangxx -fsycl -fno-sycl-libspirv -nocudalib --no-cuda-version-check -fsycl-targets=nvidia_gpu_sm_120f -### %s 2>&1 | \
// RUN:   FileCheck %s --check-prefix=CHECK-SYCL-NVPTX-NVIDIA-CUDA-DEVICE-TRIPLE
// RUN: %clangxx -fsycl -fno-sycl-libspirv -nocudalib --no-cuda-version-check -fsycl-targets=nvidia_gpu_sm_121 -### %s 2>&1 | \
// RUN:   FileCheck %s --check-prefix=CHECK-SYCL-NVPTX-NVIDIA-CUDA-DEVICE-TRIPLE
// RUN: %clangxx -fsycl -fno-sycl-libspirv -nocudalib --no-cuda-version-check -fsycl-targets=nvidia_gpu_sm_121a -### %s 2>&1 | \
// RUN:   FileCheck %s --check-prefix=CHECK-SYCL-NVPTX-NVIDIA-CUDA-DEVICE-TRIPLE
// RUN: %clangxx -fsycl -fno-sycl-libspirv -nocudalib --no-cuda-version-check -fsycl-targets=nvidia_gpu_sm_121f -### %s 2>&1 | \
// RUN:   FileCheck %s --check-prefix=CHECK-SYCL-NVPTX-NVIDIA-CUDA-DEVICE-TRIPLE
