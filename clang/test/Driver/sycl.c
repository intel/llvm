...
// CHECK_WARNING: 'sycldevice' component of 'spir64-unknown-unknown-sycldevice' SYCL offloading target triple is deprecated. Effective triple is 'spir64-unknown-unknown'
