...
// FOFFLOAD_STATIC_LIB_SRC: 7: append-footer, {6}, c++-cpp-output, (host-sycl)
...
// FOFFLOAD_STATIC_LIB_SRC: 12: linker, {0, 10}, image, (host-sycl)
...
// FOFFLOAD_STATIC_LIB_SRC: 16: linker, {5, 13, 15}, ir, (device-sycl)
