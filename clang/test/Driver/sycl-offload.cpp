...
// RUN:  %clangxx -### -fsycl -target x86_64-unknown-linux-gnu -fsycl-targets=spir64_x86_64 -fno-spirv %t_empty.o %s 2>&1 \
...
// RUN:    | FileCheck -check-prefix NO_IMPLIED_DEVICE %s
// RUN:  %clangxx -### -fsycl -target x86_64-unknown-linux-gnu -fsycl-targets=spir64_gen -fno-spirv %t_empty.o %s 2>&1 \
// RUN:    | FileCheck -check-prefix NO_IMPLIED_DEVICE %s
