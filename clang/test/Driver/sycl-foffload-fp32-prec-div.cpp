...
// RUN:    -fsycl-targets=intel_gpu_pvc -foffload-fp32-prec-div %s 2>&1 \
...
// JIT: llvm-offload-binary{{.*}} "--image=file={{.*}}.bc,triple=spir64-unknown-unknown,arch={{.*}}compile-opts={{.*}}-foffload-fp32-prec-div"
