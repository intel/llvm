...
// Also verifies that -mlink-builtin-bitcode-postopt is set to enable linking after optimization.
...
// CHECK-HHH-NONEXISTENT: error: cannot find 'libspirv.bc'; provide path to libspirv library via '-fsycl-libspirv-path', or pass '-fno-sycl-libspirv' to build without linking with libspirv
//
...
// CHECK-AMDGCN-HHH-NONEXISTENT: clang: error: cannot find 'libspirv.bc'; provide path to libspirv library via '-fsycl-libspirv-path', or pass '-fno-sycl-libspirv' to build without linking with libspirv
//
...
// CHECK-DO-NONEXISTENT: error: cannot find 'libspirv.bc'; provide path to libspirv library via '-fsycl-libspirv-path', or pass '-fno-sycl-libspirv' to build without linking with libspirv
