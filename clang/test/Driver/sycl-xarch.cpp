...
// RUN: %clangxx -fsycl --offload-new-driver --no-offloadlib %s -Xarch_device -fsanitize=address -### 2>&1 \
...
// SYCL_XARCH_DEVICE_ONLY-NOT: clang{{.*}} "-fsycl-is-host"{{.*}} "-fsanitize=address"
...
// RUN: %clangxx -fsycl --offload-new-driver --no-offloadlib %s -Xarch_device "-fsanitize=address -DXARCH_DEVICE_TEST -mllvm -enable-merge-functions" -### 2>&1 \
...
// RUN: %clangxx -fsycl --offload-new-driver --no-offloadlib %s -Xarch_host -fsanitize=address -### 2>&1 \
...
// RUN: %clangxx -fsycl --offload-new-driver --no-offloadlib %s -Xarch_host "-fsanitize=address -DXARCH_HOST_TEST -mllvm -enable-merge-functions" -### 2>&1 \
...
// RUN: %clangxx -fsycl --offload-new-driver --no-offloadlib %s -Xarch_device "-fsanitize=address -mllvm -enable-merge-functions" \
...
// RUN: %clangxx -fsycl --offload-new-driver --no-offloadlib %s -Xarch_host "-fsanitize=address -mllvm -enable-merge-functions" \
