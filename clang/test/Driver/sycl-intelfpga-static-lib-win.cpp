...
// RUN: %clang_cl --target=x86_64-pc-windows-msvc -fsycl -fno-sycl-device-lib -fintelfpga %t.lib -ccc-print-phases 2>&1 \
...
// RUN: %clang_cl --target=x86_64-pc-windows-msvc -fsycl -fno-sycl-device-lib -fintelfpga %t.lib -### 2>&1 \
