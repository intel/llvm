...
// speculatable belongs on the declaration only: a call site may carry it while
// the callee is speculatable too, which stops holding once a module defining
// the builtin is linked in.
// CHECK: call spir_func {{.*}}@_Z11__spirv_DotDv4_fS_{{.*}} #[[DOTCALL:[0-9]+]]
