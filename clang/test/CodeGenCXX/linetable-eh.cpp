// This test was originally written when debug info for system headers was generated by default.
//  Use -system-debug to enable generation of debug info for system headers, since the CHECKs rely on this.

// RUN: %clang_cc1 -emit-llvm -system-debug -debug-info-kind=limited -gno-column-info -triple x86_64-apple-macosx10.9.0 -funwind-tables=2 -std=c++11 -fcxx-exceptions -fexceptions %s -o - | FileCheck -allow-deprecated-dag-overlap %s
