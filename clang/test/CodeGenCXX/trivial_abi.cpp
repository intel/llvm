...
// CHECK: define{{.*}} void @_Z14testParamLarge5Large(ptr nofreeobj noundef align 8 dead_on_return dereferenceable(520) %[[A:.*]])
...
// CHECK: call void @_Z14testParamLarge5Large(ptr nofreeobj noundef align 8 dead_on_return dereferenceable(520) %[[AGG_TMP]])
...
// CHECK: call void @_Z20calleeExceptionLarge5LargeS_(ptr nofreeobj noundef align 8 dead_on_return dereferenceable(520) %[[AGG_TMP]], ptr nofreeobj noundef align 8 dead_on_return dereferenceable(520) %[[AGG_TMP1]])
// CHECK-NEXT: ret void
