...
// CHECK: define{{.*}} void @_Z14testParamLarge5Large(ptr noundef dead_on_return %[[A:.*]])
...
// CHECK: call void @_Z14testParamLarge5Large(ptr noundef dead_on_return %[[AGG_TMP]])
...
// CHECK: call void @_Z20calleeExceptionLarge5LargeS_(ptr noundef dead_on_return %[[AGG_TMP]], ptr noundef dead_on_return %[[AGG_TMP1]])
// CHECK-NEXT: ret void
