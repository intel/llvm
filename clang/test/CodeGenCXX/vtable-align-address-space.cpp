...
// CHECK: @_ZTI1A = addrspace(1) constant { ptr, ptr addrspace(1) } { ptr getelementptr inbounds (ptr, ptr addrspacecast (ptr addrspace(1) @_ZTVN10__cxxabiv117__class_type_infoE to ptr), i64 2), ptr addrspace(1) @_ZTS1A }, align 8
