...
//CHECK-HC:extern "C" void _ZTSZ4mainE10TestKernel();
//CHECK-HC:inline static void _ZTSZ4mainE10TestKernelsubhandler(const sycl::detail::NativeCPUArgDesc *MArgs, __nativecpu_state *state) {
//CHECK-HC-NEXT:  _ZTSZ4mainE10TestKernel();
//CHECK-HC-NEXT:};
