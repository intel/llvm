...
//CHECK-HC:extern "C" void _ZTS5Test1();
//CHECK-HC:inline static void _ZTS5Test1subhandler(const sycl::detail::NativeCPUArgDesc *MArgs, __nativecpu_state *state) {
//CHECK-HC-NEXT:  _ZTS5Test1();
//CHECK-HC-NEXT:};
