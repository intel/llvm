...
// CHECK: fake_accessors{{.*}} 'void ((lambda at {{.*}}fake-accessors.cpp{{.*}}), __global int *, cl::sycl::range<1>, cl::sycl::range<1>, cl::sycl::id<1>, foo::cl::sycl::accessor, accessor)
// CHECK: accessor_typedef{{.*}} 'void ((lambda at {{.*}}fake-accessors.cpp{{.*}}), __global int *, cl::sycl::range<1>, cl::sycl::range<1>, cl::sycl::id<1>, foo::cl::sycl::accessor, accessor)
// CHECK: accessor_alias{{.*}} 'void ((lambda at {{.*}}fake-accessors.cpp{{.*}}), __global int *, cl::sycl::range<1>, cl::sycl::range<1>, cl::sycl::id<1>, foo::cl::sycl::accessor, accessor)
