...
[[__sycl_detail__::add_ir_attributes_function(nullptr, 1, 3.14, true, false, TestEnum::EnumVal1, 'F', nullptr, 1, 3.14, true, false, TestEnum::EnumVal1, 'F')]] void InvalidFunction20() {}         // expected-error {{each name argument in 'add_ir_attributes_function' must be a 'const char *' usable in a constant expression}}
...
[[__sycl_detail__::add_ir_attributes_function(CENullptr, CEInt, CEFloat, CETrue, CEFalse, CEEnum, CEChar, CENullptr, CEInt, CEFloat, CETrue, CEFalse, CEEnum, CEChar)]] void InvalidFunction29() {} // expected-error {{each name argument in 'add_ir_attributes_function' must be a 'const char *' usable in a constant expression}}
...
struct [[__sycl_detail__::add_ir_attributes_global_variable(nullptr, 1, 3.14, true, false, TestEnum::EnumVal1, 'F', nullptr, 1, 3.14, true, false, TestEnum::EnumVal1, 'F')]] InvalidGlobalVarStruct20{};         // expected-error {{each name argument in 'add_ir_attributes_global_variable' must be a 'const char *' usable in a constant expression}}
...
struct [[__sycl_detail__::add_ir_attributes_global_variable(CENullptr, CEInt, CEFloat, CETrue, CEFalse, CEEnum, CEChar, CENullptr, CEInt, CEFloat, CETrue, CEFalse, CEEnum, CEChar)]] InvalidGlobalVarStruct29{}; // expected-error {{each name argument in 'add_ir_attributes_global_variable' must be a 'const char *' usable in a constant expression}}
...
struct __attribute__((sycl_special_class)) InvalidSpecialClassStruct20 {
  void __init([[__sycl_detail__::add_ir_attributes_kernel_parameter(nullptr, 1, 3.14, true, false, TestEnum::EnumVal1, 'F', nullptr, 1, 3.14, true, false, TestEnum::EnumVal1, 'F')]] int x) {} // expected-error {{each name argument in 'add_ir_attributes_kernel_parameter' must be a 'const char *' usable in a constant expression}}
};
...
struct __attribute__((sycl_special_class)) InvalidSpecialClassStruct29 {
  void __init([[__sycl_detail__::add_ir_attributes_kernel_parameter(CENullptr, CEInt, CEFloat, CETrue, CEFalse, CEEnum, CEChar, CENullptr, CEInt, CEFloat, CETrue, CEFalse, CEEnum, CEChar)]] int x) {} // expected-error {{each name argument in 'add_ir_attributes_kernel_parameter' must be a 'const char *' usable in a constant expression}}
};
