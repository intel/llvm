...
[[__sycl_detail__::add_ir_attributes_function("Attr1")]] void InvalidFunctionCEName1(){};                                               // expected-error {{'add_ir_attributes_function' must have an attribute value for each attribute name}}
[[__sycl_detail__::add_ir_attributes_function("Attr1", nullptr, "Attr2")]] void InvalidFunctionCEName2(){};                             // expected-error {{'add_ir_attributes_function' must have an attribute value for each attribute name}}
[[__sycl_detail__::add_ir_attributes_function("Attr1", "Attr2", nullptr)]] void InvalidFunctionCEName3(){};                             // expected-error {{'add_ir_attributes_function' must have an attribute value for each attribute name}}
[[__sycl_detail__::add_ir_attributes_function({"Attr5", "Attr3"}, "Attr1")]] void InvalidFunctionCEName4(){};                           // expected-error {{'add_ir_attributes_function' must have an attribute value for each attribute name}}
[[__sycl_detail__::add_ir_attributes_function({"Attr5", "Attr3"}, "Attr1", nullptr, "Attr2")]] void InvalidFunctionCEName5(){};         // expected-error {{'add_ir_attributes_function' must have an attribute value for each attribute name}}
[[__sycl_detail__::add_ir_attributes_function({"Attr5", "Attr3"}, "Attr1", "Attr2", nullptr)]] void InvalidFunctionCEName6(){};         // expected-error {{'add_ir_attributes_function' must have an attribute value for each attribute name}}
...
struct [[__sycl_detail__::add_ir_attributes_global_variable("Attr1")]] InvalidGlobalVarStruct1{};                                               // expected-error {{'add_ir_attributes_global_variable' must have an attribute value for each attribute name}}
struct [[__sycl_detail__::add_ir_attributes_global_variable("Attr1", nullptr, "Attr2")]] InvalidGlobalVarStruct2{};                             // expected-error {{'add_ir_attributes_global_variable' must have an attribute value for each attribute name}}
struct [[__sycl_detail__::add_ir_attributes_global_variable("Attr1", "Attr2", nullptr)]] InvalidGlobalVarStruct3{};                             // expected-error {{'add_ir_attributes_global_variable' must have an attribute value for each attribute name}}
struct [[__sycl_detail__::add_ir_attributes_global_variable({"Attr5", "Attr3"}, "Attr1")]] InvalidGlobalVarStruct4{};                           // expected-error {{'add_ir_attributes_global_variable' must have an attribute value for each attribute name}}
struct [[__sycl_detail__::add_ir_attributes_global_variable({"Attr5", "Attr3"}, "Attr1", nullptr, "Attr2")]] InvalidGlobalVarStruct5{};         // expected-error {{'add_ir_attributes_global_variable' must have an attribute value for each attribute name}}
struct [[__sycl_detail__::add_ir_attributes_global_variable({"Attr5", "Attr3"}, "Attr1", "Attr2", nullptr)]] InvalidGlobalVarStruct6{};         // expected-error {{'add_ir_attributes_global_variable' must have an attribute value for each attribute name}}
...
struct __attribute__((sycl_special_class)) InvalidSpecialClassStruct1 {
  void __init([[__sycl_detail__::add_ir_attributes_kernel_parameter("Attr1")]] int x) {} // expected-error {{'add_ir_attributes_kernel_parameter' must have an attribute value for each attribute name}}
};
struct __attribute__((sycl_special_class)) InvalidSpecialClassStruct2 {
  void __init([[__sycl_detail__::add_ir_attributes_kernel_parameter("Attr1", nullptr, "Attr2")]] int x) {} // expected-error {{'add_ir_attributes_kernel_parameter' must have an attribute value for each attribute name}}
};
struct __attribute__((sycl_special_class)) InvalidSpecialClassStruct3 {
  void __init([[__sycl_detail__::add_ir_attributes_kernel_parameter("Attr1", "Attr2", nullptr)]] int x) {} // expected-error {{'add_ir_attributes_kernel_parameter' must have an attribute value for each attribute name}}
};
struct __attribute__((sycl_special_class)) InvalidSpecialClassStruct4 {
  void __init([[__sycl_detail__::add_ir_attributes_kernel_parameter({"Attr5", "Attr3"}, "Attr1")]] int x) {} // expected-error {{'add_ir_attributes_kernel_parameter' must have an attribute value for each attribute name}}
};
struct __attribute__((sycl_special_class)) InvalidSpecialClassStruct5 {
  void __init([[__sycl_detail__::add_ir_attributes_kernel_parameter({"Attr5", "Attr3"}, "Attr1", nullptr, "Attr2")]] int x) {} // expected-error {{'add_ir_attributes_kernel_parameter' must have an attribute value for each attribute name}}
};
struct __attribute__((sycl_special_class)) InvalidSpecialClassStruct6 {
  void __init([[__sycl_detail__::add_ir_attributes_kernel_parameter({"Attr5", "Attr3"}, "Attr1", "Attr2", nullptr)]] int x) {} // expected-error {{'add_ir_attributes_kernel_parameter' must have an attribute value for each attribute name}}
};
