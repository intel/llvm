...
// RUN: %clang_cc1 -fsycl-is-device -internal-isystem %S/Inputs -sycl-std=2020 -ast-dump -fsycl-force-glob-as-in-kernel-args %s | FileCheck --check-prefixes=CHECK,GLOB-AS %s
