...
int main() {
  ...
  deviceQueue.submit([&](sycl::handler &h) {
    // expected-note@Inputs/sycl.hpp:225 {{called by 'kernel_single_task<variables, (lambda}}
  ...
  deviceQueue.submit([&](sycl::handler &h) {
    // expected-note@Inputs/sycl.hpp:225 4{{called by 'kernel_single_task<functions, (lambda}}
  ...
  deviceQueue.submit([&](sycl::handler &h) {
    // expected-note@Inputs/sycl.hpp:225 {{called by 'kernel_single_task<ok, (lambda}}
