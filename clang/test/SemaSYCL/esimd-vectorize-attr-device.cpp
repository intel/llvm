...
// expected-warning@+1{{attribute 'intel::sycl_esimd_vectorize' is already applied with different arguments}}
...
// expected-error@+1{{'intel::sycl_esimd_vectorize' attribute only applies to functions}}
