...
// expected-error@+1{{'max_work_group_size' attribute requires an integer constant}}
...
class KernelFunctor {
public:
  // expected-error@+1{{'max_work_group_size' attribute requires a positive integral compile time constant expression}}
