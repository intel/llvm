...
// expected-error@+4 {{the 'clang::sycl_kernel_entry_point' attribute cannot be applied to a function defined with a function try block}}
#ifdef __SYCL_DEVICE_ONLY__
// expected-error@+3 {{SYCL kernel cannot use exceptions}}
#endif
