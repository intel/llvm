...
#ifdef SPIR64
// expected-warning@Inputs/sycl.hpp:242 {{size of kernel arguments (7994 bytes) may exceed the supported maximum of 2048 bytes on some devices}}
#elif SPIR32
// expected-warning@Inputs/sycl.hpp:242 {{size of kernel arguments (7986 bytes) may exceed the supported maximum of 2048 bytes on some devices}}
#endif
