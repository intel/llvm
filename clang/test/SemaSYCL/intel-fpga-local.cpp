...
//Merging of incompatible attributes: 'fpga_register' and 'max_replicates'.
...
// Merging of incompatible attributes: 'fpga_register' and 'force_pow2_depth'.
//expected-error@+3{{'fpga_register' and 'force_pow2_depth' attributes are not compatible}}
//expected-note@+1{{conflicting attribute is here}}
[[intel::force_pow2_depth(1)]] extern const int var_force_pow2_depth_2;
[[intel::fpga_register]] const int var_force_pow2_depth_2 =0;

// Merging of incompatible attributes: 'fpga_register' and 'numbanks'.
...
// Merging of incompatible attributes: 'fpga_register' and 'bankwidth'.
