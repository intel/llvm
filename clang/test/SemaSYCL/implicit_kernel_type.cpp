...
#if defined(WARN)
  // expected-warning@Inputs/sycl.hpp:242 {{SYCL 1.2.1 specification requires an explicit forward declaration for a kernel type name; your program may not be portable}}
#elif defined(ERROR)
  // expected-error@Inputs/sycl.hpp:242 {{SYCL 1.2.1 specification requires an explicit forward declaration for a kernel type name; your program may not be portable}}
#endif
