...
// expected-warning {{'device_has' attribute can only be applied to a SYCL kernel function}}
...
[[sycl::device_has(sycl::aspect::cpu)]] // expected-note{{previous attribute is here}} // expected-warning {{'device_has' attribute can only be applied to a SYCL kernel function}}
