...
// This test checks that an undefined "__failed_assertion" without SYCL_EXTERNAL which is not declared
// in a system header will lead to SYCL sema check failure.
