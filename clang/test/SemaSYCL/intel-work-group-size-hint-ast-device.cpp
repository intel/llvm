...
public:
  [[sycl::work_group_size_hint(16, 16, 16)]] void operator()() const {}
};
...
class FunctorAttr {
public:
  [[sycl::work_group_size_hint(128, 128, 128)]] void operator()() const {}
};
...
[[sycl::work_group_size_hint(2, 2, 2)]] void func1() {}
...
int main() {
  q.submit([&](handler &h) {
    ...
    // CHECK-NEXT:  value: Int 32
    // CHECK-NEXT:  IntegerLiteral{{.*}}32{{$}}
    h.single_task<class kernel_name5>([]() [[sycl::work_group_size_hint(32, 32, 32)]] {
      f32x32x32();
    });
