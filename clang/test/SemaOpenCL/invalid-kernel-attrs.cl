...
__kernel __attribute__((reqd_work_group_size(8, 16, -32))) void neg2() {} //expected-warning{{'reqd_work_group_size' attribute requires a non-negative integral compile time constant expression}}
