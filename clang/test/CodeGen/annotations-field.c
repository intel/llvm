...
// AMDGPU-NEXT: call ptr @llvm.ptr.annotation.p0.p4(ptr %{{.*}}, ptr addrspace(4) @.str{{.*}}, ptr addrspace(4) @.str{{.*}}, i32 13, ptr addrspace(4) null)
    gf.w = 42;
// X86: call ptr @llvm.ptr.annotation.p0.p0(ptr getelementptr inbounds nuw (i8, ptr @gf, i64 4), {{.*}}str{{.*}}str{{.*}}i32 14, ptr null)
// AMDGPU: call ptr @llvm.ptr.annotation.p0.p4(ptr getelementptr inbounds nuw (i8, ptr addrspacecast (ptr addrspace(1) @gf to ptr), i64 4), {{.*}}str{{.*}}str{{.*}}i32 14, ptr addrspace(4) null)
    gf.f = 0;
// X86: call ptr @llvm.ptr.annotation.p0.p0(ptr getelementptr inbounds nuw (i8, ptr @gf, i64 8), {{.*}}str{{.*}}str{{.*}}i32 15, ptr null)
// AMDGPU: call ptr @llvm.ptr.annotation.p0.p4(ptr getelementptr inbounds nuw (i8, ptr addrspacecast (ptr addrspace(1) @gf to ptr), i64 8), {{.*}}str{{.*}}str{{.*}}i32 15, ptr addrspace(4) null)
    return 0;
}
