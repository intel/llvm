...
static inline double __complex__ __devicelib___muldc3(double __a, double __b,
...
static inline double __complex__ __devicelib___divdc3(double __a, double __b,
                                                      double __c, double __d) {
  int __ilogbw = 0;
