...
function(add_lib_imf name)
  ...
  if(NOT DL_DEVICE)
    ...
    if (${DL_FTYPE} STREQUAL ${new-offload-lib-suffix})
...
add_lib_imf(libsycl-fallback-imf DEVICE DIR ${obj_binary_dir} FTYPE obj DTYPE fp32)
add_lib_imf(libsycl-fallback-imf DEVICE DIR ${obj_binary_dir} FTYPE new_offload_obj DTYPE fp32)
...
add_lib_imf(libsycl-fallback-imf-fp64 DEVICE DIR ${obj_binary_dir} FTYPE obj DTYPE fp64)
add_lib_imf(libsycl-fallback-imf-fp64 DEVICE DIR ${obj_binary_dir} FTYPE new_offload_obj DTYPE fp64)
...
add_lib_imf(libsycl-fallback-imf-bf16 DEVICE DIR ${obj_binary_dir} FTYPE obj DTYPE bf16)
add_lib_imf(libsycl-fallback-imf-bf16 DEVICE DIR ${obj_binary_dir} FTYPE new_offload_obj DTYPE bf16)
