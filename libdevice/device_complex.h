...
DEVICE_EXTERN_C
double __complex__ __devicelib___muldc3(double a, double b,
                                                 double c, double d);

DEVICE_EXTERN_C
float  __complex__ __devicelib___mulsc3(float a, float b,
                                                 float c, float d);

DEVICE_EXTERN_C
double __complex__ __devicelib___divdc3(double a, double b,
                                                 double c, double d);

DEVICE_EXTERN_C
float  __complex__ __devicelib___divsc3(float a, float b,
                                                 float c, float d);
