...
class Options:
    ...
    # LLVM install prefix containing the liboffload library and headers in
    # include/offload. When set, the Offload SubmitKernel benchmark is built.
    offload_prefix: str = None
    offload_lib_dir: str = None
