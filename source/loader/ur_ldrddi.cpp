...
urDeviceGetGlobalTimestamps(
    ...
    __urdlllocal ur_result_t UR_APICALL urQueueGetInfo(
        ...
        size_t *pPropSizeRet      ///< [out][optional] size in bytes returned in
    ...
    __urdlllocal ur_result_t UR_APICALL urKernelCreate(
        ...
        // extract platform's function pointer table
        auto dditable =
            reinterpret_cast<ur_program_object_t *>(hProgram)->dditable;
        ...
        __urdlllocal ur_result_t UR_APICALL urQueueCreate(
            ...
            const ur_queue_property_t
                *pProps, ///< [in][optional] specifies a list of queue
                         ///< properties and their corresponding values. Each
                         ///< property name is immediately followed by the
                         ///< corresponding desired value. The list is
                         ///< terminated with a 0. If a property value is not
                         ///< specified, then its default value will be used.
            ur_queue_handle_t
            ...
            // extract platform's function pointer table
            auto dditable =
                reinterpret_cast<ur_context_object_t *>(hContext)->dditable;
            auto pfnCreate = dditable->ur.Queue.pfnCreate;
            if (nullptr == pfnCreate) {
                return UR_RESULT_ERROR_UNINITIALIZED;
            }
            ...
            // convert loader handle to platform handle
            hContext =
                reinterpret_cast<ur_context_object_t *>(hContext)->handle;
        ...
        __urdlllocal ur_result_t UR_APICALL urKernelSetArgValue(
            ...
            // extract platform's function pointer table
            auto dditable =
                reinterpret_cast<ur_kernel_object_t *>(hKernel)->dditable;
        ...
        __urdlllocal ur_result_t UR_APICALL urKernelSetArgSampler(
            ...
            // convert loader handle to platform handle
            hArgValue =
                reinterpret_cast<ur_sampler_object_t *>(hArgValue)->handle;
        ...
        __urdlllocal ur_result_t UR_APICALL urModuleRetain(
            ...
            // extract platform's function pointer table
            auto dditable =
                reinterpret_cast<ur_module_object_t *>(hModule)->dditable;
        ...
        __urdlllocal ur_result_t UR_APICALL urModuleCreateWithNativeHandle(
            ...
            // forward to device-platform
            result =
                pfnCreateWithNativeHandle(hNativeModule, hContext, phModule);
        ...
        __urdlllocal ur_result_t UR_APICALL urPlatformGet(
            ...
            for (auto &platform : context->platforms) {
                ...
                if (nullptr != phPlatforms && NumEntries != 0) {
                    if (total_platform_handle_count +
                    ...
                    try {
                        for (uint32_t i = 0; i < library_platform_handle_count;
                             ++i) {
                            uint32_t platform_index =
                                total_platform_handle_count + i;
        ...
        __urdlllocal ur_result_t UR_APICALL urPlatformGetApiVersion(
            ...
            // extract platform's function pointer table
            auto dditable =
                reinterpret_cast<ur_platform_object_t *>(hDriver)->dditable;
        ...
        __urdlllocal ur_result_t UR_APICALL urPlatformCreateWithNativeHandle(
            ...
            // extract platform's function pointer table
            auto dditable =
                reinterpret_cast<ur_native_object_t *>(hNativePlatform)
                    ->dditable;
            auto pfnCreateWithNativeHandle =
        ...
        __urdlllocal ur_result_t UR_APICALL urProgramCreate(
            ...
            for (size_t i = 0; (nullptr != phModules) && (i < count); ++i) {
                phModulesLocal[i] =
                    reinterpret_cast<ur_module_object_t *>(phModules[i])
                        ->handle;
            }
        ...
        __urdlllocal ur_result_t UR_APICALL urProgramGetFunctionPointer(
            ...
            // extract platform's function pointer table
            auto dditable =
                reinterpret_cast<ur_device_object_t *>(hDevice)->dditable;
            auto pfnGetFunctionPointer =
                dditable->ur.Program.pfnGetFunctionPointer;
        ...
        __urdlllocal ur_result_t UR_APICALL urProgramCreateWithNativeHandle(
            ...
            // extract platform's function pointer table
            auto dditable =
                reinterpret_cast<ur_native_object_t *>(hNativeProgram)
                    ->dditable;
            auto pfnCreateWithNativeHandle =
        ...
        __urdlllocal ur_result_t UR_APICALL urInit(
            ...
            for (auto &platform : context->platforms) {
                ...
                platform.initStatus =
                    platform.dditable.ur.Global.pfnInit(device_flags);
                if (platform.initStatus == UR_RESULT_SUCCESS) {
    ...
    UR_DLLEXPORT ur_result_t UR_APICALL urGetGlobalProcAddrTable(
        ...
        for (auto &platform : loader::context->platforms) {
            ...
            auto getTableResult =
                getTable(version, &platform.dditable.ur.Global);
    ...
    UR_DLLEXPORT ur_result_t UR_APICALL urGetContextProcAddrTable(
        ...
        for (auto &platform : loader::context->platforms) {
            ...
            auto getTableResult =
                getTable(version, &platform.dditable.ur.Context);
            if (getTableResult == UR_RESULT_SUCCESS) {
                atLeastOneplatformValid = true;
            } else {
                platform.initStatus = getTableResult;
        ...
        if (UR_RESULT_SUCCESS == result) {
            if ((loader::context->platforms.size() > 1) ||
                ...
                pDdiTable->pfnGetNativeHandle =
                    loader::urContextGetNativeHandle;
                ...
                // return pointers directly to platform's DDIs
                *pDdiTable =
                    loader::context->platforms.front().dditable.ur.Context;
            }
        }
    ...
    UR_DLLEXPORT ur_result_t UR_APICALL urGetEnqueueProcAddrTable(
        ...
        for (auto &platform : loader::context->platforms) {
            ...
            auto getTableResult =
                getTable(version, &platform.dditable.ur.Enqueue);
            if (getTableResult == UR_RESULT_SUCCESS) {
                atLeastOneplatformValid = true;
            } else {
                platform.initStatus = getTableResult;
        ...
        if (UR_RESULT_SUCCESS == result) {
            if ((loader::context->platforms.size() > 1) ||
                ...
                // return pointers directly to platform's DDIs
                *pDdiTable =
                    loader::context->platforms.front().dditable.ur.Enqueue;
            }
        }
    ...
    UR_DLLEXPORT ur_result_t UR_APICALL urGetEventProcAddrTable(
        ...
        for (auto &platform : loader::context->platforms) {
            ...
            auto getTableResult =
                getTable(version, &platform.dditable.ur.Event);
            if (getTableResult == UR_RESULT_SUCCESS) {
                atLeastOneplatformValid = true;
            } else {
                platform.initStatus = getTableResult;
        ...
        if (UR_RESULT_SUCCESS == result) {
            if ((loader::context->platforms.size() > 1) ||
                ...
                pDdiTable->pfnGetProfilingInfo =
                    loader::urEventGetProfilingInfo;
                ...
                // return pointers directly to platform's DDIs
                *pDdiTable =
                    loader::context->platforms.front().dditable.ur.Event;
            }
        }
    ...
    UR_DLLEXPORT ur_result_t UR_APICALL urGetKernelProcAddrTable(
        ...
        for (auto &platform : loader::context->platforms) {
            ...
            auto getTableResult =
                getTable(version, &platform.dditable.ur.Kernel);
            if (getTableResult == UR_RESULT_SUCCESS) {
                atLeastOneplatformValid = true;
            } else {
                platform.initStatus = getTableResult;
        ...
        if (UR_RESULT_SUCCESS == result) {
            if ((loader::context->platforms.size() > 1) ||
                ...
                // return pointers directly to platform's DDIs
                *pDdiTable =
                    loader::context->platforms.front().dditable.ur.Kernel;
            }
        }
    ...
    UR_DLLEXPORT ur_result_t UR_APICALL urGetModuleProcAddrTable(
        ...
        for (auto &platform : loader::context->platforms) {
            ...
            auto getTableResult =
                getTable(version, &platform.dditable.ur.Module);
            if (getTableResult == UR_RESULT_SUCCESS) {
                atLeastOneplatformValid = true;
            } else {
                platform.initStatus = getTableResult;
    ...
    UR_DLLEXPORT ur_result_t UR_APICALL urGetPlatformProcAddrTable(
        ...
        for (auto &platform : loader::context->platforms) {
            ...
            auto getTable = reinterpret_cast<ur_pfnGetPlatformProcAddrTable_t>(
                GET_FUNCTION_PTR(platform.handle,
                                 "urGetPlatformProcAddrTable"));
            if (!getTable) {
                continue;
            }
            auto getTableResult =
                getTable(version, &platform.dditable.ur.Platform);
            if (getTableResult == UR_RESULT_SUCCESS) {
                atLeastOneplatformValid = true;
            } else {
                platform.initStatus = getTableResult;
        ...
        if (UR_RESULT_SUCCESS == result) {
            if ((loader::context->platforms.size() > 1) ||
                ...
                pDdiTable->pfnGetNativeHandle =
                    loader::urPlatformGetNativeHandle;
                pDdiTable->pfnCreateWithNativeHandle =
    ...
    UR_DLLEXPORT ur_result_t UR_APICALL urGetProgramProcAddrTable(
        ...
        for (auto &platform : loader::context->platforms) {
            ...
            auto getTableResult =
                getTable(version, &platform.dditable.ur.Program);
            if (getTableResult == UR_RESULT_SUCCESS) {
                atLeastOneplatformValid = true;
            } else {
                platform.initStatus = getTableResult;
        ...
        if (UR_RESULT_SUCCESS == result) {
            if ((loader::context->platforms.size() > 1) ||
                ...
                pDdiTable->pfnGetNativeHandle =
                    loader::urProgramGetNativeHandle;
                pDdiTable->pfnCreateWithNativeHandle =
                    loader::urProgramCreateWithNativeHandle;
            } else {
                // return pointers directly to platform's DDIs
                *pDdiTable =
                    loader::context->platforms.front().dditable.ur.Program;
            }
        }
    ...
    UR_DLLEXPORT ur_result_t UR_APICALL urGetQueueProcAddrTable(
        ...
        for (auto &platform : loader::context->platforms) {
            ...
            auto getTableResult =
                getTable(version, &platform.dditable.ur.Queue);
            if (getTableResult == UR_RESULT_SUCCESS) {
                atLeastOneplatformValid = true;
            } else {
                platform.initStatus = getTableResult;
        ...
        if (UR_RESULT_SUCCESS == result) {
            if ((loader::context->platforms.size() > 1) ||
                ...
                // return pointers directly to platform's DDIs
                *pDdiTable =
                    loader::context->platforms.front().dditable.ur.Queue;
            }
        }
    ...
    UR_DLLEXPORT ur_result_t UR_APICALL urGetSamplerProcAddrTable(
        ...
        for (auto &platform : loader::context->platforms) {
            ...
            auto getTableResult =
                getTable(version, &platform.dditable.ur.Sampler);
            if (getTableResult == UR_RESULT_SUCCESS) {
                atLeastOneplatformValid = true;
            } else {
                platform.initStatus = getTableResult;
        ...
        if (UR_RESULT_SUCCESS == result) {
            if ((loader::context->platforms.size() > 1) ||
                ...
                pDdiTable->pfnGetNativeHandle =
                    loader::urSamplerGetNativeHandle;
                pDdiTable->pfnCreateWithNativeHandle =
                    loader::urSamplerCreateWithNativeHandle;
            } else {
                // return pointers directly to platform's DDIs
                *pDdiTable =
                    loader::context->platforms.front().dditable.ur.Sampler;
            }
        }
    ...
    UR_DLLEXPORT ur_result_t UR_APICALL urGetDeviceProcAddrTable(
        ...
        for (auto &platform : loader::context->platforms) {
            ...
            auto getTableResult =
                getTable(version, &platform.dditable.ur.Device);
            if (getTableResult == UR_RESULT_SUCCESS) {
                atLeastOneplatformValid = true;
            } else {
                platform.initStatus = getTableResult;
        ...
        if (UR_RESULT_SUCCESS == result) {
            if ((loader::context->platforms.size() > 1) ||
                ...
                // return pointers directly to platform's DDIs
                *pDdiTable =
                    loader::context->platforms.front().dditable.ur.Device;
            }
        }
