...
__urdlllocal ur_result_t UR_APICALL urQueueCreate(
    ...
    if (nullptr != pfnCreate) {
        ...
        *phQueue = reinterpret_cast<ur_queue_handle_t>(d_context.get());
        ...
        __urdlllocal ur_result_t UR_APICALL urEventGetInfo(
            ...
            size_t propValueSize,     ///< [in] size in bytes of the event property
                                      ///< value
            void *pPropValue,         ///< [out][optional] value of the event property
            size_t *pPropValueSizeRet ///< [out][optional] bytes returned in
                                      ///< event property
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;

            // if the driver has created a custom function, then call it instead
            // of using the generic path
        ...
        __urdlllocal ur_result_t UR_APICALL urEventGetProfilingInfo(
            ...
            size_t propValueSize, ///< [in] size in bytes of the profiling
                                  ///< property value
            void *
                pPropValue,           ///< [out][optional] value of the profiling property
            size_t *pPropValueSizeRet ///< [out][optional] pointer to the actual
                                      ///< size in bytes returned in propValue
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
            ...
            auto pfnGetProfilingInfo =
                d_context.urDdiTable.Event.pfnGetProfilingInfo;
        ...
        __urdlllocal ur_result_t UR_APICALL urEventWait(
            ...
            const ur_event_handle_t
                *phEventWaitList ///< [in][range(0, numEvents)] pointer to a
        ...
        __urdlllocal ur_result_t UR_APICALL urEventGetNativeHandle(
            ...
            ur_native_handle_t * phNativeEvent ///< [out] a pointer to the
                                               ///< native handle of the event.
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
            ...
            auto pfnGetNativeHandle =
                d_context.urDdiTable.Event.pfnGetNativeHandle;
            if (nullptr != pfnGetNativeHandle) {
        ...
        __urdlllocal ur_result_t UR_APICALL urEventCreateWithNativeHandle(
            ...
            ur_context_handle_t hContext, ///< [in] handle of the context object
            ur_event_handle_t * phEvent   ///< [out] pointer to the handle of the
        ...
        __urdlllocal ur_result_t UR_APICALL urEventSetCallback(
            ...
            void *pUserData ///< [in][out][optional] pointer to data to be
                            ///< passed to callback.
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
        ...
        __urdlllocal ur_result_t UR_APICALL urMemImageCreate(
            ...
            if (nullptr != pfnImageCreate) {
                result = pfnImageCreate(hContext, flags, pImageFormat,
        ...
        __urdlllocal ur_result_t UR_APICALL urMemBufferCreate(
            ...
            ur_mem_flags_t
                flags,                ///< [in] allocation and usage information flags
            size_t size,              ///< [in] size in bytes of the memory object to be
                                      ///< allocated
            void *pHost,              ///< [in][optional] pointer to the buffer data
            ur_mem_handle_t *phBuffer ///< [out] pointer to handle of the memory
                                      ///< buffer created
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
        ...
        __urdlllocal ur_result_t UR_APICALL urMemBufferPartition(
            ...
            ur_buffer_region_t *
                pBufferCreateInfo, ///< [in] pointer to buffer create region
                                   ///< information
            ur_mem_handle_t *
            ...
            auto pfnBufferPartition =
                d_context.urDdiTable.Mem.pfnBufferPartition;
        ...
        __urdlllocal ur_result_t UR_APICALL urMemGetNativeHandle(
            ...
            ur_native_handle_t * phNativeMem ///< [out] a pointer to the native
                                             ///< handle of the mem.
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
            ...
            // of using the generic path
            auto pfnGetNativeHandle =
                d_context.urDdiTable.Mem.pfnGetNativeHandle;
            if (nullptr != pfnGetNativeHandle) {
        ...
        __urdlllocal ur_result_t UR_APICALL urMemCreateWithNativeHandle(
            ur_native_handle_t
                hNativeMem,               ///< [in] the native handle of the mem.
            ur_context_handle_t hContext, ///< [in] handle of the context object
            ur_mem_handle_t * phMem       ///< [out] pointer to the handle of the mem
                                          ///< object created.
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
        ...
        __urdlllocal ur_result_t UR_APICALL urMemGetInfo(
            ...
            size_t propSize,           ///< [in] the number of bytes of memory pointed to
                                       ///< by pMemInfo.
            void *
                pMemInfo, ///< [out][optional] array of bytes holding the info.
            ...
            size_t *pPropSizeRet ///< [out][optional] pointer to the actual size
                                 ///< in bytes of data queried by pMemInfo.
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
            ...
            if (nullptr != pfnGetInfo) {
                result = pfnGetInfo(hMemory, MemInfoType, propSize, pMemInfo,
                                    pPropSizeRet);
            } else {
                // generic implementation
            }
        ...
        __urdlllocal ur_result_t UR_APICALL urMemImageGetInfo(
            ...
            ur_image_info_t
                ImgInfoType, ///< [in] type of image info to retrieve.
            size_t propSize, ///< [in] the number of bytes of memory pointer to
                             ///< by pImgInfo.
            void *
                pImgInfo, ///< [out][optional] array of bytes holding the info.
                          ///< If propSize is less than the real number of bytes
                          ///< needed to return the info then the
            ///< ::UR_RESULT_ERROR_INVALID_SIZE error is returned and
            ///< pImgInfo is not used.
            size_t *pPropSizeRet ///< [out][optional] pointer to the actual size
                                 ///< in bytes of data queried by pImgInfo.
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
            ...
            if (nullptr != pfnImageGetInfo) {
                result = pfnImageGetInfo(hMemory, ImgInfoType, propSize,
        ...
        __urdlllocal ur_result_t UR_APICALL urQueueGetInfo(
            ...
            size_t propValueSize, ///< [in] size in bytes of the queue property
                                  ///< value provided
            void *pPropValue,     ///< [out] value of the queue property
            size_t *pPropSizeRet  ///< [out] size in bytes returned in queue
                                  ///< property value
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
        ...
        __urdlllocal ur_result_t UR_APICALL urQueueCreate(
            ...
            ur_device_handle_t hDevice,   ///< [in] handle of the device object
            const ur_queue_property_t
                *pProps, ///< [in] specifies a list of queue properties and
                         ///< their corresponding values. Each property name is
                         ///< immediately followed by the corresponding desired
                         ///< value. The list is terminated with a 0. If a
                         ///< property value is not specified, then its default
                         ///< value will be used.
            ur_queue_handle_t
                *phQueue ///< [out] pointer to handle of queue object created
        ) {
        ...
        __urdlllocal ur_result_t UR_APICALL urQueueGetNativeHandle(
            ...
            ur_native_handle_t * phNativeQueue ///< [out] a pointer to the
                                               ///< native handle of the queue.
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
            ...
            // of using the generic path
            auto pfnGetNativeHandle =
                d_context.urDdiTable.Queue.pfnGetNativeHandle;
            if (nullptr != pfnGetNativeHandle) {
        ...
        __urdlllocal ur_result_t UR_APICALL urQueueCreateWithNativeHandle(
            ...
            ur_context_handle_t hContext, ///< [in] handle of the context object
            ur_queue_handle_t * phQueue   ///< [out] pointer to the handle of the
        ...
        __urdlllocal ur_result_t UR_APICALL urSamplerCreate(
            ...
            const ur_sampler_property_t
                *pProps, ///< [in] specifies a list of sampler property names
            ...
            if (nullptr != pfnCreate) {
                ...
                // generic implementation
                *phSampler =
                    reinterpret_cast<ur_sampler_handle_t>(d_context.get());
            }
        ...
        __urdlllocal ur_result_t UR_APICALL urSamplerGetInfo(
            ...
            size_t propValueSize, ///< [in] size in bytes of the sampler
                                  ///< property value provided
            void *pPropValue,     ///< [out] value of the sampler property
            size_t *pPropSizeRet  ///< [out] size in bytes returned in sampler
                                  ///< property value
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
            ...
            if (nullptr != pfnGetInfo) {
                result = pfnGetInfo(hSampler, propName, propValueSize,
        ...
        __urdlllocal ur_result_t UR_APICALL urSamplerGetNativeHandle(
            ...
            ur_native_handle_t *
                phNativeSampler ///< [out] a pointer to the native
            ...
            // of using the generic path
            auto pfnGetNativeHandle =
                d_context.urDdiTable.Sampler.pfnGetNativeHandle;
            if (nullptr != pfnGetNativeHandle) {
        ...
        __urdlllocal ur_result_t UR_APICALL urSamplerCreateWithNativeHandle(
            ...
            ur_context_handle_t hContext,   ///< [in] handle of the context object
            ur_sampler_handle_t * phSampler ///< [out] pointer to the handle of
                                            ///< the sampler object created.
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
        ...
        __urdlllocal ur_result_t UR_APICALL urUSMHostAlloc(
            ...
            size_t size,                   ///< [in] size in bytes of the USM memory object to be
                                           ///< allocated
        ...
        __urdlllocal ur_result_t UR_APICALL urUSMDeviceAlloc(
            ...
            if (nullptr != pfnDeviceAlloc) {
                result = pfnDeviceAlloc(hContext, hDevice, pUSMProp, size,
                                        align, ppMem);
            } else {
                // generic implementation
            }
        ...
        __urdlllocal ur_result_t UR_APICALL urUSMSharedAlloc(
            ...
            if (nullptr != pfnSharedAlloc) {
                result = pfnSharedAlloc(hContext, hDevice, pUSMProp, size,
                                        align, ppMem);
            } else {
                // generic implementation
            }
        ...
        __urdlllocal ur_result_t UR_APICALL urUSMGetMemAllocInfo(
            ...
            ur_usm_alloc_info_t propName, ///< [in] the name of the USM
                                          ///< allocation property to query
            size_t propValueSize,         ///< [in] size in bytes of the USM allocation
                                          ///< property value
            void *pPropValue,             ///< [out][optional] value of the USM allocation
                                          ///< property
            ...
            auto pfnGetMemAllocInfo =
                d_context.urDdiTable.USM.pfnGetMemAllocInfo;
            if (nullptr != pfnGetMemAllocInfo) {
                result =
                    pfnGetMemAllocInfo(hContext, pMem, propName, propValueSize,
                                       pPropValue, pPropValueSizeRet);
            } else {
                // generic implementation
            }
        ...
        __urdlllocal ur_result_t UR_APICALL urDeviceGet(
            ...
            uint32_t NumEntries,         ///< [in] the number of devices to be added to
                                         ...
                                         ///< NumEntries should be greater than zero,
                                         ///< otherwise
                                         ///< ::UR_RESULT_ERROR_INVALID_VALUE, will be
                                         ///< returned.
            ur_device_handle_t *
                phDevices, ///< [out][optional][range(0, NumEntries)] array of
                           ///< handle of devices. If NumEntries is less than
                           ///< the number of devices available, then platform
                           ///< shall only retrieve that number of devices.
            uint32_t *
                pNumDevices ///< [out][optional] pointer to the number of
            ...
            if (nullptr != pfnGet) {
                result = pfnGet(hPlatform, DeviceType, NumEntries, phDevices,
                                pNumDevices);
            } else {
                // generic implementation
                for (size_t i = 0; (nullptr != phDevices) && (i < NumEntries);
                     ++i) {
                    phDevices[i] =
        ...
        __urdlllocal ur_result_t UR_APICALL urDeviceGetInfo(
            ...
            size_t propSize,            ///< [in] the number of bytes pointed to by
                                        ///< pDeviceInfo.
            void *pDeviceInfo,          ///< [out][optional] array of bytes holding the
                                        ///< info. If propSize is not equal to or greater
                                        ///< than the real number of bytes needed to
                                        ///< return the info then the
                                        ///< ::UR_RESULT_ERROR_INVALID_VALUE error is
                                        ///< returned and pDeviceInfo is not used.
            size_t *pPropSizeRet        ///< [out][optional] pointer to the actual size
                                        ///< in bytes of the queried infoType.
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
            ...
            if (nullptr != pfnGetInfo) {
                result = pfnGetInfo(hDevice, infoType, propSize, pDeviceInfo,
                                    pPropSizeRet);
            } else {
                // generic implementation
            }
        ...
        __urdlllocal ur_result_t UR_APICALL urDevicePartition(
            ...
            const ur_device_partition_property_t
                *pProperties,    ///< [in] null-terminated array of
                                 ///< <$_device_partition_t enum, value> pairs.
            uint32_t NumDevices, ///< [in] the number of sub-devices.
            ur_device_handle_t
                *phSubDevices, ///< [out][optional][range(0, NumDevices)] array
                               ///< of handle of devices. If NumDevices is less
                               ///< than the number of sub-devices available,
                               ///< then the function shall only retrieve that
                               ///< number of sub-devices.
            uint32_t *
                pNumDevicesRet ///< [out][optional] pointer to the number of
                               ///< sub-devices the device can be partitioned
                               ///< into according to the partitioning property.
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
            ...
            if (nullptr != pfnPartition) {
                result = pfnPartition(hDevice, pProperties, NumDevices,
                                      phSubDevices, pNumDevicesRet);
            } else {
                // generic implementation
                for (size_t i = 0;
                     (nullptr != phSubDevices) && (i < NumDevices); ++i) {
                    phSubDevices[i] =
                        reinterpret_cast<ur_device_handle_t>(d_context.get());
                }
            }
        ...
        __urdlllocal ur_result_t UR_APICALL urDeviceSelectBinary(
            ...
            const uint8_t *
                *ppBinaries, ///< [in] the array of binaries to select from.
            uint32_t
                NumBinaries, ///< [in] the number of binaries passed in
                             ///< ppBinaries. Must greater than or equal to zero
                             ///< otherwise
                             ///< ::UR_RESULT_ERROR_INVALID_VALUE is returned.
            uint32_t
                *pSelectedBinary ///< [out] the index of the selected binary in
                                 ///< the input array of binaries. If a suitable
                                 ///< binary was not found the function returns
                                 ///< ${X}_INVALID_BINARY.
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
            ...
            if (nullptr != pfnSelectBinary) {
                result = pfnSelectBinary(hDevice, ppBinaries, NumBinaries,
                                         pSelectedBinary);
            } else {
                // generic implementation
            }
        ...
        __urdlllocal ur_result_t UR_APICALL urDeviceGetNativeHandle(
            ...
            ur_native_handle_t *
                phNativeDevice ///< [out] a pointer to the native handle of the
                               ///< device.
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
            ...
            // of using the generic path
            auto pfnGetNativeHandle =
                d_context.urDdiTable.Device.pfnGetNativeHandle;
            if (nullptr != pfnGetNativeHandle) {
        ...
        __urdlllocal ur_result_t UR_APICALL urDeviceCreateWithNativeHandle(
            ...
            ur_platform_handle_t
                hPlatform,                ///< [in] handle of the platform instance
            ur_device_handle_t * phDevice ///< [out] pointer to the handle of
        ...
        __urdlllocal ur_result_t UR_APICALL urDeviceGetGlobalTimestamps(
            ur_device_handle_t hDevice, ///< [in] handle of the device instance
            uint64_t *
                pDeviceTimestamp,     ///< [out][optional] pointer to the Device's
                                      ///< global timestamp that correlates with the
                                      ///< Host's global timestamp value
            uint64_t * pHostTimestamp ///< [out][optional] pointer to the Host's
                                      ///< global timestamp that correlates with
                                      ///< the Device's global timestamp value
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
            ...
            if (nullptr != pfnGetGlobalTimestamps) {
                result = pfnGetGlobalTimestamps(hDevice, pDeviceTimestamp,
                                                pHostTimestamp);
            } else {
                // generic implementation
            }
        ...
        __urdlllocal ur_result_t UR_APICALL urKernelCreate(
            ...
            if (nullptr != pfnCreate) {
                ...
                // generic implementation
                *phKernel =
                    reinterpret_cast<ur_kernel_handle_t>(d_context.get());
            }
        ...
        __urdlllocal ur_result_t UR_APICALL urKernelSetArgValue(
            ...
            const void *pArgValue ///< [in] argument value represented as
                                  ///< matching arg type.
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
        ...
        __urdlllocal ur_result_t UR_APICALL urKernelSetArgLocal(
            ...
            uint32_t
                argIndex,  ///< [in] argument index in range [0, num args - 1]
            size_t argSize ///< [in] size of the local buffer to be allocated by
                           ///< the runtime
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
        ...
        __urdlllocal ur_result_t UR_APICALL urKernelGetInfo(
            ...
            void *pKernelInfo, ///< [in,out][optional] array of bytes holding
                               ///< the kernel info property. If propSize is not
                               ///< equal to or greater than the real number of
                               ///< bytes needed to return the info then the
                               ///< ::UR_RESULT_ERROR_INVALID_SIZE error is
                               ///< returned and pKernelInfo is not used.
            size_t
                *pPropSizeRet ///< [out][optional] pointer to the actual size in
            ...
            if (nullptr != pfnGetInfo) {
                result = pfnGetInfo(hKernel, propName, propSize, pKernelInfo,
                                    pPropSizeRet);
            } else {
                // generic implementation
            }
        ...
        __urdlllocal ur_result_t UR_APICALL urKernelGetGroupInfo(
            ...
            void *pPropValue, ///< [in,out][optional][range(0, propSize)] value
                              ///< of the Kernel Work Group property.
            size_t
                *pPropSizeRet ///< [out][optional] pointer to the actual size in
                              ///< bytes of data being queried by propName.
        ) {
        ...
        __urdlllocal ur_result_t UR_APICALL urKernelGetSubGroupInfo(
            ...
            void *pPropValue, ///< [in,out][range(0, propSize)][optional] value
                              ///< of the Kernel SubGroup property.
            size_t
                *pPropSizeRet ///< [out][optional] pointer to the actual size in
                              ///< bytes of data being queried by propName.
        ) {
            ...
            auto pfnGetSubGroupInfo =
                d_context.urDdiTable.Kernel.pfnGetSubGroupInfo;
            if (nullptr != pfnGetSubGroupInfo) {
                result = pfnGetSubGroupInfo(hKernel, hDevice, propName,
        ...
        __urdlllocal ur_result_t UR_APICALL urKernelSetArgPointer(
            ...
            size_t argSize, ///< [in] size of argument type
            const void
                *pArgValue ///< [in][optional] SVM pointer to memory location
                           ///< holding the argument value. If null then
                           ///< argument value is considered null.
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
            ...
            auto pfnSetArgPointer =
                d_context.urDdiTable.Kernel.pfnSetArgPointer;
            if (nullptr != pfnSetArgPointer) {
                result =
                    pfnSetArgPointer(hKernel, argIndex, argSize, pArgValue);
            } else {
                // generic implementation
            }
        ...
        __urdlllocal ur_result_t UR_APICALL urKernelSetExecInfo(
            ...
            const void
                *pPropValue ///< [in][range(0, propSize)] pointer to memory
        ...
        __urdlllocal ur_result_t UR_APICALL urKernelSetArgSampler(
            ...
            auto pfnSetArgSampler =
                d_context.urDdiTable.Kernel.pfnSetArgSampler;
        ...
        __urdlllocal ur_result_t UR_APICALL urKernelGetNativeHandle(
            ...
            ur_native_handle_t *
                phNativeKernel ///< [out] a pointer to the native handle of the
                               ///< kernel.
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
            ...
            // of using the generic path
            auto pfnGetNativeHandle =
                d_context.urDdiTable.Kernel.pfnGetNativeHandle;
            if (nullptr != pfnGetNativeHandle) {
        ...
        __urdlllocal ur_result_t UR_APICALL urKernelCreateWithNativeHandle(
            ...
            ur_context_handle_t hContext, ///< [in] handle of the context object
            ur_kernel_handle_t * phKernel ///< [out] pointer to the handle of
                                          ///< the kernel object created.
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
            ...
            if (nullptr != pfnCreateWithNativeHandle) {
                result = pfnCreateWithNativeHandle(hNativeKernel, hContext,
                                                   phKernel);
            } else {
                // generic implementation
                *phKernel =
        ...
        __urdlllocal ur_result_t UR_APICALL urModuleCreate(
            ...
            const char *pOptions, ///< [in] pointer to compiler options
                                  ///< null-terminated string.
            ur_modulecreate_callback_t
                pfnNotify,   ///< [in][optional] A function pointer to a
                             ///< notification routine that is called when program
                             ///< compilation is complete.
            void *pUserData, ///< [in][optional] Passed as an argument when
                             ///< pfnNotify is called.
            ur_module_handle_t
            ...
            if (nullptr != pfnCreate) {
                ...
                // generic implementation
                *phModule =
                    reinterpret_cast<ur_module_handle_t>(d_context.get());
            }
        ...
        __urdlllocal ur_result_t UR_APICALL urModuleRelease(
            ur_module_handle_t
                hModule ///< [in] handle for the Module to release
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
        ...
        __urdlllocal ur_result_t UR_APICALL urModuleGetNativeHandle(
            ...
            ur_native_handle_t *
                phNativeModule ///< [out] a pointer to the native handle of the
                               ///< module.
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
            ...
            // of using the generic path
            auto pfnGetNativeHandle =
                d_context.urDdiTable.Module.pfnGetNativeHandle;
            if (nullptr != pfnGetNativeHandle) {
        ...
        __urdlllocal ur_result_t UR_APICALL urModuleCreateWithNativeHandle(
            ...
            ur_context_handle_t
                hContext,                 ///< [in] handle of the context instance.
            ur_module_handle_t * phModule ///< [out] pointer to the handle of
            ...
            if (nullptr != pfnCreateWithNativeHandle) {
                result = pfnCreateWithNativeHandle(hNativeModule, hContext,
                                                   phModule);
            } else {
                // generic implementation
                *phModule =
        ...
        __urdlllocal ur_result_t UR_APICALL urPlatformGet(
            uint32_t NumEntries, ///< [in] the number of platforms to be added
                                 ///< to phPlatforms. If phPlatforms is not
                                 ///< NULL, then NumEntries should be greater
                                 ///< than zero, otherwise
                                 ///< ::UR_RESULT_ERROR_INVALID_SIZE, will be
                                 ///< returned.
            ur_platform_handle_t *
                phPlatforms,         ///< [out][optional][range(0, NumEntries)] array of
                                     ///< handle of platforms. If NumEntries is less
                                     ///< than the number of platforms available, then
                                     ///< ::urPlatformGet shall only retrieve that
                                     ///< number of platforms.
            uint32_t * pNumPlatforms ///< [out][optional] returns the total
            ...
            if (nullptr != pfnGet) {
                ...
                // generic implementation
                for (size_t i = 0; (nullptr != phPlatforms) && (i < NumEntries);
                     ++i) {
                    phPlatforms[i] =
        ...
        __urdlllocal ur_result_t UR_APICALL urPlatformGetInfo(
            ...
            ur_platform_info_t
                PlatformInfoType, ///< [in] type of the info to retrieve
            size_t
                Size,            ///< [in] the number of bytes pointed to by pPlatformInfo.
            void *pPlatformInfo, ///< [out][optional] array of bytes holding the
                                 ///< info. If Size is not equal to or greater
                                 ///< to the real number of bytes needed to
                                 ///< return the info then the
                                 ///< ::UR_RESULT_ERROR_INVALID_SIZE error is
                                 ///< returned and pPlatformInfo is not used.
            size_t *pSizeRet     ///< [out][optional] pointer to the actual number
                                 ///< of bytes being queried by pPlatformInfo.
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
            ...
            if (nullptr != pfnGetInfo) {
                result = pfnGetInfo(hPlatform, PlatformInfoType, Size,
                                    pPlatformInfo, pSizeRet);
            } else {
                // generic implementation
            }
        ...
        __urdlllocal ur_result_t UR_APICALL urPlatformGetApiVersion(
            ...
            auto pfnGetApiVersion =
                d_context.urDdiTable.Platform.pfnGetApiVersion;
        ...
        __urdlllocal ur_result_t UR_APICALL urPlatformGetNativeHandle(
            ur_platform_handle_t hPlatform, ///< [in] handle of the platform.
            ur_native_handle_t *
                phNativePlatform ///< [out] a pointer to the native
            ...
            // of using the generic path
            auto pfnGetNativeHandle =
                d_context.urDdiTable.Platform.pfnGetNativeHandle;
            if (nullptr != pfnGetNativeHandle) {
        ...
        __urdlllocal ur_result_t UR_APICALL urPlatformCreateWithNativeHandle(
            ...
            ur_platform_handle_t *
                phPlatform ///< [out] pointer to the handle of the
        ...
        __urdlllocal ur_result_t UR_APICALL urGetLastResult(
            ur_platform_handle_t
                hPlatform, ///< [in] handle of the platform instance
            const char *
                *ppMessage ///< [out] pointer to a string containing adapter
            ...
            // if the driver has created a custom function, then call it instead
            // of using the generic path
            auto pfnGetLastResult =
                d_context.urDdiTable.Global.pfnGetLastResult;
        ...
        __urdlllocal ur_result_t UR_APICALL urProgramCreate(
            ...
            const ur_module_handle_t
                *phModules,                ///< [in][range(0, count)] pointer to array of
                                           ///< modules.
            const char *pOptions,          ///< [in][optional] pointer to linker options
                                           ///< null-terminated string.
            ur_program_handle_t *phProgram ///< [out] pointer to handle of
            ...
            if (nullptr != pfnCreate) {
                result =
                    pfnCreate(hContext, count, phModules, pOptions, phProgram);
            } else {
                // generic implementation
                *phProgram =
        ...
        __urdlllocal ur_result_t UR_APICALL urProgramCreateWithBinary(
            ...
            auto pfnCreateWithBinary =
                d_context.urDdiTable.Program.pfnCreateWithBinary;
        ...
        __urdlllocal ur_result_t UR_APICALL urProgramGetFunctionPointer(
            ...
            ur_program_handle_t
                hProgram,              ///< [in] handle of the program to search for function
                                       ///< in. The program must already be built to the
                                       ///< specified device, or otherwise
                                       ///< ::UR_RESULT_ERROR_INVALID_PROGRAM_EXECUTABLE is
                                       ///< returned.
            const char *pFunctionName, ///< [in] A null-terminates string
                                       ///< denoting the mangled function name.
            void *
                *ppFunctionPointer ///< [out] Returns the pointer to the
                                   ///< function if it is found in the program.
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
        ...
        __urdlllocal ur_result_t UR_APICALL urProgramGetInfo(
            ...
            void
                *pProgramInfo,   ///< [in,out][optional] array of bytes of holding
                                 ///< the program info property. If propSize is
                                 ///< not equal to or greater than the real number
                                 ///< of bytes needed to return the info then the
                                 ///< ::UR_RESULT_ERROR_INVALID_SIZE error is
                                 ///< returned and pProgramInfo is not used.
            size_t *pPropSizeRet ///< [out][optional] pointer to the actual size
                                 ///< in bytes of data copied to propName.
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
        ...
        __urdlllocal ur_result_t UR_APICALL urProgramGetBuildInfo(
            ...
            void *pPropValue, ///< [in,out][optional] value of the Program build
                              ///< property. If propSize is not equal to or
                              ///< greater than the real number of bytes needed
                              ///< to return the info then the
                              ///< ::UR_RESULT_ERROR_INVALID_SIZE error is
                              ///< returned and pKernelInfo is not used.
            size_t
                *pPropSizeRet ///< [out][optional] pointer to the actual size in
        ...
        __urdlllocal ur_result_t UR_APICALL urProgramSetSpecializationConstant(
            ...
            const void
                *pSpecValue ///< [in] pointer to the specialization value bytes
        ) {
            ur_result_t result = UR_RESULT_SUCCESS;
            ...
            if (nullptr != pfnSetSpecializationConstant) {
                result = pfnSetSpecializationConstant(hProgram, specId,
                                                      specSize, pSpecValue);
            } else {
                // generic implementation
            }
        ...
        __urdlllocal ur_result_t UR_APICALL urProgramGetNativeHandle(
            ...
            ur_native_handle_t *
                phNativeProgram ///< [out] a pointer to the native
            ...
            // of using the generic path
            auto pfnGetNativeHandle =
                d_context.urDdiTable.Program.pfnGetNativeHandle;
            if (nullptr != pfnGetNativeHandle) {
        ...
        __urdlllocal ur_result_t UR_APICALL urProgramCreateWithNativeHandle(
            ...
            ur_context_handle_t
                hContext,                   ///< [in] handle of the context instance
            ur_program_handle_t * phProgram ///< [out] pointer to the handle of
    ...
    UR_DLLEXPORT ur_result_t UR_APICALL urGetMemProcAddrTable(
        ...
        pDdiTable->pfnCreateWithNativeHandle =
            driver::urMemCreateWithNativeHandle;
