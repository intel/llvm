...
typedef struct ur_usm_p2_p_exp_dditable_t {
...
urGetUsmP2PExpProcAddrTable(
    ur_api_version_t version,             ///< [in] API version requested
    ur_usm_p2_p_exp_dditable_t *pDdiTable ///< [in,out] pointer to table of DDI function pointers
);
...
typedef struct ur_dditable_t {
    ...
    ur_usm_p2_p_exp_dditable_t UsmP2PExp;
