...
typedef enum ur_function_t {
  ...
  UR_FUNCTION_ENQUEUE_HOST_TASK_EXP = 273,
  /// @cond
...
typedef enum ur_structure_type_t {
  ...
  UR_STRUCTURE_TYPE_EXP_HOST_TASK_PROPERTIES = 0x5000,
  /// @cond
...
typedef enum ur_device_info_t {
  ...
  /// tasks
  UR_DEVICE_INFO_ENQUEUE_HOST_TASK_SUPPORT_EXP = 0x7000,
  /// @cond
...
typedef enum ur_command_t {
  ...
  UR_COMMAND_HOST_TASK_EXP = 0x3000,
  /// @cond
