...
typedef enum ur_function_t {
  ...
  UR_FUNCTION_PHYSICAL_MEM_GET_INFO = 227,
  /// Enumerator for ::urEnqueueUSMSharedAllocExp
  UR_FUNCTION_ENQUEUE_USM_SHARED_ALLOC_EXP = 229,
  /// Enumerator for ::urEnqueueUSMHostAllocExp
  UR_FUNCTION_ENQUEUE_USM_HOST_ALLOC_EXP = 230,
  /// Enumerator for ::urEnqueueUSMFreeExp
  UR_FUNCTION_ENQUEUE_USM_FREE_EXP = 231,
  /// Enumerator for ::urUSMPoolCreateExp
  UR_FUNCTION_USM_POOL_CREATE_EXP = 232,
  /// Enumerator for ::urUSMPoolDestroyExp
  UR_FUNCTION_USM_POOL_DESTROY_EXP = 233,
  /// Enumerator for ::urUSMPoolSetThresholdExp
  UR_FUNCTION_USM_POOL_SET_THRESHOLD_EXP = 234,
  /// Enumerator for ::urUSMPoolGetDefaultDevicePoolExp
  UR_FUNCTION_USM_POOL_GET_DEFAULT_DEVICE_POOL_EXP = 235,
  /// Enumerator for ::urUSMPoolGetInfoExp
  UR_FUNCTION_USM_POOL_GET_INFO_EXP = 236,
  /// Enumerator for ::urUSMPoolSetDevicePoolExp
  UR_FUNCTION_USM_POOL_SET_DEVICE_POOL_EXP = 237,
  /// Enumerator for ::urEnqueueUSMDeviceAllocExp
  UR_FUNCTION_ENQUEUE_USM_DEVICE_ALLOC_EXP = 238,
  /// Enumerator for ::urUSMPoolGetDevicePoolExp
  UR_FUNCTION_USM_POOL_GET_DEVICE_POOL_EXP = 238,
  /// Enumerator for ::urUSMPoolTrimToExp
  UR_FUNCTION_USM_POOL_TRIM_TO_EXP = 239,
  /// Enumerator for ::urBindlessImagesMapExternalLinearMemoryExp
  UR_FUNCTION_BINDLESS_IMAGES_MAP_EXTERNAL_LINEAR_MEMORY_EXP = 240,
  /// Enumerator for ::urBindlessImagesReleaseExternalMemoryExp
  UR_FUNCTION_BINDLESS_IMAGES_RELEASE_EXTERNAL_MEMORY_EXP = 241,
  /// Enumerator for ::urBindlessImagesImportExternalSemaphoreExp
  UR_FUNCTION_BINDLESS_IMAGES_IMPORT_EXTERNAL_SEMAPHORE_EXP = 242,
  /// Enumerator for ::urCommandBufferAppendUSMMemcpyExp
  UR_FUNCTION_COMMAND_BUFFER_APPEND_USM_MEMCPY_EXP = 243,
  /// Enumerator for ::urCommandBufferAppendUSMFillExp
  UR_FUNCTION_COMMAND_BUFFER_APPEND_USM_FILL_EXP = 244,
  /// Enumerator for ::urCommandBufferAppendMemBufferCopyExp
  UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_COPY_EXP = 245,
  /// Enumerator for ::urCommandBufferAppendMemBufferWriteExp
  UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_WRITE_EXP = 246,
  /// Enumerator for ::urCommandBufferAppendMemBufferReadExp
  UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_READ_EXP = 247,
  /// Enumerator for ::urCommandBufferAppendMemBufferCopyRectExp
  UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_COPY_RECT_EXP = 248,
  /// Enumerator for ::urCommandBufferAppendMemBufferWriteRectExp
  UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_WRITE_RECT_EXP = 249,
  /// Enumerator for ::urCommandBufferAppendMemBufferReadRectExp
  UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_READ_RECT_EXP = 250,
  /// Enumerator for ::urCommandBufferAppendMemBufferFillExp
  UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_FILL_EXP = 251,
  /// Enumerator for ::urCommandBufferAppendUSMPrefetchExp
  UR_FUNCTION_COMMAND_BUFFER_APPEND_USM_PREFETCH_EXP = 252,
  /// Enumerator for ::urCommandBufferAppendUSMAdviseExp
  UR_FUNCTION_COMMAND_BUFFER_APPEND_USM_ADVISE_EXP = 253,
  /// Enumerator for ::urEnqueueCommandBufferExp
  UR_FUNCTION_ENQUEUE_COMMAND_BUFFER_EXP = 254,
  /// Enumerator for ::urCommandBufferUpdateSignalEventExp
  UR_FUNCTION_COMMAND_BUFFER_UPDATE_SIGNAL_EVENT_EXP = 255,
  /// Enumerator for ::urCommandBufferUpdateWaitEventsExp
  UR_FUNCTION_COMMAND_BUFFER_UPDATE_WAIT_EVENTS_EXP = 256,
  /// Enumerator for ::urEnqueueKernelLaunchCustomExp
  UR_FUNCTION_ENQUEUE_KERNEL_LAUNCH_CUSTOM_EXP = 257,
  /// Enumerator for ::urEnqueueEventsWaitWithBarrierExt
  UR_FUNCTION_ENQUEUE_EVENTS_WAIT_WITH_BARRIER_EXT = 258,
  /// Enumerator for ::urEnqueueNativeCommandExp
  UR_FUNCTION_ENQUEUE_NATIVE_COMMAND_EXP = 259,
  /// Enumerator for ::urAdapterSetLoggerCallback
  UR_FUNCTION_ADAPTER_SET_LOGGER_CALLBACK = 260,
  /// Enumerator for ::urAdapterSetLoggerCallbackLevel
  UR_FUNCTION_ADAPTER_SET_LOGGER_CALLBACK_LEVEL = 261,
  /// @cond
