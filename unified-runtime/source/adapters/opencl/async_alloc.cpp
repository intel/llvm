...
ur_result_t
urEnqueueUSMHostAllocExp(ur_queue_handle_t, ur_usm_pool_handle_t, const size_t,
                         const ur_exp_async_usm_alloc_properties_t *, uint32_t,
...
ur_result_t urEnqueueUSMFreeExp(ur_queue_handle_t, ur_usm_pool_handle_t, void *,
