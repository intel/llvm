...
UR_APIEXPORT ur_result_t UR_APICALL
    urMemBufferCreate(ur_context_handle_t hContext, ur_mem_flags_t flags,
                      size_t size, const ur_buffer_properties_t *pProperties,
...
UR_APIEXPORT ur_result_t UR_APICALL
    urMemGetInfo(ur_mem_handle_t /*hMemory*/, ur_mem_info_t /*propName*/,
...
UR_APIEXPORT ur_result_t UR_APICALL
    urMemImageGetInfo(ur_mem_handle_t /*hMemory*/, ur_image_info_t /*propName*/,
                      size_t /*propSize*/, void * /*pPropValue*/,
                      size_t * /*pPropSizeRet*/) {
