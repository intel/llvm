...
// Pull the namespaced concrete-handle struct into global scope for callers
// that are outside `ur::level_zero::common`. The cast helper remains
// namespace-scoped and must be qualified.
using ur::level_zero::common::kernel_command_handle;
