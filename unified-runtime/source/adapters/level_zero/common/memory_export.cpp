...
ur_result_t urMemoryExportAllocExportableMemoryExp(
  ...
  ZE2UR_CALL(zeMemAllocDevice, (asInterface(hContext)->getZeHandle(), &MemAllocDesc, size,
...
ur_result_t urMemoryExportExportMemoryHandleExp(
  ...
  case UR_EXP_EXTERNAL_MEM_TYPE_OPAQUE_FD: {
    ...
    ZE2UR_CALL(zeMemGetAllocProperties,
               (asInterface(hContext)->getZeHandle(), pMem, &MemAllocProps, nullptr));
  ...
  case UR_EXP_EXTERNAL_MEM_TYPE_WIN32_NT: {
    ...
    ZE2UR_CALL(zeMemGetAllocProperties,
               (asInterface(hContext)->getZeHandle(), pMem, &MemAllocProps,
                nullptr));
