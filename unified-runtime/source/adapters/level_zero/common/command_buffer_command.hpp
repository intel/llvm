...
struct ur_exp_command_buffer_command_handle_t_ : public ur_shared_handle_base_t {
...
// Cast from opaque UR command-buffer-command handle to the common concrete.
inline ur_exp_command_buffer_command_handle_t_ *
cast(::ur_exp_command_buffer_command_handle_t h) {
  return reinterpret_cast<ur_exp_command_buffer_command_handle_t_ *>(h);
}
