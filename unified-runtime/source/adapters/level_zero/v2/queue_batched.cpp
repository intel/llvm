...
// void batch_manager::clearOldCommandLists() {
//   runBatches.clear();
// }
...
//     v2::raii::command_list_unique_handle &&newRegularBatch) {
//   UR_CALL(enqueueCurrentBatchUnlocked(immediateList.getZeCommandList(),
...
ur_queue_batched_t::queueFlushUnlocked(locked<batch_manager> &batchLocked) {
  ...
  return renewBatchUnlocked(
      batchLocked); // batchLocked->renewRegularUnlocked(
