...
ur_result_t urBindlessImagesImageCopyExp(
    ...
    std::cerr << __FUNCTION__ << "pSrc=" << pSrc << std::endl;

    std::cerr << __FUNCTION__ << "pSrcImageDesc->width=" << pSrcImageDesc->width << std::endl;
    std::cerr << __FUNCTION__ << "pSrcImageDesc->height=" << pSrcImageDesc->height << std::endl;
    std::cerr << __FUNCTION__ << "pSrcImageDesc->depth=" << pSrcImageDesc->depth << std::endl;
    std::cerr << __FUNCTION__ << "pSrcImageDesc->arraySize=" << pSrcImageDesc->arraySize << std::endl;  
