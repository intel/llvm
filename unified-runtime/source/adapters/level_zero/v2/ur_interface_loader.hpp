...
urContextSetExtendedDeleter(::ur_context_handle_t hContext,
                            ...
                            void *pUserData);
ur_result_t urMemImageCreate(::ur_context_handle_t hContext,
...
ur_result_t urMemBufferPartition(::ur_mem_handle_t hBuffer,
                                 ur_mem_flags_t flags,
...
ur_result_t urUSMGetMemAllocInfo(::ur_context_handle_t hContext,
                                 const void *pMem, ur_usm_alloc_info_t propName,
                                 size_t propSize, void *pPropValue,
                                 size_t *pPropSizeRet);
...
ur_result_t urVirtualMemUnmap(::ur_context_handle_t hContext,
                              const void *pStart, size_t size);
...
ur_result_t urPhysicalMemGetInfo(::ur_physical_mem_handle_t hPhysicalMem,
                                 ...
                                 size_t propSize, void *pPropValue,
                                 size_t *pPropSizeRet);
ur_result_t urProgramCreateWithIL(::ur_context_handle_t hContext,
...
ur_result_t urKernelGetSuggestedLocalWorkSizeWithArgs(
    ::ur_kernel_handle_t hKernel, ::ur_queue_handle_t hQueue,
    uint32_t numWorkDim, const size_t *pGlobalWorkOffset,
    const size_t *pGlobalWorkSize, uint32_t numArgs,
    const ur_exp_kernel_arg_properties_t *pArgs,
    size_t *pSuggestedLocalWorkSize);
...
ur_result_t urBindlessImagesImageCopyExp(
    ...
    ::ur_event_handle_t *phEvent);
ur_result_t
urBindlessImagesImageGetInfoExp(::ur_context_handle_t hContext,
                                ::ur_exp_image_mem_native_handle_t hImageMem,
...
ur_result_t urCommandBufferAppendUSMMemcpyExp(
    ::ur_exp_command_buffer_handle_t hCommandBuffer, void *pDst,
