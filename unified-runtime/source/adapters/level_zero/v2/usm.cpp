...
ur_result_t ur_usm_pool_handle_t_::free(void *ptr) {
  ...
  if (umfPool) {
    ...
    UR_LOG(ERROR, "Failed to find pool for pointer: {}", ptr);
    return UR_RESULT_ERROR_INVALID_VALUE;
  }
}
...
ur_result_t urUSMGetMemAllocInfo(
  ...
  case UR_USM_ALLOC_INFO_TYPE: {
    ...
    case ZE_MEMORY_TYPE_SHARED:
      ...
      break;
    default:
      UR_LOG(ERROR, "urUSMGetMemAllocInfo: unexpected usm memory type");
      return UR_RESULT_ERROR_INVALID_VALUE;
    }
  ...
  default:
    UR_LOG(ERROR, "urUSMGetMemAllocInfo: unsupported ParamName");
    return UR_RESULT_ERROR_INVALID_VALUE;
  }
  }
  return UR_RESULT_SUCCESS;
