...
template <typename T> void test_fill(T Val) {
  ...
  const T Value = Val;
  {
    ...
    Queue.submit([&](handler &Cgh) {
      accessor<T, 1, access_mode::write, access::target::device> Accessor(
...
template <typename T> void test_copy_ptr_acc() {
  ...
  T DstValue = 0;
  {
    ...
    queue Queue;
    Queue.submit([&](handler &Cgh) {
      accessor<T, 0, access_mode::write, access::target::device>
          DstAcc(DstBuf, Cgh, sycl::no_init);
...
template <typename T> void test_3D_copy_ptr_acc() {
...

  {
    ...
    queue Queue;
    Queue.submit([&](handler &Cgh) {
      accessor<T, 3, access_mode::write, access::target::device> Accessor(
          Buffer, Cgh, Range);
      Cgh.copy(Values, Accessor);
    });
  }
...
template <typename T> void test_copy_acc_ptr() {
  ...
  T Values[Size] = {0};
  {
    ...
    queue Queue;
    Queue.submit([&](handler &Cgh) {
      accessor<T, 1, access_mode::read, access::target::device> Accessor(
          Buffer, Cgh, range<1>(Size));
  ...
  // Check copy from 'const T' accessor to 'void *' memory.
  {
    ...
    queue Queue;
    Queue.submit([&](handler &Cgh) {
      auto Acc = Buffer.template get_access<access_mode::read>(Cgh);
  ...
  T DstValue = 0;
  {
    ...
    queue Queue;
    Queue.submit([&](handler &Cgh) {
      accessor<T, 0, access_mode::read, access::target::device> SrcAcc(SrcBuf,
                                                                        Cgh);
  ...
  {
    buffer<T, 1> SrcBuf(&SrcValue, range<1>(1));
    accessor<T, 0, access_mode::read, access::target::device,
...
template <typename T> void test_3D_copy_acc_ptr() {
...

  {
    ...
    queue Queue;
    Queue.submit([&](handler &Cgh) {
      accessor<T, 3, access_mode::read, access::target::device> Accessor(
          Buffer, Cgh, Range);
      Cgh.copy(Accessor, Values);
    });
  }
...
template <typename T> void test_copy_acc_acc() {
  ...
  T Values[Size] = {0};
  {
    ...
    queue Queue;
    Queue.submit([&](handler &Cgh) {
      accessor<T, 1, access_mode::read, access::target::device> AccessorFrom(
          BufferFrom, Cgh, range<1>(Size));
      accessor<T, 1, access_mode::write, access::target::device> AccessorTo(
...
template <typename T> void test_2D_copy_acc_acc() {
  ...
  T Values[Size][Size] = {{0}};
  {
    ...
    queue Queue;
    Queue.submit([&](handler &Cgh) {
      accessor<T, 2, access_mode::read, access::target::device> AccessorFrom(
          BufferFrom, Cgh, range<2>(Size, Size));
      accessor<T, 2, access_mode::write, access::target::device> AccessorTo(
...
template <typename T> void test_3D_copy_acc_acc() {
  ...
  T Values[Size][Size][Size] = {{{0}}};
  {
    ...
    queue Queue;
    Queue.submit([&](handler &Cgh) {
      accessor<T, 3, access_mode::read, access::target::device> AccessorFrom(
          BufferFrom, Cgh, range<3>(Size, Size, Size));
      accessor<T, 3, access_mode::write, access::target::device> AccessorTo(
...
template <typename T> void test_0D1D_copy_acc_acc() {
  ...
  T Src(1), Dst(0);
  {
    ...
    queue Queue;
    Queue.submit([&](handler &Cgh) {
      accessor<T, 0, access_mode::read, access::target::device> AccessorFrom(
          BufferFrom, Cgh);
      accessor<T, 1, access_mode::write, access::target::device> AccessorTo(
          BufferTo, Cgh);
      Cgh.copy(AccessorFrom, AccessorTo);
  ...
  Dst = T(0);
  {
    ...
    Queue.submit([&](handler &Cgh) {
      accessor<T, 1, access_mode::read, access::target::device> AccessorFrom(
          BufferFrom, Cgh);
      accessor<T, 0, access_mode::write, access::target::device> AccessorTo(
          BufferTo, Cgh);
      Cgh.copy(AccessorFrom, AccessorTo);
    });
  }
