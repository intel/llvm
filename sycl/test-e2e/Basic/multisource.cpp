...
// RUN: %clangxx -fsycl -fsycl-targets=%{sycl_triple} %{arch_flag} %t.kernel.o %t.main.o -Wno-unused-command-line-argument -o %t1.fat
// RUN: %{run} %t1.fat
...
// RUN: %{build} -c -o %t.main.o -DMAIN_APP
// RUN: %clangxx -fsycl -fsycl-targets=%{sycl_triple} %{arch_flag} %t.init.o %t.calc.o %t.main.o -Wno-unused-command-line-argument -o %t2.fat
// RUN: %{run} %t2.fat
