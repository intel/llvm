...
// successfully during runtime for a cpu device of the opencl backend. In this
// context, verification during runtime means for the runtime to verify that the
// device to which a kernel is submitted actually provides the guarantees
// required by the kernel submission. If the device does not provide all
