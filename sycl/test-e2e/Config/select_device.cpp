...
// RUN: %{build} -o %t.out
//
// RUN: %GPU_RUN_PLACEHOLDER %t.out DEVICE_INFO write > %t.txt
// RUN: %GPU_RUN_PLACEHOLDER %t.out DEVICE_INFO read %t.txt
//
// RUN: %GPU_RUN_PLACEHOLDER %t.out PLATFORM_INFO write > %t.txt
// RUN: %GPU_RUN_PLACEHOLDER %t.out PLATFORM_INFO read %t.txt
//
// RUN: %GPU_RUN_PLACEHOLDER %t.out DEVICE_ERROR_INFO write > %t.txt
// RUN: %GPU_RUN_PLACEHOLDER %t.out DEVICE_ERROR_INFO read %t.txt
//
// RUN: %GPU_RUN_PLACEHOLDER %t.out PLATFORM_ERROR_INFO write > %t.txt
// RUN: %GPU_RUN_PLACEHOLDER %t.out PLATFORM_ERROR_INFO read %t.txt
//
// RUN: %GPU_RUN_PLACEHOLDER %t.out REG_EX_INFO write > %t.txt
// RUN: %GPU_RUN_PLACEHOLDER %t.out REG_EX_INFO read %t.txt
//
// RUN: %GPU_RUN_PLACEHOLDER %t.out DEVICE_NAME_INFO write > %t.txt
// RUN: %GPU_RUN_PLACEHOLDER %t.out DEVICE_NAME_INFO read %t.txt
//
// RUN: %GPU_RUN_PLACEHOLDER %t.out PLATFORM_NAME_INFO write > %t.txt
// RUN: %GPU_RUN_PLACEHOLDER %t.out PLATFORM_NAME_INFO read %t.txt
//
// RUN: %GPU_RUN_PLACEHOLDER %t.out DEVICE_MULTI_INFO write > %t.txt
// RUN: %GPU_RUN_PLACEHOLDER %t.out DEVICE_MULTI_INFO read %t.txt
//
// RUN: %GPU_RUN_PLACEHOLDER %t.out DEVICE_MALFORMED_INFO write > %t.txt
// RUN: %GPU_RUN_PLACEHOLDER %t.out DEVICE_MALFORMED_INFO read %t.txt
//
// RUN: %GPU_RUN_PLACEHOLDER %t.out PLATOFRM_MALFORMED_INFO write > %t.txt
// RUN: %GPU_RUN_PLACEHOLDER %t.out PLATOFRM_MALFORMED_INFO read %t.txt
//
// RUN: %GPU_RUN_PLACEHOLDER %t.out DRIVER_MALFORMED_INFO write > %t.txt
// RUN: %GPU_RUN_PLACEHOLDER %t.out DRIVER_MALFORMED_INFO read %t.txt
//
// RUN: %GPU_RUN_PLACEHOLDER %t.out PLATVER_MALFORMED_INFO write > %t.txt
// RUN: %GPU_RUN_PLACEHOLDER %t.out PLATVER_MALFORMED_INFO read %t.txt
//
