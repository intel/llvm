...
bool joint_exclusive_scan(sycl::queue q, T input, BinaryOperation binary_op) {
  ...
  q.submit([&](sycl::handler &cgh) {
    cgh.parallel_for(sycl::nd_range<1>(N, N), [=](sycl::nd_item<1> it) {
      ...
      sycl::ext::oneapi::experimental::joint_exclusive_scan(
          g, in, in + N, output_with_init, init, binary_op);
      sycl::ext::oneapi::experimental::joint_exclusive_scan(
