...
std::vector<cmplx<double>>
    marray_cplx_test_cases<test_struct>::std_test_values = {
        ...
        cmplx<double>(0, 0.5),
        cmplx<double>(0, -0.5),
        cmplx<double>(0, inf_val<double>),
        cmplx<double>(0, nan_val<double>),
        ...
        cmplx<double>(0.5, 1),
        cmplx<double>(0.5, -1),
        cmplx<double>(0.5, 0.5),
        cmplx<double>(0.5, -0.5),
        cmplx<double>(0.5, 0),
        cmplx<double>(0.5, inf_val<double>),
        ...
        cmplx<double>(inf_val<double>, 1),
        cmplx<double>(inf_val<double>, -1),
        cmplx<double>(inf_val<double>, 0.5),
        cmplx<double>(inf_val<double>, -0.5),
        cmplx<double>(inf_val<double>, 0),

        cmplx<double>(nan_val<double>, 1),
        cmplx<double>(nan_val<double>, -1),
        cmplx<double>(nan_val<double>, 0.5),
        cmplx<double>(nan_val<double>, -0.5),
        cmplx<double>(nan_val<double>, 0),
        cmplx<double>(nan_val<double>, nan_val<double>),
};
template <template <typename> typename test_struct>
