...
// RUN: %clangxx %{aot_options} %{aot_backend_options} -fsycl-device-code-split=per_kernel -fsycl-allow-device-image-dependencies -ftarget-export-symbols %t_a.o %t_b.o %t_c.o %t_d.o %S/Inputs/basic.cpp -o %t.out
// RUN: %{run} %t.out
