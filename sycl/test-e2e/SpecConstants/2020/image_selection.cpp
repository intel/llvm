...
int main() {
  ...
  // CHECK-DEFAULT-SAME: -> UR_RESULT_SUCCESS
  ...
  // CHECK-ENABLED: ---> urKernelSetArgMemObj(
  // CHECK-ENABLED-SAME: .phArgValue = {{(0x)?[0-9,a-f,A-F]+}}
  // CHECK-ENABLED-SAME: -> UR_RESULT_SUCCESS
  ...
  // CHECK-ENABLED: ---> urKernelSetArgMemObj(
  // CHECK-ENABLED-SAME: .phArgValue = {{0+}}
  // CHECK-ENABLED-SAME: -> UR_RESULT_SUCCESS
  // CHECK-ENABLED: Default value of specialization constant was used.
  ...
  // CHECK-DEFAULT-EXPLICIT-SET: ---> urKernelSetArgMemObj(
  // CHECK-DEFAULT-EXPLICIT-SET-SAME:	.phArgValue = {{0+}}
  // CHECK-DEFAULT-EXPLICIT-SET-SAME: -> UR_RESULT_SUCCESS
  ...
  // CHECK-DEFAULT-BACK-TO-DEFAULT: ---> urKernelSetArgMemObj(
  // CHECK-DEFAULT-BACK-TO-DEFAULT-SAME: .phArgValue = {{0+}}
  // CHECK-DEFAULT-BACK-TO-DEFAULT-SAME: -> UR_RESULT_SUCCESS
