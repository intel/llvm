...
template <template <typename> typename CallableT> void runTest(sycl::queue Q) {
  ...
  sycl::host_accessor<int, 1, sycl::access_mode::read_write> HAcc1D;
  sycl::host_accessor<int, 2, sycl::access_mode::read_write> HAcc2D;
  sycl::host_accessor<int, 3, sycl::access_mode::read_write> HAcc3D;
...
void runTestMulti(sycl::queue Q1) {
  ...
  sycl::host_accessor<int, 1, sycl::access_mode::read_write> HAcc1D1;
  sycl::host_accessor<int, 1, sycl::access_mode::read_write> HAcc1D2;
  sycl::host_accessor<int, 2, sycl::access_mode::read_write> HAcc2D1;
  sycl::host_accessor<int, 2, sycl::access_mode::read_write> HAcc2D2;
  sycl::host_accessor<int, 3, sycl::access_mode::read_write> HAcc3D1;
  sycl::host_accessor<int, 3, sycl::access_mode::read_write> HAcc3D2;
