...
const char* const kernel_names[] = {
  "_ZTSZZ10run_test_aiENKUlRN4sycl3_V17handlerEE_clES2_E8kernel_a",
  "",
};
...
template <> struct KernelInfo<kernel_a> {
  __SYCL_DLL_LOCAL
  static constexpr const char* getName() { return "_ZTSZZ10run_test_aiENKUlRN4sycl3_V17handlerEE_clES2_E8kernel_a"; }
  __SYCL_DLL_LOCAL
