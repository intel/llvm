...
const char* const kernel_names[] = {
  "_ZTSN4sycl3_V16detail19__pf_kernel_wrapperIZZ4mainENKUlRNS0_7handlerEE_clES4_E10FillBufferEE",
  "_ZTSZZ4mainENKUlRN4sycl3_V17handlerEE_clES2_E10FillBuffer",
  "",
};

static constexpr unsigned kernel_args_sizes[] = {2, 1, };
...
template <> struct KernelInfo<::sycl::detail::__pf_kernel_wrapper<FillBuffer>> {
  __SYCL_DLL_LOCAL
  static constexpr const char* getName() { return "_ZTSN4sycl3_V16detail19__pf_kernel_wrapperIZZ4mainENKUlRNS0_7handlerEE_clES4_E10FillBufferEE"; }
  __SYCL_DLL_LOCAL
...
#ifndef NDEBUG
    return "::sycl::detail::__pf_kernel_wrapper<FillBuffer>";
#else
    return "";
#endif
  }
...
template <> struct KernelInfo<FillBuffer> {
  __SYCL_DLL_LOCAL
  static constexpr const char* getName() { return "_ZTSZZ4mainENKUlRN4sycl3_V17handlerEE_clES2_E10FillBuffer"; }
  __SYCL_DLL_LOCAL
