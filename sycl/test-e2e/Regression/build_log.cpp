...
void test() {
  ...
  b.submit([&](handler &aj) {
    auto ak = c.get_access<access_mode::read>(aj);
    auto al = d.get_access<access_mode::read>(aj);
    auto am = e.get_access<access_mode::read>(aj);
    auto an = f.get_access<access_mode::read>(aj);
    auto ao = g.get_access<access_mode::read>(aj);
    auto ap = h.get_access<access_mode::read>(aj);
    auto aq = i.get_access<access_mode::read>(aj);
    auto ar = j.get_access<access_mode::read>(aj);
    auto as = k.get_access<access_mode::read>(aj);
    auto at = l.get_access<access_mode::read>(aj);
    auto au = m.get_access<access_mode::write>(aj);
    auto av = n.get_access<access_mode::write>(aj);
    auto aw = o.get_access<access_mode::write>(aj);
    auto ax = p.get_access<access_mode::write>(aj);
    auto ay = q.get_access<access_mode::write>(aj);
    auto az = r.get_access<access_mode::write>(aj);
    auto ba = s.get_access<access_mode::write>(aj);
    auto bb = t.get_access<access_mode::write>(aj);
    auto bc = u.get_access<access_mode::write>(aj);
    auto bd = v.get_access<access_mode::write>(aj);
    auto be = w.get_access<access_mode::write>(aj);
    auto bf = x.get_access<access_mode::write>(aj);
    auto bg = y.get_access<access_mode::write>(aj);
    auto bh = z.get_access<access_mode::write>(aj);
    auto bi = aa.get_access<access_mode::write>(aj);
    auto bj = ab.get_access<access_mode::write>(aj);
    auto bk = ac.get_access<access_mode::write>(aj);
    auto bl = ad.get_access<access_mode::write>(aj);
    auto bm = ae.get_access<access_mode::write>(aj);
    auto bn = af.get_access<access_mode::write>(aj);
    auto bo = ag.get_access<access_mode::write>(aj);
    auto bp = ah.get_access<access_mode::write>(aj);
    auto bq = ai.get_access<access_mode::write>(aj);
