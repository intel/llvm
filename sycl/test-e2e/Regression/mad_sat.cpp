// RUN: %{build} -Wno-error=implicitly-unsigned-literal -o %t.out
// RUNx: %{run} %t.out
...
int main() {
  ...
  using inte64_x3 = sycl::vec<int64_t, 3>;
  using inte64_x4 = sycl::vec<int64_t, 4>;
  using inte64_x8 = sycl::vec<int64_t, 8>;
  using inte64_x16 = sycl::vec<int64_t, 16>;

  {
    const inte64_x3 verification3(9223372036854775807LL, 9223372036854775807LL,
                                  -9223372036854775808LL);

    inte64_x3 inputData_0(1152105081885725616LL, 8383539663869980295LL,
                          -3013159033463244495LL);
    inte64_x3 inputData_1(9169239286331099647LL, 8545168655265359544LL,
                          69290337040907021LL);
    inte64_x3 inputData_2(-5670250901301018333LL, 216462155376518854LL,
  ...
  {
    const inte64_x4 verification4(9223372036854775807LL, 9223372036854775807LL,
                                  -9223372036854775808LL,
                                  9223372036854775807LL);

    inte64_x4 inputData_0(-4713774672458165250LL, 7161321293740295698LL,
                          -7560042360032818022LL, 1712118953348815386LL);
    inte64_x4 inputData_1(-5256951628950351348LL, 3094294642897896981LL,
                          4183324171724765944LL, 1726930751531248453LL);
    inte64_x4 inputData_2(-614349234816759997LL, -7793620271163345724LL,
  ...
  }
  {
    ...
    inte64_x8 inputData_0(3002837817109371705LL, -6132505093056073745LL,
    ...
    inte64_x8 inputData_1(3895748400226584336LL, -3171989754828069475LL,
    ...
    inte64_x8 inputData_2(5847800471474896191LL, 6421268696360310080LL,
  ...
  {
    const inte64_x16 verification16(
        -9223372036854775808LL, 9223372036854775807LL, 9223372036854775807LL,
        -9223372036854775808LL, 9223372036854775807LL, 9223372036854775807LL,
