...
// RUN: %clangxx -DIMPL_SUBGROUP -fsycl -fno-sycl-device-code-split-esimd -Xclang -fsycl-allow-func-ptr %S/../single_SPMD_invoke_several_nested_ESIMD.cpp -o %t.out
 ...
 * InvokeSimd/Regression/single_SPMD_invoke_several_nested_ESIMD.cpp, but
