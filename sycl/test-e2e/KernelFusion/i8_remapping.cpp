...
// Test private internalization with "LocalSize" == 3 on two specially-prepared
// buffers:
// - `tmp` uses a struct for which the frontend generates `i8`-typed GEPs to
//   access the elements in the sycl::vec. These GEPs shall _not_ be remapped
