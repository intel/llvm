...
// RUN: env ZE_DEBUG=-1 ZE_ENABLE_VALIDATION_LAYER=1 SYCL_UR_TRACE=-1 UR_L0_ENABLE_RELAXED_ALLOCATION_LIMITS=1 SYCL_PROGRAM_COMPILE_OPTIONS=-ze-intel-greater-than-4GB-buffer-required %{run} %t.out
