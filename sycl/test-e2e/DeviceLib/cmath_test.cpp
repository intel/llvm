...
float ref[TEST_NUM] = {
    1.0f, 1.0f, 100, 0.5, 1.0, 0, 0, -2, 1, 2,   1,   1,   0,   1, 1, 0, 0, 0,
    0,    0,    1,   1,   0.5, 0, 0, 1,  0, 2,   0,   0,   0,   0, 0, 1, 0, 1,
    2,    0,    1,   2,   5,   0, 0, 0,  0, 0.5, 0.5, NAN, NAN, 2, 0, 0, 0, 0,
    ...
    deviceQueue.submit([&](s::handler &cgh) {
      ...
      cgh.single_task<class DeviceMathTest1>([=]() {
        ...
        *((uint32_t *)&subnormal) = 0x7FFFFF;
        ...
        res_access[i++] = std::nearbyint(0.9f);
