...
int main() {
...

  {
    ...
    test_host(input_vals, ref_vals, FT(uint16_t, sycl::ext::intel::math::double2bfloat16));
    test(device_queue, input_vals, ref_vals, FT(uint16_t, sycl::ext::intel::math::double2bfloat16));
  }
