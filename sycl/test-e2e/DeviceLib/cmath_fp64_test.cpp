...
double ref[TEST_NUM] = {
    1.0, 1.0, 6, 100, 0.5, 1.0, 0, 0, -2, 1, 2, 1,   1,   1,   0,   1, 1, 0, 0,
    0,   0,   0, 1,   1,   0.5, 0, 2, 0,  0, 1, 0,   2,   0,   0,   0, 0, 0, 1,
    0,   1,   2, 0,   1,   2,   5, 0, 0,  0, 0, 0.5, 0.5, NAN, NAN, 2, 0, 0, 0,
    ...
    deviceQueue.submit([&](sycl::handler &cgh) {
      ...
      cgh.single_task<class DeviceMathTest>([=]() {
        ...
        *((uint64_t *)&subnormal) = 0xFFFFFFFFFFFFFULL;
        ...
        res_access[i++] = std::nearbyint(0.9);
