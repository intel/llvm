...
#include "group_joint_sort_p1p3.hpp"
#include <cassert>
#include <cmath>
#include <cstddef>
#include <iostream>
  ...
  nd_range<1> num_items((range<1>(wg_size)), (range<1>(wg_size)));
  {
    ...
    q.submit([&](auto &h) {
       ...
       h.parallel_for(num_items, [=](nd_item<1> i) {
         Ty *optr = slm.template get_multi_ptr<access::decorated::no>().get();
...
int main() {
...

  {
    ...
    std::cout << "work group joint sort p1i8_u32_p3i8 passes" << std::endl;
  }

  {
    ...
    test_work_group_joint_sort<int32_t, 8, NUM, decltype(work_group_sorter)>(
        q, a, work_group_sorter);
    std::cout << "work group joint sort p1i32_u32_p3i8 passes" << std::endl;
  }

  {
    ...
    test_work_group_joint_sort<int16_t, 8, NUM, decltype(work_group_sorter)>(
        q, a, work_group_sorter);
    std::cout << "work group joint sort p1i16_u32_p3i8 passes" << std::endl;
  }

  {
    ...
    test_work_group_joint_sort<int64_t, 8, NUM, decltype(work_group_sorter)>(
        q, a, work_group_sorter);
    std::cout << "work group joint sort p1i64_u32_p3i8 passes" << std::endl;
  }

  {
    ...
    test_work_group_joint_sort<float, 8, NUM, decltype(work_group_sorter)>(
        q, a, work_group_sorter);
    std::cout << "work group joint sort p1f32_u32_p3i8 passes" << std::endl;
  }

  {
    ...
    test_work_group_joint_sort<uint8_t, 8, NUM, decltype(work_group_sorter)>(
        q, a, work_group_sorter);
    std::cout << "work group joint sort p1u8_u32_p3i8 passes" << std::endl;
  }

  {
    ...
    test_work_group_joint_sort<uint16_t, 8, NUM, decltype(work_group_sorter)>(
        q, a, work_group_sorter);
    std::cout << "work group joint sort p1u16_u32_p3i8 passes" << std::endl;
  }

  {
    ...
    test_work_group_joint_sort<uint32_t, 8, NUM, decltype(work_group_sorter)>(
        q, a, work_group_sorter);
    std::cout << "work group joint sort p1u32_u32_p3i8 passes" << std::endl;
  }

  {
    ...
    test_work_group_joint_sort<uint64_t, 8, NUM, decltype(work_group_sorter)>(
        q, a, work_group_sorter);
    std::cout << "work group joint sort p1u64_u32_p3i8 passes" << std::endl;
  }
