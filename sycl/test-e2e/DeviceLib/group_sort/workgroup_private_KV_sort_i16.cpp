...
int main() {
  queue q;
  {
    ...
    int16_t ikeys[NUM] = {1,   -11,  1,   9,   -3,  100, 34,  8,  121,
    ...
    auto work_group_sorter = [](int16_t *keys, uint32_t *vals, uint32_t n,
                                uint8_t *scratch) {
#if __DEVICE_CODE
#ifdef DES
    ...
    auto work_group_sorter1 = [](int16_t *keys, uint8_t *vals, uint32_t n,
                                 uint8_t *scratch) {
#if __DEVICE_CODE
#ifdef DES
    ...
    auto work_group_sorter2 = [](int16_t *keys, int8_t *vals, uint32_t n,
                                 uint8_t *scratch) {
#if __DEVICE_CODE
#ifdef DES
    ...
    auto work_group_sorter3 = [](int16_t *keys, uint16_t *vals, uint32_t n,
                                 uint8_t *scratch) {
#if __DEVICE_CODE
#ifdef DES
    ...
    auto work_group_sorter4 = [](int16_t *keys, int16_t *vals, uint32_t n,
                                 uint8_t *scratch) {
#if __DEVICE_CODE
#ifdef DES
    ...
    auto work_group_sorter5 = [](int16_t *keys, uint32_t *vals, uint32_t n,
                                 uint8_t *scratch) {
#if __DEVICE_CODE
#ifdef DES
      __devicelib_default_work_group_private_sort_close_descending_p1i16_p1u32_u32_p1i8(
    ...
    auto work_group_sorter6 = [](int16_t *keys, int32_t *vals, uint32_t n,
                                 uint8_t *scratch) {
#if __DEVICE_CODE
#ifdef DES
    ...
    auto work_group_sorter7 = [](int16_t *keys, uint64_t *vals, uint32_t n,
                                 uint8_t *scratch) {
#if __DEVICE_CODE
#ifdef DES
    ...
    auto work_group_sorter8 = [](int16_t *keys, int64_t *vals, uint32_t n,
                                 uint8_t *scratch) {
#if __DEVICE_CODE
#ifdef DES
    ...
    std::cout << "KV private sort <Key: int16_t, Val: uint8_t> NUM = " << NUM1
              << ", WG = 1 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, uint8_t, 2, NUM1,
                                    decltype(work_group_sorter1)>(
        q, ikeys, ivals1, work_group_sorter1);
    std::cout << "KV private sort <Key: int16_t, Val: uint8_t> NUM = " << NUM1
              << ", WG = 2 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, uint8_t, 4, NUM1,
                                    decltype(work_group_sorter1)>(
        q, ikeys, ivals1, work_group_sorter1);
    std::cout << "KV private sort <Key: int16_t, Val: uint8_t> NUM = " << NUM1
              << ", WG = 4 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, uint8_t, 8, NUM1,
                                    decltype(work_group_sorter1)>(
        q, ikeys, ivals1, work_group_sorter1);
    std::cout << "KV private sort <Key: int16_t, Val: uint8_t> NUM = " << NUM1
              << ", WG = 8 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, uint8_t, 16, NUM1,
                                    decltype(work_group_sorter1)>(
        q, ikeys, ivals1, work_group_sorter1);
    std::cout << "KV private sort <Key: int16_t, Val: uint8_t> NUM = " << NUM1
              << ", WG = 16 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, uint8_t, 32, NUM1,
                                    decltype(work_group_sorter1)>(
        q, ikeys, ivals1, work_group_sorter1);
    std::cout << "KV private sort <Key: int16_t, Val: uint8_t> NUM = " << NUM1
              << ", WG = 32 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, int8_t, 1, NUM,
                                    decltype(work_group_sorter2)>(
        q, ikeys, ivals2, work_group_sorter2);
    std::cout << "KV private sort <Key: int16_t, Val: int8_t> NUM = " << NUM
              << ", WG = 1 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, int8_t, 5, NUM,
                                    decltype(work_group_sorter2)>(
        q, ikeys, ivals2, work_group_sorter2);
    std::cout << "KV private sort <Key: int16_t, Val: int8_t> NUM = " << NUM
              << ", WG = 5 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, int8_t, 7, NUM,
                                    decltype(work_group_sorter2)>(
        q, ikeys, ivals2, work_group_sorter2);
    std::cout << "KV private sort <Key: int16_t, Val: int8_t> NUM = " << NUM
              << ", WG = 7 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, int8_t, 35, NUM,
                                    decltype(work_group_sorter2)>(
        q, ikeys, ivals2, work_group_sorter2);
    std::cout << "KV private sort <Key: int16_t, Val: int8_t> NUM = " << NUM
              << ", WG = 35 pass." << std::endl;
    ...
    test_work_group_KV_private_sort<int16_t, uint16_t, 1, NUM2,
                                    decltype(work_group_sorter3)>(
        q, ikeys, ivals3, work_group_sorter3);
    std::cout << "KV private sort <Key: int16_t, Val: uint16_t> NUM = " << NUM2
              << ", WG = 1 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, uint16_t, 2, NUM2,
                                    decltype(work_group_sorter3)>(
        q, ikeys, ivals3, work_group_sorter3);
    std::cout << "KV private sort <Key: int16_t, Val: uint16_t> NUM = " << NUM2
              << ", WG = 2 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, uint16_t, 3, NUM2,
                                    decltype(work_group_sorter3)>(
        q, ikeys, ivals3, work_group_sorter3);
    std::cout << "KV private sort <Key: int16_t, Val: uint16_t> NUM = " << NUM2
              << ", WG = 3 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, uint16_t, 4, NUM2,
                                    decltype(work_group_sorter3)>(
        q, ikeys, ivals3, work_group_sorter3);
    std::cout << "KV private sort <Key: int16_t, Val: uint16_t> NUM = " << NUM2
              << ", WG = 4 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, uint16_t, 6, NUM2,
                                    decltype(work_group_sorter3)>(
        q, ikeys, ivals3, work_group_sorter3);
    std::cout << "KV private sort <Key: int16_t, Val: uint16_t> NUM = " << NUM2
              << ", WG = 6 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, uint16_t, 8, NUM2,
                                    decltype(work_group_sorter3)>(
        q, ikeys, ivals3, work_group_sorter3);
    std::cout << "KV private sort <Key: int16_t, Val: uint16_t> NUM = " << NUM2
              << ", WG = 8 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, uint16_t, 12, NUM2,
                                    decltype(work_group_sorter3)>(
        q, ikeys, ivals3, work_group_sorter3);
    std::cout << "KV private sort <Key: int16_t, Val: uint16_t> NUM = " << NUM2
              << ", WG = 12 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, uint16_t, 24, NUM2,
                                    decltype(work_group_sorter3)>(
        q, ikeys, ivals3, work_group_sorter3);
    std::cout << "KV private sort <Key: int16_t, Val: uint16_t> NUM = " << NUM2
              << ", WG = 24 pass." << std::endl;
    ...
    test_work_group_KV_private_sort<int16_t, int16_t, 1, NUM3,
                                    decltype(work_group_sorter4)>(
        q, ikeys, ivals4, work_group_sorter4);
    std::cout << "KV private sort <Key: int16_t, Val: int16_t> NUM = " << NUM3
              << ", WG = 1 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, int16_t, 2, NUM3,
                                    decltype(work_group_sorter4)>(
        q, ikeys, ivals4, work_group_sorter4);
    std::cout << "KV private sort <Key: int16_t, Val: int16_t> NUM = " << NUM3
              << ", WG = 2 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, int16_t, 4, NUM3,
                                    decltype(work_group_sorter4)>(
        q, ikeys, ivals4, work_group_sorter4);
    std::cout << "KV private sort <Key: int16_t, Val: int16_t> NUM = " << NUM3
              << ", WG = 4 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, int16_t, 5, NUM3,
                                    decltype(work_group_sorter4)>(
        q, ikeys, ivals4, work_group_sorter4);
    std::cout << "KV private sort <Key: int16_t, Val: int16_t> NUM = " << NUM3
              << ", WG = 5 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, int16_t, 10, NUM3,
                                    decltype(work_group_sorter4)>(
        q, ikeys, ivals4, work_group_sorter4);
    std::cout << "KV private sort <Key: int16_t, Val: int16_t> NUM = " << NUM3
              << ", WG = 10 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, int16_t, 20, NUM3,
                                    decltype(work_group_sorter4)>(
        q, ikeys, ivals4, work_group_sorter4);
    std::cout << "KV private sort <Key: int16_t, Val: int16_t> NUM = " << NUM3
              << ", WG = 20 pass." << std::endl;
    ...
    test_work_group_KV_private_sort<int16_t, uint32_t, 1, NUM4,
                                    decltype(work_group_sorter5)>(
        q, ikeys, ivals5, work_group_sorter5);
    std::cout << "KV private sort <Key: int16_t, Val: uint32_t> NUM = " << NUM4
              << ", WG = 1 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, uint32_t, 2, NUM4,
                                    decltype(work_group_sorter5)>(
        q, ikeys, ivals5, work_group_sorter5);
    std::cout << "KV private sort <Key: int16_t, Val: uint32_t> NUM = " << NUM4
              << ", WG = 2 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, uint32_t, 3, NUM4,
                                    decltype(work_group_sorter5)>(
        q, ikeys, ivals5, work_group_sorter5);
    std::cout << "KV private sort <Key: int16_t, Val: uint16_t> NUM = " << NUM4
              << ", WG = 3 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, uint32_t, 5, NUM4,
                                    decltype(work_group_sorter5)>(
        q, ikeys, ivals5, work_group_sorter5);
    std::cout << "KV private sort <Key: int16_t, Val: uint32_t> NUM = " << NUM4
              << ", WG = 5 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, uint32_t, 6, NUM4,
                                    decltype(work_group_sorter5)>(
        q, ikeys, ivals5, work_group_sorter5);
    std::cout << "KV private sort <Key: int16_t, Val: uint32_t> NUM = " << NUM4
              << ", WG = 6 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, uint32_t, 10, NUM4,
                                    decltype(work_group_sorter5)>(
        q, ikeys, ivals5, work_group_sorter5);
    std::cout << "KV private sort <Key: int16_t, Val: uint32_t> NUM = " << NUM4
              << ", WG = 10 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, uint32_t, 15, NUM4,
                                    decltype(work_group_sorter5)>(
        q, ikeys, ivals5, work_group_sorter5);
    std::cout << "KV private sort <Key: int16_t, Val: uint32_t> NUM = " << NUM4
              << ", WG = 15 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, uint32_t, 30, NUM4,
                                    decltype(work_group_sorter5)>(
        q, ikeys, ivals5, work_group_sorter5);
    std::cout << "KV private sort <Key: int16_t, Val: uint32_t> NUM = " << NUM4
              << ", WG = 30 pass." << std::endl;
    ...
    test_work_group_KV_private_sort<int16_t, int32_t, 1, NUM5,
                                    decltype(work_group_sorter6)>(
        q, ikeys, ivals6, work_group_sorter6);
    std::cout << "KV private sort <Key: int16_t, Val: int32_t> NUM = " << NUM5
              << ", WG = 1 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, int32_t, 5, NUM5,
                                    decltype(work_group_sorter6)>(
        q, ikeys, ivals6, work_group_sorter6);
    std::cout << "KV private sort <Key: int16_t, Val: int32_t> NUM = " << NUM5
              << ", WG = 5 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, int32_t, 25, NUM5,
                                    decltype(work_group_sorter6)>(
        q, ikeys, ivals6, work_group_sorter6);
    std::cout << "KV private sort <Key: int16_t, Val: int32_t> NUM = " << NUM5
              << ", WG = 25 pass." << std::endl;
    ...
    test_work_group_KV_private_sort<int16_t, uint64_t, 1, NUM6,
                                    decltype(work_group_sorter7)>(
        q, ikeys, ivals7, work_group_sorter7);
    std::cout << "KV private sort <Key: int16_t, Val: uint64_t> NUM = " << NUM6
              << ", WG = 1 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, uint64_t, 2, NUM6,
                                    decltype(work_group_sorter7)>(
        q, ikeys, ivals7, work_group_sorter7);
    std::cout << "KV private sort <Key: int16_t, Val: uint64_t> NUM = " << NUM6
              << ", WG = 2 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, uint64_t, 3, NUM6,
                                    decltype(work_group_sorter7)>(
        q, ikeys, ivals7, work_group_sorter7);
    std::cout << "KV private sort <Key: int16_t, Val: uint64_t> NUM = " << NUM6
              << ", WG = 3 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, uint64_t, 5, NUM6,
                                    decltype(work_group_sorter7)>(
        q, ikeys, ivals7, work_group_sorter7);
    std::cout << "KV private sort <Key: int16_t, Val: uint64_t> NUM = " << NUM6
              << ", WG = 5 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, uint64_t, 6, NUM6,
                                    decltype(work_group_sorter7)>(
        q, ikeys, ivals7, work_group_sorter7);
    std::cout << "KV private sort <Key: int16_t, Val: uint64_t> NUM = " << NUM6
              << ", WG = 6 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, uint64_t, 10, NUM6,
                                    decltype(work_group_sorter7)>(
        q, ikeys, ivals7, work_group_sorter7);
    std::cout << "KV private sort <Key: int16_t, Val: uint64_t> NUM = " << NUM6
              << ", WG = 10 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, uint64_t, 15, NUM6,
                                    decltype(work_group_sorter7)>(
        q, ikeys, ivals7, work_group_sorter7);
    std::cout << "KV private sort <Key: int16_t, Val: uint64_t> NUM = " << NUM6
              << ", WG = 15 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, uint64_t, 30, NUM6,
                                    decltype(work_group_sorter7)>(
        q, ikeys, ivals7, work_group_sorter7);
    std::cout << "KV private sort <Key: int16_t, Val: uint64_t> NUM = " << NUM6
              << ", WG = 30 pass." << std::endl;
    ...
    std::cout << "KV private sort <Key: int16_t, Val: int64_t> NUM = " << NUM7
              << ", WG = 1 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, int64_t, 3, NUM7,
                                    decltype(work_group_sorter8)>(
        q, ikeys, ivals8, work_group_sorter8);
    std::cout << "KV private sort <Key: int16_t, Val: int64_t> NUM = " << NUM7
              << ", WG = 3 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, int64_t, 7, NUM7,
                                    decltype(work_group_sorter8)>(
        q, ikeys, ivals8, work_group_sorter8);
    std::cout << "KV private sort <Key: int16_t, Val: int64_t> NUM = " << NUM7
              << ", WG = 7 pass." << std::endl;

    test_work_group_KV_private_sort<int16_t, int64_t, 21, NUM7,
                                    decltype(work_group_sorter8)>(
        q, ikeys, ivals8, work_group_sorter8);
    std::cout << "KV private sort <Key: int16_t, Val: int64_t> NUM = " << NUM7
              << ", WG = 21 pass." << std::endl;
