...
// >> host compilation...
// RUN: %clangxx -Wno-error=unused-command-line-argument -Wno-error=deprecated-declarations -Wno-error=ignored-attributes %cxx_std_optionc++17 %include_option std_complex_math_test_ihdr.h -c %S/std_complex_math_test.cpp -o %t_host.o %sycl_options -Wno-sycl-strict %{mathflags}
...
// >> host compilation...
// RUN: %clangxx -Wno-error=unused-command-line-argument -Wno-error=deprecated-declarations -Wno-error=ignored-attributes %cxx_std_optionc++17 %include_option std_complex_math_fp64_test_ihdr.h -c %S/std_complex_math_fp64_test.cpp -o %t_fp64_host.o %sycl_options -Wno-sycl-strict %{mathflags}
