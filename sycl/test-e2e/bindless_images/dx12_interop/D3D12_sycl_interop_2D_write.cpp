...
// RUN-IF: !gpu-intel-dg2, %{run} %t.exe --type float --channels 4 --semaphores 32x33
// RUN-IF: !gpu-intel-dg2, %{run} %t.exe --type float --channels 1 --semaphores 32x33
// RUN-IF: !gpu-intel-dg2, %{run} %t.exe --type half --channels 2 --semaphores 32x33
// RUN-IF: !gpu-intel-dg2, %{run} %t.exe --type int32 --channels 4 --semaphores 32x33
// RUN-IF: !gpu-intel-dg2, %{run} %t.exe --type uint32 --channels 1 --semaphores 32x33
// RUN-IF: !gpu-intel-dg2, %{run} %t.exe --type int16 --channels 2 --semaphores 32x33
// RUN-IF: !gpu-intel-dg2, %{run} %t.exe --type uint16 --channels 4 --semaphores 32x33
// RUN-IF: !gpu-intel-dg2, %{run} %t.exe --type uint8 --channels 1 --semaphores 32x33
// RUN-IF: !gpu-intel-dg2, %{run} %t.exe --type int8 --channels 2 --semaphores 32x33
