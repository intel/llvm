...
// RUN: %{run} %t.out --type float --channels 1 --sampled 33x32x31
// RUN: %{run} %t.out --type float --channels 2 --sampled 32x33x31
// RUN: %{run} %t.out --type float --channels 4 --sampled 31x32x33
// RUN: %{run} %t.out --type half --channels 1 --sampled 16x17x15
// RUN: %{run} %t.out --type half --channels 2 --sampled 17x16x15
// RUN: %{run} %t.out --type half --channels 4 --sampled 15x16x17
// RUN: %{run} %t.out --type int32 --channels 1 --sampled 9x8x7
// RUN: %{run} %t.out --type int32 --channels 2 --sampled 8x9x7
// RUN: %{run} %t.out --type int32 --channels 4 --sampled 7x8x9
// RUN: %{run} %t.out --type uint32 --channels 1 --sampled 33x31x32
// RUN: %{run} %t.out --type uint32 --channels 2 --sampled 31x33x32
// RUN: %{run} %t.out --type uint32 --channels 4 --sampled 32x31x33
// RUN: %{run} %t.out --type int16 --channels 1 --sampled 17x15x16
// RUN: %{run} %t.out --type int16 --channels 2 --sampled 15x17x16
// RUN: %{run} %t.out --type int16 --channels 4 --sampled 16x15x17
// RUN: %{run} %t.out --type uint16 --channels 1 --sampled 9x7x8
// RUN: %{run} %t.out --type uint16 --channels 2 --sampled 7x9x8
// RUN: %{run} %t.out --type uint16 --channels 4 --sampled 8x7x9
// RUN: %{run} %t.out --type uint8 --channels 1 --sampled 33x32x31
// RUN: %{run} %t.out --type uint8 --channels 2 --sampled 32x31x33
// RUN: %{run} %t.out --type uint8 --channels 4 --sampled 31x33x32
// RUN: %{run} %t.out --type int8 --channels 1 --sampled 17x16x15
// RUN: %{run} %t.out --type int8 --channels 2 --sampled 16x15x17
// RUN: %{run} %t.out --type int8 --channels 4 --sampled 15x17x16
// RUN: %{run} %t.out --type unorm8 --channels 1 --sampled 9x8x7
// RUN: %{run} %t.out --type unorm8 --channels 2 --sampled 8x7x9
// RUN: %{run} %t.out --type unorm8 --channels 4 --sampled 7x9x8
