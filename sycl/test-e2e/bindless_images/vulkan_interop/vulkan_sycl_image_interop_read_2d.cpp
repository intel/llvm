...
// RUN: %t.out --type float --channels 4 32x33 --semaphores
// RUN: %t.out --type half --channels 1 32x33 --semaphores
// RUN: %t.out --type uint32 --channels 4 32x33 --semaphores
// RUN: %t.out --type uint16 --channels 2 32x33 --semaphores
// RUN: %t.out --type int8 --channels 1 32x33 --semaphores
// RUN: %t.out --type float --channels 4 --sampled 32x33 --semaphores
// RUN: %t.out --type int32 --channels 4 --sampled 32x33 --semaphores
// RUN: %t.out --type int16 --channels 4 --sampled 32x33 --semaphores
// RUN: %t.out --type uint8 --channels 2 --sampled 32x33 --semaphores
