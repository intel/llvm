...
// RUN: %t.out --type float --channels 1 --sampled 32
// RUN: %t.out --type float --channels 2 --sampled 32
// RUN: %t.out --type float --channels 4 --sampled 32
// RUN: %t.out --type half --channels 1 --sampled 32
// RUN: %t.out --type half --channels 2 --sampled 32
// RUN: %t.out --type half --channels 4 --sampled 32
// RUN: %t.out --type int32 --channels 1 --sampled 32
// RUN: %t.out --type int32 --channels 2 --sampled 32
// RUN: %t.out --type int32 --channels 4 --sampled 32
// RUN: %t.out --type uint32 --channels 1 --sampled 32
// RUN: %t.out --type uint32 --channels 2 --sampled 32
// RUN: %t.out --type uint32 --channels 4 --sampled 32
// RUN: %t.out --type int16 --channels 1 --sampled 32
// RUN: %t.out --type int16 --channels 2 --sampled 32
// RUN: %t.out --type int16 --channels 4 --sampled 32
// RUN: %t.out --type uint16 --channels 1 --sampled 32
// RUN: %t.out --type uint16 --channels 2 --sampled 32
// RUN: %t.out --type uint16 --channels 4 --sampled 32
// RUN: %t.out --type uint8 --channels 1 --sampled 32
// RUN: %t.out --type uint8 --channels 2 --sampled 32
// RUN: %t.out --type uint8 --channels 4 --sampled 32
// RUN: %t.out --type int8 --channels 1 --sampled 32
// RUN: %t.out --type int8 --channels 2 --sampled 32
// RUN: %t.out --type int8 --channels 4 --sampled 32
// RUN: %t.out --type unorm8 --channels 1 --sampled 32
// RUN: %t.out --type unorm8 --channels 2 --sampled 32
// RUN: %t.out --type unorm8 --channels 4 --sampled 32


// RUN: %t.out --type float --channels 1 32 --semaphores
// RUN: %t.out --type float --channels 2 32 --semaphores
// RUN: %t.out --type float --channels 4 32 --semaphores
// RUN: %t.out --type half --channels 1 32 --semaphores
// RUN: %t.out --type int32 --channels 2 32 --semaphores
// RUN: %t.out --type uint32 --channels 4 32 --semaphores
// RUN: %t.out --type int16 --channels 1 32 --semaphores
// RUN: %t.out --type uint16 --channels 2 32 --semaphores
// RUN: %t.out --type uint8 --channels 4 32 --semaphores
// RUN: %t.out --type int8 --channels 1 32 --semaphores
// RUN: %t.out --type unorm8 --channels 2 32 --semaphores
// RUN: %t.out --type float --channels 4 --sampled 32 --semaphores
// RUN: %t.out --type int16 --channels 4 --sampled 32 --semaphores
// RUN: %t.out --type int8 --channels 4 --sampled 32 --semaphores
// RUN: %t.out --type unorm8 --channels 4 --sampled 32 --semaphores

/*  

The block above tests these formats, sampled and unsampled, with and without semaphores
