...
// sample: Normalized + Repeat + Linear
std::vector<pixelT> ref_boundary = {
    {0.4, 0.4, 0.4, 0.4}, {0.4, 0.4, 0.4, 0.4}, {0.4, 0.4, 0.4, 0.4}};
// Four pixels above right bound, sample: Normalized + Repeat + Linear
std::vector<pixelT> ref_right = {{0.4, 0.4, 0.4, 0.4},
                                 {0.4, 0.4, 0.4, 0.4},
                                 {0.4, 0.4, 0.4, 0.4},
                                 {0.4, 0.4, 0.4, 0.4}};
// Four pixels below left bound. sample: Normalized + Repeat + Linear
