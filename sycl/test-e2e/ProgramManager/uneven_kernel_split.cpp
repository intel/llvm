...
// RUN: %clangxx -fsycl -fsycl-targets=spir64_gen -I %S/Inputs/ %S/Inputs/gpu_kernel1.cpp -c -o %t1.o
// RUN: %clangxx -fsycl -fsycl-targets=spir64_gen -I %S/Inputs/ %S/Inputs/gpu_kernel2.cpp -c -o %t2.o
// RUN: %clangxx -fsycl -fsycl-targets=spir64_x86_64,spir64_gen %t.o %t1.o %t2.o -o %t.out
// RUN: %{run} %t.out
