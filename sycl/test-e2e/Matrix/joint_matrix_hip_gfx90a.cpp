...
template <size_t KX> void matrix_mfma() {
  ...
  hip_matrix_mfma<float, float, 32, 32, 2, KX, layout::row_major>();
  hip_matrix_mfma<float, float, 16, 16, 4, KX, layout::row_major>();
  ...
  hip_matrix_mfma<float, float, 32, 32, 2, KX, layout::col_major>();
  hip_matrix_mfma<float, float, 16, 16, 4, KX, layout::col_major>();
...
int main() {
  ...
  hip_matrix_copy<float, float, 32, 32, 2, layout::row_major>();
  hip_matrix_copy<float, float, 16, 16, 4, layout::row_major>();
  ...
  hip_matrix_copy<float, float, 32, 32, 2, layout::col_major>();
  hip_matrix_copy<float, float, 16, 16, 4, layout::col_major>();
  ...
  hip_matrix_fill<float, float, 32, 32, 2>();
  hip_matrix_fill<float, float, 16, 16, 4>();
  ...
  hip_matrix_apply<float, float, 32, 32, 2>();
  hip_matrix_apply<float, float, 16, 16, 4>();
