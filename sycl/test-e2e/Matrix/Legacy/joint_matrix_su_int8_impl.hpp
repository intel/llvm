     ...
     cgh.parallel_for<class imatrix>(
         ...
         [accA, accB, accC, M, N, K](nd_item<2> spmd_item)
             [[intel::reqd_sub_group_size(SG_SZ)]] {
               ...
               // For B, since current implementation does not support
               // non-packed layout, users need to specify the updated VNNI
               // sizes along with the packed_b layout. By default, the layout
               // is row_major and size is (TK, TN).
               ...
               for (int k = 0; k < K / TK; k += 1) {
                 ...
                 joint_matrix_mad(sg, sub_a, sub_b, sub_c, sub_c)(sg, sub_a,
                                                                  sub_b, sub_c);
               }
               joint_matrix_store(
                   sg, sub_c,
