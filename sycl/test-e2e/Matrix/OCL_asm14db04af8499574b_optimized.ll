; ------------------------------------------------
; OCL_asm14db04af8499574b_optimized.ll
...
__builtin_spriv_OpJointMatrixLoadINTEL_Accumulator_RowMajor_8x8_i32_8_global_v8i8_pi32_i32.24.exit:
  ...
  %payloadHeader.scalar90 = extractelement <8 x i32> %payloadHeader, i64 1
  %enqueuedLocalSize.scalar = extractelement <3 x i32> %enqueuedLocalSize, i64 0
  %enqueuedLocalSize.scalar88 = extractelement <3 x i32> %enqueuedLocalSize, i64 1
  %r0.scalar81 = extractelement <8 x i32> %r0, i64 1
  %r0.scalar86 = extractelement <8 x i32> %r0, i64 6
  ...
  %13 = mul i64 %const_reg_qword6, %const_reg_qword5
  %14 = getelementptr %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %4, i64 %13
  %15 = getelementptr %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %14, i64 %const_reg_qword7
  %16 = mul i64 %const_reg_qword10, %const_reg_qword9
  %17 = getelementptr %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %7, i64 %16
  %18 = getelementptr %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %17, i64 %const_reg_qword11
  %19 = mul i32 %enqueuedLocalSize.scalar88, %r0.scalar86
  %localIdY15 = zext i16 %localIdY to i32
  %20 = add i32 %19, %localIdY15
  %21 = add i32 %20, %payloadHeader.scalar90
  %22 = call i32 @llvm.genx.GenISA.WaveShuffleIndex.i32.i32.i32(i32 %21, i32 0, i32 0)
  ...
  %31 = call i64 @llvm.genx.GenISA.WaveShuffleIndex.i64.i32.i32(i64 %30, i32 0, i32 0)
  %32 = sub nsw i64 %23, %31, !spirv.Decorations !519
  %33 = zext i16 %localIdX to i64
  %34 = sub nsw i64 %28, %33, !spirv.Decorations !519
  %35 = add i64 %10, %const_reg_qword3
  %36 = sub i64 0, %35
  %37 = getelementptr inbounds float, float addrspace(1)* %12, i64 %36
  %38 = shl nsw i64 %32, 7, !spirv.Decorations !519
  %39 = getelementptr inbounds float, float addrspace(1)* %37, i64 %38
  %40 = udiv i64 %34, %3
  %41 = shl i64 %40, 3
  %42 = getelementptr inbounds float, float addrspace(1)* %39, i64 %41
  %43 = bitcast float addrspace(1)* %42 to i32 addrspace(1)*
  %44 = call float @llvm.genx.GenISA.simdBlockRead.f32.p1i32(i32 addrspace(1)* %43)
  %45 = getelementptr inbounds float, float addrspace(1)* %42, i64 16
  %46 = bitcast float addrspace(1)* %45 to i32 addrspace(1)*
  %47 = call float @llvm.genx.GenISA.simdBlockRead.f32.p1i32(i32 addrspace(1)* %46)
  %48 = getelementptr inbounds float, float addrspace(1)* %42, i64 32
  %49 = bitcast float addrspace(1)* %48 to i32 addrspace(1)*
  %50 = call float @llvm.genx.GenISA.simdBlockRead.f32.p1i32(i32 addrspace(1)* %49)
  %51 = getelementptr inbounds float, float addrspace(1)* %42, i64 48
  %52 = bitcast float addrspace(1)* %51 to i32 addrspace(1)*
  %53 = call float @llvm.genx.GenISA.simdBlockRead.f32.p1i32(i32 addrspace(1)* %52)
  %54 = getelementptr inbounds float, float addrspace(1)* %42, i64 64
  %55 = bitcast float addrspace(1)* %54 to i32 addrspace(1)*
  %56 = call float @llvm.genx.GenISA.simdBlockRead.f32.p1i32(i32 addrspace(1)* %55)
  %57 = getelementptr inbounds float, float addrspace(1)* %42, i64 80
  %58 = bitcast float addrspace(1)* %57 to i32 addrspace(1)*
  %59 = call float @llvm.genx.GenISA.simdBlockRead.f32.p1i32(i32 addrspace(1)* %58)
  %60 = getelementptr inbounds float, float addrspace(1)* %42, i64 96
  %61 = bitcast float addrspace(1)* %60 to i32 addrspace(1)*
  %62 = call float @llvm.genx.GenISA.simdBlockRead.f32.p1i32(i32 addrspace(1)* %61)
  %63 = getelementptr inbounds float, float addrspace(1)* %42, i64 112
  %64 = bitcast float addrspace(1)* %63 to i32 addrspace(1)*
  %65 = call float @llvm.genx.GenISA.simdBlockRead.f32.p1i32(i32 addrspace(1)* %64)
  %.28.vec.insert.assembled.vect = insertelement <8 x float> undef, float %44, i64 0
  %.28.vec.insert.assembled.vect170 = insertelement <8 x float> %.28.vec.insert.assembled.vect, float %47, i64 1
  %.28.vec.insert.assembled.vect171 = insertelement <8 x float> %.28.vec.insert.assembled.vect170, float %50, i64 2
  %.28.vec.insert.assembled.vect172 = insertelement <8 x float> %.28.vec.insert.assembled.vect171, float %53, i64 3
  %.28.vec.insert.assembled.vect173 = insertelement <8 x float> %.28.vec.insert.assembled.vect172, float %56, i64 4
  %.28.vec.insert.assembled.vect174 = insertelement <8 x float> %.28.vec.insert.assembled.vect173, float %59, i64 5
  %.28.vec.insert.assembled.vect175 = insertelement <8 x float> %.28.vec.insert.assembled.vect174, float %62, i64 6
  %.28.vec.insert.assembled.vect176 = insertelement <8 x float> %.28.vec.insert.assembled.vect175, float %65, i64 7
  %66 = add i64 %13, %const_reg_qword7
  %67 = sub i64 0, %66
  %68 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %15, i64 %67
  %69 = shl nsw i64 %32, 8, !spirv.Decorations !519
  %70 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %68, i64 %69
  %71 = add i64 %16, %const_reg_qword11
  %72 = sub i64 0, %71
  %73 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %18, i64 %72
  %74 = shl i64 %40, 4
  %75 = getelementptr %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %73, i64 %74
  %76 = bitcast %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %70 to i32 addrspace(1)*
  %77 = call i32 @llvm.genx.GenISA.simdBlockRead.i32.p1i32(i32 addrspace(1)* %76)
  %78 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %70, i64 32
  %79 = bitcast %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %78 to i32 addrspace(1)*
  %80 = call i32 @llvm.genx.GenISA.simdBlockRead.i32.p1i32(i32 addrspace(1)* %79)
  %81 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %70, i64 64
  %82 = bitcast %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %81 to i32 addrspace(1)*
  %83 = call i32 @llvm.genx.GenISA.simdBlockRead.i32.p1i32(i32 addrspace(1)* %82)
  %84 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %70, i64 96
  %85 = bitcast %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %84 to i32 addrspace(1)*
  %86 = call i32 @llvm.genx.GenISA.simdBlockRead.i32.p1i32(i32 addrspace(1)* %85)
  %87 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %70, i64 128
  %88 = bitcast %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %87 to i32 addrspace(1)*
  %89 = call i32 @llvm.genx.GenISA.simdBlockRead.i32.p1i32(i32 addrspace(1)* %88)
  %90 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %70, i64 160
  %91 = bitcast %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %90 to i32 addrspace(1)*
  %92 = call i32 @llvm.genx.GenISA.simdBlockRead.i32.p1i32(i32 addrspace(1)* %91)
  %93 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %70, i64 192
  %94 = bitcast %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %93 to i32 addrspace(1)*
  %95 = call i32 @llvm.genx.GenISA.simdBlockRead.i32.p1i32(i32 addrspace(1)* %94)
  %96 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %70, i64 224
  %97 = bitcast %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %96 to i32 addrspace(1)*
  %98 = call i32 @llvm.genx.GenISA.simdBlockRead.i32.p1i32(i32 addrspace(1)* %97)
  %.28.vec.insert24.assembled.vect = insertelement <8 x i32> undef, i32 %77, i64 0
  %.28.vec.insert24.assembled.vect177 = insertelement <8 x i32> %.28.vec.insert24.assembled.vect, i32 %80, i64 1
  %.28.vec.insert24.assembled.vect178 = insertelement <8 x i32> %.28.vec.insert24.assembled.vect177, i32 %83, i64 2
  %.28.vec.insert24.assembled.vect179 = insertelement <8 x i32> %.28.vec.insert24.assembled.vect178, i32 %86, i64 3
  %.28.vec.insert24.assembled.vect180 = insertelement <8 x i32> %.28.vec.insert24.assembled.vect179, i32 %89, i64 4
  %.28.vec.insert24.assembled.vect181 = insertelement <8 x i32> %.28.vec.insert24.assembled.vect180, i32 %92, i64 5
  %.28.vec.insert24.assembled.vect182 = insertelement <8 x i32> %.28.vec.insert24.assembled.vect181, i32 %95, i64 6
  %.28.vec.insert24.assembled.vect183 = insertelement <8 x i32> %.28.vec.insert24.assembled.vect182, i32 %98, i64 7
  %99 = bitcast %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %75 to i32 addrspace(1)*
  %100 = call i32 @llvm.genx.GenISA.simdBlockRead.i32.p1i32(i32 addrspace(1)* %99)
  %101 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %75, i64 32
  %102 = bitcast %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %101 to i32 addrspace(1)*
  %103 = call i32 @llvm.genx.GenISA.simdBlockRead.i32.p1i32(i32 addrspace(1)* %102)
  %104 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %75, i64 64
  %105 = bitcast %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %104 to i32 addrspace(1)*
  %106 = call i32 @llvm.genx.GenISA.simdBlockRead.i32.p1i32(i32 addrspace(1)* %105)
  %107 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %75, i64 96
  %108 = bitcast %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %107 to i32 addrspace(1)*
  %109 = call i32 @llvm.genx.GenISA.simdBlockRead.i32.p1i32(i32 addrspace(1)* %108)
  %110 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %75, i64 128
  %111 = bitcast %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %110 to i32 addrspace(1)*
  %112 = call i32 @llvm.genx.GenISA.simdBlockRead.i32.p1i32(i32 addrspace(1)* %111)
  %113 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %75, i64 160
  %114 = bitcast %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %113 to i32 addrspace(1)*
  %115 = call i32 @llvm.genx.GenISA.simdBlockRead.i32.p1i32(i32 addrspace(1)* %114)
  %116 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %75, i64 192
  ...
  %119 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %75, i64 224
  ...
  %.28.vec.insert41.assembled.vect = insertelement <8 x i32> undef, i32 %100, i64 0
  %.28.vec.insert41.assembled.vect184 = insertelement <8 x i32> %.28.vec.insert41.assembled.vect, i32 %103, i64 1
  %.28.vec.insert41.assembled.vect185 = insertelement <8 x i32> %.28.vec.insert41.assembled.vect184, i32 %106, i64 2
  %.28.vec.insert41.assembled.vect186 = insertelement <8 x i32> %.28.vec.insert41.assembled.vect185, i32 %109, i64 3
  %.28.vec.insert41.assembled.vect187 = insertelement <8 x i32> %.28.vec.insert41.assembled.vect186, i32 %112, i64 4
  %.28.vec.insert41.assembled.vect188 = insertelement <8 x i32> %.28.vec.insert41.assembled.vect187, i32 %115, i64 5
  %.28.vec.insert41.assembled.vect189 = insertelement <8 x i32> %.28.vec.insert41.assembled.vect188, i32 %118, i64 6
  %.28.vec.insert41.assembled.vect190 = insertelement <8 x i32> %.28.vec.insert41.assembled.vect189, i32 %121, i64 7
  ...
  %122 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %70, i64 16
  ...
  %125 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %122, i64 32
  ...
  %128 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %122, i64 64
  ...
  %131 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %122, i64 96
  ...
  %134 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %122, i64 128
  ...
  %137 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %122, i64 160
  ...
  %140 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %122, i64 192
  %141 = bitcast %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %140 to i32 addrspace(1)*
  %142 = call i32 @llvm.genx.GenISA.simdBlockRead.i32.p1i32(i32 addrspace(1)* %141)
  %143 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %122, i64 224
  %144 = bitcast %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %143 to i32 addrspace(1)*
  %145 = call i32 @llvm.genx.GenISA.simdBlockRead.i32.p1i32(i32 addrspace(1)* %144)
  %.28.vec.insert24.assembled.vect.1 = insertelement <8 x i32> undef, i32 %124, i64 0
  %.28.vec.insert24.assembled.vect177.1 = insertelement <8 x i32> %.28.vec.insert24.assembled.vect.1, i32 %127, i64 1
  %.28.vec.insert24.assembled.vect178.1 = insertelement <8 x i32> %.28.vec.insert24.assembled.vect177.1, i32 %130, i64 2
  %.28.vec.insert24.assembled.vect179.1 = insertelement <8 x i32> %.28.vec.insert24.assembled.vect178.1, i32 %133, i64 3
  %.28.vec.insert24.assembled.vect180.1 = insertelement <8 x i32> %.28.vec.insert24.assembled.vect179.1, i32 %136, i64 4
  %.28.vec.insert24.assembled.vect181.1 = insertelement <8 x i32> %.28.vec.insert24.assembled.vect180.1, i32 %139, i64 5
  %.28.vec.insert24.assembled.vect182.1 = insertelement <8 x i32> %.28.vec.insert24.assembled.vect181.1, i32 %142, i64 6
  %.28.vec.insert24.assembled.vect183.1 = insertelement <8 x i32> %.28.vec.insert24.assembled.vect182.1, i32 %145, i64 7
  %146 = getelementptr %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %75, i64 256
  %147 = bitcast %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %146 to i32 addrspace(1)*
  %148 = call i32 @llvm.genx.GenISA.simdBlockRead.i32.p1i32(i32 addrspace(1)* %147)
  %149 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %146, i64 32
  ...
  %152 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %146, i64 64
  ...
  %155 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %146, i64 96
  ...
  %158 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %146, i64 128
  ...
  %161 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %146, i64 160
  ...
  %164 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %146, i64 192
  ...
  %167 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %146, i64 224
  ...
  %.28.vec.insert41.assembled.vect.1 = insertelement <8 x i32> undef, i32 %148, i64 0
  %.28.vec.insert41.assembled.vect184.1 = insertelement <8 x i32> %.28.vec.insert41.assembled.vect.1, i32 %151, i64 1
  %.28.vec.insert41.assembled.vect185.1 = insertelement <8 x i32> %.28.vec.insert41.assembled.vect184.1, i32 %154, i64 2
  %.28.vec.insert41.assembled.vect186.1 = insertelement <8 x i32> %.28.vec.insert41.assembled.vect185.1, i32 %157, i64 3
  %.28.vec.insert41.assembled.vect187.1 = insertelement <8 x i32> %.28.vec.insert41.assembled.vect186.1, i32 %160, i64 4
  %.28.vec.insert41.assembled.vect188.1 = insertelement <8 x i32> %.28.vec.insert41.assembled.vect187.1, i32 %163, i64 5
  %.28.vec.insert41.assembled.vect189.1 = insertelement <8 x i32> %.28.vec.insert41.assembled.vect188.1, i32 %166, i64 6
  %.28.vec.insert41.assembled.vect190.1 = insertelement <8 x i32> %.28.vec.insert41.assembled.vect189.1, i32 %169, i64 7
  ...
  %bc = bitcast <8 x float> %dpas.1 to <8 x i32>
  %bc106 = extractelement <8 x i32> %bc, i64 0
  call void @llvm.genx.GenISA.simdBlockWrite.p1i32.i32(i32 addrspace(1)* %43, i32 %bc106)
  %bc74115 = extractelement <8 x i32> %bc, i64 1
  call void @llvm.genx.GenISA.simdBlockWrite.p1i32.i32(i32 addrspace(1)* %46, i32 %bc74115)
  %bc75124 = extractelement <8 x i32> %bc, i64 2
  call void @llvm.genx.GenISA.simdBlockWrite.p1i32.i32(i32 addrspace(1)* %49, i32 %bc75124)
  %bc76133 = extractelement <8 x i32> %bc, i64 3
  call void @llvm.genx.GenISA.simdBlockWrite.p1i32.i32(i32 addrspace(1)* %52, i32 %bc76133)
  %bc77142 = extractelement <8 x i32> %bc, i64 4
  call void @llvm.genx.GenISA.simdBlockWrite.p1i32.i32(i32 addrspace(1)* %55, i32 %bc77142)
  %bc78151 = extractelement <8 x i32> %bc, i64 5
  call void @llvm.genx.GenISA.simdBlockWrite.p1i32.i32(i32 addrspace(1)* %58, i32 %bc78151)
  %bc79160 = extractelement <8 x i32> %bc, i64 6
  call void @llvm.genx.GenISA.simdBlockWrite.p1i32.i32(i32 addrspace(1)* %61, i32 %bc79160)
  %bc80169 = extractelement <8 x i32> %bc, i64 7
  call void @llvm.genx.GenISA.simdBlockWrite.p1i32.i32(i32 addrspace(1)* %64, i32 %bc80169)
  ret void
}
...
declare i64 @llvm.genx.GenISA.WaveShuffleIndex.i64.i32.i32(i64, i32, i32) #7
...
; Arg 2: helperLaneMode : 0: not used; 1: helper lanes participatein wave ops, 2: helper lanes do not participate in wave ops.
; Function Attrs: convergent nounwind readnone
declare i32 @llvm.genx.GenISA.WaveShuffleIndex.i32.i32.i32(i32, i32, i32) #7
