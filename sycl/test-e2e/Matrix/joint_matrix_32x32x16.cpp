...
void test() {
    ...
    matrix_fill(MATRIX_M, MATRIX_N, (TResult *)C, [](int i, int j) { return TResult(32) * i + T(1) * j; });
    matrix_fill(MATRIX_M, MATRIX_N, (TResult *)D, [](int i, int j) { return TResult(32) * i + T(1) * j; });
