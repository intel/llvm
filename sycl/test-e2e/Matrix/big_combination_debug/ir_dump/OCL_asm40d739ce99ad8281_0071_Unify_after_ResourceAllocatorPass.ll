; ------------------------------------------------
; OCL_asm40d739ce99ad8281_0071_Unify_after_ResourceAllocatorPass.ll
...
116:                                              ; preds = %111
  ...
  %121 = load i32, i32 addrspace(1)* %120, align 4, !tbaa !518
  br label %122
...
122:                                              ; preds = %116, %111
  ...
  store i32 %123, i32* %125, align 4, !tbaa !518
...
__builtin_spriv_OpJointMatrixLoadINTEL_Accumulator_RowMajor_32x32_i32_128_global_v8i8_pi32_i32.23.exit: ; preds = %122
  ...
  %137 = shl nsw i64 %63, 10, !spirv.Decorations !516
...
147:                                              ; preds = %144
  %148 = shl nuw nsw i32 %145, 4, !spirv.Decorations !522
...
178:                                              ; preds = %178, %_Z18get_sub_group_sizev.exit.i6
  ...
  store i32 %183, i32* %184, align 4, !tbaa !518
...
__builtin_spriv_OpJointMatrixLoadINTEL_PackedA_RowMajor_32x16_i16_32_global_v8i8_pi32_i32.24.exit: ; preds = %178
  %187 = shl nuw nsw i64 %149, 6, !spirv.Decorations !522
...
229:                                              ; preds = %224
  ...
  %234 = load i32, i32 addrspace(1)* %233, align 4, !tbaa !518
  br label %235
...
235:                                              ; preds = %229, %224
  ...
  store i32 %236, i32* %238, align 4, !tbaa !518
...
__builtin_spriv_OpJointMatrixLoadINTEL_PackedB_PackedB_16x32_i16_32_global_v8i8_pi32_i32.25.exit: ; preds = %235
  %241 = add nuw nsw i32 %145, 1, !spirv.Decorations !522
  br label %144
...
283:                                              ; preds = %278
  ...
  %286 = load i32, i32* %285, align 4, !tbaa !518
  ...
  store i32 %286, i32 addrspace(1)* %290, align 4, !tbaa !518
  br label %291
