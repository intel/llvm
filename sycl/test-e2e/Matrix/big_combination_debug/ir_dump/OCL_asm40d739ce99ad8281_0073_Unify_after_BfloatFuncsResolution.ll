; ------------------------------------------------
; OCL_asm40d739ce99ad8281_0073_Unify_after_BfloatFuncsResolution.ll
...
105:                                              ; preds = %116, %_Z18get_sub_group_sizev.exit.i4
  %106 = phi i32 [ 0, %_Z18get_sub_group_sizev.exit.i4 ], [ %120, %116 ]
...
110:                                              ; preds = %105
  ...
  %112 = mul nsw i64 %111, 64
  %113 = add nsw i64 %112, %104
  %114 = getelementptr inbounds i32, i32 addrspace(1)* %97, i64 %113
  %115 = load i32, i32 addrspace(1)* %114, align 4, !tbaa !518
  br label %116

116:                                              ; preds = %110, %105
  %117 = phi i32 [ %115, %110 ], [ 0, %105 ]
  %118 = zext i32 %106 to i64
  %119 = getelementptr inbounds i32, i32* %99, i64 %118
  store i32 %117, i32* %119, align 4, !tbaa !518
  %120 = add nuw nsw i32 %106, 1
  %121 = icmp ult i32 %106, 127
  br i1 %121, label %105, label %__builtin_spriv_OpJointMatrixLoadINTEL_Accumulator_RowMajor_32x32_i32_128_global_v8i8_pi32_i32.23.exit

__builtin_spriv_OpJointMatrixLoadINTEL_Accumulator_RowMajor_32x32_i32_128_global_v8i8_pi32_i32.23.exit: ; preds = %116
  %122 = bitcast [2 x <64 x float>]* %14 to <64 x float>*
  %123 = load <64 x float>, <64 x float>* %122, align 256
  %124 = getelementptr <64 x float>, <64 x float>* %122, i32 1
  %125 = load <64 x float>, <64 x float>* %124, align 256
  %126 = insertvalue [2 x <64 x float>] undef, <64 x float> %123, 0
  %127 = insertvalue [2 x <64 x float>] %126, <64 x float> %125, 1
  %128 = add i64 %34, %33
  %129 = sub i64 0, %128
  %130 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %36, i64 %129
  %131 = shl nsw i64 %63, 10, !spirv.Decorations !516
  %132 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %130, i64 %131
  %133 = add i64 %45, %44
  %134 = sub i64 0, %133
  %135 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %47, i64 %134
  %136 = shl i64 %73, 6
  %137 = getelementptr %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %135, i64 %136
  br label %138

138:                                              ; preds = %__builtin_spriv_OpJointMatrixLoadINTEL_PackedB_PackedB_16x32_i16_32_global_v8i8_pi32_i32.25.exit, %__builtin_spriv_OpJointMatrixLoadINTEL_Accumulator_RowMajor_32x32_i32_128_global_v8i8_pi32_i32.23.exit
  %139 = phi i32 [ 0, %__builtin_spriv_OpJointMatrixLoadINTEL_Accumulator_RowMajor_32x32_i32_128_global_v8i8_pi32_i32.23.exit ], [ %224, %__builtin_spriv_OpJointMatrixLoadINTEL_PackedB_PackedB_16x32_i16_32_global_v8i8_pi32_i32.25.exit ]
  %140 = icmp ult i32 %139, 2
  br i1 %140, label %141, label %225

141:                                              ; preds = %138
  %142 = shl nuw nsw i32 %139, 4, !spirv.Decorations !522
  %143 = zext i32 %142 to i64
  %144 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %132, i64 %143
  %145 = bitcast <32 x i32>* %12 to i8*
  %.ascast.i5 = bitcast %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %144 to i8 addrspace(1)*
  %localSize36 = extractelement <3 x i32> %localSize, i32 0
  %localSize37 = extractelement <3 x i32> %localSize, i32 1
  %146 = mul i32 %localSize37, %localSize36
  %localSize38 = extractelement <3 x i32> %localSize, i32 2
  %147 = mul i32 %146, %localSize38
  %148 = add i32 8, -1
  %149 = and i32 %148, %147
...
151:                                              ; preds = %141
  ...
  %152 = mul i32 %localSize40, %localIdZ39
  %localIdY41 = zext i16 %localIdY to i32
  %153 = add i32 %152, %localIdY41
  %localSize42 = extractelement <3 x i32> %localSize, i32 0
  %154 = mul i32 %153, %localSize42
  %localIdX43 = zext i16 %localIdX to i32
  %155 = add i32 %154, %localIdX43
  %156 = udiv i32 %155, 8
  %localSize44 = extractelement <3 x i32> %localSize, i32 0
  %localSize45 = extractelement <3 x i32> %localSize, i32 1
  %157 = mul i32 %localSize45, %localSize44
  %localSize46 = extractelement <3 x i32> %localSize, i32 2
  %158 = mul i32 %157, %localSize46
  %159 = add i32 %158, -1
  %160 = add i32 %159, 8
  %161 = udiv i32 %160, 8
  %162 = add i32 %161, -1
  %163 = icmp ult i32 %156, %162
  br i1 %163, label %164, label %_Z18get_sub_group_sizev.exit.i6

164:                                              ; preds = %151, %141
  br label %_Z18get_sub_group_sizev.exit.i6

_Z18get_sub_group_sizev.exit.i6:                  ; preds = %164, %151
  %165 = bitcast i8* %145 to i32*
  %166 = bitcast i8 addrspace(1)* %.ascast.i5 to i32 addrspace(1)*
  br label %167

167:                                              ; preds = %167, %_Z18get_sub_group_sizev.exit.i6
  %168 = phi i32 [ 0, %_Z18get_sub_group_sizev.exit.i6 ], [ %174, %167 ]
  %169 = zext i32 %168 to i64
  %170 = mul nsw i64 16, %169
  %171 = getelementptr inbounds i32, i32 addrspace(1)* %166, i64 %170
  %172 = call i32 @llvm.genx.GenISA.simdBlockRead.i32.p1i32(i32 addrspace(1)* %171)
  %173 = getelementptr inbounds i32, i32* %165, i64 %169
  store i32 %172, i32* %173, align 4, !tbaa !518
  %174 = add nuw nsw i32 %168, 1
  %175 = icmp ult i32 %168, 31
  br i1 %175, label %167, label %__builtin_spriv_OpJointMatrixLoadINTEL_PackedA_RowMajor_32x16_i16_32_global_v8i8_pi32_i32.24.exit

__builtin_spriv_OpJointMatrixLoadINTEL_PackedA_RowMajor_32x16_i16_32_global_v8i8_pi32_i32.24.exit: ; preds = %167
  %176 = shl nuw nsw i64 %143, 6, !spirv.Decorations !522
  %177 = getelementptr %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %137, i64 %176
  %178 = bitcast <32 x i32>* %11 to i8*
  %.ascast.i7 = bitcast %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %177 to i8 addrspace(1)*
  %localSize47 = extractelement <3 x i32> %localSize, i32 0
  %localSize48 = extractelement <3 x i32> %localSize, i32 1
  %179 = mul i32 %localSize48, %localSize47
  %localSize49 = extractelement <3 x i32> %localSize, i32 2
  %180 = mul i32 %179, %localSize49
  %181 = add i32 8, -1
  %182 = and i32 %181, %180
  %183 = icmp eq i32 %182, 0
  br i1 %183, label %197, label %184

184:                                              ; preds = %__builtin_spriv_OpJointMatrixLoadINTEL_PackedA_RowMajor_32x16_i16_32_global_v8i8_pi32_i32.24.exit
  %localIdZ50 = zext i16 %localIdZ to i32
  %localSize51 = extractelement <3 x i32> %localSize, i32 1
  %185 = mul i32 %localSize51, %localIdZ50
  %localIdY52 = zext i16 %localIdY to i32
  %186 = add i32 %185, %localIdY52
  %localSize53 = extractelement <3 x i32> %localSize, i32 0
  %187 = mul i32 %186, %localSize53
  %localIdX54 = zext i16 %localIdX to i32
  %188 = add i32 %187, %localIdX54
  %189 = udiv i32 %188, 8
  %localSize55 = extractelement <3 x i32> %localSize, i32 0
  %localSize56 = extractelement <3 x i32> %localSize, i32 1
  %190 = mul i32 %localSize56, %localSize55
  %localSize57 = extractelement <3 x i32> %localSize, i32 2
  %191 = mul i32 %190, %localSize57
  %192 = add i32 %191, -1
  %193 = add i32 %192, 8
  %194 = udiv i32 %193, 8
  %195 = add i32 %194, -1
  %196 = icmp ult i32 %189, %195
  br i1 %196, label %197, label %_Z18get_sub_group_sizev.exit.i8

197:                                              ; preds = %184, %__builtin_spriv_OpJointMatrixLoadINTEL_PackedA_RowMajor_32x16_i16_32_global_v8i8_pi32_i32.24.exit
  br label %_Z18get_sub_group_sizev.exit.i8

_Z18get_sub_group_sizev.exit.i8:                  ; preds = %197, %184
  %198 = phi i32 [ 8, %197 ], [ %182, %184 ]
  %199 = bitcast i8 addrspace(1)* %.ascast.i7 to i32 addrspace(1)*
  %simdLaneId1669 = call i16 @llvm.genx.GenISA.simdLaneId()
  %simdLaneId70 = zext i16 %simdLaneId1669 to i32
  %200 = sdiv i32 %198, 32
  %201 = bitcast i8* %178 to i32*
  %202 = freeze i32 %simdLaneId70
  %203 = sdiv i32 %202, 32
  %204 = mul i32 %203, 32
  %205 = sub i32 %202, %204
...
207:                                              ; preds = %218, %_Z18get_sub_group_sizev.exit.i8
  %208 = phi i32 [ 0, %_Z18get_sub_group_sizev.exit.i8 ], [ %222, %218 ]
...
212:                                              ; preds = %207
  ...
  %214 = mul nsw i64 64, %213
  %215 = add nsw i64 %214, %206
  %216 = getelementptr inbounds i32, i32 addrspace(1)* %199, i64 %215
  %217 = load i32, i32 addrspace(1)* %216, align 4, !tbaa !518
  br label %218

218:                                              ; preds = %212, %207
  %219 = phi i32 [ %217, %212 ], [ 0, %207 ]
  %220 = zext i32 %208 to i64
  %221 = getelementptr inbounds i32, i32* %201, i64 %220
  store i32 %219, i32* %221, align 4, !tbaa !518
  %222 = add nuw nsw i32 %208, 1
  %223 = icmp ult i32 %208, 31
  br i1 %223, label %207, label %__builtin_spriv_OpJointMatrixLoadINTEL_PackedB_PackedB_16x32_i16_32_global_v8i8_pi32_i32.25.exit

__builtin_spriv_OpJointMatrixLoadINTEL_PackedB_PackedB_16x32_i16_32_global_v8i8_pi32_i32.25.exit: ; preds = %218
  %224 = add nuw nsw i32 %139, 1, !spirv.Decorations !522
  br label %138

225:                                              ; preds = %138
  %.fca.0.extract = extractvalue [2 x <64 x float>] %127, 0
  ...
  %.fca.1.extract = extractvalue [2 x <64 x float>] %127, 1
  ...
  %226 = bitcast [2 x <64 x float>]* %13 to i8*
  ...
  %227 = mul i32 %localSize59, %localSize58
  %localSize60 = extractelement <3 x i32> %localSize, i32 2
  %228 = mul i32 %227, %localSize60
  %229 = add i32 8, -1
  %230 = and i32 %229, %228
...
255:                                              ; preds = %268, %_Z18get_sub_group_sizev.exit.i
  %256 = phi i32 [ 0, %_Z18get_sub_group_sizev.exit.i ], [ %269, %268 ]
...
260:                                              ; preds = %255
  ...
  %263 = load i32, i32* %262, align 4, !tbaa !518
  %264 = sext i32 %258 to i64
  %265 = mul nsw i64 %264, 64
  %266 = add nsw i64 %265, %254
  %267 = getelementptr inbounds i32, i32 addrspace(1)* %247, i64 %266
  store i32 %263, i32 addrspace(1)* %267, align 4, !tbaa !518
  br label %268

268:                                              ; preds = %260, %255
  %269 = add nuw nsw i32 %256, 1
  %270 = icmp ult i32 %256, 127
  br i1 %270, label %255, label %__builtin_spriv_OpJointMatrixStoreINTEL_Accumulator_RowMajor_32x32_i32_128_global_pi64_v8i8.26.exit

__builtin_spriv_OpJointMatrixStoreINTEL_Accumulator_RowMajor_32x32_i32_128_global_pi64_v8i8.26.exit: ; preds = %268
  ret void
}
