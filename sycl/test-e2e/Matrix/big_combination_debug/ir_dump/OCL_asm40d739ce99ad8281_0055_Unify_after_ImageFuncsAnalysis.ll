; ------------------------------------------------
; OCL_asm40d739ce99ad8281_0055_Unify_after_ImageFuncsAnalysis.ll
...
211:                                              ; preds = %211, %_Z18get_sub_group_sizev.exit.i6
  ...
  store i32 %216, i32* %217, align 4, !tbaa !463
...
__builtin_spriv_OpJointMatrixLoadINTEL_PackedA_RowMajor_32x16_i16_32_global_v8i8_pi32_i32.24.exit: ; preds = %211
  ...
  %221 = shl nuw nsw i64 %170, 6, !spirv.Decorations !467
...
274:                                              ; preds = %269
  ...
  %279 = load i32, i32 addrspace(1)* %278, align 4, !tbaa !463
  br label %280
...
280:                                              ; preds = %274, %269
  ...
  store i32 %281, i32* %283, align 4, !tbaa !463
...
__builtin_spriv_OpJointMatrixLoadINTEL_PackedB_PackedB_16x32_i16_32_global_v8i8_pi32_i32.25.exit: ; preds = %280
  ...
  %287 = add nuw nsw i32 %166, 1, !spirv.Decorations !467
  br label %165
...
340:                                              ; preds = %335
  ...
  %343 = load i32, i32* %342, align 4, !tbaa !463
  ...
  store i32 %343, i32 addrspace(1)* %347, align 4, !tbaa !463
  br label %348
