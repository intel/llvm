; ------------------------------------------------
; OCL_asm40d739ce99ad8281_0118_OPT_after_Combineredundantinstructions.ll
...
39:                                               ; preds = %50, %_Z18get_sub_group_sizev.exit.i4
  %40 = phi i32 [ 0, %_Z18get_sub_group_sizev.exit.i4 ], [ %54, %50 ]
  %41 = icmp ult i16 %simdLaneId16.fr, 1024
...
50:                                               ; preds = %42, %39
  ...
  %55 = icmp ult i32 %40, 127
  br i1 %55, label %39, label %__builtin_spriv_OpJointMatrixLoadINTEL_Accumulator_RowMajor_32x32_i32_128_global_v8i8_pi32_i32.23.exit
...
60:                                               ; preds = %__builtin_spriv_OpJointMatrixLoadINTEL_PackedB_PackedB_16x32_i16_32_global_v8i8_pi32_i32.25.exit, %__builtin_spriv_OpJointMatrixLoadINTEL_Accumulator_RowMajor_32x32_i32_128_global_v8i8_pi32_i32.23.exit
  %61 = phi i32 [ 0, %__builtin_spriv_OpJointMatrixLoadINTEL_Accumulator_RowMajor_32x32_i32_128_global_v8i8_pi32_i32.23.exit ], [ %71, %__builtin_spriv_OpJointMatrixLoadINTEL_PackedB_PackedB_16x32_i16_32_global_v8i8_pi32_i32.25.exit ]
  %62 = icmp ult i32 %61, 2
  br i1 %62, label %_Z18get_sub_group_sizev.exit.i6, label %_Z18get_sub_group_sizev.exit.i

_Z18get_sub_group_sizev.exit.i6:                  ; preds = %60
  br label %63

63:                                               ; preds = %63, %_Z18get_sub_group_sizev.exit.i6
  %64 = phi i32 [ 0, %_Z18get_sub_group_sizev.exit.i6 ], [ %65, %63 ]
  %65 = add nuw nsw i32 %64, 1
  %66 = icmp ult i32 %64, 31
  br i1 %66, label %63, label %__builtin_spriv_OpJointMatrixLoadINTEL_PackedA_RowMajor_32x16_i16_32_global_v8i8_pi32_i32.24.exit

__builtin_spriv_OpJointMatrixLoadINTEL_PackedA_RowMajor_32x16_i16_32_global_v8i8_pi32_i32.24.exit: ; preds = %63
  br label %67

67:                                               ; preds = %67, %__builtin_spriv_OpJointMatrixLoadINTEL_PackedA_RowMajor_32x16_i16_32_global_v8i8_pi32_i32.24.exit
  %68 = phi i32 [ 0, %__builtin_spriv_OpJointMatrixLoadINTEL_PackedA_RowMajor_32x16_i16_32_global_v8i8_pi32_i32.24.exit ], [ %69, %67 ]
  %69 = add nuw nsw i32 %68, 1
  %70 = icmp ult i32 %68, 31
  br i1 %70, label %67, label %__builtin_spriv_OpJointMatrixLoadINTEL_PackedB_PackedB_16x32_i16_32_global_v8i8_pi32_i32.25.exit

__builtin_spriv_OpJointMatrixLoadINTEL_PackedB_PackedB_16x32_i16_32_global_v8i8_pi32_i32.25.exit: ; preds = %67
  %71 = add nuw nsw i32 %61, 1, !spirv.Decorations !525
  br label %60

_Z18get_sub_group_sizev.exit.i:                   ; preds = %60
  ...
  %72 = bitcast [2 x <64 x float>]* %10 to i32*
  br label %73

73:                                               ; preds = %85, %_Z18get_sub_group_sizev.exit.i
  %74 = phi i32 [ 0, %_Z18get_sub_group_sizev.exit.i ], [ %86, %85 ]
  br i1 %41, label %75, label %85

75:                                               ; preds = %73
  %76 = zext i32 %74 to i64
  %77 = getelementptr inbounds i32, i32* %72, i64 %76
  %78 = load i32, i32* %77, align 4, !tbaa !521
  %79 = shl nuw nsw i32 %simdLaneId, 1
  %80 = and i32 %79, 131008
  %81 = or i32 %80, %38
  %82 = zext i32 %81 to i64
  %83 = getelementptr inbounds float, float addrspace(1)* %36, i64 %82
  %84 = bitcast float addrspace(1)* %83 to i32 addrspace(1)*
  store i32 %78, i32 addrspace(1)* %84, align 4, !tbaa !521
  br label %85

85:                                               ; preds = %75, %73
  %86 = add nuw nsw i32 %74, 1
  %87 = icmp ult i32 %74, 127
  br i1 %87, label %73, label %__builtin_spriv_OpJointMatrixStoreINTEL_Accumulator_RowMajor_32x32_i32_128_global_pi64_v8i8.26.exit

__builtin_spriv_OpJointMatrixStoreINTEL_Accumulator_RowMajor_32x32_i32_128_global_pi64_v8i8.26.exit: ; preds = %85
  ret void
}
