; ------------------------------------------------
; OCL_asm40d739ce99ad8281_0124_OPT_after_BreakcriticaledgesinCFG.ll
...
40:                                               ; preds = %._crit_edge96, %_Z18get_sub_group_sizev.exit.i4
  %41 = phi i32 [ 0, %_Z18get_sub_group_sizev.exit.i4 ], [ %54, %._crit_edge96 ]
...
50:                                               ; preds = %._crit_edge, %42
  ...
  br i1 %55, label %._crit_edge96, label %__builtin_spriv_OpJointMatrixLoadINTEL_Accumulator_RowMajor_32x32_i32_128_global_v8i8_pi32_i32.23.exit

._crit_edge96:                                    ; preds = %50
  br label %40
...
61:                                               ; preds = %._crit_edge98, %_Z18get_sub_group_sizev.exit.i
  %62 = phi i32 [ 0, %_Z18get_sub_group_sizev.exit.i ], [ %74, %._crit_edge98 ]
  br i1 %.lcssa, label %63, label %._crit_edge97
...
73:                                               ; preds = %._crit_edge97, %63
  %74 = add nuw nsw i32 %62, 1
  %75 = icmp ult i32 %62, 127
  br i1 %75, label %._crit_edge98, label %__builtin_spriv_OpJointMatrixStoreINTEL_Accumulator_RowMajor_32x32_i32_128_global_pi64_v8i8.26.exit

._crit_edge98:                                    ; preds = %73
  br label %61
