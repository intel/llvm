; ------------------------------------------------
; OCL_asm40d739ce99ad8281_0113_OPT_after_BreakConstantExprPass.ll
...
_Z18get_sub_group_sizev.exit.i4:
  ...
  %40 = bitcast [2 x <64 x float>]* %11 to i32*
  %41 = and i32 %simdLaneId, 31
  br label %42

42:                                               ; preds = %53, %_Z18get_sub_group_sizev.exit.i4
  %43 = phi i32 [ 0, %_Z18get_sub_group_sizev.exit.i4 ], [ %57, %53 ]
  %44 = icmp ult i16 %simdLaneId16.fr, 1024
  br i1 %44, label %45, label %53

45:                                               ; preds = %42
  %46 = shl nuw nsw i32 %simdLaneId, 1
  %47 = and i32 %46, 131008
  %48 = or i32 %47, %41
  %49 = zext i32 %48 to i64
  %50 = getelementptr inbounds float, float addrspace(1)* %36, i64 %49
  %51 = bitcast float addrspace(1)* %50 to i32 addrspace(1)*
  %52 = load i32, i32 addrspace(1)* %51, align 4, !tbaa !521
  br label %53

53:                                               ; preds = %45, %42
  %54 = phi i32 [ %52, %45 ], [ 0, %42 ]
  %55 = zext i32 %43 to i64
  %56 = getelementptr inbounds i32, i32* %40, i64 %55
  store i32 %54, i32* %56, align 4, !tbaa !521
  %57 = add nuw nsw i32 %43, 1
  %58 = icmp ult i32 %43, 127
  br i1 %58, label %42, label %__builtin_spriv_OpJointMatrixLoadINTEL_Accumulator_RowMajor_32x32_i32_128_global_v8i8_pi32_i32.23.exit

__builtin_spriv_OpJointMatrixLoadINTEL_Accumulator_RowMajor_32x32_i32_128_global_v8i8_pi32_i32.23.exit: ; preds = %53
  %59 = getelementptr inbounds [2 x <64 x float>], [2 x <64 x float>]* %11, i64 0, i64 0
  %60 = load <64 x float>, <64 x float>* %59, align 256
  %61 = getelementptr inbounds [2 x <64 x float>], [2 x <64 x float>]* %11, i64 0, i64 1
  %62 = load <64 x float>, <64 x float>* %61, align 256
  br label %63

63:                                               ; preds = %__builtin_spriv_OpJointMatrixLoadINTEL_PackedB_PackedB_16x32_i16_32_global_v8i8_pi32_i32.25.exit, %__builtin_spriv_OpJointMatrixLoadINTEL_Accumulator_RowMajor_32x32_i32_128_global_v8i8_pi32_i32.23.exit
  %64 = phi i32 [ 0, %__builtin_spriv_OpJointMatrixLoadINTEL_Accumulator_RowMajor_32x32_i32_128_global_v8i8_pi32_i32.23.exit ], [ %74, %__builtin_spriv_OpJointMatrixLoadINTEL_PackedB_PackedB_16x32_i16_32_global_v8i8_pi32_i32.25.exit ]
  %65 = icmp ult i32 %64, 2
  br i1 %65, label %_Z18get_sub_group_sizev.exit.i6, label %_Z18get_sub_group_sizev.exit.i

_Z18get_sub_group_sizev.exit.i6:                  ; preds = %63
  br label %66

66:                                               ; preds = %66, %_Z18get_sub_group_sizev.exit.i6
  %67 = phi i32 [ 0, %_Z18get_sub_group_sizev.exit.i6 ], [ %68, %66 ]
  %68 = add nuw nsw i32 %67, 1
  %69 = icmp ult i32 %67, 31
  br i1 %69, label %66, label %__builtin_spriv_OpJointMatrixLoadINTEL_PackedA_RowMajor_32x16_i16_32_global_v8i8_pi32_i32.24.exit

__builtin_spriv_OpJointMatrixLoadINTEL_PackedA_RowMajor_32x16_i16_32_global_v8i8_pi32_i32.24.exit: ; preds = %66
  br label %70

70:                                               ; preds = %70, %__builtin_spriv_OpJointMatrixLoadINTEL_PackedA_RowMajor_32x16_i16_32_global_v8i8_pi32_i32.24.exit
  %71 = phi i32 [ 0, %__builtin_spriv_OpJointMatrixLoadINTEL_PackedA_RowMajor_32x16_i16_32_global_v8i8_pi32_i32.24.exit ], [ %72, %70 ]
  %72 = add nuw nsw i32 %71, 1
  %73 = icmp ult i32 %71, 31
  br i1 %73, label %70, label %__builtin_spriv_OpJointMatrixLoadINTEL_PackedB_PackedB_16x32_i16_32_global_v8i8_pi32_i32.25.exit

__builtin_spriv_OpJointMatrixLoadINTEL_PackedB_PackedB_16x32_i16_32_global_v8i8_pi32_i32.25.exit: ; preds = %70
  %74 = add nuw nsw i32 %64, 1, !spirv.Decorations !525
  br label %63

_Z18get_sub_group_sizev.exit.i:                   ; preds = %63
  %.fca.0.gep = getelementptr inbounds [2 x <64 x float>], [2 x <64 x float>]* %10, i64 0, i64 0
  store <64 x float> %60, <64 x float>* %.fca.0.gep, align 256
  %.fca.1.gep = getelementptr inbounds [2 x <64 x float>], [2 x <64 x float>]* %10, i64 0, i64 1
  store <64 x float> %62, <64 x float>* %.fca.1.gep, align 256
  %75 = bitcast [2 x <64 x float>]* %10 to i32*
  br label %76

76:                                               ; preds = %88, %_Z18get_sub_group_sizev.exit.i
  %77 = phi i32 [ 0, %_Z18get_sub_group_sizev.exit.i ], [ %89, %88 ]
  br i1 %44, label %78, label %88

78:                                               ; preds = %76
  %79 = zext i32 %77 to i64
  %80 = getelementptr inbounds i32, i32* %75, i64 %79
  %81 = load i32, i32* %80, align 4, !tbaa !521
  %82 = shl nuw nsw i32 %simdLaneId, 1
  %83 = and i32 %82, 131008
  %84 = or i32 %83, %41
  %85 = zext i32 %84 to i64
  %86 = getelementptr inbounds float, float addrspace(1)* %36, i64 %85
  %87 = bitcast float addrspace(1)* %86 to i32 addrspace(1)*
  store i32 %81, i32 addrspace(1)* %87, align 4, !tbaa !521
  br label %88

88:                                               ; preds = %78, %76
  %89 = add nuw nsw i32 %77, 1
  %90 = icmp ult i32 %77, 127
  br i1 %90, label %76, label %__builtin_spriv_OpJointMatrixStoreINTEL_Accumulator_RowMajor_32x32_i32_128_global_pi64_v8i8.26.exit

__builtin_spriv_OpJointMatrixStoreINTEL_Accumulator_RowMajor_32x32_i32_128_global_pi64_v8i8.26.exit: ; preds = %88
  ret void
}
