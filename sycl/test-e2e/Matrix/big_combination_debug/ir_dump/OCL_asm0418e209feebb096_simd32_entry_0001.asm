...
//.declare TEMP_FLAG_2 (54)  rf=f32  size=4 type=uw align=2 words (f0.0)
//.declare r0 (55)  rf=r size=32 type=ud align=16 words (r0.0)
//.declare rtmp (56)  rf=r size=32 type=ud align=16 words (r127.0)
//.declare inlineRegFromTDL (57)  rf=r size=32 type=ud align=16 words (r1.0)
//.declare inlineRegExpectedLocation (58)  rf=r size=32 type=ud align=16 words (r7.0)
//.declare TV7 (59)  rf=r size=128 type=ud align=16 words (r1.0)
//.declare TV8 (60)  rf=r size=64 type=ud align=16 words (r5.0)
//.declare TV9 (61)  rf=r size=32 type=ud align=16 words (r8.0)
