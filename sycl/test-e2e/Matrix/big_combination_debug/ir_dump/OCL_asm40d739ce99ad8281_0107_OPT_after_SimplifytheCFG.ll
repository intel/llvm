; ------------------------------------------------
; OCL_asm40d739ce99ad8281_0107_OPT_after_SimplifytheCFG.ll
...
_Z18get_sub_group_sizev.exit.i4:
  %localSize.scalar = extractelement <3 x i32> %localSize, i32 0
  %localSize.scalar94 = extractelement <3 x i32> %localSize, i32 1
  %localSize.scalar95 = extractelement <3 x i32> %localSize, i32 2
  %payloadHeader.scalar = extractelement <8 x i32> %payloadHeader, i32 0
  %payloadHeader.scalar87 = extractelement <8 x i32> %payloadHeader, i32 1
  %payloadHeader.scalar88 = extractelement <8 x i32> %payloadHeader, i32 2
  %payloadHeader.scalar89 = extractelement <8 x i32> %payloadHeader, i32 3
  %payloadHeader.scalar90 = extractelement <8 x i32> %payloadHeader, i32 4
  %payloadHeader.scalar91 = extractelement <8 x i32> %payloadHeader, i32 5
  %payloadHeader.scalar92 = extractelement <8 x i32> %payloadHeader, i32 6
  %payloadHeader.scalar93 = extractelement <8 x i32> %payloadHeader, i32 7
  %enqueuedLocalSize.scalar = extractelement <3 x i32> %enqueuedLocalSize, i32 0
  %enqueuedLocalSize.scalar85 = extractelement <3 x i32> %enqueuedLocalSize, i32 1
  %enqueuedLocalSize.scalar86 = extractelement <3 x i32> %enqueuedLocalSize, i32 2
  %r0.scalar = extractelement <8 x i32> %r0, i32 0
  %r0.scalar78 = extractelement <8 x i32> %r0, i32 1
  %r0.scalar79 = extractelement <8 x i32> %r0, i32 2
  %r0.scalar80 = extractelement <8 x i32> %r0, i32 3
  %r0.scalar81 = extractelement <8 x i32> %r0, i32 4
  %r0.scalar82 = extractelement <8 x i32> %r0, i32 5
  %r0.scalar83 = extractelement <8 x i32> %r0, i32 6
  %r0.scalar84 = extractelement <8 x i32> %r0, i32 7
  ...
  %37 = mul i32 %localSize.scalar94, %localSize.scalar
  %38 = mul i32 %37, %localSize.scalar95
  %39 = and i32 %38, 7
  %40 = icmp eq i32 %39, 0
  ...
  %41 = bitcast [2 x <64 x float>]* %11 to i32*
  %42 = and i32 %simdLaneId, 31
  br label %43

43:                                               ; preds = %54, %_Z18get_sub_group_sizev.exit.i4
  %44 = phi i32 [ 0, %_Z18get_sub_group_sizev.exit.i4 ], [ %58, %54 ]
  %45 = icmp ult i16 %simdLaneId16.fr, 1024
  br i1 %45, label %46, label %54

46:                                               ; preds = %43
  %47 = shl nuw nsw i32 %simdLaneId, 1
  %48 = and i32 %47, 131008
  %49 = or i32 %48, %42
  %50 = zext i32 %49 to i64
  %51 = getelementptr inbounds float, float addrspace(1)* %36, i64 %50
  %52 = bitcast float addrspace(1)* %51 to i32 addrspace(1)*
  %53 = load i32, i32 addrspace(1)* %52, align 4, !tbaa !521
  br label %54

54:                                               ; preds = %46, %43
  %55 = phi i32 [ %53, %46 ], [ 0, %43 ]
  %56 = zext i32 %44 to i64
  %57 = getelementptr inbounds i32, i32* %41, i64 %56
  store i32 %55, i32* %57, align 4, !tbaa !521
  %58 = add nuw nsw i32 %44, 1
  %59 = icmp ult i32 %44, 127
  br i1 %59, label %43, label %__builtin_spriv_OpJointMatrixLoadINTEL_Accumulator_RowMajor_32x32_i32_128_global_v8i8_pi32_i32.23.exit

__builtin_spriv_OpJointMatrixLoadINTEL_Accumulator_RowMajor_32x32_i32_128_global_v8i8_pi32_i32.23.exit: ; preds = %54
  %60 = getelementptr inbounds [2 x <64 x float>], [2 x <64 x float>]* %11, i64 0, i64 0
  %61 = load <64 x float>, <64 x float>* %60, align 256
  %62 = getelementptr inbounds [2 x <64 x float>], [2 x <64 x float>]* %11, i64 0, i64 1
  %63 = load <64 x float>, <64 x float>* %62, align 256
  br label %64

64:                                               ; preds = %__builtin_spriv_OpJointMatrixLoadINTEL_PackedB_PackedB_16x32_i16_32_global_v8i8_pi32_i32.25.exit, %__builtin_spriv_OpJointMatrixLoadINTEL_Accumulator_RowMajor_32x32_i32_128_global_v8i8_pi32_i32.23.exit
  %65 = phi i32 [ 0, %__builtin_spriv_OpJointMatrixLoadINTEL_Accumulator_RowMajor_32x32_i32_128_global_v8i8_pi32_i32.23.exit ], [ %84, %__builtin_spriv_OpJointMatrixLoadINTEL_PackedB_PackedB_16x32_i16_32_global_v8i8_pi32_i32.25.exit ]
  %66 = icmp ult i32 %65, 2
  br i1 %66, label %_Z18get_sub_group_sizev.exit.i6, label %_Z18get_sub_group_sizev.exit.i

_Z18get_sub_group_sizev.exit.i6:                  ; preds = %64
  %67 = mul i32 %localSize.scalar94, %localSize.scalar
  %68 = mul i32 %67, %localSize.scalar95
  %69 = and i32 %68, 7
  %70 = icmp eq i32 %69, 0
  br label %71

71:                                               ; preds = %71, %_Z18get_sub_group_sizev.exit.i6
  %72 = phi i32 [ 0, %_Z18get_sub_group_sizev.exit.i6 ], [ %73, %71 ]
  %73 = add nuw nsw i32 %72, 1
  %74 = icmp ult i32 %72, 31
  br i1 %74, label %71, label %__builtin_spriv_OpJointMatrixLoadINTEL_PackedA_RowMajor_32x16_i16_32_global_v8i8_pi32_i32.24.exit

__builtin_spriv_OpJointMatrixLoadINTEL_PackedA_RowMajor_32x16_i16_32_global_v8i8_pi32_i32.24.exit: ; preds = %71
  %75 = mul i32 %localSize.scalar94, %localSize.scalar
  %76 = mul i32 %75, %localSize.scalar95
  %77 = and i32 %76, 7
  %78 = icmp eq i32 %77, 0
...
79:                                               ; preds = %79, %__builtin_spriv_OpJointMatrixLoadINTEL_PackedA_RowMajor_32x16_i16_32_global_v8i8_pi32_i32.24.exit
  %80 = phi i32 [ 0, %__builtin_spriv_OpJointMatrixLoadINTEL_PackedA_RowMajor_32x16_i16_32_global_v8i8_pi32_i32.24.exit ], [ %82, %79 ]
  %81 = icmp ult i16 %simdLaneId1669.fr, 256
  %82 = add nuw nsw i32 %80, 1
  %83 = icmp ult i32 %80, 31
  br i1 %83, label %79, label %__builtin_spriv_OpJointMatrixLoadINTEL_PackedB_PackedB_16x32_i16_32_global_v8i8_pi32_i32.25.exit

__builtin_spriv_OpJointMatrixLoadINTEL_PackedB_PackedB_16x32_i16_32_global_v8i8_pi32_i32.25.exit: ; preds = %79
  %84 = add nuw nsw i32 %65, 1, !spirv.Decorations !525
  br label %64

_Z18get_sub_group_sizev.exit.i:                   ; preds = %64
  %.fca.0.gep = getelementptr inbounds [2 x <64 x float>], [2 x <64 x float>]* %10, i64 0, i64 0
  store <64 x float> %61, <64 x float>* %.fca.0.gep, align 256
  %.fca.1.gep = getelementptr inbounds [2 x <64 x float>], [2 x <64 x float>]* %10, i64 0, i64 1
  store <64 x float> %63, <64 x float>* %.fca.1.gep, align 256
  %85 = mul i32 %localSize.scalar94, %localSize.scalar
  %86 = mul i32 %85, %localSize.scalar95
  %87 = and i32 %86, 7
  %88 = icmp eq i32 %87, 0
  ...
  %89 = bitcast [2 x <64 x float>]* %10 to i32*
  %90 = and i32 %simdLaneId72, 31
  br label %91

91:                                               ; preds = %104, %_Z18get_sub_group_sizev.exit.i
  %92 = phi i32 [ 0, %_Z18get_sub_group_sizev.exit.i ], [ %105, %104 ]
  %93 = icmp ult i16 %simdLaneId1671.fr, 1024
  br i1 %93, label %94, label %104

94:                                               ; preds = %91
  %95 = zext i32 %92 to i64
  %96 = getelementptr inbounds i32, i32* %89, i64 %95
  %97 = load i32, i32* %96, align 4, !tbaa !521
  %98 = shl nuw nsw i32 %simdLaneId72, 1
  %99 = and i32 %98, 131008
  %100 = or i32 %99, %90
  %101 = zext i32 %100 to i64
  %102 = getelementptr inbounds float, float addrspace(1)* %36, i64 %101
  %103 = bitcast float addrspace(1)* %102 to i32 addrspace(1)*
  store i32 %97, i32 addrspace(1)* %103, align 4, !tbaa !521
  br label %104

104:                                              ; preds = %94, %91
  %105 = add nuw nsw i32 %92, 1
  %106 = icmp ult i32 %92, 127
  br i1 %106, label %91, label %__builtin_spriv_OpJointMatrixStoreINTEL_Accumulator_RowMajor_32x32_i32_128_global_pi64_v8i8.26.exit

__builtin_spriv_OpJointMatrixStoreINTEL_Accumulator_RowMajor_32x32_i32_128_global_pi64_v8i8.26.exit: ; preds = %104
  ret void
}
