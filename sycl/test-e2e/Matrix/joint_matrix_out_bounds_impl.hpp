...
void matrix_multiply(big_matrix<T1, NUM_ROWS_C, NUM_COLS_C> &C,
  ...
  size_t NDRangeM = M / TM + 1; // 1 is for the out of bounds dpas instruction
...
//By default, out of bounds are treated as zero 
static constexpr size_t MATRIX_M = TM * 2 + 4; // there will be 4 out of bounds
