...
template <class T, int BLOCK_WIDTH, int BLOCK_HEIGHT, int NUM_BLOCKS,
          ...
          int N = __ESIMD_ENS::get_lsc_block_2d_data_size<
...
constexpr int N16_8 =
    __ESIMD_ENS::get_lsc_block_2d_data_size<float, 1, 16, 8, false>();
...
constexpr int N16_16 =
    __ESIMD_ENS::get_lsc_block_2d_data_size<float, 1, 16, 16, false>();
