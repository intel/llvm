...
esimd_math(simd<float, 16> x) {
  simd<float, 16> v = 0;
  //CHECK:  call spir_func noundef <16 x float> @_Z22__spirv_ocl_native_cosIfLi16EEDvT0__T_S1_
  v = esimd::cos(x);
  //CHECK: call spir_func noundef <16 x float> @_Z22__spirv_ocl_native_sinIfLi16EEDvT0__T_S1_
  v = esimd::sin(v);
  //CHECK: call spir_func noundef <16 x float> @_Z23__spirv_ocl_native_log2IfLi16EEDvT0__T_S1_
  v = esimd::log2(v);
  //CHECK: call spir_func noundef <16 x float> @_Z23__spirv_ocl_native_exp2IfLi16EEDvT0__T_S1_
  v = esimd::exp2(v);
  return v;
}
