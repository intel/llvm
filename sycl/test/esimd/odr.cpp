...
//
// RUN: %clangxx -fsycl -fsycl-targets=%sycl_triple -DSOURCE1 -Xclang -opaque-pointers -c %s -o %t1.o
// RUN: %clangxx -fsycl -fsycl-targets=%sycl_triple -DSOURCE2 -Xclang -opaque-pointers -c %s -o %t2.o
// RUN: %clangxx -fsycl -fsycl-targets=%sycl_triple -Xclang -opaque-pointers %t1.o %t2.o -o %t.exe
//
