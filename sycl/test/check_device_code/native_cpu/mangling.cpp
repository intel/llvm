...
// RUN: %clang -cc1 -triple x86_64-pc-windows-msvc   -aux-triple x86_64-pc-windows-msvc   -fsycl-is-device -fsycl-is-native-cpu -emit-llvm -o - -x c++ %s | FileCheck %s
// RUN: %clang -cc1 -triple x86_64-unknown-linux-gnu -aux-triple x86_64-unknown-linux-gnu -fsycl-is-device -fsycl-is-native-cpu -emit-llvm -o - -x c++ %s | FileCheck %s
// RUN: %clang -cc1 -triple x86_64-unknown-linux-gnu -aux-triple x86_64-pc-windows-msvc   -fsycl-is-device -fsycl-is-native-cpu -emit-llvm -o - -x c++ %s | FileCheck %s
// RUN: %clang -cc1 -triple x86_64-pc-windows-msvc   -aux-triple x86_64-unknown-linux-gnu -fsycl-is-device -fsycl-is-native-cpu -emit-llvm -o - -x c++ %s | FileCheck %s
