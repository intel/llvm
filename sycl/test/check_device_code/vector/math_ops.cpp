...
// CHECK-SAME: ptr dead_on_unwind noalias writable writeonly sret(%"class.sycl::_V1::vec") align 8 captures(none) initializes((0, 8)) [[AGG_RESULT:%.*]], ptr noundef readonly byval(%"class.sycl::_V1::vec") align 8 captures(none) [[A:%.*]], ptr noundef readonly byval(%"class.sycl::_V1::vec") align 8 captures(none) [[B:%.*]]) local_unnamed_addr #[[ATTR0:[0-9]+]] {{.*}}{
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    store <2 x i32> [[ADD_I_I_I_I_I]], ptr [[AGG_RESULT]], align 8, !alias.scope [[META18:![0-9]+]]
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr dead_on_unwind noalias writable writeonly sret(%"class.sycl::_V1::vec.33") align 16 captures(none) initializes((0, 16)) [[AGG_RESULT:%.*]], ptr noundef readonly byval(%"class.sycl::_V1::vec.33") align 16 captures(none) [[A:%.*]], ptr noundef readonly byval(%"class.sycl::_V1::vec.33") align 16 captures(none) [[B:%.*]]) local_unnamed_addr #[[ATTR0]] {{.*}}{
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    store <4 x float> [[EXTRACTVEC_I_I]], ptr [[AGG_RESULT]], align 16, !alias.scope [[META28]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    store <16 x i8> [[ADD_I_I_I_I_I]], ptr [[AGG_RESULT]], align 16, !alias.scope [[META36]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    store <8 x i8> [[XOR_I_I_I_I_I]], ptr [[AGG_RESULT]], align 8, !alias.scope [[META45:![0-9]+]]
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr dead_on_unwind noalias writable writeonly sret(%"class.sycl::_V1::vec.123") align 4 captures(none) initializes((0, 4)) [[AGG_RESULT:%.*]], ptr noundef readonly byval(%"class.sycl::_V1::vec.123") align 4 captures(none) [[A:%.*]], ptr noundef readonly byval(%"class.sycl::_V1::vec.123") align 4 captures(none) [[B:%.*]]) local_unnamed_addr #[[ATTR0]] {{.*}}{
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    store <4 x i8> [[SEXT_NEG_I_I]], ptr [[AGG_RESULT]], align 4, !alias.scope [[META56:![0-9]+]]
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr dead_on_unwind noalias writable writeonly sret(%"class.sycl::_V1::vec.163") align 8 captures(none) initializes((0, 8)) [[AGG_RESULT:%.*]], ptr noundef readonly byval(%"class.sycl::_V1::vec.163") align 8 captures(none) [[A:%.*]], ptr noundef readonly byval(%"class.sycl::_V1::vec.163") align 8 captures(none) [[B:%.*]]) local_unnamed_addr #[[ATTR0]] {{.*}}{
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    store <4 x half> [[EXTRACTVEC_I_I]], ptr [[AGG_RESULT]], align 8, !alias.scope [[META69:![0-9]+]]
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr dead_on_unwind noalias writable writeonly sret(%"class.sycl::_V1::vec.203") align 8 captures(none) [[AGG_RESULT:%.*]], ptr noundef byval(%"class.sycl::_V1::vec.203") align 8 [[A:%.*]], ptr noundef byval(%"class.sycl::_V1::vec.203") align 8 [[B:%.*]]) local_unnamed_addr #[[ATTR1:[0-9]+]] {{.*}}{
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    store i64 [[TMP0]], ptr [[AGG_RESULT]], align 8, !alias.scope [[META79]]
...
// CHECK-NEXT:    store <16 x i32> [[SEXT_I_I_I_I]], ptr [[AGG_RESULT]], align 64, !alias.scope [[META99]]
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr dead_on_unwind noalias writable writeonly sret(%"class.sycl::_V1::vec.290") align 2 captures(none) initializes((0, 2)) [[AGG_RESULT:%.*]], ptr noundef readonly byval(%"class.sycl::_V1::vec.328") align 2 captures(none) [[A:%.*]], ptr noundef readonly byval(%"class.sycl::_V1::vec.328") align 2 captures(none) [[B:%.*]]) local_unnamed_addr #[[ATTR0]] {{.*}}{
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    store <2 x i8> [[SEXT_I_I_I_I]], ptr [[AGG_RESULT]], align 2, !alias.scope [[META109:![0-9]+]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    store <8 x i16> [[SEXT_I_I_I_I]], ptr [[AGG_RESULT]], align 16, !alias.scope [[META119]]
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr dead_on_unwind noalias writable writeonly sret(%"class.sycl::_V1::vec.450") align 8 captures(none) [[AGG_RESULT:%.*]], ptr noundef byval(%"class.sycl::_V1::vec.488") align 8 [[A:%.*]], ptr noundef byval(%"class.sycl::_V1::vec.488") align 8 [[B:%.*]]) local_unnamed_addr #[[ATTR1]] {{.*}}{
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    store i64 [[TMP0]], ptr [[AGG_RESULT]], align 8, !alias.scope [[META127]]
...
// CHECK-SAME: ptr dead_on_unwind noalias writable writeonly sret(%"class.sycl::_V1::vec.526") align 16 captures(none) initializes((0, 16)) [[AGG_RESULT:%.*]], ptr noundef readonly byval(%"class.sycl::_V1::vec.526") align 16 captures(none) [[A:%.*]]) local_unnamed_addr #[[ATTR0]] {{.*}}{
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    store <4 x i32> [[EXTRACTVEC_I_I]], ptr [[AGG_RESULT]], align 16, !alias.scope [[META136]]
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr dead_on_unwind noalias writable writeonly sret(%"class.sycl::_V1::vec.565") align 16 captures(none) initializes((0, 16)) [[AGG_RESULT:%.*]], ptr noundef readonly byval(%"class.sycl::_V1::vec.565") align 16 captures(none) [[A:%.*]]) local_unnamed_addr #[[ATTR0]] {{.*}}{
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    store <4 x i32> [[SUB_I_I_I_I]], ptr [[AGG_RESULT]], align 16, !alias.scope [[META144]]
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr dead_on_unwind noalias writable writeonly sret(%"class.sycl::_V1::vec.604") align 16 captures(none) initializes((0, 16)) [[AGG_RESULT:%.*]], ptr noundef readonly byval(%"class.sycl::_V1::vec.604") align 16 captures(none) [[A:%.*]]) local_unnamed_addr #[[ATTR0]] {{.*}}{
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    store <16 x i8> [[NOT_I_I_I_I]], ptr [[AGG_RESULT]], align 16, !alias.scope [[META152]]
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr dead_on_unwind noalias writable writeonly sret(%"class.sycl::_V1::vec.613") align 4 captures(none) initializes((0, 4)) [[AGG_RESULT:%.*]], ptr noundef readonly byval(%"class.sycl::_V1::vec.123") align 4 captures(none) [[A:%.*]]) local_unnamed_addr #[[ATTR0]] {{.*}}{
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    store <4 x i8> [[SEXT_I_I_I_I]], ptr [[AGG_RESULT]], align 4, !alias.scope [[META161:![0-9]+]]
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr dead_on_unwind noalias writable writeonly sret(%"class.sycl::_V1::vec.652") align 4 captures(none) initializes((0, 4)) [[AGG_RESULT:%.*]], ptr noundef readonly byval(%"class.sycl::_V1::vec.690") align 4 captures(none) [[A:%.*]]) local_unnamed_addr #[[ATTR0]] {{.*}}{
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    store <2 x i16> [[SEXT_I_I_I_I]], ptr [[AGG_RESULT]], align 4, !alias.scope [[META172:![0-9]+]]
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr dead_on_unwind noalias writable writeonly sret(%"class.sycl::_V1::vec.408") align 16 captures(none) initializes((0, 16)) [[AGG_RESULT:%.*]], ptr noundef readonly byval(%"class.sycl::_V1::vec.408") align 16 captures(none) [[A:%.*]]) local_unnamed_addr #[[ATTR0]] {{.*}}{
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    store <8 x half> [[FNEG_I_I_I_I]], ptr [[AGG_RESULT]], align 16, !alias.scope [[META182]]
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr dead_on_unwind noalias writable writeonly sret(%"class.sycl::_V1::vec.730") align 8 captures(none) [[AGG_RESULT:%.*]], ptr noundef byval(%"class.sycl::_V1::vec.203") align 8 [[A:%.*]]) local_unnamed_addr #[[ATTR1]] {{.*}}{
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    store i64 [[TMP0]], ptr [[AGG_RESULT]], align 8, !alias.scope [[META190]]
...
// CHECK-SAME: ptr dead_on_unwind noalias writable writeonly sret(%"class.sycl::_V1::vec.768") align 32 captures(none) [[AGG_RESULT:%.*]], ptr noundef byval(%"class.sycl::_V1::vec.768") align 32 [[A:%.*]]) local_unnamed_addr #[[ATTR1]] {{.*}}{
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[REF_TMP_I_I_I_I:%.*]] = alloca float, align 4
...
// CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 32 [[AGG_RESULT]], ptr align 32 [[RES_I_I]], i64 32, i1 false)
