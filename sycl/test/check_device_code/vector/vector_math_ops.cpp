...
// CHECK-NEXT:    [[CALL_I_I_I_I_I_I:%.*]] = call spir_func noundef float @__devicelib_ConvertBF16ToFINTEL(ptr addrspace(4) noundef align 2 dereferenceable(2) [[REF_TMP2_ASCAST_I_I]]) #[[ATTR9:[0-9]+]], !noalias [[META86:![0-9]+]]
// CHECK-NEXT:    [[CALL_I_I2_I_I_I_I:%.*]] = call spir_func noundef float @__devicelib_ConvertBF16ToFINTEL(ptr addrspace(4) noundef align 2 dereferenceable(2) [[REF_TMP3_ASCAST_I_I]]) #[[ATTR9]], !noalias [[META86]]
...
// CHECK-NEXT:    [[CALL_I_I3_I_I_I_I:%.*]] = call spir_func noundef zeroext i16 @__devicelib_ConvertFToBF16INTEL(ptr addrspace(4) noundef align 4 dereferenceable(4) [[REF_TMP_ASCAST_I_I_I_I]]) #[[ATTR9]], !noalias [[META86]]
...
// CHECK-SAME: ptr nocapture noundef readonly byval(%"class.sycl::_V1::vec.739") align 4 [[A:%.*]], ptr nocapture noundef readonly byval(%"class.sycl::_V1::vec.739") align 4 [[B:%.*]]) local_unnamed_addr #[[ATTR4:[0-9]+]] !srcloc [[META100:![0-9]+]] !sycl_fixed_targets [[META7]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[LOADVEC4_I_I_I:%.*]] = load <4 x i8>, ptr [[A]], align 1
// CHECK-NEXT:    [[LOADVEC4_I_I_I2:%.*]] = load <4 x i8>, ptr [[B]], align 1
// CHECK-NEXT:    [[TMP0:%.*]] = icmp ugt <4 x i8> [[LOADVEC4_I_I_I]], [[LOADVEC4_I_I_I2]]
...
// CHECK-SAME: ptr addrspace(4) dead_on_unwind noalias nocapture writable writeonly sret(%"class.sycl::_V1::vec.832") align 2 [[AGG_RESULT:%.*]], ptr nocapture noundef readonly byval(%"class.sycl::_V1::vec.924") align 2 [[A:%.*]], ptr nocapture noundef readonly byval(%"class.sycl::_V1::vec.924") align 2 [[B:%.*]]) local_unnamed_addr #[[ATTR1]] !srcloc [[META101:![0-9]+]] !sycl_fixed_targets [[META7]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP_I_I:%.*]] = alloca %"class.sycl::_V1::vec.832", align 2
...
// CHECK-NEXT:    call void @llvm.lifetime.start.p0(i64 2, ptr nonnull [[TMP_I_I]]), !noalias [[META102]]
// CHECK-NEXT:    store i16 0, ptr [[TMP_I_I]], align 2, !noalias [[META108:![0-9]+]]
// CHECK-NEXT:    br label [[FOR_COND_I_I:%.*]]
// CHECK:       for.cond.i.i:
// CHECK-NEXT:    [[I_0_I_I:%.*]] = phi i32 [ 0, [[ENTRY:%.*]] ], [ [[INC_I_I:%.*]], [[FOR_BODY_I_I:%.*]] ]
...
// CHECK-NEXT:    [[TMP0:%.*]] = load i8, ptr [[ARRAYIDX_I_I_I_I_I_I]], align 1, !tbaa [[TBAA50]], !range [[RNG52]], !noalias [[META108]], !noundef [[META7]]
// CHECK-NEXT:    [[ARRAYIDX_I_I_I_I12_I_I:%.*]] = getelementptr inbounds [2 x i8], ptr [[B]], i64 0, i64 [[CONV_I_I_I_I]]
// CHECK-NEXT:    [[TMP1:%.*]] = load i8, ptr [[ARRAYIDX_I_I_I_I12_I_I]], align 1, !tbaa [[TBAA50]], !range [[RNG52]], !noalias [[META108]], !noundef [[META7]]
...
// CHECK-NEXT:    store i8 [[CONV_I_I]], ptr [[ARRAYIDX_I_I_I_I_I]], align 1, !tbaa [[TBAA15]], !noalias [[META108]]
// CHECK-NEXT:    [[INC_I_I]] = add nuw nsw i32 [[I_0_I_I]], 1
// CHECK-NEXT:    br label [[FOR_COND_I_I]], !llvm.loop [[LOOP109:![0-9]+]]
// CHECK:       _ZN4sycl3_V16detailgtERKNS0_3vecIbLi2EEES5_.exit:
// CHECK-NEXT:    [[TMP2:%.*]] = load i16, ptr [[TMP_I_I]], align 2, !noalias [[META108]]
// CHECK-NEXT:    store i16 [[TMP2]], ptr addrspace(4) [[AGG_RESULT]], align 2, !alias.scope [[META108]]
// CHECK-NEXT:    call void @llvm.lifetime.end.p0(i64 2, ptr nonnull [[TMP_I_I]]), !noalias [[META102]]
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr addrspace(4) dead_on_unwind noalias nocapture writable writeonly sret(%"class.sycl::_V1::vec.1018") align 16 [[AGG_RESULT:%.*]], ptr nocapture noundef readonly byval(%"class.sycl::_V1::vec.1110") align 16 [[A:%.*]], ptr nocapture noundef readonly byval(%"class.sycl::_V1::vec.1110") align 16 [[B:%.*]]) local_unnamed_addr #[[ATTR0]] !srcloc [[META110:![0-9]+]] !sycl_used_aspects [[META56]] !sycl_fixed_targets [[META7]] {
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    [[REF_TMP_SROA_0_0_COPYLOAD_I_I:%.*]] = load <8 x half>, ptr [[A]], align 16, !noalias [[META117:![0-9]+]]
// CHECK-NEXT:    [[REF_TMP2_SROA_0_0_COPYLOAD_I_I:%.*]] = load <8 x half>, ptr [[B]], align 16, !noalias [[META117]]
...
// CHECK-NEXT:    store <8 x i16> [[SEXT_I_I_I]], ptr addrspace(4) [[AGG_RESULT]], align 16, !tbaa [[TBAA15]], !alias.scope [[META117]]
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr addrspace(4) dead_on_unwind noalias nocapture writable writeonly sret(%"class.sycl::_V1::vec.1205") align 8 [[AGG_RESULT:%.*]], ptr nocapture noundef readonly byval(%"class.sycl::_V1::vec.1297") align 8 [[A:%.*]], ptr nocapture noundef readonly byval(%"class.sycl::_V1::vec.1297") align 8 [[B:%.*]]) local_unnamed_addr #[[ATTR2]] !srcloc [[META118:![0-9]+]] !sycl_fixed_targets [[META7]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP_I_I:%.*]] = alloca %"class.sycl::_V1::vec.1205", align 8
...
// CHECK-NEXT:    call void @llvm.lifetime.start.p0(i64 8, ptr nonnull [[TMP_I_I]]), !noalias [[META119]]
// CHECK-NEXT:    call void @llvm.lifetime.start.p0(i64 2, ptr nonnull [[REF_TMP_I_I]]), !noalias [[META119]]
// CHECK-NEXT:    call void @llvm.lifetime.start.p0(i64 2, ptr nonnull [[REF_TMP2_I_I]]), !noalias [[META119]]
// CHECK-NEXT:    [[REF_TMP_ASCAST_I_I:%.*]] = addrspacecast ptr [[REF_TMP_I_I]] to ptr addrspace(4)
// CHECK-NEXT:    [[REF_TMP2_ASCAST_I_I:%.*]] = addrspacecast ptr [[REF_TMP2_I_I]] to ptr addrspace(4)
// CHECK-NEXT:    store i64 0, ptr [[TMP_I_I]], align 8, !noalias [[META125:![0-9]+]]
// CHECK-NEXT:    br label [[FOR_COND_I_I:%.*]]
// CHECK:       for.cond.i.i:
// CHECK-NEXT:    [[I_0_I_I:%.*]] = phi i32 [ 0, [[ENTRY:%.*]] ], [ [[INC_I_I:%.*]], [[FOR_BODY_I_I:%.*]] ]
// CHECK-NEXT:    [[CMP_I_I:%.*]] = icmp ult i32 [[I_0_I_I]], 4
...
// CHECK-NEXT:    [[CONV_I_I_I_I:%.*]] = zext nneg i32 [[I_0_I_I]] to i64
// CHECK-NEXT:    [[ARRAYIDX_I_I_I_I_I_I:%.*]] = getelementptr inbounds [4 x %"class.sycl::_V1::ext::oneapi::bfloat16"], ptr [[A]], i64 0, i64 [[CONV_I_I_I_I]]
// CHECK-NEXT:    [[TMP0:%.*]] = load i16, ptr [[ARRAYIDX_I_I_I_I_I_I]], align 2, !tbaa [[TBAA76]], !noalias [[META129:![0-9]+]]
// CHECK-NEXT:    store i16 [[TMP0]], ptr [[REF_TMP_I_I]], align 2, !tbaa [[TBAA76]], !alias.scope [[META126]], !noalias [[META125]]
// CHECK-NEXT:    call void @llvm.experimental.noalias.scope.decl(metadata [[META130:![0-9]+]])
// CHECK-NEXT:    [[ARRAYIDX_I_I_I_I9_I_I:%.*]] = getelementptr inbounds [4 x %"class.sycl::_V1::ext::oneapi::bfloat16"], ptr [[B]], i64 0, i64 [[CONV_I_I_I_I]]
// CHECK-NEXT:    [[TMP1:%.*]] = load i16, ptr [[ARRAYIDX_I_I_I_I9_I_I]], align 2, !tbaa [[TBAA76]], !noalias [[META133:![0-9]+]]
// CHECK-NEXT:    store i16 [[TMP1]], ptr [[REF_TMP2_I_I]], align 2, !tbaa [[TBAA76]], !alias.scope [[META130]], !noalias [[META125]]
// CHECK-NEXT:    [[CALL_I_I_I_I_I_I_I:%.*]] = call spir_func noundef float @__devicelib_ConvertBF16ToFINTEL(ptr addrspace(4) noundef align 2 dereferenceable(2) [[REF_TMP_ASCAST_I_I]]) #[[ATTR9]], !noalias [[META125]]
// CHECK-NEXT:    [[CALL_I_I2_I_I_I_I_I:%.*]] = call spir_func noundef float @__devicelib_ConvertBF16ToFINTEL(ptr addrspace(4) noundef align 2 dereferenceable(2) [[REF_TMP2_ASCAST_I_I]]) #[[ATTR9]], !noalias [[META125]]
...
// CHECK-NEXT:    store i16 [[CONV_I_I]], ptr [[ARRAYIDX_I_I_I_I_I]], align 2, !tbaa [[TBAA76]], !noalias [[META125]]
// CHECK-NEXT:    [[INC_I_I]] = add nuw nsw i32 [[I_0_I_I]], 1
// CHECK-NEXT:    br label [[FOR_COND_I_I]], !llvm.loop [[LOOP134:![0-9]+]]
// CHECK:       _ZN4sycl3_V16detailgtERKNS0_3vecINS0_3ext6oneapi8bfloat16ELi4EEES8_.exit:
// CHECK-NEXT:    [[TMP2:%.*]] = load i64, ptr [[TMP_I_I]], align 8, !noalias [[META125]]
// CHECK-NEXT:    store i64 [[TMP2]], ptr addrspace(4) [[AGG_RESULT]], align 8, !alias.scope [[META125]]
// CHECK-NEXT:    call void @llvm.lifetime.end.p0(i64 8, ptr nonnull [[TMP_I_I]]), !noalias [[META119]]
// CHECK-NEXT:    call void @llvm.lifetime.end.p0(i64 2, ptr nonnull [[REF_TMP_I_I]]), !noalias [[META119]]
// CHECK-NEXT:    call void @llvm.lifetime.end.p0(i64 2, ptr nonnull [[REF_TMP2_I_I]]), !noalias [[META119]]
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr addrspace(4) dead_on_unwind noalias nocapture writable writeonly sret(%"class.sycl::_V1::vec.1391") align 16 [[AGG_RESULT:%.*]], ptr nocapture noundef readonly byval(%"class.sycl::_V1::vec.1391") align 16 [[A:%.*]]) local_unnamed_addr #[[ATTR5:[0-9]+]] !srcloc [[META135:![0-9]+]] !sycl_fixed_targets [[META7]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP_I_I:%.*]] = alloca %"class.sycl::_V1::vec.1391", align 16
// CHECK-NEXT:    call void @llvm.lifetime.start.p0(i64 16, ptr nonnull [[TMP_I_I]]), !noalias [[META136:![0-9]+]]
// CHECK-NEXT:    br label [[FOR_COND_I_I:%.*]]
// CHECK:       for.cond.i.i:
// CHECK-NEXT:    [[I_0_I_I:%.*]] = phi i32 [ 0, [[ENTRY:%.*]] ], [ [[INC_I_I:%.*]], [[FOR_BODY_I_I:%.*]] ]
// CHECK-NEXT:    [[CMP_I_I:%.*]] = icmp ult i32 [[I_0_I_I]], 3
...
// CHECK-NEXT:    [[TMP0:%.*]] = load i32, ptr [[ARRAYIDX_I_I_I_I_I]], align 4, !tbaa [[TBAA139:![0-9]+]], !noalias [[META141:![0-9]+]]
...
// CHECK-NEXT:    store i32 [[COND_I_I]], ptr [[ARRAYIDX_I_I_I9_I_I]], align 4, !tbaa [[TBAA139]], !noalias [[META141]]
// CHECK-NEXT:    [[INC_I_I]] = add nuw nsw i32 [[I_0_I_I]], 1
...
// CHECK-NEXT:    call void @llvm.lifetime.end.p0(i64 16, ptr nonnull [[TMP_I_I]]), !noalias [[META136]]
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr addrspace(4) dead_on_unwind noalias nocapture writable writeonly sret(%"class.sycl::_V1::vec.1483") align 16 [[AGG_RESULT:%.*]], ptr nocapture noundef readonly byval(%"class.sycl::_V1::vec.1483") align 16 [[A:%.*]]) local_unnamed_addr #[[ATTR0]] !srcloc [[META145:![0-9]+]] !sycl_fixed_targets [[META7]] {
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    [[TMP0:%.*]] = load <4 x i32>, ptr [[A]], align 4, !tbaa [[TBAA15]], !noalias [[META152:![0-9]+]]
// CHECK-NEXT:    [[SUB_I_I_I:%.*]] = sub <4 x i32> zeroinitializer, [[TMP0]]
// CHECK-NEXT:    store <4 x i32> [[SUB_I_I_I]], ptr addrspace(4) [[AGG_RESULT]], align 16, !tbaa [[TBAA15]], !alias.scope [[META152]]
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr addrspace(4) dead_on_unwind noalias nocapture writable writeonly sret(%"class.sycl::_V1::vec.1574") align 16 [[AGG_RESULT:%.*]], ptr nocapture noundef readonly byval(%"class.sycl::_V1::vec.1574") align 16 [[A:%.*]]) local_unnamed_addr #[[ATTR0]] !srcloc [[META153:![0-9]+]] !sycl_fixed_targets [[META7]] {
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    [[TMP0:%.*]] = load <16 x i8>, ptr [[A]], align 1, !tbaa [[TBAA15]], !noalias [[META160:![0-9]+]]
// CHECK-NEXT:    [[NOT_I_I_I:%.*]] = xor <16 x i8> [[TMP0]], <i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1>
// CHECK-NEXT:    store <16 x i8> [[NOT_I_I_I]], ptr addrspace(4) [[AGG_RESULT]], align 16, !tbaa [[TBAA15]], !alias.scope [[META160]]
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr addrspace(4) dead_on_unwind noalias nocapture writable writeonly sret(%"class.sycl::_V1::vec.1667") align 4 [[AGG_RESULT:%.*]], ptr nocapture noundef readonly byval(%"class.sycl::_V1::vec.363") align 4 [[A:%.*]]) local_unnamed_addr #[[ATTR1]] !srcloc [[META161:![0-9]+]] !sycl_fixed_targets [[META7]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP_I_I:%.*]] = alloca %"class.sycl::_V1::vec.1667", align 4
...
// CHECK-NEXT:    call void @llvm.lifetime.start.p0(i64 4, ptr nonnull [[TMP_I_I]]), !noalias [[META162]]
// CHECK-NEXT:    br label [[FOR_COND_I_I:%.*]]
// CHECK:       for.cond.i.i:
// CHECK-NEXT:    [[I_0_I_I:%.*]] = phi i32 [ 0, [[ENTRY:%.*]] ], [ [[INC_I_I:%.*]], [[FOR_BODY_I_I:%.*]] ]
// CHECK-NEXT:    [[CMP_I_I:%.*]] = icmp ult i32 [[I_0_I_I]], 4
...
// CHECK-NEXT:    [[TMP0:%.*]] = load i8, ptr [[ARRAYIDX_I_I_I_I_I]], align 1, !tbaa [[TBAA50]], !range [[RNG52]], !noalias [[META168:![0-9]+]], !noundef [[META7]]
...
// CHECK-NEXT:    store i8 [[DOTNEG_I_I]], ptr [[ARRAYIDX_I_I_I10_I_I]], align 1, !tbaa [[TBAA15]], !noalias [[META168]]
// CHECK-NEXT:    [[INC_I_I]] = add nuw nsw i32 [[I_0_I_I]], 1
// CHECK-NEXT:    br label [[FOR_COND_I_I]], !llvm.loop [[LOOP169:![0-9]+]]
// CHECK:       _ZN4sycl3_V16detailntERKNS0_3vecIbLi4EEE.exit:
// CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[TMP_I_I]], align 4, !noalias [[META168]]
// CHECK-NEXT:    store i32 [[TMP1]], ptr addrspace(4) [[AGG_RESULT]], align 4, !alias.scope [[META168]]
// CHECK-NEXT:    call void @llvm.lifetime.end.p0(i64 4, ptr nonnull [[TMP_I_I]]), !noalias [[META162]]
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr addrspace(4) dead_on_unwind noalias nocapture writable writeonly sret(%"class.sycl::_V1::vec.1759") align 4 [[AGG_RESULT:%.*]], ptr nocapture noundef readonly byval(%"class.sycl::_V1::vec.1851") align 4 [[A:%.*]]) local_unnamed_addr #[[ATTR1]] !srcloc [[META170:![0-9]+]] !sycl_used_aspects [[META56]] !sycl_fixed_targets [[META7]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP_I_I:%.*]] = alloca %"class.sycl::_V1::vec.1759", align 4
...
// CHECK-NEXT:    [[TMP0:%.*]] = load half, ptr [[ARRAYIDX_I_I_I_I_I]], align 2, !tbaa [[TBAA177:![0-9]+]], !noalias [[META180:![0-9]+]]
...
// CHECK-NEXT:    store i16 [[CONV4_I_I]], ptr [[ARRAYIDX_I_I_I10_I_I]], align 2, !tbaa [[TBAA76]], !noalias [[META180]]
// CHECK-NEXT:    [[INC_I_I]] = add nuw nsw i32 [[I_0_I_I]], 1
// CHECK-NEXT:    br label [[FOR_COND_I_I]], !llvm.loop [[LOOP181:![0-9]+]]
// CHECK:       _ZN4sycl3_V16detailntERKNS0_3vecINS1_9half_impl4halfELi2EEE.exit:
// CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[TMP_I_I]], align 4, !noalias [[META180]]
// CHECK-NEXT:    store i32 [[TMP1]], ptr addrspace(4) [[AGG_RESULT]], align 4, !alias.scope [[META180]]
...
// CHECK-SAME: ptr addrspace(4) dead_on_unwind noalias nocapture writable writeonly sret(%"class.sycl::_V1::vec.1110") align 16 [[AGG_RESULT:%.*]], ptr nocapture noundef readonly byval(%"class.sycl::_V1::vec.1110") align 16 [[A:%.*]]) local_unnamed_addr #[[ATTR0]] !srcloc [[META182:![0-9]+]] !sycl_used_aspects [[META56]] !sycl_fixed_targets [[META7]] {
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    [[TMP0:%.*]] = load <8 x half>, ptr [[A]], align 2, !tbaa [[TBAA15]], !noalias [[META189:![0-9]+]]
// CHECK-NEXT:    [[FNEG_I_I_I:%.*]] = fneg <8 x half> [[TMP0]]
// CHECK-NEXT:    store <8 x half> [[FNEG_I_I_I]], ptr addrspace(4) [[AGG_RESULT]], align 16, !tbaa [[TBAA15]], !alias.scope [[META189]]
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr addrspace(4) dead_on_unwind noalias nocapture writable writeonly sret(%"class.sycl::_V1::vec.1943") align 8 [[AGG_RESULT:%.*]], ptr noundef byval(%"class.sycl::_V1::vec.550") align 8 [[A:%.*]]) local_unnamed_addr #[[ATTR2]] !srcloc [[META190:![0-9]+]] !sycl_fixed_targets [[META7]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP_I_I:%.*]] = alloca %"class.sycl::_V1::vec.1943", align 8
...
// CHECK-NEXT:    call void @llvm.lifetime.start.p0(i64 8, ptr nonnull [[TMP_I_I]]), !noalias [[META191]]
// CHECK-NEXT:    br label [[FOR_COND_I_I:%.*]]
// CHECK:       for.cond.i.i:
// CHECK-NEXT:    [[I_0_I_I:%.*]] = phi i32 [ 0, [[ENTRY:%.*]] ], [ [[INC_I_I:%.*]], [[FOR_BODY_I_I:%.*]] ]
// CHECK-NEXT:    [[CMP_I_I:%.*]] = icmp ult i32 [[I_0_I_I]], 3
...
// CHECK-NEXT:    [[CALL_I_I_I_I_I:%.*]] = call spir_func noundef float @__devicelib_ConvertBF16ToFINTEL(ptr addrspace(4) noundef align 2 dereferenceable(2) [[ARRAYIDX_I_I_I_I_I]]) #[[ATTR9]], !noalias [[META197:![0-9]+]]
...
// CHECK-NEXT:    store i16 [[CONV4_I_I]], ptr [[ARRAYIDX_I_I_I10_I_I]], align 2, !tbaa [[TBAA76]], !noalias [[META197]]
// CHECK-NEXT:    [[INC_I_I]] = add nuw nsw i32 [[I_0_I_I]], 1
// CHECK-NEXT:    br label [[FOR_COND_I_I]], !llvm.loop [[LOOP198:![0-9]+]]
// CHECK:       _ZN4sycl3_V16detailntERKNS0_3vecINS0_3ext6oneapi8bfloat16ELi3EEE.exit:
// CHECK-NEXT:    [[TMP0:%.*]] = load i64, ptr [[TMP_I_I]], align 8, !noalias [[META197]]
// CHECK-NEXT:    store i64 [[TMP0]], ptr addrspace(4) [[AGG_RESULT]], align 8, !alias.scope [[META197]]
// CHECK-NEXT:    call void @llvm.lifetime.end.p0(i64 8, ptr nonnull [[TMP_I_I]]), !noalias [[META191]]
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr addrspace(4) dead_on_unwind noalias nocapture writable writeonly sret(%"class.sycl::_V1::vec.2034") align 32 [[AGG_RESULT:%.*]], ptr nocapture noundef readonly byval(%"class.sycl::_V1::vec.2034") align 32 [[A:%.*]]) local_unnamed_addr #[[ATTR0]] !srcloc [[META199:![0-9]+]] !sycl_fixed_targets [[META7]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    tail call void @llvm.experimental.noalias.scope.decl(metadata [[META200:![0-9]+]])
// CHECK-NEXT:    tail call void @llvm.experimental.noalias.scope.decl(metadata [[META203:![0-9]+]])
// CHECK-NEXT:    [[TMP0:%.*]] = load <16 x i16>, ptr [[A]], align 2, !tbaa [[TBAA15]], !noalias [[META206:![0-9]+]]
// CHECK-NEXT:    [[SUB_I_I_I:%.*]] = sub <16 x i16> zeroinitializer, [[TMP0]]
// CHECK-NEXT:    store <16 x i16> [[SUB_I_I_I]], ptr addrspace(4) [[AGG_RESULT]], align 32, !tbaa [[TBAA15]], !alias.scope [[META206]]
// CHECK-NEXT:    ret void
//
