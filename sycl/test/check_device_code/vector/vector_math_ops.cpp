...
// CHECK-NEXT:    ret void
//
SYCL_EXTERNAL auto TestGreaterThan(VecINT2Type a, VecINT2Type b) {
  return a > b;
}
...
// CHECK-NEXT:    ret void
//
SYCL_EXTERNAL auto TestGreaterThan(VecBYTE2Type a, VecBYTE2Type b) {
  return a > b;
}
...
// CHECK-NEXT:    ret void
//
SYCL_EXTERNAL auto TestGreaterThan(VecBOOL2Type a, VecBOOL2Type b) {
  return a > b;
}
...
// CHECK-NEXT:    ret void
//
SYCL_EXTERNAL auto TestGreaterThan(VecHALF2Type a, VecHALF2Type b) {
  return a > b;
}
...
// CHECK-NEXT:    ret void
//
SYCL_EXTERNAL auto TestGreaterThan(VecBF162Type a, VecBF162Type b) {
  return a > b;
}
