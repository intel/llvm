...
// CHECK-SAME: ptr dead_on_unwind noalias writable writeonly sret(%"class.sycl::_V1::vec.108") align 4 captures(none) [[AGG_RESULT:%.*]], ptr addrspace(4) noundef readonly align 2 captures(none) dereferenceable(2) [[INP:%.*]]) local_unnamed_addr #[[ATTR0]] {{.*}}{
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    store <4 x i16> [[EXTRACTVEC_I]], ptr [[AGG_RESULT]], align 8, !alias.scope [[META26]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    store <4 x i16> [[EXTRACTVEC_I]], ptr [[AGG_RESULT]], align 8, !alias.scope [[META29]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[EXTRACTVEC_I:%.*]] = shufflevector <3 x i16> [[RETVAL1_SROA_0_0_I_I_I]], <3 x i16> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 poison>
// CHECK-NEXT:    store <4 x i16> [[EXTRACTVEC_I]], ptr [[AGG_RESULT]], align 8, !alias.scope [[META33]]
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr dead_on_unwind noalias writable writeonly sret(%"class.sycl::_V1::vec.145") align 2 captures(none) [[AGG_RESULT:%.*]], ptr addrspace(4) noundef readonly align 8 captures(none) dereferenceable(8) [[INP:%.*]]) local_unnamed_addr #[[ATTR0]] {{.*}}{
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    store i16 [[CALL_I_I_I_I]], ptr [[AGG_RESULT]], align 2, !alias.scope [[META37]]
...
// CHECK-SAME: ptr dead_on_unwind noalias writable writeonly sret(%"class.sycl::_V1::vec.226") align 4 captures(none) [[AGG_RESULT:%.*]], ptr addrspace(4) noundef readonly align 4 captures(none) dereferenceable(4) [[INP:%.*]]) local_unnamed_addr #[[ATTR0]] {{.*}}{
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    store <2 x i16> [[RETVAL1_0_I_I_I]], ptr [[AGG_RESULT]], align 4, !alias.scope [[META42]]
// CHECK-NEXT:    ret void
//
