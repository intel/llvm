...
// Had to increase inline threashold for this test to force inline of the vec<> math builtins.
...
// CHECK-NEXT:    ret void
//
SYCL_EXTERNAL auto TestFMin(vec<bfloat16, 2> a, vec<bfloat16, 2> b) { return experimental::fmin(a, b); }
...
// CHECK-NEXT:    ret void
//
SYCL_EXTERNAL auto TestFMax(vec<bfloat16, 3> a, vec<bfloat16, 3> b) { return experimental::fmax(a, b); }
...
// CHECK-NEXT:    ret void
//
SYCL_EXTERNAL auto TestIsNan(vec<bfloat16, 4> a) { return experimental::isnan(a); }
...
// CHECK-NEXT:    ret void
//
SYCL_EXTERNAL auto TestFabs(vec<bfloat16, 8> a) { return experimental::fabs(a); }
...
// CHECK-NEXT:    ret void
//
SYCL_EXTERNAL auto TestCeil(vec<bfloat16, 8> a) { return experimental::ceil(a); }
...
// CHECK-NEXT:    ret void
//
SYCL_EXTERNAL auto TestFMA(vec<bfloat16, 16> a, vec<bfloat16, 16> b, vec<bfloat16, 16> c) { return experimental::fma(a, b, c); }
