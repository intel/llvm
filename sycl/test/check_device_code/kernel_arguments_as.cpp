...
// RUN: FileCheck %s --input-file %t.ll --check-prefixes=CHECK,CHECK-DEFAULT,CHECK-DEP
//
...
// RUN: FileCheck %s --input-file %t.ll --check-prefixes=CHECK,CHECK-DEFAULT,CHECK-SYCL2020
//
...
// CHECK-DEFAULT: %[[UNION]] = type { ptr addrspace(1) }
