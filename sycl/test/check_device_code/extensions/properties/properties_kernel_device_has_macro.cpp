...
static constexpr auto device_has_all = device_has<
    ...
    aspect::ext_intel_max_mem_bandwidth, aspect::usm_atomic_host_allocations,
    ...
    aspect::ext_intel_gpu_hw_threads_per_eu, aspect::usm_host_allocations,
    aspect::usm_shared_allocations, aspect::ext_intel_free_memory,
    aspect::ext_intel_device_id, aspect::ext_intel_memory_clock_rate,
