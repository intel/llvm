  ...
  q.submit([&](handler &cgh) {
    ...
    cgh.parallel_for<class row_row_m16n16k16>(
        ...
        [=](nd_item<2> item) [[sycl::reqd_work_group_size(1, 1, 32)]] {
          ...
          // CHECK: tail call { <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half> } @llvm.nvvm.wmma.m16n16k16.load.a.row.stride.f16.p0i32(i32* %10, i32 16
          ...
          joint_matrix_load(
              ...
              stride);
          // CHECK: tail call { <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half> } @llvm.nvvm.wmma.m16n16k16.load.b.row.stride.f16.p0i32(i32* %20, i32 16
          ...
          // CHECK: tail call void @llvm.nvvm.wmma.m16n16k16.store.d.row.stride.f32.p0f32(float* %39, float %31, float %32, float %33, float %34, float %35, float %36, float %37, float %38, i32 16
    ...
    cgh.parallel_for<class col_col_m16n16k16>(
        ...
        [=](nd_item<2> item) [[sycl::reqd_work_group_size(1, 1, 32)]] {
          ...
          // CHECK: tail call { <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half> } @llvm.nvvm.wmma.m16n16k16.load.a.col.stride.f16.p0i32(i32* %10, i32 16
          ...
          joint_matrix_load(
              sg, sub_a, accA.template get_multi_ptr<access::decorated::no>(),
              stride);
          // CHECK: tail call { <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half> } @llvm.nvvm.wmma.m16n16k16.load.b.col.stride.f16.p0i32(i32* %20, i32 16
          ...
          // CHECK-OPAQUE: tail call { float, float, float, float, float, float, float, float } @llvm.nvvm.wmma.m16n16k16.mma.col.col.f32.f32(<2 x half> %12, <2 x half> %13, <2 x half> %14, <2 x half> %15, <2 x half> %16, <2 x half> %17, <2 x half> %18, <2 x half> %19, <2 x half> %22, <2 x half> %23, <2 x half> %24, <2 x half> %25, <2 x half> %26, <2 x half> %27, <2 x half> %28, <2 x half> %29, float %2, float %3, float %4, float %5, float %6, float %7, float %8, float %9
          sub_c = joint_matrix_mad(sg, sub_a, sub_b, sub_c);
          // CHECK: tail call void @llvm.nvvm.wmma.m16n16k16.store.d.col.stride.f32.p0f32(float* %39, float %31, float %32, float %33, float %34, float %35, float %36, float %37, float %38, i32 16
    ...
    cgh.parallel_for<class row_row_m32n8k16>(
        ...
        [=](nd_item<2> item) [[sycl::reqd_work_group_size(1, 1, 32)]] {
          ...
          joint_matrix_load(
              sg, sub_c, accC.template get_multi_ptr<access::decorated::no>(),
              stride, layout::row_major);
          // CHECK: tail call { <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half> } @llvm.nvvm.wmma.m32n8k16.load.a.row.stride.f16.p0i32(i32* %10, i32 16
          ...
          joint_matrix_load(
              sg, sub_a, accA.template get_multi_ptr<access::decorated::no>(),
              stride);
          // CHECK: tail call { <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half> } @llvm.nvvm.wmma.m32n8k16.load.b.row.stride.f16.p0i32(i32* %20, i32 16
          ...
          // CHECK-OPAQUE: tail call { float, float, float, float, float, float, float, float } @llvm.nvvm.wmma.m32n8k16.mma.row.row.f32.f32(<2 x half> %12, <2 x half> %13, <2 x half> %14, <2 x half> %15, <2 x half> %16, <2 x half> %17, <2 x half> %18, <2 x half> %19, <2 x half> %22, <2 x half> %23, <2 x half> %24, <2 x half> %25, <2 x half> %26, <2 x half> %27, <2 x half> %28, <2 x half> %29, float %2, float %3, float %4, float %5, float %6, float %7, float %8, float %9
          sub_c = joint_matrix_mad(sg, sub_a, sub_b, sub_c);
          // CHECK: tail call void @llvm.nvvm.wmma.m32n8k16.store.d.row.stride.f32.p0f32(float* %39, float %31, float %32, float %33, float %34, float %35, float %36, float %37, float %38, i32 16
    ...
    cgh.parallel_for<class col_col_m32n8k16>(
        ...
        [=](nd_item<2> item) [[sycl::reqd_work_group_size(1, 1, 32)]] {
          ...
          joint_matrix_load(
              sg, sub_c, accC.template get_multi_ptr<access::decorated::no>(),
              stride, layout::col_major);
          // CHECK: tail call { <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half> } @llvm.nvvm.wmma.m32n8k16.load.a.col.stride.f16.p0i32(i32* %10, i32 16
          ...
          joint_matrix_load(
              sg, sub_a, accA.template get_multi_ptr<access::decorated::no>(),
              stride);
          // CHECK: tail call { <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half> } @llvm.nvvm.wmma.m32n8k16.load.b.col.stride.f16.p0i32(i32* %20, i32 16
          ...
          sub_c = joint_matrix_mad(sg, sub_a, sub_b, sub_c);
          // CHECK: tail call void @llvm.nvvm.wmma.m32n8k16.store.d.col.stride.f32.p0f32(float* %39, float %31, float %32, float %33, float %34, float %35, float %36, float %37, float %38, i32 16
    ...
    cgh.parallel_for<class row_row_m8n32k16>(
        ...
        [=](nd_item<2> item) [[sycl::reqd_work_group_size(1, 1, 32)]] {
          ...
          joint_matrix_load(
              sg, sub_c, accC.template get_multi_ptr<access::decorated::no>(),
              stride, layout::row_major);
          // CHECK: tail call { <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half> } @llvm.nvvm.wmma.m8n32k16.load.a.row.stride.f16.p0i32(i32* %10, i32 16
          ...
          joint_matrix_load(
              sg, sub_a, accA.template get_multi_ptr<access::decorated::no>(),
              stride);
          // CHECK: tail call { <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half> } @llvm.nvvm.wmma.m8n32k16.load.b.row.stride.f16.p0i32(i32* %20, i32 16
          ...
          // CHECK-OPAQUE: tail call { float, float, float, float, float, float, float, float } @llvm.nvvm.wmma.m8n32k16.mma.row.row.f32.f32(<2 x half> %12, <2 x half> %13, <2 x half> %14, <2 x half> %15, <2 x half> %16, <2 x half> %17, <2 x half> %18, <2 x half> %19, <2 x half> %22, <2 x half> %23, <2 x half> %24, <2 x half> %25, <2 x half> %26, <2 x half> %27, <2 x half> %28, <2 x half> %29, float %2, float %3, float %4, float %5, float %6, float %7, float %8, float %9
          sub_c = joint_matrix_mad(sg, sub_a, sub_b, sub_c);
          // CHECK: tail call void @llvm.nvvm.wmma.m8n32k16.store.d.row.stride.f32.p0f32(float* %39, float %31, float %32, float %33, float %34, float %35, float %36, float %37, float %38, i32 16
    ...
    cgh.parallel_for<class col_col_m8n32k16>(
        ...
        [=](nd_item<2> item) [[sycl::reqd_work_group_size(1, 1, 32)]] {
          ...
          joint_matrix_load(
              sg, sub_c, accC.template get_multi_ptr<access::decorated::no>(),
              stride, layout::col_major);
          // CHECK: tail call { <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half> } @llvm.nvvm.wmma.m8n32k16.load.a.col.stride.f16.p0i32(i32* %10, i32 16
          ...
          joint_matrix_load(
              sg, sub_a, accA.template get_multi_ptr<access::decorated::no>(),
              stride);
          // CHECK: tail call { <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half>, <2 x half> } @llvm.nvvm.wmma.m8n32k16.load.b.col.stride.f16.p0i32(i32* %20, i32 16
          ...
          // CHECK-OPAQUE: tail call { float, float, float, float, float, float, float, float } @llvm.nvvm.wmma.m8n32k16.mma.col.col.f32.f32(<2 x half> %12, <2 x half> %13, <2 x half> %14, <2 x half> %15, <2 x half> %16, <2 x half> %17, <2 x half> %18, <2 x half> %19, <2 x half> %22, <2 x half> %23, <2 x half> %24, <2 x half> %25, <2 x half> %26, <2 x half> %27, <2 x half> %28, <2 x half> %29, float %2, float %3, float %4, float %5, float %6, float %7, float %8, float %9
          sub_c = joint_matrix_mad(sg, sub_a, sub_b, sub_c);
          // CHECK: tail call void @llvm.nvvm.wmma.m8n32k16.store.d.col.stride.f32.p0f32(float* %39, float %31, float %32, float %33, float %34, float %35, float %36, float %37, float %38, i32 16
