  ...
  q.submit([&](handler &cgh) {
    ...
    cgh.parallel_for<class row_row_m16n16k16>(
        ...
        [=](nd_item<2> item) [[sycl::reqd_work_group_size(1, 1, 32)]] {
          ...
          joint_matrix_load(sg, sub_c, accC.template get_multi_ptr<float>(),
          ...
          joint_matrix_load(sg, sub_a, accA.template get_multi_ptr<uint16_t>(),
                            stride);
          ...
          joint_matrix_load(sg, sub_b, accB.template get_multi_ptr<uint16_t>(),
                            stride);
          ...
          joint_matrix_store(sg, sub_c, accD.template get_multi_ptr<float>(),
                             stride, layout::row_major);
        });
