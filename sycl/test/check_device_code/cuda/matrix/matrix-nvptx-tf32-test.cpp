  ...
  q.submit([&](handler &cgh) {
    ...
    cgh.parallel_for<class row_row>(
        ...
        [=](nd_item<2> item) [[sycl::reqd_work_group_size(1, 1, 32)]] {
          ...
          //CHECK: tail call { i32, i32, i32, i32 } @llvm.nvvm.wmma.m16n16k8.load.a.row.stride.tf32.p0i32(i32* %{{.*}}, i32 8)
          //CHECK-OPAQUE: tail call { i32, i32, i32, i32 } @llvm.nvvm.wmma.m16n16k8.load.a.row.stride.tf32.p0(ptr %{{.*}}, i32 8)
          joint_matrix_load(sg, sub_a, accA.template get_multi_ptr<access::decorated::no>(), K);
          ...
          joint_matrix_load(sg, sub_b, accB.template get_multi_ptr<access::decorated::no>(), N);
          ...
          joint_matrix_load(sg, sub_c, accC.template get_multi_ptr<access::decorated::no>(), N,
                            layout::row_major);
          ...
          joint_matrix_store(sg, sub_c, accD.template get_multi_ptr<access::decorated::no>(), N,
                             layout::row_major);
        });
  });
  ...
  q.submit([&](handler &cgh) {
    ...
    cgh.parallel_for<class col_col>(
        ...
        [=](nd_item<2> item) [[sycl::reqd_work_group_size(1, 1, 32)]] {
          ...
          //CHECK: tail call { i32, i32, i32, i32 } @llvm.nvvm.wmma.m16n16k8.load.a.col.stride.tf32.p0i32(i32* %{{.*}}, i32 8)
