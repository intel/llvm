  ...
  q.submit([&](handler &cgh) {
    ...
    cgh.parallel_for<class row_row>(
        ...
        [=](nd_item<2> item) [[sycl::reqd_work_group_size(1, 1, 32)]] {
          ...
          joint_matrix_load(sg, sub_a, global_ptr<float>(accA), K);
          ...
          joint_matrix_load(sg, sub_b, global_ptr<float>(accB), N);
          ...
          joint_matrix_load(sg, sub_c, global_ptr<float>(accC), N,
                            layout::row_major);
          ...
          joint_matrix_store(sg, sub_c, global_ptr<float>(accD), N,
                             layout::row_major);
        });
  });
