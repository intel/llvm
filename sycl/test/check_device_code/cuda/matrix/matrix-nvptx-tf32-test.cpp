  ...
  q.submit([&](handler &cgh) {
    ...
    cgh.parallel_for<class row_row>(
        ...
        [=](nd_item<2> item) [[sycl::reqd_work_group_size(1, 1, 32)]] {
          ...
          joint_matrix_load(
              sg, sub_a,
              accA.template get_multi_ptr<sycl::access::decorated::no>(), K);
          ...
          joint_matrix_load(
              sg, sub_b,
              accB.template get_multi_ptr<sycl::access::decorated::no>(), N);
          ...
          joint_matrix_load(
              sg, sub_c,
              accC.template get_multi_ptr<sycl::access::decorated::no>(), N,
              layout::row_major);
          ...
          joint_matrix_store(
              sg, sub_c,
              accD.template get_multi_ptr<sycl::access::decorated::no>(), N,
              layout::row_major);
        });
  });
