  ...
  q.submit([&](handler &cgh) {
    ...
    cgh.parallel_for<class row_row>(
        ...
        [=](nd_item<2> item) [[sycl::reqd_work_group_size(1, 1, 32)]] {
          ...
          joint_matrix<precision::tf32, use::a, M, K,
                       layout::row_major>
              sub_a;

          joint_matrix<precision::tf32, use::b, K, N,
                       layout::row_major>
              sub_b;

          joint_matrix<float, use::accumulator, M, N>
              sub_c;
  ...
  q.submit([&](handler &cgh) {
    ...
    cgh.parallel_for<class col_col>(
        ...
        [=](nd_item<2> item) [[sycl::reqd_work_group_size(1, 1, 32)]] {
          ...
          joint_matrix_load(sg, sub_c, accC.get_pointer(), N, layout::col_major);
          ...
          joint_matrix_store(sg, sub_c, accD.get_pointer(), N, layout::col_major);
        });
  });
