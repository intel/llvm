  ...
  q.submit([&](handler &cgh) {
    ...
    cgh.parallel_for<class col_col_m16n16k16>(
        nd_range<2>({1, 32}, {1, 32}), [=
          ...
          joint_matrix_load(sg, sub_b, accB.get_pointer(), stride);
          // CHECK: tail call { i32, i32, i32, i32, i32, i32, i32, i32 }
          // @llvm.nvvm.wmma.m16n16k16.mma.col.col.u8(i32 %19, i32 %20, i32 %23,
          // i32 %24, i32 %9, i32 %10, i32 %11, i32 %12, i32 %13, i32 %14, i32
          // %15, i32 %16) #{{.*}}
          sub_c = joint_matrix_mad(sg, sub_a, sub_b, sub_c);
          // CHECK: tail call void
    ...
    cgh.parallel_for<class row_row_m32n8k16>(
        nd_range<2>({1, 32}, {1, 32}), [=
          ...
          joint_matrix_load(sg, sub_b, accB.get_pointer(), stride);
          // CHECK: tail call { i32, i32, i32, i32, i32, i32, i32, i32 }
          // @llvm.nvvm.wmma.m32n8k16.mma.row.row.u8(i32 %19, i32 %20, i32 %21,
    ...
    cgh.parallel_for<class col_col_m32n8k16>(
        nd_range<2>({1, 32}, {1, 32}), [=
          ...
          joint_matrix_load(sg, sub_b, accB.get_pointer(), stride);
          // CHECK: tail call { i32, i32, i32, i32, i32, i32, i32, i32 }
          // @llvm.nvvm.wmma.m32n8k16.mma.col.col.u8(i32 %19, i32 %20, i32 %21,
          // i32 %22, i32 %24, i32 %9, i32 %10, i32 %11, i32 %12, i32 %13, i32
          // %14, i32 %15, i32 %16) #{{.*}}
          sub_c = joint_matrix_mad(sg, sub_a, sub_b, sub_c);
          // CHECK: tail call void
    ...
    cgh.parallel_for<class row_row_m8n32k16>(
        nd_range<2>({1, 32}, {1, 32}), [=
          ...
          joint_matrix_load(sg, sub_b, accB.get_pointer(), stride);
          // CHECK: tail call { i32, i32, i32, i32, i32, i32, i32, i32 }
          // @llvm.nvvm.wmma.m8n32k16.mma.row.row.u8(i32 %18, i32 %21, i32 %22,
    ...
    cgh.parallel_for<class col_col_m8n32k16>(
        nd_range<2>({1, 32}, {1, 32}), [=
          ...
          joint_matrix_load(sg, sub_b, accB.get_pointer(), stride);
          // CHECK: tail call { i32, i32, i32, i32, i32, i32, i32, i32 }
          // @llvm.nvvm.wmma.m8n32k16.mma.col.col.u8(i32 %18, i32 %21, i32 %22,
          // i32 %23, i32 %24, i32 %9, i32 %10, i32 %11, i32 %12, i32 %13, i32
          // %14, i32 %15, i32 %16) #{{.*}}
          sub_c = joint_matrix_mad(sg, sub_a, sub_b, sub_c);
          // CHECK: tail call void
