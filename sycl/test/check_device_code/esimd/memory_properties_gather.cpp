...
test_gather(AccType &acc, LocalAccType &local_acc, float *ptrf,
  ...
  // 1) gather(usm, offsets): offsets is simd or simd_view
  // CHECK-COUNT-10: call <32 x float> @llvm.masked.gather.v32f32.v32p4(<32 x ptr addrspace(4)> align 4 {{[^)]+}}, <32 x i1> {{[^)]+}}, <32 x float> {{[^)]+}})
  ...
  // CHECK-COUNT-10: call <32 x float> @llvm.masked.gather.v32f32.v32p4(<32 x ptr addrspace(4)> align 8 {{[^)]+}}, <32 x i1> {{[^)]+}}, <32 x float> {{[^)]+}})
  ...
  // 3) gather(usm, offsets, mask, pass_thru)
  // CHECK-COUNT-26: call <32 x float> @llvm.masked.gather.v32f32.v32p4(<32 x ptr addrspace(4)> align 4 {{[^)]+}}, <32 x i1> {{[^)]+}}, <32 x float> {{[^)]+}})
  ...
  // CHECK-COUNT-26: call <32 x float> @llvm.masked.gather.v32f32.v32p4(<32 x ptr addrspace(4)> align 8 {{[^)]+}}, <32 x i1> {{[^)]+}}, <32 x float> {{[^)]+}})
  ...
  // CHECK-STATELESS-COUNT-40: call <32 x float> @llvm.masked.gather.v32f32.v32p4(<32 x ptr addrspace(4)> align 4 {{[^)]+}}, <32 x i1> {{[^)]+}}, <32 x float> {{[^)]+}})
  ...
  // 9) gather(lacc, offsets): offsets is simd or simd_view
  // CHECK-COUNT-38: call <32 x float> @llvm.masked.gather.v32f32.v32p3(<32 x ptr addrspace(3)> align 4 {{[^)]+}}, <32 x i1> {{[^)]+}}, <32 x float> {{[^)]+}})
...
SYCL_ESIMD_FUNCTION SYCL_EXTERNAL void test_slm_gather(int byte_offset32) {
  ...
  // 1) slm_gather(offsets): offsets is simd or simd_view
  // CHECK-COUNT-3: call <32 x float> @llvm.masked.gather.v32f32.v32p3(<32 x ptr addrspace(3)> align 4 {{[^)]+}}, <32 x i1> {{[^)]+}}, <32 x float> {{[^)]+}})
  ...
  // CHECK-COUNT-3: call <32 x float> @llvm.masked.gather.v32f32.v32p3(<32 x ptr addrspace(3)> align 8 {{[^)]+}}, <32 x i1> {{[^)]+}}, <32 x float> {{[^)]+}})
  ...
  // 3) slm_gather(offsets, mask, pass_thru)
  // CHECK-COUNT-13: call <32 x float> @llvm.masked.gather.v32f32.v32p3(<32 x ptr addrspace(3)> align 4 {{[^)]+}}, <32 x i1> {{[^)]+}}, <32 x float> {{[^)]+}})
  ...
  // CHECK-COUNT-13: call <32 x float> @llvm.masked.gather.v32f32.v32p3(<32 x ptr addrspace(3)> align 8 {{[^)]+}}, <32 x i1> {{[^)]+}}, <32 x float> {{[^)]+}})
