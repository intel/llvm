...
// optimizations.
// RUN: sycl-post-link -properties -split=none -split-esimd -lower-esimd -lower-esimd-force-stateless-mem=false -O0 -force-disable-esimd-opt -S %t -o %t.table
...
// -O0 lowering, requires `-force-disable-esimd-opt` to disable all
// optimizations.
// RUN: sycl-post-link -properties -split=none -split-esimd -lower-esimd -lower-esimd-force-stateless-mem=true -O0 -force-disable-esimd-opt -S %t -o %t.table
