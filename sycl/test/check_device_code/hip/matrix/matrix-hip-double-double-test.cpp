...
SYCL_EXTERNAL [[sycl::reqd_work_group_size(1, 1, 64)]] void row_row_m16n16k4(
    sycl::accessor<double, 1, sycl::access::mode::read_write, sycl::target::device> accA,
    sycl::accessor<double, 1, sycl::access::mode::read_write, sycl::target::device> accB,
    sycl::accessor<double, 1, sycl::access::mode::read_write, sycl::target::device> accC,
    sycl::accessor<double, 1, sycl::access::mode::read_write, sycl::target::device> accD,
    nd_item<2> item) {
