...
SYCL_EXTERNAL [[sycl::reqd_work_group_size(1, 1, 64)]] void row_row_m16n16k16(
    sycl::accessor<bfloat16, 1, sycl::access::mode::read_write, sycl::target::device> accA,
    sycl::accessor<bfloat16, 1, sycl::access::mode::read_write, sycl::target::device> accB,
