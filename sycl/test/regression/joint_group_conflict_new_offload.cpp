// RUN: %clangxx -fsycl -fsycl-targets=%sycl_triple --offload-new-driver -fPIC -DCASE1 %s -c -o %t.1.o
// RUN: %clangxx -fsycl -fsycl-targets=%sycl_triple --offload-new-driver -fPIC -DCASE2 %s -c -o %t.2.o
// RUN: %clangxx -fsycl -fsycl-targets=%sycl_triple --offload-new-driver -shared %t.1.o %t.2.o -o %t.so
//
