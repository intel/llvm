...
// REQUIRES: linux
// RUN: bash %S/deps_known.sh sycl/khr/split_headers/multi_ptr.hpp | FileCheck %s

// CHECK-LABEL: Dependencies for <sycl/khr/split_headers/multi_ptr.hpp>:
// CHECK-NEXT: /dev/null: /dev/null
// CHECK-NEXT: khr/split_headers/multi_ptr.hpp
