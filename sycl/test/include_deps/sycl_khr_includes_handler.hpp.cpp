...
// REQUIRES: linux
// RUN: bash %S/deps_known.sh sycl/khr/includes/handler.hpp | FileCheck %s

// CHECK-LABEL: Dependencies for <sycl/khr/includes/handler.hpp>:
// CHECK-NEXT: /dev/null: /dev/null
// CHECK-NEXT: khr/includes/handler.hpp
