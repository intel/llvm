...
// REQUIRES: linux
// RUN: bash %S/deps_known.sh sycl/khr/includes/platform | FileCheck %s

// CHECK-LABEL: Dependencies for <sycl/khr/includes/platform>:
// CHECK-NEXT: /dev/null: /dev/null
// CHECK-NEXT: khr/includes/platform
