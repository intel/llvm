...
// REQUIRES: linux
// RUN: bash %S/deps_known.sh sycl/khr/includes/context.hpp | FileCheck %s

// CHECK-LABEL: Dependencies for <sycl/khr/includes/context.hpp>:
// CHECK-NEXT: /dev/null: /dev/null
// CHECK-NEXT: khr/includes/context.hpp
