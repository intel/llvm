...
// REQUIRES: linux
// RUN: bash %S/deps_known.sh sycl/khr/split_headers/index_space.hpp | FileCheck %s

// CHECK-LABEL: Dependencies for <sycl/khr/split_headers/index_space.hpp>:
// CHECK-NEXT: /dev/null: /dev/null
// CHECK-NEXT: khr/split_headers/index_space.hpp
