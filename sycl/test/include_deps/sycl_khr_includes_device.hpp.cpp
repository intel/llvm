...
// REQUIRES: linux
// RUN: bash %S/deps_known.sh sycl/khr/includes/device.hpp | FileCheck %s

// CHECK-LABEL: Dependencies for <sycl/khr/includes/device.hpp>:
// CHECK-NEXT: /dev/null: /dev/null
// CHECK-NEXT: khr/includes/device.hpp
