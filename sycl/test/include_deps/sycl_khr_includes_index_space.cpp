...
// REQUIRES: linux
// RUN: bash %S/deps_known.sh sycl/khr/includes/index_space | FileCheck %s

// CHECK-LABEL: Dependencies for <sycl/khr/includes/index_space>:
// CHECK-NEXT: /dev/null: /dev/null
// CHECK-NEXT: khr/includes/index_space
// CHECK-NEXT: id.hpp
