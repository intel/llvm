...
// REQUIRES: linux
// RUN: bash %S/deps_known.sh sycl/khr/includes/image.hpp | FileCheck %s

// CHECK-LABEL: Dependencies for <sycl/khr/includes/image.hpp>:
// CHECK-NEXT: /dev/null: /dev/null
// CHECK-NEXT: khr/includes/image.hpp
