...
// REQUIRES: linux
// RUN: bash %S/deps_known.sh sycl/khr/includes/builtins_relational.hpp | FileCheck %s

// CHECK-LABEL: Dependencies for <sycl/khr/includes/builtins_relational.hpp>:
// CHECK-NEXT: /dev/null: /dev/null
// CHECK-NEXT: khr/includes/builtins_relational.hpp
// CHECK-NEXT: khr/includes/version.hpp
// CHECK-NEXT: detail/defines_elementary.hpp
// CHECK-NEXT: feature_test.hpp
// CHECK-NEXT: builtins_relational.hpp
