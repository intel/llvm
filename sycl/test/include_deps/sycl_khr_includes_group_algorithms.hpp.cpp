...
// REQUIRES: linux
// RUN: bash %S/deps_known.sh sycl/khr/includes/group_algorithms.hpp | FileCheck %s

// CHECK-LABEL: Dependencies for <sycl/khr/includes/group_algorithms.hpp>:
// CHECK-NEXT: /dev/null: /dev/null
// CHECK-NEXT: khr/includes/group_algorithms.hpp
