...
// REQUIRES: linux
// RUN: bash %S/deps_known.sh sycl/khr/includes/event.hpp | FileCheck %s

// CHECK-LABEL: Dependencies for <sycl/khr/includes/event.hpp>:
// CHECK-NEXT: /dev/null: /dev/null
// CHECK-NEXT: khr/includes/event.hpp
