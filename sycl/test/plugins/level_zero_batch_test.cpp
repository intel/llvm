...
// RUN: env SYCL_PI_LEVEL_ZERO_DISABLE_DYNAMIC_BATCH=1 SYCL_PI_TRACE=2 ZE_DEBUG=1 %GPU_RUN_PLACEHOLDER %t.out 2>&1 | FileCheck --check-prefixes=CKALL,CKB4 %s

// Set batching to 4 explicitly
// RUN: env SYCL_PI_LEVEL_ZERO_DISABLE_DYNAMIC_BATCH=1 SYCL_PI_LEVEL_ZERO_BATCH_SIZE=4 SYCL_PI_TRACE=2 ZE_DEBUG=1 %GPU_RUN_PLACEHOLDER %t.out 2>&1 | FileCheck --check-prefixes=CKALL,CKB4 %s

// Set batching to 1 explicitly
// RUN: env SYCL_PI_LEVEL_ZERO_DISABLE_DYNAMIC_BATCH=1 SYCL_PI_LEVEL_ZERO_BATCH_SIZE=1 SYCL_PI_TRACE=2 ZE_DEBUG=1 %GPU_RUN_PLACEHOLDER %t.out 2>&1 | FileCheck --check-prefixes=CKALL,CKB1 %s

// Set batching to 3 explicitly
// RUN: env SYCL_PI_LEVEL_ZERO_DISABLE_DYNAMIC_BATCH=1 SYCL_PI_LEVEL_ZERO_BATCH_SIZE=3 SYCL_PI_TRACE=2 ZE_DEBUG=1 %GPU_RUN_PLACEHOLDER %t.out 2>&1 | FileCheck --check-prefixes=CKALL,CKB3 %s

// Set batching to 5 explicitly
// RUN: env SYCL_PI_LEVEL_ZERO_DISABLE_DYNAMIC_BATCH=1 SYCL_PI_LEVEL_ZERO_BATCH_SIZE=5 SYCL_PI_TRACE=2 ZE_DEBUG=1 %GPU_RUN_PLACEHOLDER %t.out 2>&1 | FileCheck --check-prefixes=CKALL,CKB5 %s

// Set batching to 7 explicitly
// RUN: env SYCL_PI_LEVEL_ZERO_DISABLE_DYNAMIC_BATCH=1 SYCL_PI_LEVEL_ZERO_BATCH_SIZE=7 SYCL_PI_TRACE=2 ZE_DEBUG=1 %GPU_RUN_PLACEHOLDER %t.out 2>&1 | FileCheck --check-prefixes=CKALL,CKB7 %s

// Set batching to 8 explicitly
// RUN: env SYCL_PI_LEVEL_ZERO_DISABLE_DYNAMIC_BATCH=1 SYCL_PI_LEVEL_ZERO_BATCH_SIZE=8 SYCL_PI_TRACE=2 ZE_DEBUG=1 %GPU_RUN_PLACEHOLDER %t.out 2>&1 | FileCheck --check-prefixes=CKALL,CKB8 %s

// Set batching to 9 explicitly
// RUN: env SYCL_PI_LEVEL_ZERO_DISABLE_DYNAMIC_BATCH=1 SYCL_PI_LEVEL_ZERO_BATCH_SIZE=9 SYCL_PI_TRACE=2 ZE_DEBUG=1 %GPU_RUN_PLACEHOLDER %t.out 2>&1 | FileCheck --check-prefixes=CKALL,CKB9 %s
