...
#define HALF 0 // TODO not yet supported
#if HALF
  cl::sycl::ONEAPI::spec_constant<cl::sycl::half, MyHalfConst> f16 =
  ...
  cl::sycl::ONEAPI::spec_constant<double, MyDoubleConst> f64 =
