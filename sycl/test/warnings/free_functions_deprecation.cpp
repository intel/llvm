...
int main() {
  ...
  // expected-warning@+1 {{'this_nd_item<1>' is deprecated: use sycl::ext::oneapi::this_work_item::this_nd_item() instead}}
  ...
  // expected-warning@+1 {{'this_item<1>' is deprecated: use nd_range kernel and sycl::ext::oneapi::this_work_item::this_nd_item() instead}}
  (void)sycl_exp::this_item<1>();
  // expected-warning@+1 {{'this_id<1>' is deprecated: use nd_range kernel and sycl::ext::oneapi::this_work_item::this_nd_item() instead}}
