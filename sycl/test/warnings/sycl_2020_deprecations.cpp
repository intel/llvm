...
int main() {
  ...
  Queue.submit([&](sycl::handler &CGH) {
    ...
    CGH.single_task([=]() {
      ...
      // expected-warning@+2{{'legacy' is deprecated: Legacy 'multi_ptr' is deprecated since SYCL 2020}}
      sycl::multi_ptr<int, sycl::access::address_space::global_space,
                      sycl::access::decorated::legacy>
          LegacyGlobalMptr{GlobalAcc};
      // expected-warning@+2{{'legacy' is deprecated: Legacy 'multi_ptr' is deprecated since SYCL 2020}}
      sycl::multi_ptr<int, sycl::access::address_space::local_space,
                      sycl::access::decorated::legacy>
          LegacyLocalMptr{LocalAcc};
      // expected-warning@+2{{'legacy' is deprecated: Legacy 'multi_ptr' is deprecated since SYCL 2020}}
      sycl::multi_ptr<int, sycl::access::address_space::private_space,
                      sycl::access::decorated::legacy>
          LegacyPrivateMptr{&PrivateVal};
      ...
      // expected-warning@+3{{'legacy' is deprecated: Legacy 'multi_ptr' is deprecated since SYCL 2020}}
      LegacyGlobalMptr =
