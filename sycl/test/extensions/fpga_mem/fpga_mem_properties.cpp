...
static intel::fpga_mem<int, decltype(oneapi::properties(intel::num_banks<888>))> mem_num;
static intel::fpga_mem<int> mem_empty;
static intel::fpga_mem<int, decltype(oneapi::properties(intel::clock_2x_true))> mem_bool;
static intel::fpga_mem<int, decltype(oneapi::properties(intel::resource_mlab))> mem_enum;
static intel::fpga_mem<int, decltype(oneapi::properties(intel::ram_stitching_min_ram, intel::stride_size<777>, intel::bi_directional_ports_true))> mem_multi;
...
template <typename T> void checkIsPropertyOf() {
  ...
  static_assert(oneapi::is_property_key_of<intel::bi_directional_ports_key, T>::value);
  ...
  static_assert(oneapi::is_property_key_of<intel::max_private_copies_key, T>::value);
  static_assert(oneapi::is_property_key_of<intel::num_replicates_key, T>::value);
}
...
int main() {
  ...
  static_assert(oneapi::is_property_key<intel::bi_directional_ports_key>::value);
  ...
  static_assert(oneapi::is_property_value<decltype(intel::resource_mlab)>::value);
  static_assert(oneapi::is_property_value<decltype(intel::resource_block_ram)>::value);
  static_assert(oneapi::is_property_value<decltype(intel::num_banks<8>)>::value);
  static_assert(oneapi::is_property_value<decltype(intel::stride_size<8>)>::value);
  static_assert(oneapi::is_property_value<decltype(intel::word_size<32>)>::value);
  static_assert(oneapi::is_property_value<decltype(intel::bi_directional_ports_false)>::value);
  static_assert(oneapi::is_property_value<decltype(intel::bi_directional_ports_true)>::value);
  static_assert(oneapi::is_property_value<decltype(intel::clock_2x_false)>::value);
  static_assert(oneapi::is_property_value<decltype(intel::clock_2x_true)>::value);
  static_assert(oneapi::is_property_value<decltype(intel::ram_stitching_min_ram)>::value);
  static_assert(oneapi::is_property_value<decltype(intel::ram_stitching_max_fmax)>::value);
  static_assert(oneapi::is_property_value<decltype(intel::max_private_copies<8>)>::value);
  static_assert(oneapi::is_property_value<decltype(intel::num_replicates<8>)>::value);
  ...
  static_assert(mem_num.get_property<intel::num_banks_key>().value ==
                888);
  ...
  static_assert(mem_enum.get_property<intel::resource_key>().value == intel::resource_enum::mlab);
  ...
  static_assert(mem_multi.get_property<intel::ram_stitching_key>().value == intel::ram_stitching_enum::min_ram);
  static_assert(mem_multi.get_property<intel::stride_size_key>().value == 777);
  static_assert(mem_multi.get_property<intel::bi_directional_ports_key>().value == true);
