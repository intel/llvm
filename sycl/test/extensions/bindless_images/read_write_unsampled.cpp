...
bool run_test(sycl::range<NDims> dims, sycl::range<NDims> localSize,
  ...
  try {
    ...
    q.ext_oneapi_copy(input_0.data(), img_mem_0, desc);
    q.ext_oneapi_copy(input_1.data(), img_mem_1, desc);
    q.wait();

    {
      ...
      q.ext_oneapi_copy(img_mem_2, actual.data(), desc);
      q.wait();
    }

    // Cleanup
    sycl::ext::oneapi::experimental::destroy_image_handle(ctxt, img_input_0);
    sycl::ext::oneapi::experimental::destroy_image_handle(ctxt, img_input_1);
...
int main() {
  ...
  run_test<2, int32_t, 1, sycl::image_channel_type::signed_int32,
           sycl::image_channel_order::r, class int_2d>({2816, 32}, {32, 32},
                                                       seed);
  std::cout << "Running 3D int\n";
  run_test<3, int32_t, 1, sycl::image_channel_type::signed_int32,
           sycl::image_channel_order::r, class int_3d>({48, 128, 32},
                                                       {16, 16, 4}, seed);
  ...
  run_test<2, int32_t, 2, sycl::image_channel_type::signed_int32,
           sycl::image_channel_order::rg, class int2_2d>({2816, 32}, {32, 32},
                                                         seed);
  std::cout << "Running 3D int2\n";
  run_test<3, int32_t, 2, sycl::image_channel_type::signed_int32,
           sycl::image_channel_order::rg, class int2_3d>({48, 128, 32},
                                                         {16, 16, 4}, seed);
  ...
  run_test<2, int32_t, 4, sycl::image_channel_type::signed_int32,
           sycl::image_channel_order::rgba, class int4_2d>({2816, 32}, {32, 32},
                                                           seed);
  std::cout << "Running 3D int4\n";
  run_test<3, int32_t, 4, sycl::image_channel_type::signed_int32,
           sycl::image_channel_order::rgba, class int4_3d>({48, 128, 32},
                                                           {16, 16, 4}, seed);
  ...
  run_test<2, uint32_t, 1, sycl::image_channel_type::unsigned_int32,
           sycl::image_channel_order::r, class uint_2d>({2816, 32}, {32, 32},
                                                        seed);
  std::cout << "Running 3D unsigned int\n";
  run_test<3, uint32_t, 1, sycl::image_channel_type::unsigned_int32,
           sycl::image_channel_order::r, class uint_3d>({48, 128, 32},
                                                        {16, 16, 4}, seed);
  ...
  run_test<2, uint32_t, 2, sycl::image_channel_type::unsigned_int32,
           sycl::image_channel_order::rg, class uint2_2d>({2816, 32}, {32, 32},
                                                          seed);
  std::cout << "Running 3D unsigned int2\n";
  run_test<3, uint32_t, 2, sycl::image_channel_type::unsigned_int32,
           sycl::image_channel_order::rg, class uint2_3d>({48, 128, 32},
                                                          {16, 16, 4}, seed);
  std::cout << "Running 1D unsigned int4\n";
  run_test<1, unsigned int, 4, sycl::image_channel_type::unsigned_int32,
           sycl::image_channel_order::rgba, class uint4_1d>({32}, {2}, seed);
  std::cout << "Running 2D unsigned int4\n";
  run_test<2, uint32_t, 4, sycl::image_channel_type::unsigned_int32,
           sycl::image_channel_order::rgba, class uint4_2d>({2816, 32},
                                                            {32, 32}, seed);
  std::cout << "Running 3D unsigned int4\n";
  run_test<3, uint32_t, 4, sycl::image_channel_type::unsigned_int32,
           sycl::image_channel_order::rgba, class uint4_3d>({48, 128, 32},
                                                            {16, 16, 4}, seed);
  ...
  run_test<2, short, 1, sycl::image_channel_type::signed_int16,
           sycl::image_channel_order::r, class short_2d>({2816, 32}, {32, 32},
                                                         seed);
  std::cout << "Running 3D short\n";
  run_test<3, short, 1, sycl::image_channel_type::signed_int16,
           sycl::image_channel_order::r, class short_3d>({48, 128, 32},
                                                         {16, 16, 4}, seed);
  ...
  run_test<2, short, 2, sycl::image_channel_type::signed_int16,
           sycl::image_channel_order::rg, class short2_2d>({2816, 32}, {32, 32},
                                                           seed);
  std::cout << "Running 3D short2\n";
  run_test<3, short, 2, sycl::image_channel_type::signed_int16,
           sycl::image_channel_order::rg, class short2_3d>({48, 128, 32},
                                                           {16, 16, 4}, seed);
  std::cout << "Running 1D short4\n";
  run_test<1, short, 4, sycl::image_channel_type::signed_int16,
           sycl::image_channel_order::rgba, class short4_1d>({32}, {2}, seed);
  std::cout << "Running 2D short4\n";
  run_test<2, short, 4, sycl::image_channel_type::signed_int16,
           sycl::image_channel_order::rgba, class short4_2d>({2816, 32},
                                                             {32, 32}, seed);
  std::cout << "Running 3D short4\n";
  run_test<3, short, 4, sycl::image_channel_type::signed_int16,
           sycl::image_channel_order::rgba, class short4_3d>({48, 128, 32},
                                                             {16, 16, 4}, seed);
  ...
  run_test<2, signed char, 1, sycl::image_channel_type::signed_int8,
           sycl::image_channel_order::r, class char_2d>({2816, 32}, {32, 32},
                                                        seed);
  std::cout << "Running 3D char\n";
  run_test<3, signed char, 1, sycl::image_channel_type::signed_int8,
           sycl::image_channel_order::r, class char_3d>({48, 128, 32},
                                                        {16, 16, 4}, seed);
  ...
  run_test<2, signed char, 2, sycl::image_channel_type::signed_int8,
           sycl::image_channel_order::rg, class char2_2d>({2816, 32}, {32, 32},
                                                          seed);
  std::cout << "Running 3D char2\n";
  run_test<3, signed char, 2, sycl::image_channel_type::signed_int8,
           sycl::image_channel_order::rg, class char2_3d>({48, 128, 32},
                                                          {16, 16, 4}, seed);
  std::cout << "Running 1D char4\n";
  run_test<1, signed char, 4, sycl::image_channel_type::signed_int8,
           sycl::image_channel_order::rgba, class char4_1d>({32}, {2}, seed);
  std::cout << "Running 2D char4\n";
  run_test<2, signed char, 4, sycl::image_channel_type::signed_int8,
           sycl::image_channel_order::rgba, class char4_2d>({2816, 32},
                                                            {32, 32}, seed);
  std::cout << "Running 3D char4\n";
  run_test<3, signed char, 4, sycl::image_channel_type::signed_int8,
           sycl::image_channel_order::rgba, class char4_3d>({48, 128, 32},
                                                            {16, 16, 4}, seed);
  ...
  run_test<2, unsigned char, 1, sycl::image_channel_type::unsigned_int8,
           sycl::image_channel_order::r, class uchar_2d>({2816, 32}, {32, 32},
                                                         seed);
  ...
  run_test<2, unsigned char, 2, sycl::image_channel_type::unsigned_int8,
           sycl::image_channel_order::rg, class uchar2_2d>({2816, 32}, {32, 32},
                                                           seed);
  std::cout << "Running 3D unsigned char2\n";
  run_test<3, unsigned char, 2, sycl::image_channel_type::unsigned_int8,
           sycl::image_channel_order::rg, class uchar2_3d>({48, 128, 32},
                                                           {16, 16, 4}, seed);
  std::cout << "Running 1D unsigned char4\n";
  run_test<1, unsigned char, 4, sycl::image_channel_type::unsigned_int8,
           sycl::image_channel_order::rgba, class uchar4_1d>({32}, {2}, seed);
  std::cout << "Running 2D unsigned char4\n";
  run_test<2, unsigned char, 4, sycl::image_channel_type::unsigned_int8,
           sycl::image_channel_order::rgba, class uchar4_2d>({2816, 32},
                                                             {32, 32}, seed);
  std::cout << "Running 3D unsigned char4\n";
  run_test<3, unsigned char, 4, sycl::image_channel_type::unsigned_int8,
           sycl::image_channel_order::rgba, class uchar4_3d>({48, 128, 32},
                                                             {16, 16, 4}, seed);

  std::cout << "Running 1D float\n";
  run_test<1, float, 1, sycl::image_channel_type::fp32,
           sycl::image_channel_order::r, class float_1d>({1024}, {512}, seed);
  std::cout << "Running 2D float\n";
  run_test<2, float, 1, sycl::image_channel_type::fp32,
           sycl::image_channel_order::r, class float_2d>({4096, 3808}, {32, 32},
                                                         seed);
  std::cout << "Running 3D float\n";
  run_test<3, float, 1, sycl::image_channel_type::fp32,
           sycl::image_channel_order::r, class float_3d>({1024, 832, 32},
                                                         {16, 16, 4}, seed);
  std::cout << "Running 1D float2\n";
  run_test<1, float, 2, sycl::image_channel_type::fp32,
           sycl::image_channel_order::rg, class float2_1d>({608}, {32}, seed);
  std::cout << "Running 2D float2\n";
  run_test<2, float, 2, sycl::image_channel_type::fp32,
           sycl::image_channel_order::rg, class float2_2d>({3808, 4096},
                                                           {32, 32}, seed);
  std::cout << "Running 3D float2\n";
  run_test<3, float, 2, sycl::image_channel_type::fp32,
           sycl::image_channel_order::rg, class float2_3d>({832, 1024, 32},
                                                           {16, 16, 4}, seed);
  std::cout << "Running 1D float4\n";
  run_test<1, float, 4, sycl::image_channel_type::fp32,
           sycl::image_channel_order::rgba, class float4_1d>({1024}, {512},
                                                             seed);
  std::cout << "Running 2D float4\n";
  run_test<2, float, 4, sycl::image_channel_type::fp32,
           sycl::image_channel_order::rgba, class float4_2d>({4096, 4096},
                                                             {32, 32}, seed);
  std::cout << "Running 3D float4\n";
  run_test<3, float, 4, sycl::image_channel_type::fp32,
           sycl::image_channel_order::rgba, class float4_3d>({1024, 1024, 16},
                                                             {16, 16, 4}, seed);
  ...
  run_test<2, sycl::half, 1, sycl::image_channel_type::fp16,
           sycl::image_channel_order::r, class half_2d>({2816, 32}, {32, 32},
                                                        seed);
  std::cout << "Running 3D half\n";
  run_test<3, sycl::half, 1, sycl::image_channel_type::fp16,
           sycl::image_channel_order::r, class half_3d>({48, 128, 32},
                                                        {16, 16, 4}, seed);
  ...
  run_test<2, sycl::half, 2, sycl::image_channel_type::fp16,
           sycl::image_channel_order::rg, class half2_2d>({2816, 32}, {32, 32},
                                                          seed);
  std::cout << "Running 3D half2\n";
  run_test<3, sycl::half, 2, sycl::image_channel_type::fp16,
           sycl::image_channel_order::rg, class half2_3d>({48, 128, 32},
                                                          {16, 16, 4}, seed);
  std::cout << "Running 1D half4\n";
  run_test<1, sycl::half, 4, sycl::image_channel_type::fp16,
           sycl::image_channel_order::rgba, class half4_1d>({32}, {2}, seed);
  std::cout << "Running 2D half4\n";
  run_test<2, sycl::half, 4, sycl::image_channel_type::fp16,
           sycl::image_channel_order::rgba, class half4_2d>({2816, 32},
                                                            {32, 32}, seed);
  std::cout << "Running 3D half4\n";
  run_test<3, sycl::half, 4, sycl::image_channel_type::fp16,
           sycl::image_channel_order::rgba, class half4_3d>({48, 128, 32},
                                                            {16, 16, 4}, seed);
