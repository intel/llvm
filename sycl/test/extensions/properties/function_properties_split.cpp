...
int main() {
  ...
  static_assert(is_property_value<decltype(work_group_size_hint<4, 5, 6>)>::value);
  ...
  static_assert(is_property_value<decltype(max_linear_work_group_size<10>)>::value);
  ...
  static_assert(std::is_same_v<decltype(sub_group_size<7>)::key_t,
                               sub_group_size_key>);
