...
int main() {
  ...
  static_assert(std::is_same_v<
                decltype(intel::experimental::streaming_interface_accept_downstream_stall),
                decltype(intel::experimental::streaming_interface<intel::experimental::streaming_interface_options_enum::accept_downstream_stall>)>);
  static_assert(std::is_same_v<
                decltype(intel::experimental::streaming_interface_remove_downstream_stall),
                decltype(intel::experimental::streaming_interface<intel::experimental::streaming_interface_options_enum::remove_downstream_stall>)>);
  static_assert(std::is_same_v<
                decltype(intel::experimental::register_map_interface_wait_for_done_write),
                decltype(intel::experimental::register_map_interface<intel::experimental::register_map_interface_options_enum::wait_for_done_write>)>);
  static_assert(std::is_same_v<
                decltype(intel::experimental::register_map_interface_do_not_wait_for_done_write),
                decltype(intel::experimental::register_map_interface<intel::experimental::register_map_interface_options_enum::do_not_wait_for_done_write>)>);
  static_assert(std::is_same_v<
                decltype(intel::experimental::use_stall_enable_clusters),
                decltype(intel::experimental::fpga_cluster<intel::experimental::fpga_cluster_options_enum::stall_enable>)>);
  static_assert(std::is_same_v<
                decltype(intel::experimental::use_stall_free_clusters),
                decltype(intel::experimental::fpga_cluster<intel::experimental::fpga_cluster_options_enum::stall_free>)>);
  ...
  static_assert(
      PS::has_property<intel::experimental::pipelined_key>());
        static_assert(
      PS::has_property<intel::experimental::fpga_cluster_key>());
  static_assert(
      PS::get_property<intel::experimental::streaming_interface_key>() ==
      intel::experimental::streaming_interface<intel::experimental::streaming_interface_options_enum::remove_downstream_stall>);
  static_assert(
      PS::get_property<intel::experimental::pipelined_key>() ==
      intel::experimental::pipelined<1>);
  static_assert(
      PS::get_property<intel::experimental::fpga_cluster_key>() ==
      intel::experimental::fpga_cluster<intel::experimental::fpga_cluster_options_enum::stall_enable>);
  ...
  static_assert(
      PR::has_property<intel::experimental::pipelined_key>());
  static_assert(
      PR::has_property<intel::experimental::fpga_cluster_key>());
  static_assert(
      PR::get_property<intel::experimental::register_map_interface_key>() ==
      intel::experimental::register_map_interface<intel::experimental::register_map_interface_options_enum::wait_for_done_write>);
  static_assert(
      PR::get_property<intel::experimental::pipelined_key>() ==
      intel::experimental::pipelined<0>);
  static_assert(
      PR::get_property<intel::experimental::fpga_cluster_key>() ==
      intel::experimental::fpga_cluster<intel::experimental::fpga_cluster_options_enum::stall_free>);
}
