...
void check_work_group_size() {
  ...
  // expected-error-re@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size property must only contain non-zero values.}}
  // expected-error@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{constexpr variable 'work_group_size<0>' must be initialized by a constant expression}}
  ...
  // expected-error-re@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size property must only contain non-zero values.}}
  // expected-error@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{constexpr variable 'work_group_size<0, 0>' must be initialized by a constant expression}}
  ...
  // expected-error-re@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size property must only contain non-zero values.}}
  // expected-error@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{constexpr variable 'work_group_size<1, 0>' must be initialized by a constant expression}}
  ...
  // expected-error-re@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size property must only contain non-zero values.}}
  // expected-error@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{constexpr variable 'work_group_size<0, 1>' must be initialized by a constant expression}}
  ...
  // expected-error-re@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size property must only contain non-zero values.}}
  // expected-error@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{constexpr variable 'work_group_size<0, 0, 0>' must be initialized by a constant expression}}
  ...
  // expected-error-re@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size property must only contain non-zero values.}}
  // expected-error@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{constexpr variable 'work_group_size<1, 0, 0>' must be initialized by a constant expression}}
  ...
  // expected-error-re@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size property must only contain non-zero values.}}
  // expected-error@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{constexpr variable 'work_group_size<0, 1, 0>' must be initialized by a constant expression}}
  ...
  // expected-error-re@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size property must only contain non-zero values.}}
  // expected-error@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{constexpr variable 'work_group_size<0, 0, 1>' must be initialized by a constant expression}}
  ...
  // expected-error-re@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size property must only contain non-zero values.}}
  // expected-error@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{constexpr variable 'work_group_size<1, 1, 0>' must be initialized by a constant expression}}
  ...
  // expected-error-re@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size property must only contain non-zero values.}}
  // expected-error@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{constexpr variable 'work_group_size<0, 1, 1>' must be initialized by a constant expression}}
  ...
  // expected-error-re@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size property must only contain non-zero values.}}
  // expected-error@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{constexpr variable 'work_group_size<1, 0, 1>' must be initialized by a constant expression}}
  ...
  // expected-error-re@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size property currently only supports up to three values.}}
  // expected-error@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{constexpr variable 'work_group_size<1, 1, 1, 1>' must be initialized by a constant expression}}
...
void check_work_group_size_hint() {
  ...
  // expected-error-re@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size_hint property must only contain non-zero values.}}
  // expected-error@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{constexpr variable 'work_group_size_hint<0>' must be initialized by a constant expression}}
  ...
  // expected-error-re@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size_hint property must only contain non-zero values.}}
  // expected-error@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{constexpr variable 'work_group_size_hint<0, 0>' must be initialized by a constant expression}}
  ...
  // expected-error-re@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size_hint property must only contain non-zero values.}}
  // expected-error@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{constexpr variable 'work_group_size_hint<1, 0>' must be initialized by a constant expression}}
  ...
  // expected-error-re@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size_hint property must only contain non-zero values.}}
  // expected-error@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{constexpr variable 'work_group_size_hint<0, 1>' must be initialized by a constant expression}}
  ...
  // expected-error-re@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size_hint property must only contain non-zero values.}}
  // expected-error@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{constexpr variable 'work_group_size_hint<0, 0, 0>' must be initialized by a constant expression}}
  ...
  // expected-error-re@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size_hint property must only contain non-zero values.}}
  // expected-error@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{constexpr variable 'work_group_size_hint<1, 0, 0>' must be initialized by a constant expression}}
  ...
  // expected-error-re@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size_hint property must only contain non-zero values.}}
  // expected-error@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{constexpr variable 'work_group_size_hint<0, 1, 0>' must be initialized by a constant expression}}
  ...
  // expected-error-re@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size_hint property must only contain non-zero values.}}
  // expected-error@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{constexpr variable 'work_group_size_hint<0, 0, 1>' must be initialized by a constant expression}}
  ...
  // expected-error-re@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size_hint property must only contain non-zero values.}}
  // expected-error@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{constexpr variable 'work_group_size_hint<1, 1, 0>' must be initialized by a constant expression}}
  ...
  // expected-error-re@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size_hint property must only contain non-zero values.}}
  // expected-error@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{constexpr variable 'work_group_size_hint<0, 1, 1>' must be initialized by a constant expression}}
  ...
  // expected-error-re@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size_hint property must only contain non-zero values.}}
  // expected-error@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{constexpr variable 'work_group_size_hint<1, 0, 1>' must be initialized by a constant expression}}
  ...
  // expected-error-re@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size_hint property currently only supports up to three values.}}
  // expected-error@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{constexpr variable 'work_group_size_hint<1, 1, 1, 1>' must be initialized by a constant expression}}
...
void check_sub_group_size() {
  ...
  // expected-error-re@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{static assertion failed due to requirement {{.+}}: sub_group_size property must contain a non-zero value.}}
  // expected-error@sycl/ext/oneapi/kernel_properties/function_properties.hpp:* {{constexpr variable 'sub_group_size<0>' must be initialized by a constant expression}}
