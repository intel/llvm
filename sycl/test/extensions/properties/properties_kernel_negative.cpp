...
void check_work_group_size() {
  ...
  auto WGSize0 = sycl::ext::oneapi::experimental::work_group_size<>;
    ...
    // expected-error-re@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size property must only contain non-zero values.}}
    // expected-error@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{constexpr variable 'work_group_size<0>' must be initialized by a constant expression}}
  ...
  auto WGSize1 = sycl::ext::oneapi::experimental::work_group_size<0>;
    // expected-error-re@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size property must only contain non-zero values.}}
    // expected-error@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{constexpr variable 'work_group_size<0, 0>' must be initialized by a constant expression}}
  ...
  auto WGSize2 = sycl::ext::oneapi::experimental::work_group_size<0, 0>;
    // expected-error-re@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size property must only contain non-zero values.}}
    // expected-error@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{constexpr variable 'work_group_size<1, 0>' must be initialized by a constant expression}}
  ...
  auto WGSize3 = sycl::ext::oneapi::experimental::work_group_size<1, 0>;
    // expected-error-re@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size property must only contain non-zero values.}}
    // expected-error@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{constexpr variable 'work_group_size<0, 1>' must be initialized by a constant expression}}
  ...
  auto WGSize4 = sycl::ext::oneapi::experimental::work_group_size<0, 1>;
    // expected-error-re@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size property must only contain non-zero values.}}
    // expected-error@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{constexpr variable 'work_group_size<0, 0, 0>' must be initialized by a constant expression}}
  ...
  auto WGSize5 = sycl::ext::oneapi::experimental::work_group_size<0, 0, 0>;
    // expected-error-re@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size property must only contain non-zero values.}}
    // expected-error@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{constexpr variable 'work_group_size<1, 0, 0>' must be initialized by a constant expression}}
  ...
  auto WGSize6 = sycl::ext::oneapi::experimental::work_group_size<1, 0, 0>;
    // expected-error-re@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size property must only contain non-zero values.}}
    // expected-error@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{constexpr variable 'work_group_size<0, 1, 0>' must be initialized by a constant expression}}
  ...
  auto WGSize7 = sycl::ext::oneapi::experimental::work_group_size<0, 1, 0>;
    // expected-error-re@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size property must only contain non-zero values.}}
    // expected-error@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{constexpr variable 'work_group_size<0, 0, 1>' must be initialized by a constant expression}}
  ...
  auto WGSize8 = sycl::ext::oneapi::experimental::work_group_size<0, 0, 1>;
    // expected-error-re@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size property must only contain non-zero values.}}
    // expected-error@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{constexpr variable 'work_group_size<1, 1, 0>' must be initialized by a constant expression}}
  ...
  auto WGSize9 = sycl::ext::oneapi::experimental::work_group_size<1, 1, 0>;
    // expected-error-re@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size property must only contain non-zero values.}}
    // expected-error@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{constexpr variable 'work_group_size<0, 1, 1>' must be initialized by a constant expression}}
  ...
  auto WGSize10 = sycl::ext::oneapi::experimental::work_group_size<0, 1, 1>;
    // expected-error-re@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size property must only contain non-zero values.}}
    // expected-error@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{constexpr variable 'work_group_size<1, 0, 1>' must be initialized by a constant expression}}
  ...
  auto WGSize11 = sycl::ext::oneapi::experimental::work_group_size<1, 0, 1>;
    ...
    // expected-error-re@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size property currently only supports up to three values.}}
    // expected-error@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{constexpr variable 'work_group_size<1, 1, 1, 1>' must be initialized by a constant expression}}
  ...
  sycl::queue Q;
    ...
    // expected-error-re@sycl/ext/oneapi/properties.hpp:* {{static assertion failed due to requirement {{.+}}: Failed to merge property lists due to conflicting properties.}}
...
void check_work_group_size_hint() {
  ...
  auto WGSize0 = sycl::ext::oneapi::experimental::work_group_size_hint<>;
    ...
    // expected-error-re@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size_hint property must only contain non-zero values.}}
    // expected-error@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{constexpr variable 'work_group_size_hint<0>' must be initialized by a constant expression}}
  ...
  auto WGSize1 = sycl::ext::oneapi::experimental::work_group_size_hint<0>;
    // expected-error-re@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size_hint property must only contain non-zero values.}}
    // expected-error@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{constexpr variable 'work_group_size_hint<0, 0>' must be initialized by a constant expression}}
  ...
  auto WGSize2 = sycl::ext::oneapi::experimental::work_group_size_hint<0, 0>;
    // expected-error-re@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size_hint property must only contain non-zero values.}}
    // expected-error@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{constexpr variable 'work_group_size_hint<1, 0>' must be initialized by a constant expression}}
  ...
  auto WGSize3 = sycl::ext::oneapi::experimental::work_group_size_hint<1, 0>;
    // expected-error-re@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size_hint property must only contain non-zero values.}}
    // expected-error@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{constexpr variable 'work_group_size_hint<0, 1>' must be initialized by a constant expression}}
  ...
  auto WGSize4 = sycl::ext::oneapi::experimental::work_group_size_hint<0, 1>;
    // expected-error-re@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size_hint property must only contain non-zero values.}}
    // expected-error@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{constexpr variable 'work_group_size_hint<0, 0, 0>' must be initialized by a constant expression}}
  ...
  auto WGSize5 = sycl::ext::oneapi::experimental::work_group_size_hint<0, 0, 0>;
    // expected-error-re@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size_hint property must only contain non-zero values.}}
    // expected-error@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{constexpr variable 'work_group_size_hint<1, 0, 0>' must be initialized by a constant expression}}
  ...
  auto WGSize6 = sycl::ext::oneapi::experimental::work_group_size_hint<1, 0, 0>;
    // expected-error-re@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size_hint property must only contain non-zero values.}}
    // expected-error@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{constexpr variable 'work_group_size_hint<0, 1, 0>' must be initialized by a constant expression}}
  ...
  auto WGSize7 = sycl::ext::oneapi::experimental::work_group_size_hint<0, 1, 0>;
    // expected-error-re@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size_hint property must only contain non-zero values.}}
    // expected-error@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{constexpr variable 'work_group_size_hint<0, 0, 1>' must be initialized by a constant expression}}
  ...
  auto WGSize8 = sycl::ext::oneapi::experimental::work_group_size_hint<0, 0, 1>;
    // expected-error-re@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size_hint property must only contain non-zero values.}}
    // expected-error@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{constexpr variable 'work_group_size_hint<1, 1, 0>' must be initialized by a constant expression}}
  ...
  auto WGSize9 = sycl::ext::oneapi::experimental::work_group_size_hint<1, 1, 0>;
    // expected-error-re@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size_hint property must only contain non-zero values.}}
    // expected-error@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{constexpr variable 'work_group_size_hint<0, 1, 1>' must be initialized by a constant expression}}
  ...
  auto WGSize10 =
    ...
    // expected-error-re@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size_hint property must only contain non-zero values.}}
    // expected-error@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{constexpr variable 'work_group_size_hint<1, 0, 1>' must be initialized by a constant expression}}
  ...
  auto WGSize11 =
    ...
    // expected-error-re@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size_hint property currently only supports up to three values.}}
    // expected-error@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{constexpr variable 'work_group_size_hint<1, 1, 1, 1>' must be initialized by a constant expression}}
...
void check_sub_group_size() {
  ...
  auto WGSize0 = sycl::ext::oneapi::experimental::sub_group_size<>;
    ...
    // expected-error-re@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{static assertion failed due to requirement {{.+}}: sub_group_size property must contain a non-zero value.}}
    // expected-error@sycl/ext/oneapi/free_function_kernel_properties.hpp:* {{constexpr variable 'sub_group_size<0>' must be initialized by a constant expression}}
...
void check_max_work_group_size() {
  sycl::queue Q;
    ...
    // expected-error-re@sycl/detail/kernel_launch_helper.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size and max_work_group_size dimensionality must match}}
  Q.single_task(
      sycl::ext::oneapi::experimental::properties{
    ...
    // expected-error-re@sycl/detail/kernel_launch_helper.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size must not exceed max_work_group_size}}
  Q.single_task(
      sycl::ext::oneapi::experimental::properties{
...
void check_max_linear_work_group_size() {
  sycl::queue Q;
    ...
    // expected-error-re@sycl/detail/kernel_launch_helper.hpp:* {{static assertion failed due to requirement {{.+}}: work_group_size must not exceed max_linear_work_group_size}}
  Q.single_task(
      sycl::ext::oneapi::experimental::properties{
          sycl::ext::oneapi::experimental::work_group_size<2>,
