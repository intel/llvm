    ...
    if (OCLVersionMajor == '1') {
      ...
      try {
        ...
        if ((string_class(E.what()).find(
                 ...
                 "than global range in any dimension") == string_class::npos) &&
        ...
        std::cerr
            << "Test case OpenCL1XNegativeA2 failed: something unexpected "
               "has been caught"
            << std::endl;
        return 1;
      }
      ...
      try {
        ...
        std::cerr
            << "Test case OpenCL1XNegativeB2 failed: something unexpected "
               "has been caught"
            << std::endl;
        return 1;
      }
      ...
      try {
        ...
        Q.wait_and_throw();
        std::cerr
            << "Test case OpenCL1XNegativeC failed: no exception has been "
               "thrown\n";
        return 1; // We shouldn't be here, exception is expected
      } catch (nd_range_error &E) {
        if ((string_class(E.what()).find(
      ...
      // than the value specified by CL_KERNEL_WORK_GROUP_SIZE in table 5.21.
      {
        ...
        try {
          ...
          std::cerr
              << "Test case OpenCL2XNegativeA failed: something unexpected "
                 "has been caught"
              << std::endl;
          return 1;
        }
      ...
      // divisible by size of work-group given by local_work_size
      {
        try {
          ...
          if (string_class(E.what()).find(
                  ...
                  "and to enable it, build device program with "
                  "-cl-std=CL2.0") == string_class::npos) {
            std::cerr
          ...
          std::cerr
              << "Test case OpenCL2XNegativeB failed: something unexpected "
                 "has been caught"
              << std::endl;
          return 1;
        }
        ...
        try {
          ...
          std::cerr
              << "Test case OpenCL2XNegativeC failed: something unexpected "
                 "has been caught"
              << std::endl;
          return 1;
        }
      ...
      // This is a sub-case of the more general 'non-uniform work group'
      {
        try {
          ...
          if (string_class(E.what()).find(
                  ...
                  "Non-uniform work-groups are not allowed by default. "
                  "Underlying "
                  "OpenCL 2.x implementation supports this feature and to "
                  "enable "
      ...
      // Enable non-uniform work-groups by passing -cl-std=CL2.0
      {
        ...
        try {
          ...
          std::cerr
              << "Test case OpenCL2XPositiveA failed: something unexpected "
                 "has been caught"
              << std::endl;
          return 1;
        }
      ...
      // Multi-dimensional nd_range.
      {
        ...
        try {
          ...
          std::cerr
              << "Test case OpenCL2XPositiveB failed: something unexpected "
                 "has been caught"
              << std::endl;
          return 1;
        }
      ...
      // given by local_work_size
      {
        ...
        try {
          ...
          std::cerr
              << "Test case OpenCL2XNegativeD failed: something unexpected "
                 "has been caught"
              << std::endl;
          return 1;
        }
      ...
      // Multi-dimensional nd_range.
      {
        ...
        try {
          ...
          std::cerr
              << "Test case OpenCL2XNegativeE failed: something unexpected "
                 "has been caught"
              << std::endl;
          return 1;
        }
      ...
      // Local Size larger than Global, -cl-std=CL2.0
      // -cl-uniform-work-group-size flag used CL_INVALID_WORK_GROUP_SIZE if
      // local_work_size is specified as larger than the global size, then a
      // different error string is used. This is a sub-case of the more general
