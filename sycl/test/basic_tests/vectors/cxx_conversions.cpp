...
#define EXCEPT_NEW_VEC_IMPL
#define NEW_VEC_IMPL_ONLY !
#else
#define EXCEPT_NEW_VEC_IMPL !
#define NEW_VEC_IMPL_ONLY
#endif
...
//            NEW_VEC_IMPL_ONLY   condition<>
//            EXCEPT_NEW_VEC_IMPL condition<>

static_assert(                    std::is_invocable_v<decltype(f_half_v1), half>);
static_assert(EXCEPT_NEW_VEC_IMPL std::is_invocable_v<decltype(f_half_v1), float>);
static_assert(EXCEPT_NEW_VEC_IMPL std::is_invocable_v<decltype(f_half_v1), double>);
static_assert(                    std::is_invocable_v<decltype(f_half_v1), sw_half_1>);
static_assert(EXCEPT_NEW_VEC_IMPL std::is_invocable_v<decltype(f_half_v1), sw_float_1>);
static_assert(EXCEPT_NEW_VEC_IMPL std::is_invocable_v<decltype(f_half_v1), sw_double_1>);
static_assert(                    std::is_invocable_v<decltype(f_half_v1), vec<half, 1>>);
static_assert(EXCEPT_NEW_VEC_IMPL std::is_invocable_v<decltype(f_half_v1), vec<float, 1>>);
static_assert(EXCEPT_NEW_VEC_IMPL std::is_invocable_v<decltype(f_half_v1), vec<double, 1>>);

static_assert(EXCEPT_NEW_VEC_IMPL std::is_invocable_v<decltype(f_float_v1), half>);
static_assert(                    std::is_invocable_v<decltype(f_float_v1), float>);
static_assert(                    std::is_invocable_v<decltype(f_float_v1), double>);
static_assert(EXCEPT_NEW_VEC_IMPL std::is_invocable_v<decltype(f_float_v1), sw_half_1>);
static_assert(                    std::is_invocable_v<decltype(f_float_v1), sw_float_1>);
static_assert(EXCEPT_NEW_VEC_IMPL std::is_invocable_v<decltype(f_float_v1), sw_double_1>);
static_assert(EXCEPT_NEW_VEC_IMPL std::is_invocable_v<decltype(f_float_v1), vec<half, 1>>);
static_assert(                    std::is_invocable_v<decltype(f_float_v1), vec<float, 1>>);
static_assert(EXCEPT_NEW_VEC_IMPL std::is_invocable_v<decltype(f_float_v1), vec<double, 1>>);
...
#else
static_assert(NEW_VEC_IMPL_ONLY   is_explicitly_convertible_to_v<vec<half, 1>,  float>);
static_assert(NEW_VEC_IMPL_ONLY   is_explicitly_convertible_to_v<vec<half, 1>,  double>);
#endif
