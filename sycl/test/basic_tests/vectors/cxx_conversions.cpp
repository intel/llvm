...
static_assert(
    !std::is_invocable_v<decltype(f_half_v4), sw_float_2, sw_float_2>);
static_assert(
    !std::is_invocable_v<decltype(f_half_v4), sw_double_2, sw_double_2>);
static_assert(!std::is_invocable_v<decltype(f_half_v4), sw_half_2, sw_float_2>);
static_assert(
    !std::is_invocable_v<decltype(f_half_v4), sw_half_2, sw_double_2>);
...
static_assert(
    !std::is_invocable_v<decltype(f_float_v4), sw_float_2, sw_float_2>);
static_assert(
    !std::is_invocable_v<decltype(f_float_v4), sw_double_2, sw_double_2>);
static_assert(
    !std::is_invocable_v<decltype(f_float_v4), sw_float_2, sw_float_2>);
static_assert(
    !std::is_invocable_v<decltype(f_float_v4), sw_float_2, sw_double_2>);
