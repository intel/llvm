...
// RUN: %clangxx -fsycl -fsyntax-only -fpreview-major-release %s -Wno-sycl-strict -Xclang -verify-ignore-unexpected=note,warning
...
// RUN: %clangxx -fsycl-device-only -fsyntax-only -fpreview-major-release %s -Wno-sycl-strict
