...
int main() {
  ...
  sycl::ext::oneapi::experimental::spec_constant<uint32_t, MyUInt32Const> ui32 =
      program.set_spec_constant<MyUInt32Const>((uint32_t)get_value());
  // CHECK-DAG: _ZTS13MyUInt32Const=2|

  sycl::ext::oneapi::experimental::spec_constant<int64_t, MyInt64Const> i64 =
      program.set_spec_constant<MyInt64Const>((int64_t)get_value());
  // CHECK-DAG: _ZTS12MyInt64Const=2|
  sycl::ext::oneapi::experimental::spec_constant<uint64_t, MyUInt64Const> ui64 =
...
#define HALF 0 // TODO not yet supported
#if HALF
  sycl::ext::oneapi::experimental::spec_constant<sycl::half, MyHalfConst> f16 =
      program.set_spec_constant<MyHalfConst>((sycl::half)get_value());
#endif
  ...
  sycl::ext::oneapi::experimental::spec_constant<double, MyDoubleConst> f64 =
