...
// CHECK-NEXT:   0 |               struct std::_Head_base<1, struct std::default_delete<class sycl::detail::handler_impl> > (base) (empty)
// CHECK-NEXT:   0 |                 struct std::default_delete<class sycl::detail::handler_impl> _M_head_impl (empty)
// CHECK-NEXT:   0 |             struct std::_Head_base<0, class sycl::detail::handler_impl *> (base)
...
// CHECK-NEXT:  16 |           pointer _M_start
...
// CHECK-NEXT: 144 |     struct std::__uniq_ptr_data<class sycl::detail::HostKernelBase, struct std::default_delete<class sycl::detail::HostKernelBase> > _M_t
// CHECK-NEXT: 144 |       class std::__uniq_ptr_impl<class sycl::detail::HostKernelBase, struct std::default_delete<class sycl::detail::HostKernelBase> > (base)
// CHECK-NEXT: 144 |         class std::tuple<class sycl::detail::HostKernelBase *, struct std::default_delete<class sycl::detail::HostKernelBase> > _M_t
...
// CHECK-NEXT: 144 |               struct std::_Head_base<1, struct std::default_delete<class sycl::detail::HostKernelBase> > (base) (empty)
// CHECK-NEXT: 144 |                 struct std::default_delete<class sycl::detail::HostKernelBase> _M_head_impl (empty)
// CHECK-NEXT: 144 |             struct std::_Head_base<0, class sycl::detail::HostKernelBase *> (base)
