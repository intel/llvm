...
// CHECK: 0 | class {{.*}}::detail::buffer_impl
...
// CHECK: 0 | class {{.*}}::buffer<int, 2, class {{.*}}::detail::aligned_allocator<char>, void>
// CHECK-NEXT: 0 |   class std::shared_ptr<class {{.*}}::detail::buffer_impl> impl
// CHECK-NEXT: 0 |     class std::__shared_ptr<class {{.*}}::detail::buffer_impl, __gnu_cxx::_S_atomic> (base)
// CHECK-NEXT: 0 |       class std::__shared_ptr_access<class {{.*}}::detail::buffer_impl, __gnu_cxx::_S_atomic, false, false> (base) (empty)
// CHECK-NEXT: 0 |       std::__shared_ptr<class {{.*}}::detail::buffer_impl, __gnu_cxx::_S_atomic>::element_type * _M_ptr
...
// CHECK-NEXT: 16 |   class {{.*}}::range<2> Range
