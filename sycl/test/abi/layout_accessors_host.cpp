...
// CHECK:        0 | class {{.*}}::detail::AccessorImplHost
// CHECK-NEXT:   0 |   class {{.*}}::id<3> MOffset
// CHECK-NEXT:   0 |     class {{.*}}::detail::array<3> (base)
// CHECK-NEXT:   0 |       size_t [3] common_array
// CHECK-NEXT:  24 |   class {{.*}}::range<3> MAccessRange
// CHECK-NEXT:  24 |     class {{.*}}::detail::array<3> (base)
// CHECK-NEXT:  24 |       size_t [3] common_array
// CHECK-NEXT:  48 |   class {{.*}}::range<3> MMemoryRange
// CHECK-NEXT:  48 |     class {{.*}}::detail::array<3> (base)
...
// CHECK-NEXT: 112 |   class {{.*}}::detail::Command * MBlockedCmd
...
// CHECK:       0 | class {{.*}}::detail::LocalAccessorImplHost
// CHECK-NEXT:  0 |   class {{.*}}::range<3> MSize
// CHECK-NEXT:  0 |     class {{.*}}::detail::array<3> (base)
// CHECK-NEXT:  0 |       size_t [3] common_array
...
// CHECK-COUNT-2: 0 | class {{.*}}::accessor<int, 1, {{.*}}::access::mode::read, {{.*}}::access::target::host_buffer, {{.*}}::access::placeholder::false_t>
// CHECK-NEXT:  0 |   class {{.*}}::detail::AccessorBaseHost (base)
// CHECK-NEXT:  0 |     class std::shared_ptr<class {{.*}}::detail::AccessorImplHost> impl
// CHECK-NEXT:  0 |       class std::__shared_ptr<class {{.*}}::detail::AccessorImplHost, __gnu_cxx::_S_atomic> (base)
// CHECK-NEXT:  0 |         class std::__shared_ptr_access<class {{.*}}::detail::AccessorImplHost, __gnu_cxx::_S_atomic, false, false> (base) (empty)
// CHECK-NEXT:  0 |         std::__shared_ptr<class {{.*}}::detail::AccessorImplHost, __gnu_cxx::_S_atomic>::element_type * _M_ptr
...
// CHECK-NEXT:  0 |   class {{.*}}::detail::accessor_common<int, 1, {{.*}}::access::mode::read, {{.*}}::access::target::host_buffer, {{.*}}::access::placeholder::false_t> (base) (empty)
...
// CHECK-NEXT: 0 |   class {{.*}}::detail::LocalAccessorBaseHost (base)
// CHECK-NEXT: 0 |     class std::shared_ptr<class {{.*}}::detail::LocalAccessorImplHost> impl
// CHECK-NEXT: 0 |       class std::__shared_ptr<class {{.*}}::detail::LocalAccessorImplHost, __gnu_cxx::_S_atomic> (base)
// CHECK-NEXT: 0 |         class std::__shared_ptr_access<class {{.*}}::detail::LocalAccessorImplHost, __gnu_cxx::_S_atomic, false, false> (base) (empty)
// CHECK-NEXT: 0 |         std::__shared_ptr<class {{.*}}::detail::LocalAccessorImplHost, __gnu_cxx::_S_atomic>::element_type * _M_ptr
// CHECK-NEXT: 8 |         class std::__shared_count<__gnu_cxx::_S_atomic> _M_refcount
// CHECK-NEXT: 8 |           _Sp_counted_base<(enum __gnu_cxx::_Lock_policy)2U> * _M_pi
...
// CHECK:      0 | class {{.*}}::accessor<class {{.*}}::vec<int, 4>, 1, {{.*}}::access::mode::read_write, {{.*}}::access::target::host_image, {{.*}}::access::placeholder::false_t>
// CHECK-NEXT: 0 |   class {{.*}}::detail::image_accessor<class {{.*}}::vec<int, 4>, 1, {{.*}}::access::mode::read_write, {{.*}}::access::target::host_image, {{.*}}::access::placeholder::false_t> (base)
// CHECK-NEXT: 0 |     class {{.*}}::detail::AccessorBaseHost (base)
// CHECK-NEXT: 0 |       class std::shared_ptr<class {{.*}}::detail::AccessorImplHost> impl
// CHECK-NEXT: 0 |         class std::__shared_ptr<class {{.*}}::detail::AccessorImplHost, __gnu_cxx::_S_atomic> (base)
// CHECK-NEXT: 0 |           class std::__shared_ptr_access<class {{.*}}::detail::AccessorImplHost, __gnu_cxx::_S_atomic, false, false> (base) (empty)
...
// CHECK-NEXT: 24 |     enum {{.*}}::image_channel_order MImgChannelOrder
// CHECK-NEXT: 28 |     enum {{.*}}::image_channel_type MImgChannelType
// CHECK-NEXT: [sizeof=32, dsize=32, align=8,
// CHECK-NEXT: nvsize=32, nvalign=8]
