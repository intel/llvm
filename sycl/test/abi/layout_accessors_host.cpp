...
// CHECK-NEXT:  0 |   class sycl::detail::AccessorOwnerLessBase<class sycl::accessor<int, 1, sycl::access::mode::read, sycl::access::target::host_buffer, sycl::access::placeholder::false_t> > (base) (empty)
...
// CHECK-NEXT: 0 |   class sycl::detail::AccessorOwnerLessBase<class sycl::accessor<class sycl::vec<int, 4>, 1, sycl::access::mode::read_write, sycl::access::target::host_image, sycl::access::placeholder::false_t> > (base) (empty)
// CHECK-NEXT: [sizeof=32, dsize=32, align=8,
// CHECK-NEXT: nvsize=32, nvalign=8]
