...
// CHECK-NEXT: 0 |   struct sycl::_V1::detail::ItemBase<2, true> MImpl
// CHECK-NEXT: 0 |     class sycl::range<2> MExtent
// CHECK-NEXT: 0 |       class sycl::_V1::detail::array<2> (base)
// CHECK-NEXT: 0 |         size_t[2] common_array
// CHECK-NEXT: 16 |     class sycl::id<2> MIndex
// CHECK-NEXT: 16 |       class sycl::_V1::detail::array<2> (base)
// CHECK-NEXT: 16 |         size_t[2] common_array
// CHECK-NEXT: 32 |     class sycl::id<2> MOffset
// CHECK-NEXT: 32 |       class sycl::_V1::detail::array<2> (base)
