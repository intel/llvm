...
// CHECK:           0 | class sycl::_V1::detail::AccessorImplDevice<1>
// CHECK-NEXT:      0 |   class sycl::id<> Offset
// CHECK-NEXT:      0 |     class sycl::_V1::detail::array<> (base)
// CHECK-NEXT:      0 |       size_t[1] common_array
// CHECK-NEXT:      8 |   class sycl::range<> AccessRange
// CHECK-NEXT:      8 |     class sycl::_V1::detail::array<> (base)
// CHECK-NEXT:      8 |       size_t[1] common_array
// CHECK-NEXT:     16 |   class sycl::range<> MemRange
// CHECK-NEXT:     16 |     class sycl::_V1::detail::array<> (base)
...
// CHECK-NEXT:      0 |   class sycl::_V1::detail::accessor_common<int, 1, sycl::access::mode::read_write, sycl::access::target::global_buffer, sycl::access::placeholder::false_t> (base) (empty)
// CHECK-NEXT:      0 |   class sycl::_V1::detail::OwnerLessBase<class sycl::accessor<int, 1, sycl::access::mode::read_write, sycl::access::target::global_buffer, sycl::access::placeholder::false_t> > (base) (empty)
// CHECK-NEXT:      0 |   class sycl::_V1::detail::AccessorImplDevice<1> impl
// CHECK-NEXT:      0 |     class sycl::id<> Offset
// CHECK-NEXT:      0 |       class sycl::_V1::detail::array<> (base)
// CHECK-NEXT:      0 |         size_t[1] common_array
// CHECK-NEXT:      8 |     class sycl::range<> AccessRange
