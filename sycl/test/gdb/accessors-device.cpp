...
// CHECK-NEXT:      0 |   class sycl::detail::AccessorOwnerLessBase<class sycl::accessor<int, 1, sycl::access::mode::read_write, sycl::access::target::global_buffer, sycl::access::placeholder::false_t> > (base) (empty)
