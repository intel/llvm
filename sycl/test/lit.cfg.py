...
if config.sycl_headers_filter is not None:
    lit_config.note("SYCL_HEADESR_FILTER param is set to '{}', it will impact amount of tests discovered within self-contained-headers sub-suite".format(config.sycl_headers_filter));
