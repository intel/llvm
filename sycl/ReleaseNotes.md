...
## New features
 ...
 - Implemented support for `[[intel::named_sub_group_size(primary)]]` attribute
   from [sub-group extension](doc/extensions/supported/SYCL_EXT_ONEAPI_SUB_GROUP.asciidoc#attributes)
   [347e41c]
...
### Documentation
 ...
 - Updated
   [SYCL_INTEL_sub_group](doc/extensions/supported/SYCL_EXT_ONEAPI_SUB_GROUP.asciidoc)
...
### Documentation
  ...
  - The [SYCL_INTEL_sub_group extension](doc/extensions/supported/SYCL_EXT_ONEAPI_SUB_GROUP.asciidoc)
...
### SYCL Library
  - Updated the implementation to align with changes in
    [SubGroup extension](doc/extensions/supported/SYCL_EXT_ONEAPI_SUB_GROUP.asciidoc) [9d4c284]
...
### Documentation
  ...
  - The [SYCL_INTEL_sub_group extension document](doc/extensions/supported/SYCL_EXT_ONEAPI_SUB_GROUP.asciidoc)
...
## New features
  - Implemented [reduction extension](doc/extensions/supported/SYCL_EXT_ONEAPI_ND_RANGE_REDUCTIONS.md)
...
### Documentation
  ...
  - Added missing constructors and member functions in
    [reduction extension proposal](doc/extensions/supported/SYCL_EXT_ONEAPI_ND_RANGE_REDUCTIONS.md)
    [f695479]
...
## New features
  ...
  - Added the implementation of [GroupAlgorithms extension](doc/extensions/supported/SYCL_EXT_ONEAPI_GROUP_ALGORITHMS.asciidoc)
    [8bfa107]
...
### Documentation
  ...
  - Added extension for base sub-group class:
    [SubGroup](doc/extensions/supported/SYCL_EXT_ONEAPI_SUB_GROUP.asciidoc) [d9b178f]
