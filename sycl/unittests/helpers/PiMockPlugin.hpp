...
inline pi_result
mock_piextMemUnsampledImageHandleDestroy(pi_context context,
                                         pi_image_handle handle) {
  return PI_SUCCESS;
}

inline pi_result
mock_piextMemSampledImageHandleDestroy(pi_context context,
                                       pi_image_handle handle) {
  return PI_SUCCESS;
}
...
inline pi_result mock_piextMemMipmapGetLevel(pi_context context, pi_image_mem_handle mip_mem,
                                             unsigned int level,
                                             pi_image_mem_handle *ret_mem) {
  return PI_SUCCESS;
}
...
inline pi_result mock_piextMemMipmapFree(pi_context context,
                                         pi_image_mem_handle memory_handle) {
  return PI_SUCCESS;
}

inline pi_result mock_piextMemUnsampledImageCreate(
    pi_context context, pi_image_mem_handle img_mem, pi_image_format *image_format,
...
inline pi_result
mock_piextDestroyExternalSemaphore(pi_context context,
...
inline pi_result mock_piextMemSampledImageCreateInterop(
    pi_context context, pi_image_format *image_format, pi_image_desc *desc,
    pi_sampler sampler, pi_interop_mem_handle ext_mem_handle,
    pi_image_handle *ret_img_handle) {
  return PI_SUCCESS;
}

inline pi_result
mock_piextMemSampledImageCreate(pi_context context, pi_image_mem_handle img_mem,
                                pi_image_format *image_format,
