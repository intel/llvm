...
// This test contains basic checks for __sycl_internal::__v1::detail::CircularBuffer
void checkEquality(const __sycl_internal::__v1::detail::CircularBuffer<int> &CB,
...
TEST(CircularBufferTest, CircularBufferTest) {
  ...
  __sycl_internal::__v1::detail::CircularBuffer<int> CB{Capacity};
