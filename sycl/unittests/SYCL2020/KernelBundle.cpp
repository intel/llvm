...
// Even though secondary submission queue is optional, it is required by the
// SYCL Spec to throw an exception if the context of the secondary queue is
// different from the context of the kernel bundle.
