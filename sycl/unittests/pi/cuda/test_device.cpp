...
TEST_F(DISABLED_CudaDeviceTests, PIDeviceGetInfoSimple) {
  ...
  ASSERT_EQ((PI_CALL_NOCHECK(piDeviceGetInfo)(device_, PI_DEVICE_INFO_TYPE, sizeof(pi_device_type),
  ...
  ASSERT_EQ((PI_CALL_NOCHECK(piDeviceGetInfo)(device_, PI_DEVICE_INFO_PARENT_DEVICE, sizeof(pi_device),
                        &parent_device, &return_size)), PI_SUCCESS);
  ...
  ASSERT_EQ((PI_CALL_NOCHECK(piDeviceGetInfo)(device_, PI_DEVICE_INFO_PLATFORM, sizeof(pi_platform),
                        &platform, &return_size)), PI_SUCCESS);
  ...
  ASSERT_EQ((PI_CALL_NOCHECK(piDeviceGetInfo)(device_, PI_DEVICE_INFO_PARTITION_TYPE,
                        sizeof(cl_device_partition_property),
                        &device_partition_property, &return_size)), PI_SUCCESS);
