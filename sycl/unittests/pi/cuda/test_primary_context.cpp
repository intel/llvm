...
TEST_P(CudaPrimaryContextTests, piSingleContext) {
  ...
  context Context(deviceA_, property::context::cuda::use_primary_context());
...
TEST_P(CudaPrimaryContextTests, piMultiContextSingleDevice) {
  ...
  context ContextA(deviceA_, property::context::cuda::use_primary_context());
  context ContextB(deviceA_, property::context::cuda::use_primary_context());
...
TEST_P(CudaPrimaryContextTests, piMultiContextMultiDevice) {
  ...
  context ContextA(deviceA_, property::context::cuda::use_primary_context());
  context ContextB(deviceB_, property::context::cuda::use_primary_context());
