...
TEST(ConfigTests, CheckPreferredWGSizeConfigProcessing) {
  SetAndCheck("cpu:32", 32, 0);
  SetAndCheck("gpu:32", 0, 32);
  SetAndCheck("*:32", 32, 32);

  SetAndCheck("cpu:1,gpu:2", 1, 2);
  SetAndCheck("gpu:2,cpu:1", 1, 2);
  SetAndCheck("cpu:1", 1, 0);
  SetAndCheck("gpu:2", 0, 2);

  SetAndCheck("cpu:1,cpu:2", 2, 0);
  SetAndCheck("cpu:2,cpu:1", 1, 0);
  SetAndCheck("gpu:1,gpu:2", 0, 2);
  SetAndCheck("gpu:2,gpu:1", 0, 1);
  SetAndCheck("*:1,*:2", 2, 2);
  SetAndCheck("*:2,*:1", 1, 1);

  SetAndCheck("cpu:1,*:2", 2, 2);
  SetAndCheck("gpu:1,*:2", 2, 2);
  SetAndCheck("*:2,cpu:1", 1, 2);
  SetAndCheck("*:2,gpu:1", 2, 1);
