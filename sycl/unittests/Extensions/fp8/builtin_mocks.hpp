...
#define __SYCL_TARGET_INTEL_GPU_CRI__ 1
#endif
...
inline sycl::half __attribute__((weak))
...
inline sycl::ext::oneapi::bfloat16 __attribute__((weak))
...
inline uint8_t __attribute__((weak))
__builtin_spirv_ConvertFP16ToE4M3INTEL(sycl::half) noexcept {
  return 0x00;
}
