...
struct Counters {
  int ClampConvertE4M3ToFP16INTEL = 0;
  int ConvertE4M3ToFP16INTEL = 0;
  int ConvertE5M2ToFP16INTEL = 0;
  int ConvertE4M3ToBF16INTEL = 0;
  int ConvertE5M2ToBF16INTEL = 0;
...
__builtin_spirv_ClampConvertE4M3ToFP16INTEL(uint8_t) noexcept {
  ++fp8_builtin_mock::getCounters().ClampConvertE4M3ToFP16INTEL;
  return static_cast<sycl::half>(2.0f);
}

inline sycl::half __builtin_spirv_ConvertE4M3ToFP16INTEL(uint8_t) noexcept {
  ++fp8_builtin_mock::getCounters().ConvertE4M3ToFP16INTEL;
  return static_cast<sycl::half>(1.0f);
}

inline sycl::half __builtin_spirv_ConvertE5M2ToFP16INTEL(uint8_t) noexcept {
  ++fp8_builtin_mock::getCounters().ConvertE5M2ToFP16INTEL;
  return static_cast<sycl::half>(3.0f);
}

inline sycl::ext::oneapi::bfloat16
__builtin_spirv_ConvertE4M3ToBF16INTEL(uint8_t) noexcept {
  ++fp8_builtin_mock::getCounters().ConvertE4M3ToBF16INTEL;
  return static_cast<sycl::ext::oneapi::bfloat16>(4.0f);
}

inline sycl::ext::oneapi::bfloat16
__builtin_spirv_ConvertE5M2ToBF16INTEL(uint8_t) noexcept {
  ++fp8_builtin_mock::getCounters().ConvertE5M2ToBF16INTEL;
  return static_cast<sycl::ext::oneapi::bfloat16>(5.0f);
}

inline uint8_t __builtin_spirv_ConvertFP16ToE4M3INTEL(sycl::half) noexcept {
  return 0x00;
}

inline uint8_t
__builtin_spirv_ConvertBF16ToE5M2INTEL(sycl::ext::oneapi::bfloat16) noexcept {
  return 0x00;
}
