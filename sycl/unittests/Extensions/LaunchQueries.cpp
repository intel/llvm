...
TEST(LaunchQueries, GetWorkGroupSizeException)
{
    sycl::unittest::UrMock<> Mock;
    mock::getCallbacks().set_replace_callback("urKernelGetGroupInfo",
...
TEST(LaunchQueries, GetMaxWorkGroupItemSizesException)
{
    sycl::unittest::UrMock<> Mock;
    mock::getCallbacks().set_replace_callback("urKernelGetGroupInfo",
                                            &redefine_urKernelGetGroupInfo_Exception);
...
TEST(LaunchQueries, GetMaxSubGroupSizeException)
{
    sycl::unittest::UrMock<> Mock;
    mock::getCallbacks().set_replace_callback("urKernelGetSubGroupInfo",
                                            &redefine_urKernelGetGroupInfo_Exception);
...
TEST(LaunchQueries, GetNumSubGroupsException)
{
    sycl::unittest::UrMock<> Mock;
    mock::getCallbacks().set_replace_callback("urKernelGetSubGroupInfo",
                                            &redefine_urKernelGetGroupInfo_Exception);
