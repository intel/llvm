...
**`-fsycl-targets=<T1>[,...,<Tn>]`**
    ...
    * spir64 - this is the default generic SPIR-V
      target;
    * spir64_x86_64 - generate code ahead of time
      for x86_64 CPUs;
    * spir64_fpga - generate code ahead of time for
      Intel FPGA;
    * spir64_gen - generate code ahead of time for
...
**`-fintelfpga`**
    ...
    `-fsycl-targets=spir64_fpga -g -MMD` on Linux
    and `-fsycl-targets=spir64_fpga -Zi -MMD` on
    Windows.
