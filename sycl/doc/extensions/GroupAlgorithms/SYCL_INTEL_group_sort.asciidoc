...
|`sycl::span<uint8_t, Extent> get_memory() const`
...
namespace sycl::ext::oneapi {
  ...
  void joint_sort(group_executor<Group, Extent> exec, Ptr first, Ptr last); // (1)

  template <typename Group, std::size_t Extent, typename Ptr, typename Compare>
  void joint_sort(group_executor<Group, Extent> exec, Ptr first, Ptr last, Compare comp); // (2)
  ...
  T sort_over_group(group_executor<Group, Extent> exec, T val); // (4)

  template <typename Group, std::size_t Extent, typename T, typename Compare>
  T sort_over_group(group_executor<Group, Extent> exec, T val, Compare comp); // (5)
