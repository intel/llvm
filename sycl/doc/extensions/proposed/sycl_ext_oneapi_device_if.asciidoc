...
This experimental extension supports only the following limited set of aspects
for the `Aspects` parameter pack:
...
We expect that a future version of this specification will support all aspects.
