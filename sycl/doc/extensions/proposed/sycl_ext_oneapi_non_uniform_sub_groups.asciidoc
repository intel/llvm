...
sycl::ext::oneapi::experimental::ballot_group inner = sycl::ext::oneapi::experimental::get_ballot_group(sub_group, will_branch);
if (will_branch)
{
...
int atomic_aggregate_inc(sycl::sub_group sub_group, sycl::atomic_ref<int, order, scope, addr_space> ptr) {
    sycl::ext::oneapi::experimental::opportunistic_group active_group = sycl::ext::oneapi::experimental::get_opportunistic_group(sub_group);
