...
template <typename Properties = ext::oneapi::experimental::empty_property_list>
void prefetch(void* ptr, Properties properties = {});

template <typename Properties = ext::oneapi::experimental::empty_property_list>
void prefetch(void* ptr, size_t bytes, Properties properties = {});

template <typename T, typename Properties = ext::oneapi::experimental::empty_property_list>
...
template <typename Group, typename Properties = ext::oneapi::experimental::empty_property_list>
...
template <typename Group, typename T, typename Properties = ext::oneapi::experimental::empty_property_list>
