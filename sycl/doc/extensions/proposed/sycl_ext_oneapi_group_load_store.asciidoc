...
1.`sycl::ext::oneapi::experimental::property::data_placement_enum::blocked`.
...
2.`sycl::ext::oneapi::experimental::property::data_placement_enum::striped`.
...
Example:
`group_load(g, input, output_span, property::data_placement_blocked);`
...
q.submit([&](sycl::handler& cgh) {
    cgh.parallel_for(
        ...
        [=](sycl::nd_item<1> item) {
            ...
            sycl_exp::group_load(g, input + offset, sycl::span{ data });

            // Work with data...

            sycl_exp::group_store(g, output + offset, sycl::span{ data });
        });
});
----
...
q.submit([&](sycl::handler& cgh) {
    ...
    cgh.parallel_for(
        ...
        [=](sycl::nd_item<1> item) {
            ...
            sycl_exp::group_load(gh, input + offset, sycl::span{ data });

            // Work with data...

            sycl_exp::group_store(gh, output + offset, sycl::span{ data });
        });
});
----
...
q.submit([&](sycl::handler& cgh) {
    ...
    cgh.parallel_for(
        ...
        [=](sycl::nd_item<1> item) {
            ...
            sycl_exp::group_load(gh, input + offset, sycl::span{ data }, property::data_placement_striped);

            // Work with data...

            sycl_exp::group_store(gh, output + offset, sycl::span{ data }, property::data_placement_striped);
        });
});
----
