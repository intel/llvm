...
As `InputIteratorT` and `OutputIteratorT` are permitted to be random access iterators they
are not guaranteed to be contiguous. The following property is introduced to be used
