...
template<int stall_enable_clusters_option>
inline constexpr use_stall_enable_clusters_key::value_t<
  stall_enable_clusters_option> use_stall_enable_clusters;
...
This parameter requests that statically-scheduled clusters should handle stalls
using a stall-enable signal to freeze computation within the cluster.
