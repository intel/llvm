...
template <typename T, size_t Rows=sycl::dynamic_extent, size_t Cols=sycl::dynamic_extent, 
          use use, layout Layout = layout::unused, typename Group = sub_group>
struct joint_matrix {
...
```c++
joint_matrix<int8_t, tM, tN, use::a> tA(sg); 
```
...
namespace sycl::ext::oneapi::experimental::matrix {
  ...
  void joint_matrix_load(Group sg, joint_matrix<T, NumRows, NumCols, U, layout::unused, Group> &res,
...
namespace sycl::ext::oneapi::experimental::matrix {
  template <typename Group, typename T, size_t NumRows, size_t NumCols,
          use U, access::address_space Space>	  
  void joint_matrix_store(Group sg, joint_matrix<T, NumRows, NumCols, U, layout::unused, Group> &res,
		     multi_ptr<T, Space> src, size_t stride, layout memL);
}
```
...
namespace sycl::ext::oneapi::experimental::matrix {
  ...
  joint_matrix<Group, Td, M, N, use::accumulator, layout::unused, Group> joint_matrix_mad(Group sg,
    joint_matrix<Ta, M, K, use::a, layout::unused, Group> A,
    joint_matrix<Tb, K, N, use::b, layout::unused, Group> B,
    joint_matrix<Tc, M, N, use::accumulator, layout::unused, Group> C);
}
```
...
struct tpu_params<
  ...
  using joint_matrix_a = joint_matrix<Ta, defaultM, defaultK, use::a, Layout, Group>;
  template <layout Layout = layout::unused, typename Group = sub_group>
  using joint_matrix_b = joint_matrix<Tb, defaultK, defaultN, use::b Layout, Group>;
  template <layout Layout = layout::unused, typename Group = sub_group>
  using joint_matrix_c = joint_matrix<Tc, defaultM, defaultN, use::accumulator, Layout, Group>;
...
// device code:
joint_matrix<int8_t, msize, ksize, use::a> sub_a(sg);
joint_matrix<int8_t, ksize, nsize, use::b> sub_b(sg);
joint_matrix<int, msize, nsize, use::accumulator> sub_c(sg);
//Remainder handling
```
