...
void *
alloc_exportable_device_mem(size_t size, size_t alignment,
...
// Available only when ExternalMemType == export_external_mem_handle_type::opaque_fd
...
// Available only when
// ExternalMemType == export_external_mem_handle_type::win32_nt_handle
template <export_external_mem_handle_type ExternalMemType>
...
returned by `export_device_mem_handle` for that region. The handle must not be used
