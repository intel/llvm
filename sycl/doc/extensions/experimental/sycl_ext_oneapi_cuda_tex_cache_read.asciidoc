...
The template parameter `T` can be one of `char`, `signed char`, `short`, `int`, `long`, `long long`, `unsigned char`, `unsigned short`, `unsigned int`, `unsigned long`, `unsigned long long`, `half`, `float`, `double`, `<char, 2>`, `<char, 4>`, `<signed char, 2>`, `<signed char, 4>`, `<short, 2>`, `<short, 4>`, `<int, 2>`, `<int, 4>`, `<long, 2>`, `<long, 4>`, `<long long, 2>`, `<long long, 4>`, `<unsigned char, 2>`, `<unsigned char, 4>`, `<unsigned short, 2>`, `<unsigned short, 4>`, `<unsigned int, 2>`, `<unsigned int, 4>`, `<unsigned long, 2>`, `<unsigned long, 4>`, `<unsigned long long, 2>`, `<unsigned long long, 4>`, `<half, 2>`, `<half, 4>`, `<float, 2>`, `<float, 4>`, `<double, 2>`, or `<double, 4>`.
