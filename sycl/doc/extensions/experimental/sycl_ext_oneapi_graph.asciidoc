...
create the executable graph. This means that all nodes and edges must be added
in the same order, and all Graph-related API calls and recorded queue
submissions must occur in the same order.
