...
nodes. The param argument is used only to deduce the template parameter ValueT,
which is the type of the kernel argument this `dynamic_parameter` represents.
