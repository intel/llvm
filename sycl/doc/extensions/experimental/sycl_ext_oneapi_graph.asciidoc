...
executable graph(s) should not be executed simultaneously if at least one
execution contains a write operation to a memory address accessed by another
execution, it is undefined behavior to do so.
...
or pending execution, at any time.
