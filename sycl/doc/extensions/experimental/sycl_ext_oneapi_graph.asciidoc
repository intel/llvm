...
* Only a single queue may be in native recording state at a time for a given
  graph; transitive recording is not supported.
...
Native recording requires backend support for native command-list graph
