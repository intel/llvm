...
----
intel_gpu_nvl_s
intel_gpu_nvl_hx = intel_gpu_nvl_s
intel_gpu_nvl_ul = intel_gpu_nvl_s
----
|-
|Nova Lake S/HX/UL Intel graphics architecture.

a|
[source]
----
intel_gpu_nvl_u
intel_gpu_nvl_h = intel_gpu_nvl_u
----
|-
|Nova Lake U/H Intel graphics architecture.
...
intel_gpu_30_4_0 = intel_gpu_nvl_s
intel_gpu_30_5_0 = intel_gpu_nvl_u
intel_gpu_35_10_0 = intel_gpu_nvl_p
intel_gpu_35_11_0 = intel_gpu_cri
----
|-
...
----
|-
|NVIDIA Ampere architecture (compute capability 8.8).
...
----
|-
|NVIDIA Blackwell architecture (compute capability 10.3).

a|
[source]
----
nvidia_gpu_sm_110
nvidia_gpu_sm_101 = nvidia_gpu_sm_110
----
|-
|NVIDIA Blackwell Thor architecture (compute capability 11.0). The `sm_101`
...
----
|-
|NVIDIA Blackwell architecture (compute capability 12.1).
...
[_Note:_
NVIDIA `a` and `f` AOT target variants map to the enumerator for their base
compute capability. For example, `nvidia_gpu_sm_100a` and
`nvidia_gpu_sm_100f` both map to `architecture::nvidia_gpu_sm_100`.
_{endnote}_]
