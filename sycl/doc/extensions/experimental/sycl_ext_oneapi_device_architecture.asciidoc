...
|`amd_gpu_gfx908`
|-
|AMD GCN GFX9 (CDNA 1) architecture.
...
|`amd_gpu_gfx90a`
|-
|AMD GCN GFX9 (CDNA 2) architecture.
...
|`amd_gpu_gfx940`
|-
|AMD GCN GFX9 (CDNA 3) architecture.
