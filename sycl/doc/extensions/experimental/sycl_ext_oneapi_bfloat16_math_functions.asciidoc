...
Compute absolute value of a `bfloat16` value, `sycl::marray<bfloat16, N>`,
or `sycl::vec<bfloat16, N>`.
...
for a `bfloat16` value, `sycl::marray<bfloat16, N>`, or `sycl::vec<bfloat16, N>`.
...
Compute cosine of a `bfloat16` value, `sycl::marray<bfloat16, N>`, or `sycl::vec<bfloat16, N>`.
...
Compute sine of a `bfloat16` value, `sycl::marray<bfloat16, N>`, `sycl::vec<bfloat16, N>`.
...
Compute the base-e exponential of a `bfloat16` value, `sycl::marray<bfloat16, N>`, or `sycl::vec<bfloat16, N>`.
...
Compute the base-2 exponential of a `bfloat16` value, `sycl::marray<bfloat16, N>`, or `sycl::vec<bfloat16, N>`.
...
Compute the base-10 exponential of a `bfloat16` value, `sycl::marray<bfloat16, N>`, or `sycl::vec<bfloat16, N>`.
...
Compute natural logarithm of a `bfloat16` value, `sycl::marray<bfloat16, N>`, or `sycl::vec<bfloat16, N>`.
...
Compute base-2 logarithm of a `bfloat16` value, `sycl::marray<bfloat16, N>`, or `sycl::vec<bfloat16, N>`.
...
Compute base-10 logarithm of a `bfloat16` value, `sycl::marray<bfloat16, N>`, or `sycl::vec<bfloat16, N>`.
...
Compute square root of a `bfloat16` value, `sycl::marray<bfloat16, N>`, or `sycl::vec<bfloat16, N>`.
...
Compute inverse square root of a `bfloat16` value, `sycl::marray<bfloat16, N>`, or `sycl::vec<bfloat16, N>`.
...
for a `bfloat16` value, `sycl::marray<bfloat16, N>`,`sycl::vec<bfloat16, N>`.
