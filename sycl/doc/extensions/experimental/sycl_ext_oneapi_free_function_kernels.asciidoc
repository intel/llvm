...
* `#include <sycl/ext/oneapi/kernel_properties.hpp>` provides the
...
`properties_tag`, or depends on the umbrella property's property-list conflict
checks should include `sycl/ext/oneapi/kernel_properties.hpp`.
...
including `properties{...}`, `properties_tag`, or the associated
property-list conflict checks, should include the umbrella header.
