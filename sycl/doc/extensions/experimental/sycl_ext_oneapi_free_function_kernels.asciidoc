...
checks should include `kernel_properties/properties.hpp`.
...
include `function_properties.hpp` instead of the full
`kernel_properties/properties.hpp` header when it only needs the
