...
R operatorOP(const annotated_ref<T2, PropertyList2> &other) const;
----
|
Defines the overloaded operators for types `annotated_ref<T, ...>` and
`annotated_ref<T2, ...>`. Let `operatorOP` denote the operator used.
...
`annotated_ref<T, ...>` and raw type `T2`. Let `operatorOP` denote the operator used.
...
template <typename T, typename PropertyList, typename T2,
          typename R = decltype(std::declval<T>() OP std::declval<T2>())>
R operatorOP(const annotated_ref<T, PropertyList> &a, const T2 &b);
template <typename T, typename T2, typename PropertyList2,
          typename R = decltype(std::declval<T>() OP std::declval<T2>())>
R operatorOP(const T &a, const annotated_ref<T2, PropertyList2> &b);
----
