...
The two properties defined below and the properties from link:../proposed/sycl_ext_intel_maximum_registers.asciidoc[sycl_ext_intel_maximum_registers] are all mutually exclusive.
A kernel may be decorated with at most one of these properties.
