...
The precise meaning of this property is defined by each source language.
In general, this property allows the application to supply a list of kernel
names along with the source code that defines the kernels.
