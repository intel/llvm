...
architecture::intel_gpu_dg2_g11, architecture::intel_gpu_dg2_g12` .1+| 32 .1+| 32 .1+| 16| `matrix_type::tf32`       |  `matrix_type::tf32`   |
...
|13  |2024-08-07 |Yixing Zhang | Add 32x32x16 supported combination for
Intel XMX (intel_gpu_dg2)
|======================