...
|precision::sint4 | int32_t | Eight 4-bit signed integers are packed
into 32 bits.
|precision::uint4 | int32_t | Eight 4-bit unsigned integers are packed
into 32 bits.
|======================
...
`fp32`: `float` +
`fp64`: `double` +
`sint4`: `sycl::ext::oneapi::experimental::matrix::precision::sint4_t` +
`sint8`: `int8_t` +
`sint16`: `int16_t` +
`sint32`: `int32_t` +
`sint64`: `int64_t` +
`uint4`: `sycl::ext::oneapi::experimental::matrix::precision::uint4_t` +
`uint8`: `uint8_t` +
`uint16`: `uint16_t` +
`uint32`: `uint32_t` +
`uint64`: `uint64_t`
...
|======================
| A type | B type | C and D type | M | N | K | device
.2+| `matrix_type::uint4`  .2+| `matrix_type::uint4` .2+|
`matrix_type::sint32`  .2+|  +<=+ 8 |  16 .2+|  64
|`architecture::intel_gpu_pvc`
|8|`architecture::intel_gpu_dg2_g10,
architecture::intel_gpu_dg2_g11, architecture::intel_gpu_dg2_g12`
.2+| `matrix_type::uint4`  .2+| `matrix_type::sint4` .2+|
`matrix_type::sint32`  .2+|  +<=+ 8 |  16 .2+|  64 |
`architecture::intel_gpu_pvc`
|8|`architecture::intel_gpu_dg2_g10,
architecture::intel_gpu_dg2_g11, architecture::intel_gpu_dg2_g12`
.2+| `matrix_type::sint4`  .2+| `matrix_type::uint4` .2+|
`matrix_type::sint32`  .2+|  +<=+ 8 |  16 .2+|  64 |
`architecture::intel_gpu_pvc`
|8|`architecture::intel_gpu_dg2_g10,
architecture::intel_gpu_dg2_g11, architecture::intel_gpu_dg2_g12`
.2+| `matrix_type::sint4`  .2+| `matrix_type::sint4` .2+|
`matrix_type::sint32`  .2+|  +<=+ 8 |  16 .2+|  64 |
`architecture::intel_gpu_pvc`
|8|`architecture::intel_gpu_dg2_g10,
architecture::intel_gpu_dg2_g11, architecture::intel_gpu_dg2_g12`
...
|11   |2024-04-15 |Dounia Khaldi |Add 4 bits integer type
|======================
