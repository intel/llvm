...
|8| `architecture::intel_gpu_dg2_g10,
architecture::intel_gpu_dg2_g11, architecture::intel_gpu_dg2_g12`
.7+|  `matrix_type::bf16`       .7+|  `matrix_type::bf16`   .7+|
`matrix_type::fp32`  | 16 | 16 | 16 .4+|`architecture::intel_gpu_pvc`
| 1 | 64 | 16 | 32 | 64 | 16
.2+|  +<=+ 8 |  16   .2+|  16
|8 .3+| `architecture::intel_gpu_dg2_g10,
architecture::intel_gpu_dg2_g11, architecture::intel_gpu_dg2_g12` .2+| 32 .2+| 32 .2+| 16| `matrix_type::tf32`       |  `matrix_type::tf32`   |
