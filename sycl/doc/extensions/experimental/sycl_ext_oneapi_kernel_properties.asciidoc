...
The `function_properties.hpp` header is intended for the free-function kernel
definition path. Code that forms property lists, uses `properties_tag`, or
depends on the umbrella property's property-list conflict checks should include
