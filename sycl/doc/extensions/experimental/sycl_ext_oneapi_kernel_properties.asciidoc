...
The `sycl/ext/oneapi/free_function_kernel_properties.hpp` header is intended
for the free-function kernel definition path. Code that forms property lists,
uses `properties_tag`, or depends on the umbrella property's property-list
conflict checks should include `sycl/ext/oneapi/kernel_properties.hpp`.
