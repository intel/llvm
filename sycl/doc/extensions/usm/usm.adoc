...
[source,cpp]
----
void* sycl::aligned_alloc_device(size_t alignment, size_t size, const sycl::device& dev, const sycl::context& ctxt);
----
...
[source,cpp]
----
void* sycl::malloc_shared(size_t size, const sycl::device& dev);
----
...
[source,cpp]
----
void* sycl_aligned_alloc_shared(size_t alignment, size_t size, const sycl::device& dev);
----
