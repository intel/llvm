...
|3     |Initial extension implementation on Nvidia® Tensor Cores. Base features are supported.
|======================
...
In the Nvidia case an example declaration adds the `matrix_use` parameter, e.g.:
