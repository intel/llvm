...
- If the user specifies '-Ox' option using the environment variable, this option will override any front-end compile option and the new option will be preserved during AOT and JIT compilation.
- If the user specifies '-O0' option, SYCL runtime needs to pass the appropriate backend option to AOT and JIT compilation stages.
