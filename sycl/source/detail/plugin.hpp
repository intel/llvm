...
public:
  ...
  void checkPiResult(sycl::detail::pi::PiResult pi_result) const {
    ...
    // these macros don't function any more, but we do need to keep the old
    // plugin object around to avoid needing to change like.. every runtime
    // object just to get stuff building
