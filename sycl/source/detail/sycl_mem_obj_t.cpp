...
SYCLMemObjT::SYCLMemObjT(ur_native_handle_t MemObject,
  ...
  Plugin->call<UrApiKind::urMemBufferCreateWithNativeHandle>( MemObject,
...
SYCLMemObjT::SYCLMemObjT(ur_native_handle_t MemObject,
  ...
  Plugin->call<UrApiKind::urMemImageCreateWithNativeHandle>( MemObject,
...
size_t SYCLMemObjT::getBufSizeForContext(const ContextImplPtr &Context,
  ...
  Plugin->call<UrApiKind::urMemGetInfo>( detail::ur::cast<ur_mem_handle_t>(MemObject),
