...
bool kernel_impl::exceedsOccupancyResourceLimits(
  ...
  const auto MaxLocalMemorySizeInBytes =
  ...
  // It may be preferrable to have a "kernel_device_specific" query for this.
