...
// u_abs
SYCL_API s::cl_uchar u_abs(s::cl_uchar x) __NOEXC { return x; }
SYCL_API s::cl_ushort u_abs(s::cl_ushort x) __NOEXC { return x; }
SYCL_API s::cl_uint u_abs(s::cl_uint x) __NOEXC { return x; }
SYCL_API s::cl_ulong u_abs(s::cl_ulong x) __NOEXC { return x; }
...
// s_abs
SYCL_API s::cl_uchar s_abs(s::cl_char x) __NOEXC { return std::abs(x); }
SYCL_API s::cl_ushort s_abs(s::cl_short x) __NOEXC { return std::abs(x); }
SYCL_API s::cl_uint s_abs(s::cl_int x) __NOEXC { return std::abs(x); }
SYCL_API s::cl_ulong s_abs(s::cl_long x) __NOEXC { return std::abs(x); }
...
// u_abs_diff
SYCL_API s::cl_uchar u_abs_diff(s::cl_uchar x, s::cl_uchar y) __NOEXC {
  return __abs_diff(x, y);
}
SYCL_API s::cl_ushort u_abs_diff(s::cl_ushort x, s::cl_ushort y) __NOEXC {
  return __abs_diff(x, y);
}
SYCL_API s::cl_uint u_abs_diff(s::cl_uint x, s::cl_uint y) __NOEXC {
  return __abs_diff(x, y);
}
SYCL_API s::cl_ulong u_abs_diff(s::cl_ulong x, s::cl_ulong y) __NOEXC {
  return __abs_diff(x, y);
}
...
// s_abs_diff
SYCL_API s::cl_uchar s_abs_diff(s::cl_char x, s::cl_char y) __NOEXC {
  return __abs_diff(x, y);
}
SYCL_API s::cl_ushort s_abs_diff(s::cl_short x, s::cl_short y) __NOEXC {
  return __abs_diff(x, y);
}
SYCL_API s::cl_uint s_abs_diff(s::cl_int x, s::cl_int y) __NOEXC {
  return __abs_diff(x, y);
}
SYCL_API s::cl_ulong s_abs_diff(s::cl_long x, s::cl_long y) __NOEXC {
  return __abs_diff(x, y);
}
...
// u_add_sat
SYCL_API s::cl_uchar u_add_sat(s::cl_uchar x, s::cl_uchar y) __NOEXC {
  return __u_add_sat(x, y);
}
SYCL_API s::cl_ushort u_add_sat(s::cl_ushort x, s::cl_ushort y) __NOEXC {
  return __u_add_sat(x, y);
}
SYCL_API s::cl_uint u_add_sat(s::cl_uint x, s::cl_uint y) __NOEXC {
  return __u_add_sat(x, y);
}
SYCL_API s::cl_ulong u_add_sat(s::cl_ulong x, s::cl_ulong y) __NOEXC {
  return __u_add_sat(x, y);
}
...
// s_add_sat
SYCL_API s::cl_char s_add_sat(s::cl_char x, s::cl_char y) __NOEXC {
  return __s_add_sat(x, y);
}
SYCL_API s::cl_short s_add_sat(s::cl_short x, s::cl_short y) __NOEXC {
  return __s_add_sat(x, y);
}
SYCL_API s::cl_int s_add_sat(s::cl_int x, s::cl_int y) __NOEXC {
  return __s_add_sat(x, y);
}
SYCL_API s::cl_long s_add_sat(s::cl_long x, s::cl_long y) __NOEXC {
  return __s_add_sat(x, y);
}
...
// u_hadd
SYCL_API s::cl_uchar u_hadd(s::cl_uchar x, s::cl_uchar y) __NOEXC {
  return __hadd(x, y);
}
SYCL_API s::cl_ushort u_hadd(s::cl_ushort x, s::cl_ushort y) __NOEXC {
  return __hadd(x, y);
}
SYCL_API s::cl_uint u_hadd(s::cl_uint x, s::cl_uint y) __NOEXC {
  return __hadd(x, y);
}
SYCL_API s::cl_ulong u_hadd(s::cl_ulong x, s::cl_ulong y) __NOEXC {
  return __hadd(x, y);
}
...
// s_hadd
SYCL_API s::cl_char s_hadd(s::cl_char x, s::cl_char y) __NOEXC {
  return __hadd(x, y);
}
SYCL_API s::cl_short s_hadd(s::cl_short x, s::cl_short y) __NOEXC {
  return __hadd(x, y);
}
SYCL_API s::cl_int s_hadd(s::cl_int x, s::cl_int y) __NOEXC {
  return __hadd(x, y);
}
SYCL_API s::cl_long s_hadd(s::cl_long x, s::cl_long y) __NOEXC {
  return __hadd(x, y);
}
...
// u_rhadd
SYCL_API s::cl_uchar u_rhadd(s::cl_uchar x, s::cl_uchar y) __NOEXC {
  return __rhadd(x, y);
}
SYCL_API s::cl_ushort u_rhadd(s::cl_ushort x, s::cl_ushort y) __NOEXC {
  return __rhadd(x, y);
}
SYCL_API s::cl_uint u_rhadd(s::cl_uint x, s::cl_uint y) __NOEXC {
  return __rhadd(x, y);
}
SYCL_API s::cl_ulong u_rhadd(s::cl_ulong x, s::cl_ulong y) __NOEXC {
  return __rhadd(x, y);
}
...
// s_rhadd
SYCL_API s::cl_char s_rhadd(s::cl_char x, s::cl_char y) __NOEXC {
  return __rhadd(x, y);
}
SYCL_API s::cl_short s_rhadd(s::cl_short x, s::cl_short y) __NOEXC {
  return __rhadd(x, y);
}
SYCL_API s::cl_int s_rhadd(s::cl_int x, s::cl_int y) __NOEXC {
  return __rhadd(x, y);
}
SYCL_API s::cl_long s_rhadd(s::cl_long x, s::cl_long y) __NOEXC {
  return __rhadd(x, y);
}
...
// u_clamp
SYCL_API s::cl_uchar u_clamp(s::cl_uchar x, s::cl_uchar minval,
                             s::cl_uchar maxval) __NOEXC {
  return __clamp(x, minval, maxval);
}
SYCL_API s::cl_ushort u_clamp(s::cl_ushort x, s::cl_ushort minval,
                              s::cl_ushort maxval) __NOEXC {
  return __clamp(x, minval, maxval);
}
SYCL_API s::cl_uint u_clamp(s::cl_uint x, s::cl_uint minval,
                            s::cl_uint maxval) __NOEXC {
  return __clamp(x, minval, maxval);
}
SYCL_API s::cl_ulong u_clamp(s::cl_ulong x, s::cl_ulong minval,
...
// s_clamp
SYCL_API s::cl_char s_clamp(s::cl_char x, s::cl_char minval,
                            s::cl_char maxval) __NOEXC {
  return __clamp(x, minval, maxval);
}
SYCL_API s::cl_short s_clamp(s::cl_short x, s::cl_short minval,
                             s::cl_short maxval) __NOEXC {
  return __clamp(x, minval, maxval);
}
SYCL_API s::cl_int s_clamp(s::cl_int x, s::cl_int minval,
                           s::cl_int maxval) __NOEXC {
  return __clamp(x, minval, maxval);
}
SYCL_API s::cl_long s_clamp(s::cl_long x, s::cl_long minval,
...
// clz
SYCL_API s::cl_uchar clz(s::cl_uchar x) __NOEXC { return __clz(x); }
SYCL_API s::cl_char clz(s::cl_char x) __NOEXC { return __clz(x); }
SYCL_API s::cl_ushort clz(s::cl_ushort x) __NOEXC { return __clz(x); }
SYCL_API s::cl_short clz(s::cl_short x) __NOEXC { return __clz(x); }
SYCL_API s::cl_uint clz(s::cl_uint x) __NOEXC { return __clz(x); }
SYCL_API s::cl_int clz(s::cl_int x) __NOEXC { return __clz(x); }
SYCL_API s::cl_ulong clz(s::cl_ulong x) __NOEXC { return __clz(x); }
SYCL_API s::cl_long clz(s::cl_long x) __NOEXC { return __clz(x); }
...
// ctz
SYCL_API s::cl_uchar ctz(s::cl_uchar x) __NOEXC { return __ctz(x); }
SYCL_API s::cl_char ctz(s::cl_char x) __NOEXC { return __ctz(x); }
SYCL_API s::cl_ushort ctz(s::cl_ushort x) __NOEXC { return __ctz(x); }
SYCL_API s::cl_short ctz(s::cl_short x) __NOEXC { return __ctz(x); }
SYCL_API s::cl_uint ctz(s::cl_uint x) __NOEXC { return __ctz(x); }
SYCL_API s::cl_int ctz(s::cl_int x) __NOEXC { return __ctz(x); }
SYCL_API s::cl_ulong ctz(s::cl_ulong x) __NOEXC { return __ctz(x); }
SYCL_API s::cl_long ctz(s::cl_long x) __NOEXC { return __ctz(x); }
...
// s_mul_hi
SYCL_API s::cl_char s_mul_hi(s::cl_char a, s::cl_char b) {
  return __mul_hi(a, b);
}
SYCL_API s::cl_short s_mul_hi(s::cl_short a, s::cl_short b) {
  return __mul_hi(a, b);
}
SYCL_API s::cl_int s_mul_hi(s::cl_int a, s::cl_int b) { return __mul_hi(a, b); }
SYCL_API s::cl_long s_mul_hi(s::cl_long x, s::cl_long y) __NOEXC {
...
// u_mul_hi
SYCL_API s::cl_uchar u_mul_hi(s::cl_uchar a, s::cl_uchar b) {
  return __mul_hi(a, b);
}
SYCL_API s::cl_ushort u_mul_hi(s::cl_ushort a, s::cl_ushort b) {
  return __mul_hi(a, b);
}
SYCL_API s::cl_uint u_mul_hi(s::cl_uint a, s::cl_uint b) {
  return __mul_hi(a, b);
}
SYCL_API s::cl_ulong u_mul_hi(s::cl_ulong x, s::cl_ulong y) __NOEXC {
...
// s_mad_hi
SYCL_API s::cl_char s_mad_hi(s::cl_char x, s::cl_char minval,
                             s::cl_char maxval) __NOEXC {
  return __mad_hi(x, minval, maxval);
}
SYCL_API s::cl_short s_mad_hi(s::cl_short x, s::cl_short minval,
                              s::cl_short maxval) __NOEXC {
  return __mad_hi(x, minval, maxval);
}
SYCL_API s::cl_int s_mad_hi(s::cl_int x, s::cl_int minval,
                            s::cl_int maxval) __NOEXC {
  return __mad_hi(x, minval, maxval);
}
SYCL_API s::cl_long s_mad_hi(s::cl_long x, s::cl_long minval,
                             s::cl_long maxval) __NOEXC {
...
// u_mad_hi
SYCL_API s::cl_uchar u_mad_hi(s::cl_uchar x, s::cl_uchar minval,
                              s::cl_uchar maxval) __NOEXC {
  return __mad_hi(x, minval, maxval);
}
SYCL_API s::cl_ushort u_mad_hi(s::cl_ushort x, s::cl_ushort minval,
                               s::cl_ushort maxval) __NOEXC {
  return __mad_hi(x, minval, maxval);
}
SYCL_API s::cl_uint u_mad_hi(s::cl_uint x, s::cl_uint minval,
                             s::cl_uint maxval) __NOEXC {
  return __mad_hi(x, minval, maxval);
}
SYCL_API s::cl_ulong u_mad_hi(s::cl_ulong x, s::cl_ulong minval,
                              s::cl_ulong maxval) __NOEXC {
...
// s_mad_sat
SYCL_API s::cl_char s_mad_sat(s::cl_char a, s::cl_char b,
                              s::cl_char c) __NOEXC {
  return __s_mad_sat(a, b, c);
}
SYCL_API s::cl_short s_mad_sat(s::cl_short a, s::cl_short b,
                               s::cl_short c) __NOEXC {
  return __s_mad_sat(a, b, c);
}
SYCL_API s::cl_int s_mad_sat(s::cl_int a, s::cl_int b, s::cl_int c) __NOEXC {
  return __s_mad_sat(a, b, c);
}
SYCL_API s::cl_long s_mad_sat(s::cl_long a, s::cl_long b,
                              s::cl_long c) __NOEXC {
...
// u_mad_sat
SYCL_API s::cl_uchar u_mad_sat(s::cl_uchar a, s::cl_uchar b,
                               s::cl_uchar c) __NOEXC {
  return __u_mad_sat(a, b, c);
}
SYCL_API s::cl_ushort u_mad_sat(s::cl_ushort a, s::cl_ushort b,
                                s::cl_ushort c) __NOEXC {
  return __u_mad_sat(a, b, c);
}
SYCL_API s::cl_uint u_mad_sat(s::cl_uint a, s::cl_uint b,
                              s::cl_uint c) __NOEXC {
  return __u_mad_sat(a, b, c);
}
SYCL_API s::cl_ulong u_mad_sat(s::cl_ulong a, s::cl_ulong b,
...
// s_max
SYCL_API s::cl_char s_max(s::cl_char x, s::cl_char y) __NOEXC {
  return std::max(x, y);
}
SYCL_API s::cl_short s_max(s::cl_short x, s::cl_short y) __NOEXC {
  return std::max(x, y);
}
SYCL_API s::cl_int s_max(s::cl_int x, s::cl_int y) __NOEXC {
  return std::max(x, y);
}
SYCL_API s::cl_long s_max(s::cl_long x, s::cl_long y) __NOEXC {
  return std::max(x, y);
}
...
// u_max
SYCL_API s::cl_uchar u_max(s::cl_uchar x, s::cl_uchar y) __NOEXC {
  return std::max(x, y);
}
SYCL_API s::cl_ushort u_max(s::cl_ushort x, s::cl_ushort y) __NOEXC {
  return std::max(x, y);
}
SYCL_API s::cl_uint u_max(s::cl_uint x, s::cl_uint y) __NOEXC {
  return std::max(x, y);
}
SYCL_API s::cl_ulong u_max(s::cl_ulong x, s::cl_ulong y) __NOEXC {
  return std::max(x, y);
}
...
// s_min
SYCL_API s::cl_char s_min(s::cl_char x, s::cl_char y) __NOEXC {
  return std::min(x, y);
}
SYCL_API s::cl_short s_min(s::cl_short x, s::cl_short y) __NOEXC {
  return std::min(x, y);
}
SYCL_API s::cl_int s_min(s::cl_int x, s::cl_int y) __NOEXC {
  return std::min(x, y);
}
SYCL_API s::cl_long s_min(s::cl_long x, s::cl_long y) __NOEXC {
  return std::min(x, y);
}
...
// u_min
SYCL_API s::cl_uchar u_min(s::cl_uchar x, s::cl_uchar y) __NOEXC {
  return std::min(x, y);
}
SYCL_API s::cl_ushort u_min(s::cl_ushort x, s::cl_ushort y) __NOEXC {
  return std::min(x, y);
}
SYCL_API s::cl_uint u_min(s::cl_uint x, s::cl_uint y) __NOEXC {
  return std::min(x, y);
}
SYCL_API s::cl_ulong u_min(s::cl_ulong x, s::cl_ulong y) __NOEXC {
  return std::min(x, y);
}
...
// rotate
SYCL_API s::cl_uchar rotate(s::cl_uchar x, s::cl_uchar y) __NOEXC {
  return __rotate(x, y);
}
SYCL_API s::cl_ushort rotate(s::cl_ushort x, s::cl_ushort y) __NOEXC {
  return __rotate(x, y);
}
SYCL_API s::cl_uint rotate(s::cl_uint x, s::cl_uint y) __NOEXC {
  return __rotate(x, y);
}
SYCL_API s::cl_ulong rotate(s::cl_ulong x, s::cl_ulong y) __NOEXC {
  return __rotate(x, y);
}
SYCL_API s::cl_char rotate(s::cl_char x, s::cl_char y) __NOEXC {
  return __rotate(x, y);
}
SYCL_API s::cl_short rotate(s::cl_short x, s::cl_short y) __NOEXC {
  return __rotate(x, y);
}
SYCL_API s::cl_int rotate(s::cl_int x, s::cl_int y) __NOEXC {
  return __rotate(x, y);
}
SYCL_API s::cl_long rotate(s::cl_long x, s::cl_long y) __NOEXC {
  return __rotate(x, y);
}
...
// u_sub_sat
SYCL_API s::cl_uchar u_sub_sat(s::cl_uchar x, s::cl_uchar y) __NOEXC {
  return __u_sub_sat(x, y);
}
SYCL_API s::cl_ushort u_sub_sat(s::cl_ushort x, s::cl_ushort y) __NOEXC {
  return __u_sub_sat(x, y);
}
SYCL_API s::cl_uint u_sub_sat(s::cl_uint x, s::cl_uint y) __NOEXC {
  return __u_sub_sat(x, y);
}
SYCL_API s::cl_ulong u_sub_sat(s::cl_ulong x, s::cl_ulong y) __NOEXC {
  return __u_sub_sat(x, y);
}
...
// s_sub_sat
SYCL_API s::cl_char s_sub_sat(s::cl_char x, s::cl_char y) __NOEXC {
  return __s_sub_sat(x, y);
}
SYCL_API s::cl_short s_sub_sat(s::cl_short x, s::cl_short y) __NOEXC {
  return __s_sub_sat(x, y);
}
SYCL_API s::cl_int s_sub_sat(s::cl_int x, s::cl_int y) __NOEXC {
  return __s_sub_sat(x, y);
}
SYCL_API s::cl_long s_sub_sat(s::cl_long x, s::cl_long y) __NOEXC {
  return __s_sub_sat(x, y);
}
...
// u_upsample
SYCL_API s::cl_ushort u_upsample(s::cl_uchar x, s::cl_uchar y) __NOEXC {
  return __upsample(x, y);
}
SYCL_API s::cl_uint u_upsample(s::cl_ushort x, s::cl_ushort y) __NOEXC {
  return __upsample(x, y);
}
SYCL_API s::cl_ulong u_upsample(s::cl_uint x, s::cl_uint y) __NOEXC {
  return __upsample(x, y);
}
...
SYCL_API s::cl_short s_upsample(s::cl_char x, s::cl_uchar y) __NOEXC {
  return __upsample(x, y);
}
SYCL_API s::cl_int s_upsample(s::cl_short x, s::cl_ushort y) __NOEXC {
  return __upsample(x, y);
}
SYCL_API s::cl_long s_upsample(s::cl_int x, s::cl_uint y) __NOEXC {
  return __upsample(x, y);
}
...
// popcount
SYCL_API s::cl_uchar popcount(s::cl_uchar x) __NOEXC { return __popcount(x); }
SYCL_API s::cl_ushort popcount(s::cl_ushort x) __NOEXC { return __popcount(x); }
SYCL_API s::cl_uint popcount(s::cl_uint x) __NOEXC { return __popcount(x); }
SYCL_API s::cl_ulong popcount(s::cl_ulong x) __NOEXC { return __popcount(x); }
...
SYCL_API s::cl_char popcount(s::cl_char x) __NOEXC { return __popcount(x); }
SYCL_API s::cl_short popcount(s::cl_short x) __NOEXC { return __popcount(x); }
SYCL_API s::cl_int popcount(s::cl_int x) __NOEXC { return __popcount(x); }
SYCL_API s::cl_long popcount(s::cl_long x) __NOEXC { return __popcount(x); }
...
// u_mad24
SYCL_API s::cl_uint u_mad24(s::cl_uint x, s::cl_uint y, s::cl_uint z) __NOEXC {
  return __mad24(x, y, z);
}
MAKE_1V_2V_3V(u_mad24, s::cl_uint, s::cl_uint, s::cl_uint, s::cl_uint)

// s_mad24
SYCL_API s::cl_int s_mad24(s::cl_int x, s::cl_int y, s::cl_int z) __NOEXC {
  return __mad24(x, y, z);
}
MAKE_1V_2V_3V(s_mad24, s::cl_int, s::cl_int, s::cl_int, s::cl_int)

// u_mul24
SYCL_API s::cl_uint u_mul24(s::cl_uint x, s::cl_uint y) __NOEXC {
  return __mul24(x, y);
}
MAKE_1V_2V(u_mul24, s::cl_uint, s::cl_uint, s::cl_uint)

// s_mul24
SYCL_API s::cl_int s_mul24(s::cl_int x, s::cl_int y) __NOEXC {
  return __mul24(x, y);
}
