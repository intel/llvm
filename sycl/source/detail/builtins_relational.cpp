...
// FOrdEqual-isequal
SYCL_API s::cl_int FOrdEqual(s::cl_float x, s::cl_float y) __NOEXC {
  return __sFOrdEqual(x, y);
}
SYCL_API s::cl_int FOrdEqual(s::cl_double x, s::cl_double y) __NOEXC {
  return __sFOrdEqual(x, y);
}
SYCL_API s::cl_int FOrdEqual(s::cl_half x, s::cl_half y) __NOEXC {
  return __sFOrdEqual(x, y);
}
...
SYCL_API s::cl_int FUnordNotEqual(s::cl_float x, s::cl_float y) __NOEXC {
  return __sFUnordNotEqual(x, y);
}
SYCL_API s::cl_int FUnordNotEqual(s::cl_double x, s::cl_double y) __NOEXC {
  return __sFUnordNotEqual(x, y);
}
SYCL_API s::cl_int FUnordNotEqual(s::cl_half x, s::cl_half y) __NOEXC {
  return __sFUnordNotEqual(x, y);
}
...
SYCL_API s::cl_int FOrdGreaterThan(s::cl_float x, s::cl_float y) __NOEXC {
  return __sFOrdGreaterThan(x, y);
}
SYCL_API s::cl_int FOrdGreaterThan(s::cl_double x, s::cl_double y) __NOEXC {
  return __sFOrdGreaterThan(x, y);
}
SYCL_API s::cl_int FOrdGreaterThan(s::cl_half x, s::cl_half y) __NOEXC {
  return __sFOrdGreaterThan(x, y);
}
...
SYCL_API s::cl_int FOrdGreaterThanEqual(s::cl_float x, s::cl_float y) __NOEXC {
  return __sFOrdGreaterThanEqual(x, y);
}
SYCL_API s::cl_int FOrdGreaterThanEqual(s::cl_double x,
                                        s::cl_double y) __NOEXC {
  return __sFOrdGreaterThanEqual(x, y);
}
SYCL_API s::cl_int FOrdGreaterThanEqual(s::cl_half x, s::cl_half y) __NOEXC {
  return __sFOrdGreaterThanEqual(x, y);
}
...
// (FOrdLessThan)         // isless
SYCL_API s::cl_int FOrdLessThan(s::cl_float x, s::cl_float y) __NOEXC {
  return (x < y);
}
SYCL_API s::cl_int FOrdLessThan(s::cl_double x, s::cl_double y) __NOEXC {
  return (x < y);
}
SYCL_API s::cl_int __vFOrdLessThan(s::cl_float x, s::cl_float y) __NOEXC {
  return -(x < y);
}
SYCL_API s::cl_long __vFOrdLessThan(s::cl_double x, s::cl_double y) __NOEXC {
  return -(x < y);
}
SYCL_API s::cl_int FOrdLessThan(s::cl_half x, s::cl_half y) __NOEXC {
  return (x < y);
}
SYCL_API s::cl_short __vFOrdLessThan(s::cl_half x, s::cl_half y) __NOEXC {
  return -(x < y);
}
...
SYCL_API s::cl_int FOrdLessThanEqual(s::cl_float x, s::cl_float y) __NOEXC {
  return __sFOrdLessThanEqual(x, y);
}
SYCL_API s::cl_int FOrdLessThanEqual(s::cl_double x, s::cl_double y) __NOEXC {
  return __sFOrdLessThanEqual(x, y);
}
SYCL_API s::cl_int FOrdLessThanEqual(s::cl_half x, s::cl_half y) __NOEXC {
  return __sFOrdLessThanEqual(x, y);
}
...
SYCL_API s::cl_int LessOrGreater(s::cl_float x, s::cl_float y) __NOEXC {
  return __sLessOrGreater(x, y);
}
SYCL_API s::cl_int LessOrGreater(s::cl_double x, s::cl_double y) __NOEXC {
  return __sLessOrGreater(x, y);
}
SYCL_API s::cl_int LessOrGreater(s::cl_half x, s::cl_half y) __NOEXC {
  return __sLessOrGreater(x, y);
}
...
// (IsFinite)             // isfinite
SYCL_API s::cl_int IsFinite(s::cl_float x) __NOEXC { return std::isfinite(x); }
SYCL_API s::cl_int IsFinite(s::cl_double x) __NOEXC { return std::isfinite(x); }
SYCL_API s::cl_int __vIsFinite(s::cl_float x) __NOEXC {
  return -static_cast<s::cl_int>(std::isfinite(x));
}
SYCL_API s::cl_long __vIsFinite(s::cl_double x) __NOEXC {
  return -static_cast<s::cl_long>(std::isfinite(x));
}
SYCL_API s::cl_int IsFinite(s::cl_half x) __NOEXC {
  return std::isfinite(d::cast_if_host_half(x));
}
SYCL_API s::cl_short __vIsFinite(s::cl_half x) __NOEXC {
...
// (IsInf)                // isinf
SYCL_API s::cl_int IsInf(s::cl_float x) __NOEXC { return std::isinf(x); }
SYCL_API s::cl_int IsInf(s::cl_double x) __NOEXC { return std::isinf(x); }
SYCL_API s::cl_int __vIsInf(s::cl_float x) __NOEXC {
  return -static_cast<s::cl_int>(std::isinf(x));
}
SYCL_API s::cl_long __vIsInf(s::cl_double x) __NOEXC {
  return -static_cast<s::cl_long>(std::isinf(x));
}
SYCL_API s::cl_int IsInf(s::cl_half x) __NOEXC {
  return std::isinf(d::cast_if_host_half(x));
}
SYCL_API s::cl_short __vIsInf(s::cl_half x) __NOEXC {
...
// (IsNan)                // isnan
SYCL_API s::cl_int IsNan(s::cl_float x) __NOEXC { return std::isnan(x); }
SYCL_API s::cl_int IsNan(s::cl_double x) __NOEXC { return std::isnan(x); }
SYCL_API s::cl_int __vIsNan(s::cl_float x) __NOEXC {
  return -static_cast<s::cl_int>(std::isnan(x));
}
SYCL_API s::cl_long __vIsNan(s::cl_double x) __NOEXC {
  return -static_cast<s::cl_long>(std::isnan(x));
}

SYCL_API s::cl_int IsNan(s::cl_half x) __NOEXC {
  return std::isnan(d::cast_if_host_half(x));
}
SYCL_API s::cl_short __vIsNan(s::cl_half x) __NOEXC {
...
// (IsNormal)             // isnormal
SYCL_API s::cl_int IsNormal(s::cl_float x) __NOEXC { return std::isnormal(x); }
SYCL_API s::cl_int IsNormal(s::cl_double x) __NOEXC { return std::isnormal(x); }
SYCL_API s::cl_int __vIsNormal(s::cl_float x) __NOEXC {
  return -static_cast<s::cl_int>(std::isnormal(x));
}
SYCL_API s::cl_long __vIsNormal(s::cl_double x) __NOEXC {
  return -static_cast<s::cl_long>(std::isnormal(x));
}
SYCL_API s::cl_int IsNormal(s::cl_half x) __NOEXC {
  return std::isnormal(d::cast_if_host_half(x));
}
SYCL_API s::cl_short __vIsNormal(s::cl_half x) __NOEXC {
...
// (Ordered)              // isordered
SYCL_API s::cl_int Ordered(s::cl_float x, s::cl_float y) __NOEXC {
  return __vOrdered(x, y);
}
SYCL_API s::cl_int Ordered(s::cl_double x, s::cl_double y) __NOEXC {
  return __vOrdered(x, y);
}
SYCL_API s::cl_int Ordered(s::cl_half x, s::cl_half y) __NOEXC {
  return __vOrdered(x, y);
}
...
SYCL_API s::cl_int Unordered(s::cl_float x, s::cl_float y) __NOEXC {
  return __sUnordered(x, y);
}
SYCL_API s::cl_int Unordered(s::cl_double x, s::cl_double y) __NOEXC {
  return __sUnordered(x, y);
}
SYCL_API s::cl_int Unordered(s::cl_half x, s::cl_half y) __NOEXC {
  return __sUnordered(x, y);
}
...
// (SignBitSet)           // signbit
SYCL_API s::cl_int SignBitSet(s::cl_float x) __NOEXC { return std::signbit(x); }
SYCL_API s::cl_int SignBitSet(s::cl_double x) __NOEXC {
  return std::signbit(x);
}
SYCL_API s::cl_int __vSignBitSet(s::cl_float x) __NOEXC {
  return -static_cast<s::cl_int>(std::signbit(x));
}
SYCL_API s::cl_long __vSignBitSet(s::cl_double x) __NOEXC {
  return -static_cast<s::cl_long>(std::signbit(x));
}
SYCL_API s::cl_int SignBitSet(s::cl_half x) __NOEXC {
  return std::signbit(d::cast_if_host_half(x));
}
SYCL_API s::cl_short __vSignBitSet(s::cl_half x) __NOEXC {
