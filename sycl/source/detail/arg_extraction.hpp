//==--- arg_extraction.hpp --- SYCL kernel argument extraction utilities ---==//
//
...
void processArg(
  ...
  case kernel_param_kind_t::kind_pointer: {
    Args.emplace_back(Kind, Ptr, Size, Index + IndexShift);
    break;
  }
  case kernel_param_kind_t::kind_stream: {
    ...
    addArgsForGlobalAccessor(GBufReq, Index, IndexShift, Size,
                             IsKernelCreatedFromSource, GlobalSize, Args,
                             IsESIMD);
    ++IndexShift;
    ...
    addArgsForGlobalAccessor(GFlushReq, Index, IndexShift, Size,
                             ...
                             IsESIMD);
    ++IndexShift;
    Args.emplace_back(kernel_param_kind_t::kind_std_layout, &S->FlushBufferSize,
  ...
  case kernel_param_kind_t::kind_accessor: {
    ...
    case access::target::local: {
      ...
      addArgsForLocalAccessor(LAccImpl, Index, IndexShift,
                              IsKernelCreatedFromSource, Args, IsESIMD);
      break;
    }
    case access::target::image:
    case access::target::image_array: {
      detail::Requirement *AccImpl = static_cast<detail::Requirement *>(Ptr);
      Args.emplace_back(Kind, AccImpl, Size, Index + IndexShift);
  ...
  case kernel_param_kind_t::kind_dynamic_accessor: {
    ...
    case access::target::local: {
      ...
      DynamicParameters.emplace_back(DynParamImpl, Index + IndexShift);
      ...
      addArgsForLocalAccessor(&DynLocalAccessorImpl->LAccImplHost, Index,
                              IndexShift, IsKernelCreatedFromSource, Args,
                              IsESIMD);
      break;
    }
    default: {
  ...
  case kernel_param_kind_t::kind_work_group_memory: {
    Args.emplace_back(
        kernel_param_kind_t::kind_std_layout, nullptr,
        static_cast<detail::work_group_memory_impl *>(Ptr)->buffer_size,
        Index + IndexShift);
    break;
  }
  case kernel_param_kind_t::kind_sampler: {
    Args.emplace_back(kernel_param_kind_t::kind_sampler, Ptr, sizeof(sampler),
                      Index + IndexShift);
    break;
  }
  case kernel_param_kind_t::kind_specialization_constants_buffer: {
    Args.emplace_back(kernel_param_kind_t::kind_specialization_constants_buffer,
                      Ptr, Size, Index + IndexShift);
    break;
  }
...
void extractArgsAndReqsFromLambda(
    ...
    std::vector<ArgDesc> &Args) {
  size_t IndexShift = 0;
  Args.reserve(MaxNumAdditionalArgs * NumKernelParams);
  ...
  for (size_t I = 0; I < NumKernelParams; ++I) {
    ...
    if (Kind == detail::kernel_param_kind_t::kind_accessor) {
      ...
      validateDynamicParameterGraphState(QueueHasCommandGraph,
                                         IsGraphSubmission);
    ...
    processArg(Ptr, Kind, Size, I, IndexShift,
               /*IsKernelCreatedFromSource=*/false, IsESIMD, NDRDesc,
