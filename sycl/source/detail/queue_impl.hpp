...
public:
  ...
  queue_impl(const DeviceImplPtr &Device, const ContextImplPtr &Context,
    ...
    // Emit a queue_create notification; We do not get code location
    // information, so all queues will have the same UID with a different
    // instance ID until this gets added.
...
public:
  ...
  ~queue_impl() {
    ...
    // lifetime of the queue object as member variable.
