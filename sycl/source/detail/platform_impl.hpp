...
public:
  ...
  explicit platform_impl(ur_platform_handle_t APlatform,
    ...
    APlugin->call_nocheck<UrApiKind::urPlatformGetInfo>( APlatform,
  ...
  void getBackendOption(const char *frontend_option,
    ...
    ur_result_t Err = Plugin->call_nocheck<UrApiKind::urPlatformGetBackendOption>( MPlatform, frontend_option, backend_option);
  ...
  cl_platform_id get() const {
    ...
    getPlugin()->call<UrApiKind::urPlatformGetNativeHandle>( MPlatform, &nativeHandle);
