...
uint32_t queue_impl::get_info<info::queue::reference_count>() const {
  ...
  getPlugin()->call<UrApiKind::urQueueGetInfo>( MQueues[0], UR_QUEUE_INFO_REFERENCE_COUNT,
...
ur_native_handle_t queue_impl::getNative(int32_t &NativeHandleDesc) const {
  ...
  Plugin->call<UrApiKind::urQueueGetNativeHandle>( MQueues[0], &UrNativeDesc, &Handle);
  return Handle;
}
...
bool queue_impl::ext_oneapi_empty() const {
  ...
  getPlugin()->call<UrApiKind::urQueueGetInfo>( MQueues[0], UR_QUEUE_INFO_EMPTY,
