...
static ur_result_t SetKernelParamsAndLaunch(
    ...
    KernelNameStrRefT KernelName, const void *DirectArgs = nullptr,
    const int NumDirectArgs = 0,
...
void enqueueImpKernel(
    ...
    const RTDeviceBinaryImage *BinImage, const void *DirectArgs,
    const int NumDirectArgs,
  ...
  ur_result_t Error = UR_RESULT_SUCCESS;
  {
    ...
    Error = SetKernelParamsAndLaunch(
        ...
        BinImage, KernelName, DirectArgs, NumDirectArgs, ParamDescGetter);
