...
// the SYCL runtime. These are identified by being in the
// sycl::detail::__sycl_service_kernel__ namespace and are not given a unique
// kernel identifier and are not reported as part of kernel bundles.
static bool isServiceKernel(std::string KernelName) {
  return KernelName.rfind("_ZTSN2cl4sycl6detail23__sycl_service_kernel__", 0) !=
         std::string::npos;
}
