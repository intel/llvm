...
RT::PiProgram ProgramManager::getBuiltPIProgram(OSModuleHandle M,
  ...
  auto BuildF = [this, &M, &KSId, &Context, Prg, &CheckThatCompiled] {
    const RTDeviceBinaryImage &Img =
        getDeviceImage(M, KSId, Context, CheckThatCompiled);
