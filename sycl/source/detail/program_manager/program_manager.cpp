...
ProgramManager::getOrCreateURProgram(const RTDeviceBinaryImage &Img,
...
ur_program_handle_t ProgramManager::getBuiltURProgram(
  ...
  auto BuildF = [this, &Img, &Context, &ContextImpl, &Device, &CompileOpts,
    ...
    ProgramPtr ProgramManaged(
        NativePrg, urProgramRelease);//Plugin->getPiPlugin().PiFunctionTable.piProgramRelease);
  ...
  // program.
  ContextImpl->getPlugin()->call(urProgramRetain, BuildResult->Val);
...
static bool compatibleWithDevice(RTDeviceBinaryImage *BinImage,
  ...
  ur_result_t Error =
      Plugin->call_nocheck(urDeviceSelectBinary,
