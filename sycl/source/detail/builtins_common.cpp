...
template <typename T> SYCL_API inline T __fclamp(T x, T minval, T maxval) {
  return std::fmin(std::fmax(x, minval), maxval);
}

template <typename T> SYCL_API inline T __degrees(T radians) {
  return (180 / M_PI) * radians;
}

template <typename T> SYCL_API inline T __mix(T x, T y, T a) {
  return x + (y - x) * a;
}

template <typename T> SYCL_API inline T __radians(T degrees) {
  return (M_PI / 180) * degrees;
}

template <typename T> SYCL_API inline T __step(T edge, T x) {
  return (x < edge) ? 0.0 : 1.0;
}

template <typename T> SYCL_API inline T __smoothstep(T edge0, T edge1, T x) {
  T t;
...
template <typename T> SYCL_API inline T __sign(T x) {
...
// fclamp
SYCL_API s::cl_float fclamp(s::cl_float x, s::cl_float minval,
                            s::cl_float maxval) __NOEXC {
  return __fclamp(x, minval, maxval);
}
SYCL_API s::cl_double fclamp(s::cl_double x, s::cl_double minval,
                             s::cl_double maxval) __NOEXC {
  return __fclamp(x, minval, maxval);
}
SYCL_API s::cl_half fclamp(s::cl_half x, s::cl_half minval,
...
// degrees
SYCL_API s::cl_float degrees(s::cl_float radians) __NOEXC {
  return __degrees(radians);
}
SYCL_API s::cl_double degrees(s::cl_double radians) __NOEXC {
  return __degrees(radians);
}
SYCL_API s::cl_half degrees(s::cl_half radians) __NOEXC {
  return __degrees(radians);
}
...
// fmin_common
SYCL_API s::cl_float fmin_common(s::cl_float x, s::cl_float y) __NOEXC {
  return std::fmin(x, y);
}
SYCL_API s::cl_double fmin_common(s::cl_double x, s::cl_double y) __NOEXC {
  return std::fmin(x, y);
}
SYCL_API s::cl_half fmin_common(s::cl_half x, s::cl_half y) __NOEXC {
  return std::fmin(x, y);
}
...
// fmax_common
SYCL_API s::cl_float fmax_common(s::cl_float x, s::cl_float y) __NOEXC {
  return std::fmax(x, y);
}
SYCL_API s::cl_double fmax_common(s::cl_double x, s::cl_double y) __NOEXC {
  return std::fmax(x, y);
}
SYCL_API s::cl_half fmax_common(s::cl_half x, s::cl_half y) __NOEXC {
  return std::fmax(x, y);
}
...
// mix
SYCL_API s::cl_float mix(s::cl_float x, s::cl_float y, s::cl_float a) __NOEXC {
  return __mix(x, y, a);
}
SYCL_API s::cl_double mix(s::cl_double x, s::cl_double y,
                          s::cl_double a) __NOEXC {
  return __mix(x, y, a);
}
SYCL_API s::cl_half mix(s::cl_half x, s::cl_half y, s::cl_half a) __NOEXC {
  return __mix(x, y, a);
}
...
// radians
SYCL_API s::cl_float radians(s::cl_float degrees) __NOEXC {
  return __radians(degrees);
}
SYCL_API s::cl_double radians(s::cl_double degrees) __NOEXC {
  return __radians(degrees);
}
SYCL_API s::cl_half radians(s::cl_half degrees) __NOEXC {
  return __radians(degrees);
}
...
// step
SYCL_API s::cl_float step(s::cl_float edge, s::cl_float x) __NOEXC {
  return __step(edge, x);
}
SYCL_API s::cl_double step(s::cl_double edge, s::cl_double x) __NOEXC {
  return __step(edge, x);
}
SYCL_API s::cl_half step(s::cl_half edge, s::cl_half x) __NOEXC {
  return __step(edge, x);
}
...
// smoothstep
SYCL_API s::cl_float smoothstep(s::cl_float edge0, s::cl_float edge1,
                                s::cl_float x) __NOEXC {
  return __smoothstep(edge0, edge1, x);
}
SYCL_API s::cl_double smoothstep(s::cl_double edge0, s::cl_double edge1,
                                 s::cl_double x) __NOEXC {
  return __smoothstep(edge0, edge1, x);
}
SYCL_API s::cl_half smoothstep(s::cl_half edge0, s::cl_half edge1,
                               s::cl_half x) __NOEXC {
  return __smoothstep(edge0, edge1, x);
}
...
// sign
SYCL_API s::cl_float sign(s::cl_float x) __NOEXC { return __sign(x); }
SYCL_API s::cl_double sign(s::cl_double x) __NOEXC { return __sign(x); }
SYCL_API s::cl_half sign(s::cl_half x) __NOEXC { return __sign(x); }
