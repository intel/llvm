...
class queue_impl;
using QueueImplPtr = std::shared_ptr<__sycl_internal::__v1::detail::queue_impl>;
...
public:
  ...
  void wait(std::shared_ptr<__sycl_internal::__v1::detail::event_impl> Self) const;
  ...
  ///
  /// \param Self is a pointer to this event.
  void wait_and_throw(std::shared_ptr<__sycl_internal::__v1::detail::event_impl> Self);
