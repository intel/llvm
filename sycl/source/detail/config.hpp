...
template <ConfigID Config> class CommonReductionMaxWGSYCLConfig {
  using BaseT = SYCLConfigBase<Config>;
    ...
    static size_t Value = []() {
      ...
      try {
        ...
        throw sycl::exception(
            ...
            "Invalid value for " + std::string{BaseT::MConfigName} +
...
template <>
class SYCLConfig<SYCL_REDUCTION_PREFERRED_WORKGROUP_SIZE_CPU>
    : public CommonReductionMaxWGSYCLConfig<
          SYCL_REDUCTION_PREFERRED_WORKGROUP_SIZE_CPU> {};

template <>
class SYCLConfig<SYCL_REDUCTION_PREFERRED_WORKGROUP_SIZE_GPU>
    : public CommonReductionMaxWGSYCLConfig<
          SYCL_REDUCTION_PREFERRED_WORKGROUP_SIZE_GPU> {};

template <>
class SYCLConfig<SYCL_REDUCTION_PREFERRED_WORKGROUP_SIZE_ACC>
    : public CommonReductionMaxWGSYCLConfig<
