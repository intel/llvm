...
#define CHECK_UR_SUCCESS(Call)                                                 \
  ...
  // Implemented in UR; see EnvironmentVariables.md.
...
#define _UR_ERRC_WITH_MSG(NAME, MSG)                                           \
  case NAME:                                                                   \
    ...
    _UR_ERRC(UR_RESULT_ERROR_INVALID_GRAPH)
    _UR_ERRC(UR_RESULT_ERROR_GRAPH_CAPTURE_UNSUPPORTED)
    _UR_ERRC(UR_RESULT_ERROR_GRAPH_CAPTURE_INVALIDATED)
    _UR_ERRC(UR_RESULT_ERROR_GRAPH_CAPTURE_MERGE_ATTEMPT)
    _UR_ERRC(UR_RESULT_ERROR_COMMAND_LIST_NOT_CAPTURING)
    _UR_ERRC(UR_RESULT_ERROR_GRAPH_UNJOINED_FORKS)
