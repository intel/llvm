...
SYCL_API void __spirv_GroupWaitEvents(__spv::Scope Execution,
                                      uint32_t NumEvents,
                                      __ocl_event_t *WaitEvents) noexcept {}

SYCL_API void __spirv_ControlBarrier(__spv::Scope Execution,
                                     __spv::Scope Memory,
...
SYCL_API void __spirv_MemoryBarrier(__spv::Scope Memory,
                                    uint32_t Semantics) noexcept {
...
SYCL_API void __spirv_ocl_prefetch(const char *Ptr, size_t NumBytes) noexcept {
