...
void queue::submit_no_handler_impl(nd_range<Dims> Range, const char *KernelName, void *KernelFunc,
  ...
  impl->submit_no_handler(NDRDesc, KernelName, KernelFunc, KernelNumParams,
    KernelParamDescGetter, KernelNameBasedCachePtr);
}

template<int Dims>
event queue::submit_no_handler_impl_v2(
  ...
  std::shared_ptr<detail::event_impl> EventImpl = impl->submit_no_handler_v2(
...
template<int Dims>
void queue::submit_no_handler_impl(nd_range<Dims> Range,
...
template event queue::submit_no_handler_impl_v2<1>(
  nd_range<1> Range, const char *KernelName, void *KernelFunc,
  int KernelNumParams, detail::kernel_param_desc_t (*KernelParamDescGetter)(int),
  detail::KernelNameBasedCacheT *KernelNameBasedCachePtr,
  std::vector<event> &DepEvents) const;

template event queue::submit_no_handler_impl_v2<2>(
  nd_range<2> Range, const char *KernelName, void *KernelFunc,
  int KernelNumParams, detail::kernel_param_desc_t (*KernelParamDescGetter)(int),
  detail::KernelNameBasedCacheT *KernelNameBasedCachePtr,
  std::vector<event> &DepEvents) const;

template event queue::submit_no_handler_impl_v2<3>(
  nd_range<3> Range, const char *KernelName, void *KernelFunc,
  int KernelNumParams, detail::kernel_param_desc_t (*KernelParamDescGetter)(int),
  detail::KernelNameBasedCacheT *KernelNameBasedCachePtr,
  std::vector<event> &DepEvents) const;

template void queue::submit_no_handler_impl<1>(nd_range<1> Range,
  detail::FastKernelCacheValPtr &KernelCacheVal, std::vector<event> &DepEvents) const;
template void queue::submit_no_handler_impl<2>(nd_range<2> Range,
  detail::FastKernelCacheValPtr &KernelCacheVal, std::vector<event> &DepEvents) const;
template void queue::submit_no_handler_impl<3>(nd_range<3> Range,
  detail::FastKernelCacheValPtr &KernelCacheVal, std::vector<event> &DepEvents) const;
