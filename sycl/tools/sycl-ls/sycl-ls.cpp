...
#define __ARCH(ARCH)                                                           \
  case syclex::architecture::ARCH:                                             \
    return #ARCH;
      __ARCH(x86_64)
      __ARCH(intel_cpu_spr)
      __ARCH(intel_cpu_gnr)
      __ARCH(intel_gpu_bdw)
      __ARCH(intel_gpu_skl)
      __ARCH(intel_gpu_kbl)
      __ARCH(intel_gpu_cfl)
      __ARCH(intel_gpu_apl)
      __ARCH(intel_gpu_glk)
      __ARCH(intel_gpu_whl)
      __ARCH(intel_gpu_aml)
      __ARCH(intel_gpu_cml)
      __ARCH(intel_gpu_icllp)
      __ARCH(intel_gpu_ehl)
      __ARCH(intel_gpu_tgllp)
      __ARCH(intel_gpu_rkl)
      __ARCH(intel_gpu_adl_s)
      __ARCH(intel_gpu_adl_p)
      __ARCH(intel_gpu_adl_n)
      __ARCH(intel_gpu_dg1)
      __ARCH(intel_gpu_acm_g10)
      __ARCH(intel_gpu_acm_g11)
      __ARCH(intel_gpu_acm_g12)
      __ARCH(intel_gpu_pvc)
      __ARCH(intel_gpu_pvc_vg)
      __ARCH(intel_gpu_mtl_u)
      __ARCH(intel_gpu_mtl_h)
      __ARCH(intel_gpu_arl_h)
      __ARCH(intel_gpu_bmg_g21)
      __ARCH(intel_gpu_lnl_m)
      __ARCH(nvidia_gpu_sm_50)
      __ARCH(nvidia_gpu_sm_52)
      __ARCH(nvidia_gpu_sm_53)
      __ARCH(nvidia_gpu_sm_60)
      __ARCH(nvidia_gpu_sm_61)
      __ARCH(nvidia_gpu_sm_62)
      __ARCH(nvidia_gpu_sm_70)
      __ARCH(nvidia_gpu_sm_72)
      __ARCH(nvidia_gpu_sm_75)
      __ARCH(nvidia_gpu_sm_80)
      __ARCH(nvidia_gpu_sm_86)
      __ARCH(nvidia_gpu_sm_87)
      __ARCH(nvidia_gpu_sm_89)
      __ARCH(nvidia_gpu_sm_90)
      __ARCH(amd_gpu_gfx700)
      __ARCH(amd_gpu_gfx701)
      __ARCH(amd_gpu_gfx702)
      __ARCH(amd_gpu_gfx801)
      __ARCH(amd_gpu_gfx802)
      __ARCH(amd_gpu_gfx803)
      __ARCH(amd_gpu_gfx805)
      __ARCH(amd_gpu_gfx810)
      __ARCH(amd_gpu_gfx900)
      __ARCH(amd_gpu_gfx902)
      __ARCH(amd_gpu_gfx904)
      __ARCH(amd_gpu_gfx906)
      __ARCH(amd_gpu_gfx908)
      __ARCH(amd_gpu_gfx909)
      __ARCH(amd_gpu_gfx90a)
      __ARCH(amd_gpu_gfx90c)
      __ARCH(amd_gpu_gfx940)
      __ARCH(amd_gpu_gfx941)
      __ARCH(amd_gpu_gfx942)
      __ARCH(amd_gpu_gfx1010)
      __ARCH(amd_gpu_gfx1011)
      __ARCH(amd_gpu_gfx1012)
      __ARCH(amd_gpu_gfx1013)
      __ARCH(amd_gpu_gfx1030)
      __ARCH(amd_gpu_gfx1031)
      __ARCH(amd_gpu_gfx1032)
      __ARCH(amd_gpu_gfx1033)
      __ARCH(amd_gpu_gfx1034)
      __ARCH(amd_gpu_gfx1035)
      __ARCH(amd_gpu_gfx1036)
      __ARCH(amd_gpu_gfx1100)
      __ARCH(amd_gpu_gfx1101)
      __ARCH(amd_gpu_gfx1102)
      __ARCH(amd_gpu_gfx1103)
      __ARCH(amd_gpu_gfx1150)
      __ARCH(amd_gpu_gfx1151)
      __ARCH(amd_gpu_gfx1200)
      __ARCH(amd_gpu_gfx1201)
#undef __ARCH
    default:
      return "unknown";
    }
