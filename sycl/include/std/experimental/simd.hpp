//==------ simd.hpp - C++ data parallel types ----------*- C++ -*-----------==//
//
...
// TODO generalize for non-VecExt storarge type
#define __LIBCPP_DEFINE_SIMD_CMP_OP(op)                       \
template<class _Tp, class _Abi>                               \
...
#undef __LIBCPP_DEFINE_SIMD_CMP_OP
// } Added for SYCL/invoke_simd
