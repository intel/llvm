...
using scalar_vector_half_list = mp_append<scalar_half_list, vector_half_list>;

using half_list =
    mp_append<scalar_half_list, vector_half_list, marray_half_list>;
...
using scalar_vector_float_list =
    mp_append<scalar_float_list, vector_float_list>;

using float_list =
    mp_append<scalar_float_list, vector_float_list, marray_float_list>;
...
using scalar_vector_double_list =
    mp_append<scalar_double_list, vector_double_list>;

using double_list =
    mp_append<scalar_double_list, vector_double_list, marray_double_list>;

using scalar_floating_list =
    mp_append<scalar_float_list, scalar_double_list, scalar_half_list>;

using vector_floating_list =
    mp_append<vector_float_list, vector_double_list, vector_half_list>;

using marray_floating_list =
    mp_append<marray_float_list, marray_double_list, marray_half_list>;

using scalar_vector_floating_list =
    mp_append<scalar_floating_list, vector_floating_list>;

using floating_list =
    mp_append<scalar_floating_list, vector_floating_list, marray_floating_list>;
...
using geo_half_list = mp_append<scalar_geo_half_list, vector_geo_half_list>;

using geo_float_list = mp_append<scalar_geo_float_list, vector_geo_float_list>;

using geo_double_list =
    mp_append<scalar_geo_double_list, vector_geo_double_list>;

using scalar_geo_list = mp_append<scalar_geo_half_list, scalar_geo_float_list,
                                  scalar_geo_double_list>;

using vector_geo_list = mp_append<vector_geo_half_list, vector_geo_float_list,
                                  vector_geo_double_list>;

using marray_geo_list =
    mp_append<marray_geo_float_list, marray_geo_double_list>;

using geo_list = mp_append<scalar_geo_list, vector_geo_list>;
...
using cross_floating_list =
    mp_append<cross_float_list, cross_double_list, cross_half_list>;
...
using default_char_list =
    mp_append<scalar_default_char_list, vector_default_char_list,
...
using signed_char_list =
    mp_append<scalar_signed_char_list, vector_signed_char_list,
...
using unsigned_char_list =
    mp_append<scalar_unsigned_char_list, vector_unsigned_char_list,
              marray_unsigned_char_list>;

using scalar_char_list =
    mp_append<scalar_default_char_list, scalar_signed_char_list,
              scalar_unsigned_char_list>;

using vector_char_list =
    mp_append<vector_default_char_list, vector_signed_char_list,
              vector_unsigned_char_list>;

using marray_char_list =
    mp_append<marray_default_char_list, marray_signed_char_list,
              marray_unsigned_char_list>;

using char_list = mp_append<scalar_char_list, vector_char_list>;
...
using signed_short_list =
    mp_append<scalar_signed_short_list, vector_signed_short_list,
...
using unsigned_short_list =
    mp_append<scalar_unsigned_short_list, vector_unsigned_short_list,
              marray_unsigned_short_list>;

using scalar_short_list =
    mp_append<scalar_signed_short_list, scalar_unsigned_short_list>;

using vector_short_list =
    mp_append<vector_signed_short_list, vector_unsigned_short_list,
              marray_unsigned_short_list>;

using short_list = mp_append<scalar_short_list, vector_short_list>;
...
using signed_int_list =
    mp_append<scalar_signed_int_list, vector_signed_int_list,
...
using unsigned_int_list =
    mp_append<scalar_unsigned_int_list, vector_unsigned_int_list,
              marray_unsigned_int_list>;

using scalar_int_list =
    mp_append<scalar_signed_int_list, scalar_unsigned_int_list>;

using vector_int_list =
    mp_append<vector_signed_int_list, vector_unsigned_int_list>;

using marray_int_list =
    mp_append<marray_signed_int_list, marray_unsigned_int_list>;

using int_list = mp_append<scalar_int_list, vector_int_list, marray_int_list>;
...
using signed_long_list =
    mp_append<scalar_signed_long_list, vector_signed_long_list,
...
using unsigned_long_list =
    mp_append<scalar_unsigned_long_list, vector_unsigned_long_list,
              marray_unsigned_long_list>;

using scalar_long_list =
    mp_append<scalar_signed_long_list, scalar_unsigned_long_list>;

using vector_long_list =
    mp_append<vector_signed_long_list, vector_unsigned_long_list>;

using marray_long_list =
    mp_append<marray_signed_long_list, marray_unsigned_long_list>;

using long_list =
    mp_append<scalar_long_list, vector_long_list, marray_long_list>;
...
using signed_longlong_list =
    mp_append<scalar_signed_longlong_list, vector_signed_longlong_list,
...
using unsigned_longlong_list =
    mp_append<scalar_unsigned_longlong_list, vector_unsigned_longlong_list,
              marray_unsigned_longlong_list>;

using scalar_longlong_list =
    mp_append<scalar_signed_longlong_list, scalar_unsigned_longlong_list>;

using vector_longlong_list =
    mp_append<vector_signed_longlong_list, vector_unsigned_longlong_list>;

using marray_longlong_list =
    mp_append<marray_signed_longlong_list, marray_unsigned_longlong_list>;

using longlong_list =
    mp_append<scalar_longlong_list, vector_longlong_list, marray_longlong_list>;

// long integer types
using scalar_signed_long_integer_list =
    mp_append<scalar_signed_long_list, scalar_signed_longlong_list>;

using vector_signed_long_integer_list =
    mp_append<vector_signed_long_list, vector_signed_longlong_list>;

using marray_signed_long_integer_list =
    mp_append<marray_signed_long_list, marray_signed_longlong_list>;

using signed_long_integer_list =
    mp_append<scalar_signed_long_integer_list, vector_signed_long_integer_list,
              marray_signed_long_integer_list>;

using scalar_unsigned_long_integer_list =
    mp_append<scalar_unsigned_long_list, scalar_unsigned_longlong_list>;

using vector_unsigned_long_integer_list =
    mp_append<vector_unsigned_long_list, vector_unsigned_longlong_list>;

using marray_unsigned_long_integer_list =
    mp_append<marray_unsigned_long_list, marray_unsigned_longlong_list>;

using unsigned_long_integer_list = mp_append<scalar_unsigned_long_integer_list,
                                             vector_unsigned_long_integer_list,
                                             marray_unsigned_long_integer_list>;

using scalar_long_integer_list = mp_append<scalar_signed_long_integer_list,
                                           scalar_unsigned_long_integer_list>;

using vector_long_integer_list = mp_append<vector_signed_long_integer_list,
                                           vector_unsigned_long_integer_list>;

using marray_long_integer_list = mp_append<marray_signed_long_integer_list,
                                           marray_unsigned_long_integer_list>;

using long_integer_list =
    mp_append<scalar_long_integer_list, vector_long_integer_list,
...
using signed_integer_list =
    mp_append<scalar_signed_integer_list, vector_signed_integer_list,
              marray_signed_integer_list>;

using scalar_unsigned_integer_list =
    mp_append<std::conditional_t<std::is_unsigned_v<char>,
                                 mp_append<scalar_default_char_list,
                                           scalar_unsigned_char_list>,
                                 scalar_unsigned_char_list>,
...
using vector_unsigned_integer_list =
    mp_append<std::conditional_t<std::is_unsigned_v<char>,
                                 mp_append<vector_default_char_list,
                                           vector_unsigned_char_list>,
                                 vector_unsigned_char_list>,
...
using marray_unsigned_integer_list =
    mp_append<std::conditional_t<std::is_unsigned_v<char>,
                                 mp_append<marray_default_char_list,
                                           marray_unsigned_char_list>,
                                 marray_unsigned_char_list>,
...
using unsigned_integer_list =
    mp_append<scalar_unsigned_integer_list, vector_unsigned_integer_list,
              marray_unsigned_integer_list>;

using scalar_integer_list =
    mp_append<scalar_signed_integer_list, scalar_unsigned_integer_list>;

using vector_integer_list =
    mp_append<vector_signed_integer_list, vector_unsigned_integer_list>;

using marray_integer_list =
    mp_append<marray_signed_integer_list, marray_unsigned_integer_list>;

using integer_list =
    mp_append<scalar_integer_list, vector_integer_list, marray_integer_list>;
...
using bool_list = mp_append<scalar_bool_list, marray_bool_list>;
...
using scalar_signed_basic_list =
    mp_append<scalar_floating_list, scalar_signed_integer_list>;

using vector_signed_basic_list =
    mp_append<vector_floating_list, vector_signed_integer_list>;

using marray_signed_basic_list =
    mp_append<marray_floating_list, marray_signed_integer_list>;

using signed_basic_list =
    mp_append<scalar_signed_basic_list, vector_signed_basic_list,
              marray_signed_basic_list>;

using scalar_unsigned_basic_list = mp_append<scalar_unsigned_integer_list>;

using vector_unsigned_basic_list = mp_append<vector_unsigned_integer_list>;

using marray_unsigned_basic_list = mp_append<marray_unsigned_integer_list>;

using unsigned_basic_list =
    mp_append<scalar_unsigned_basic_list, vector_unsigned_basic_list,
              marray_unsigned_basic_list>;

using scalar_basic_list =
    mp_append<scalar_signed_basic_list, scalar_unsigned_basic_list>;

using vector_basic_list =
    mp_append<vector_signed_basic_list, vector_unsigned_basic_list>;

using marray_basic_list =
    mp_append<marray_signed_basic_list, marray_unsigned_basic_list>;

using basic_list =
    mp_append<scalar_basic_list, vector_basic_list, marray_basic_list>;

// nan builtin types
using nan_list = mp_append<gtl::unsigned_short_list, gtl::unsigned_int_list,
