...

  {
    ...
    if (local_start_1 < local_end_1) {
      ...
      if (local_start_2 < local_end_2) {
        ...
        const auto local_l_item_2 =
            detail::get_references(in_acc, local_start_2);
        ...
        if (local_size_2 > 1) {
          ...
          r_search_bound_1 = detail::upper_bound(in_acc, l_search_bound_1,
                                                 end_1, local_r_item_2, comp);
