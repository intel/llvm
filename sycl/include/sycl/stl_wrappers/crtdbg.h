...
// function with variable arguments, when compiled in debug mode (-D_DEBUG flag).

// Variable argument functions are not supported in SPIR-V, and the compilation fails with
// llvm-spirv error:
