...
extern SYCL_EXTERNAL uint16_t __imf_float2bfloat16_rd(float);
extern SYCL_EXTERNAL uint16_t __imf_float2bfloat16_rn(float);
extern SYCL_EXTERNAL uint16_t __imf_float2bfloat16_ru(float);
extern SYCL_EXTERNAL uint16_t __imf_float2bfloat16_rz(float);
