...
struct tpu_params<tpu::amx, Ta, Tb, Tc, 0, 0, 0,
  ...
  using joint_matrix_a =
      joint_matrix<Ta, defaultM, defaultK, matrix_use::matrix_a, Group>;
  template <typename Group>
  using joint_matrix_b =
      joint_matrix<Tb, defaultK, defaultN, matrix_use::matrix_b, Group>;
  template <typename Group>
  using joint_matrix_c =
      joint_matrix<Tc, defaultM, defaultN, matrix_use::accumulator, Group>;
