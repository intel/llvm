  ...
  store(sycl::ext::oneapi::experimental::matrix::joint_matrix<
    ...
    if (NumRows == 16 && NumCols == 16) {
      if constexpr (std::is_same<T, float>::value) {
        auto srcptr = reinterpret_cast<float *>(&src.wi_marray);
        __hmma_m16n16k16_st_c_f32(dst.get(), srcptr, stride,
                                  get_layout_id<Layout>());
      } else if constexpr (std::is_same<T, int32_t>::value) {
        auto srcptr = reinterpret_cast<int32_t *>(&src.wi_marray);
      ...
      auto srcptr = reinterpret_cast<double *>(&src.wi_marray);
    ...
    if constexpr (M == 16 && N == 16 && K == 16) {
      if constexpr (std::is_same<T2, int32_t>::value) {
        ...
        if constexpr (std::is_same<T2, float>::value) {
          auto ptrC = reinterpret_cast<float const *>(&C.wi_marray);
          auto ptrD = reinterpret_cast<float *>(&D.wi_marray);
      ...
      auto ptrA = reinterpret_cast<double const *>(&A.wi_marray);
      auto ptrB = reinterpret_cast<double const *>(&B.wi_marray);
      auto ptrC = reinterpret_cast<double const *>(&C.wi_marray);
      auto ptrD = reinterpret_cast<double *>(&D.wi_marray);
