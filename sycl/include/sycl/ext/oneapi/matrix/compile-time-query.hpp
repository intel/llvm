//===---------- compile-time-query.hpp - SYCL matrix ------------*- C++ -*-===//
//
...
//
// ===--------------------------------------------------------------------=== //
// This file implements the compile-time query interface for the joint_matrix
...
// there will be no runtime errors. The query interface provides two
