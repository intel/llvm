...
#include <sycl/ext/oneapi/fpga_mem/properties.hpp>      // for num_banks...
...
class fpga_mem
    : public detail::fpga_mem_base<T, detail::empty_properties_t> {

  // Inherits the base class' constructors
  using detail::fpga_mem_base<T, detail::empty_properties_t>::fpga_mem_base;
...
class fpga_mem<T, detail::properties_t<Props...>>
    : public detail::fpga_mem_base<T, detail::properties_t<Props...>> {

  using property_list_t = detail::properties_t<Props...>;

    // Inherits the base class' constructors
  using detail::fpga_mem_base<T, detail::properties_t<Props...>>::fpga_mem_base;
