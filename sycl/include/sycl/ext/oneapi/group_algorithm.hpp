...
using EnableIfIsVectorArithmetic =
    std::enable_if_t<sycl::detail::is_vector_arithmetic<T>::value, T>;

template <typename Ptr, typename T>
using EnableIfIsPointer =
    std::enable_if_t<sycl::detail::is_pointer<Ptr>::value, T>;
...
using EnableIfIsScalarArithmeticNativeOp =
    std::enable_if_t<sycl::detail::is_scalar_arithmetic<T>::value &&
                         sycl::detail::is_native_op<T, BinaryOperation>::value,
                     T>;

template <typename T, typename BinaryOperation>
using EnableIfIsVectorArithmeticNativeOp =
    std::enable_if_t<sycl::detail::is_vector_arithmetic<T>::value &&
                         sycl::detail::is_native_op<T, BinaryOperation>::value,
                     T>;
