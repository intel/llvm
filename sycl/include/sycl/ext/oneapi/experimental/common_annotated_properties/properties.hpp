...
struct propagatePassAnnotatedRef : std::false_type {};
template <typename PropTy>
struct propagatePassPointerArith : std::false_type {};
...
template <> struct propagatePassAnnotatedRef<alignment_key> : std::true_type {};
