...
using ldg_vector_types = sycl::detail::type_list<
    sycl::vec<char, 2>, sycl::vec<char, 4>, sycl::vec<signed char, 2>,
    sycl::vec<signed char, 4>, sycl::vec<short, 2>, sycl::vec<short, 4>,
    sycl::vec<int, 2>, sycl::vec<int, 4>, sycl::vec<long, 2>,
    sycl::vec<long, 4>, sycl::vec<long long, 2>, sycl::vec<long long, 4>,
    sycl::vec<unsigned char, 2>, sycl::vec<unsigned char, 4>,
    sycl::vec<unsigned short, 2>, sycl::vec<unsigned short, 4>,
    sycl::vec<unsigned int, 2>, sycl::vec<unsigned int, 4>,
    sycl::vec<unsigned long, 2>, sycl::vec<unsigned long, 4>,
    sycl::vec<unsigned long long, 2>, sycl::vec<unsigned long long, 4>,
    sycl::vec<half, 2>, sycl::vec<half, 4>, sycl::vec<float, 2>,
    sycl::vec<float, 4>, sycl::vec<double, 2>, sycl::vec<double, 4>>;
