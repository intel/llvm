...
__SYCL_INLINE_VER_NAMESPACE(_V1) {
  ...
  template <>
  struct is_property_key<streaming_interface_key> : std::true_type {};
  template <>
  struct is_property_key<register_map_interface_key> : std::true_type {};
  template <> struct is_property_key<pipelined_key> : std::true_type {};

  template <typename T, typename PropertyListT>
  struct is_property_key_of<streaming_interface_key,
                            fpga_kernel_attribute<T, PropertyListT>>
      : std::true_type {};
  template <typename T, typename PropertyListT>
  struct is_property_key_of<register_map_interface_key,
                            fpga_kernel_attribute<T, PropertyListT>>
      : std::true_type {};
  template <typename T, typename PropertyListT>
  ...
  template <>
  struct IsCompileTimeProperty<register_map_interface_key> : std::true_type {};
  ...
  template <int Value> struct PropertyMetaInfo<pipelined_key::value_t<Value>> {
