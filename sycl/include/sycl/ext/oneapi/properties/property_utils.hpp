...
template <typename PropKey> struct ConflictingPropertiesImpl {
  using type = detail::mp11::mp_list<>;
};
template <typename PropKey>
using ConflictingProperties = typename ConflictingPropertiesImpl<PropKey>::type;
