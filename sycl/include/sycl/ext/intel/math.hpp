...
std::enable_if_t<std::is_same_v<Tp, sycl::ext::oneapi::bfloat16>,
                 sycl::ext::oneapi::bfloat16>
float2bfloat16_rz(float x) {
  return __internal_fp_convert_rz<sycl::ext::oneapi::bfloat16, float>(x);
}
