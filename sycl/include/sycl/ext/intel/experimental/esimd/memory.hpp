...
ESIMD_INLINE ESIMD_NODEBUG typename __sycl_internal::detail::enable_if_t<
    ((n == 8 || n == 16 || n == 32) &&
...
/// \tparam AccessorTy is \ref __sycl_internal::accessor type.
...
template <typename T, int N, typename AccessorTy,
          CacheHint L1H = CacheHint::None, CacheHint L3H = CacheHint::None>
ESIMD_INLINE ESIMD_NODEBUG
    typename __sycl_internal::detail::enable_if_t<(sizeof(T) <= 4) &&
                                           (N == 1 || N == 8 || N == 16) &&
  ...
  if constexpr (sizeof(T) < 4) {
    ...
    using PromoT =
        typename __sycl_internal::detail::conditional_t<std::is_signed<T>::value, int32_t,
                                             uint32_t>;
...
template <typename T, int n, rgba_channel_mask Mask,
          CacheHint L1H = CacheHint::None, CacheHint L3H = CacheHint::None>
ESIMD_INLINE ESIMD_NODEBUG
    typename __sycl_internal::detail::enable_if_t<(n == 16 || n == 32) && (sizeof(T) == 4),
                                       void>
...
constexpr bool check_atomic() {
  ...
  if constexpr (Op == atomic_op::fmax || Op == atomic_op::fmin) {
    ...
    if constexpr (!is_type<T, float, __sycl_internal::detail::half_impl::StorageT>()) {
      static_assert(
          (is_type<T, float, __sycl_internal::detail::half_impl::StorageT>()),
...
ESIMD_NODEBUG ESIMD_INLINE
    typename __sycl_internal::detail::enable_if_t<detail::check_atomic<Op, T, n, 0>(),
                                       simd<T, n>>
...
template <atomic_op Op, typename T, int n, CacheHint L1H = CacheHint::None,
          CacheHint L3H = CacheHint::None>
ESIMD_NODEBUG ESIMD_INLINE
    typename __sycl_internal::detail::enable_if_t<detail::check_atomic<Op, T, n, 1>(),
                                       simd<T, n>>
...
template <atomic_op Op, typename T, int n, CacheHint L1H = CacheHint::None,
          CacheHint L3H = CacheHint::None>
ESIMD_NODEBUG ESIMD_INLINE
    typename __sycl_internal::detail::enable_if_t<detail::check_atomic<Op, T, n, 2>(),
                                       simd<T, n>>
    flat_atomic(T *p, simd<unsigned, n> offset, simd<T, n> src0,
...
ESIMD_INLINE ESIMD_NODEBUG
    typename __sycl_internal::detail::enable_if_t<(n == 16 || n == 32), simd<T, n>>
...
template <typename T, int n>
ESIMD_INLINE ESIMD_NODEBUG
    typename __sycl_internal::detail::enable_if_t<(n == 16 || n == 32), void>
