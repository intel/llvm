...
template <> struct propagateToPtrAnnotation<intel::experimental::read_hint_key> : std::true_type {};
template <>
struct propagateToPtrAnnotation<intel::experimental::read_assertion_key> : std::true_type {};
template <> struct propagateToPtrAnnotation<intel::experimental::write_hint_key> : std::true_type {};
