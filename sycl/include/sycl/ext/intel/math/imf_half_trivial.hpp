...
sycl::half2 heq2(sycl::half2 x, sycl::half2 y) {
  sycl::half2 r;
  r.s0() = heq(x.s0(), y.s0()) ? 1.0f : 0.f;
  r.s1() = heq(x.s1(), y.s1()) ? 1.0f : 0.f;
  return r;
}

sycl::half2 hequ2(sycl::half2 x, sycl::half2 y) {
  sycl::half2 r;
  r.s0() = hequ(x.s0(), y.s0()) ? 1.0f : 0.f;
  r.s1() = hequ(x.s1(), y.s1()) ? 1.0f : 0.f;
  return r;
}

sycl::half2 hge2(sycl::half2 x, sycl::half2 y) {
  sycl::half2 r;
  r.s0() = hge(x.s0(), y.s0()) ? 1.0f : 0.f;
  r.s1() = hge(x.s1(), y.s1()) ? 1.0f : 0.f;
  return r;
}

sycl::half2 hgeu2(sycl::half2 x, sycl::half2 y) {
  sycl::half2 r;
  r.s0() = hgeu(x.s0(), y.s0()) ? 1.0f : 0.f;
  r.s1() = hgeu(x.s1(), y.s1()) ? 1.0f : 0.f;
  return r;
}

sycl::half2 hgt2(sycl::half2 x, sycl::half2 y) {
  sycl::half2 r;
  r.s0() = hgt(x.s0(), y.s0()) ? 1.0f : 0.f;
  r.s1() = hgt(x.s1(), y.s1()) ? 1.0f : 0.f;
  return r;
}

sycl::half2 hgtu2(sycl::half2 x, sycl::half2 y) {
  sycl::half2 r;
  r.s0() = hgtu(x.s0(), y.s0()) ? 1.0f : 0.f;
  r.s1() = hgtu(x.s1(), y.s1()) ? 1.0f : 0.f;
  return r;
}

sycl::half2 hle2(sycl::half2 x, sycl::half2 y) {
  sycl::half2 r;
  r.s0() = hle(x.s0(), y.s0()) ? 1.0f : 0.f;
  r.s1() = hle(x.s1(), y.s1()) ? 1.0f : 0.f;
  return r;
}

sycl::half2 hleu2(sycl::half2 x, sycl::half2 y) {
  sycl::half2 r;
  r.s0() = hleu(x.s0(), y.s0()) ? 1.0f : 0.f;
  r.s1() = hleu(x.s1(), y.s1()) ? 1.0f : 0.f;
  return r;
}

sycl::half2 hlt2(sycl::half2 x, sycl::half2 y) {
  sycl::half2 r;
  r.s0() = hlt(x.s0(), y.s0()) ? 1.0f : 0.f;
  r.s1() = hlt(x.s1(), y.s1()) ? 1.0f : 0.f;
  return r;
}

sycl::half2 hltu2(sycl::half2 x, sycl::half2 y) {
  sycl::half2 r;
  r.s0() = hltu(x.s0(), y.s0()) ? 1.0f : 0.f;
  r.s1() = hltu(x.s1(), y.s1()) ? 1.0f : 0.f;
  return r;
}

sycl::half2 hisnan2(sycl::half2 x) {
  sycl::half2 r;
  r.s0() = hisnan(x.s0()) ? 1.0f : 0.f;
  r.s1() = hisnan(x.s1()) ? 1.0f : 0.f;
  return r;
}

sycl::half2 hne2(sycl::half2 x, sycl::half2 y) {
  sycl::half2 r;
  r.s0() = hne(x.s0(), y.s0()) ? 1.0f : 0.f;
  r.s1() = hne(x.s1(), y.s1()) ? 1.0f : 0.f;
  return r;
}

sycl::half2 hneu2(sycl::half2 x, sycl::half2 y) {
  sycl::half2 r;
  r.s0() = hneu(x.s0(), y.s0()) ? 1.0f : 0.f;
  r.s1() = hneu(x.s1(), y.s1()) ? 1.0f : 0.f;
  return r;
}
