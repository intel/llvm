...
shl(simd<T1, SZ> src0, U src1, Sat sat = {}) {
  simd<U, SZ> Src1 = src1; // is this right
...
shl(T1 src0, T2 src1, Sat sat = {}) {
  simd<T1, 1> Src0 = src0;
  simd<T0, 1> Result = esimd::shl<T0, T1, 1, T2, Sat>(Src0, src1, sat);
  return Result[0];
}
...
lsr(T1 src0, T2 src1, Sat sat = {}) {
  simd<T1, 1> Src0 = src0;
  simd<T0, 1> Result = esimd::lsr<T0, T1, 1, T2, Sat>(Src0, src1, sat);
...
shr(T1 src0, T2 src1, Sat sat = {}) {
  simd<T1, 1> Src0 = src0;
  simd<T0, 1> Result = esimd::shr<T0, T1, 1, T2, Sat>(Src0, src1, sat);
  return Result[0];
}
...
__ESIMD_API
    ...
    rol(T1 src0, T2 src1) {
  simd<T1, 1> Src0 = src0;
  simd<T0, 1> Result = esimd::rol<T0, T1, 1, T2>(Src0, src1);
  return Result[0];
}
