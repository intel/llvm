...
// Intrinsics
void (*cm_aux_barrier_ptr)(void);

// libcm functionalities used for intrinsics such as dpasw
int32_t (*cm_get_thread_local_idx_ptr)(void);
char *(*cm_get_xthread_broadcast_buf_ptr)(void);
/// @endcond ESIMD_EMU
