...
template <__sycl_internal::backend BE>
...
#define __SYCL_PI_HANDLE_UNKNOWN_PARAM_NAME(parameter)                         \
  { __sycl_internal::detail::pi::handleUnknownParamName(__func__, parameter); }
...
__SYCL_EXPORT void contextSetExtendedDeleter(const __sycl_internal::context &constext,
...
namespace RT = __sycl_internal::detail::pi;
