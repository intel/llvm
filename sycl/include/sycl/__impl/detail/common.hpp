  ...
  {                                                                            \
    ...
    if (code != CL_SUCCESS) {                                                  \
      std::cerr << __SYCL_OCL_ERROR_REPORT                                     \
                << __sycl_internal::detail::codeToString(code) << std::endl;          \
    }                                                                          \
  }
#endif
  ...
  {                                                                            \
    ...
    if (code != CL_SUCCESS) {                                                  \
      throw exc(__SYCL_OCL_ERROR_REPORT +                                      \
                    __sycl_internal::detail::codeToString(code),                      \
                code);                                                         \
    }                                                                          \
  }
...
#define __SYCL_REPORT_OCL_ERR_TO_EXC_BASE(code)                                \
  __SYCL_REPORT_OCL_ERR_TO_EXC(code, __sycl_internal::runtime_error)
#else
#define __SYCL_REPORT_OCL_ERR_TO_EXC_BASE(code)                                \
