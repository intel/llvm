...
public:
  ...
  static void *allocateMemBuffer(ContextImplPtr TargetContext,
                                 ...
                                 const __sycl_internal::property_list &PropsList,
  ...
  static void *allocateMemImage(
      ...
      const ContextImplPtr &InteropContext,
      const __sycl_internal::property_list &PropsList, RT::PiEvent &OutEventToWait);
  ...
  static void copy(SYCLMemObjI *SYCLMemObj, void *SrcMem, QueueImplPtr SrcQueue,
                   unsigned int DimSrc, __sycl_internal::range<3> SrcSize,
                   __sycl_internal::range<3> SrcAccessRange, __sycl_internal::id<3> SrcOffset,
                   unsigned int SrcElemSize, void *DstMem,
                   QueueImplPtr TgtQueue, unsigned int DimDst,
                   __sycl_internal::range<3> DstSize, __sycl_internal::range<3> DstAccessRange,
                   __sycl_internal::id<3> DstOffset, unsigned int DstElemSize,
  ...
  static void fill(SYCLMemObjI *SYCLMemObj, void *Mem, QueueImplPtr Queue,
                   ...
                   __sycl_internal::range<3> Size, __sycl_internal::range<3> AccessRange,
                   __sycl_internal::id<3> AccessOffset, unsigned int ElementSize,
                   std::vector<RT::PiEvent> DepEvents, RT::PiEvent &OutEvent);
