...
#include <sycl/__impl/aliases.hpp>
#include <sycl/__impl/detail/common.hpp>
#include <sycl/__impl/detail/generic_type_lists.hpp>
...
using select_cl_scalar_integral_signed_t =
    select_apply_cl_scalar_t<T, __sycl_internal::cl_char, __sycl_internal::cl_short, __sycl_internal::cl_int,
                             __sycl_internal::cl_long>;

template <typename T>
using select_cl_scalar_integral_unsigned_t =
    select_apply_cl_scalar_t<T, __sycl_internal::cl_uchar, __sycl_internal::cl_ushort, __sycl_internal::cl_uint,
                             __sycl_internal::cl_ulong>;

template <typename T>
using select_cl_scalar_float_t =
    select_apply_cl_scalar_t<T, std::false_type, __sycl_internal::cl_half, __sycl_internal::cl_float,
                             __sycl_internal::cl_double>;
...
using select_cl_scalar_t = conditional_t<
    ...
    conditional_t<
        ...
        conditional_t<std::is_same<T, half>::value,
                      __sycl_internal::detail::half_impl::BIsRepresentationT, T>>>;
