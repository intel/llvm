...
template <typename T, int dimensions = 1,
          typename AllocatorT = __sycl_internal::__v1::buffer_allocator,
...
struct hash<__sycl_internal::__v1::buffer<T, dimensions, AllocatorT>> {
  size_t
  operator()(const __sycl_internal::__v1::buffer<T, dimensions, AllocatorT> &b) const {
    return hash<std::shared_ptr<__sycl_internal::__v1::detail::buffer_impl>>()(
        __sycl_internal::__v1::detail::getSyclObjImpl(b));
  }
};
} // namespace std
