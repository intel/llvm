...
/// specifying mangled name here, use `extern "C"` \param P - __sycl_internal::program
/// object which will be used to extract device function pointer \param D -
/// __sycl_internal::device object which will be used to extract device function pointer
///
...
device_func_ptr_holder_t get_device_func_ptr(FuncType F, const char *FuncName,
  ...
  return __sycl_internal::detail::getDeviceFunctionPointerImpl(D, P, FuncName);
}
} // namespace ONEAPI
} // namespace sycl
} // namespace __sycl_internal
