...
class accessor_property_list : protected __sycl_internal::detail::PropertyListBase {
  ...
  struct AllProperties<T, Tail...>
      : detail::conditional_t<
            std::is_base_of<__sycl_internal::detail::DataLessPropertyBase, T>::value ||
                std::is_base_of<__sycl_internal::detail::PropertyWithDataBase, T>::value ||
                __sycl_internal::detail::IsCompileTimePropertyInstance<T>::value,
            AllProperties<Tail...>, std::false_type> {};

  accessor_property_list(
      std::bitset<__sycl_internal::detail::DataLessPropKind::DataLessPropKindSize>
          DataLessProps,
      std::vector<std::shared_ptr<__sycl_internal::detail::PropertyWithDataBase>>
          PropsWithData)
      : __sycl_internal::detail::PropertyListBase(DataLessProps, PropsWithData) {}

public:
  template <
      typename = typename detail::enable_if_t<AllProperties<PropsT...>::value>>
  accessor_property_list(PropsT... Props)
      : __sycl_internal::detail::PropertyListBase(false) {
    ctorHelper(Props...);
  }

  accessor_property_list(const __sycl_internal::property_list &Props)
      : __sycl_internal::detail::PropertyListBase(Props.MDataLessProps,
  ...
  accessor_property_list(const accessor_property_list<OtherProps...> &OtherList)
      : __sycl_internal::detail::PropertyListBase(OtherList.MDataLessProps,
