...
// bitselect builtin uses union with half specialization, but half has no trivial constructor.
// This struct allow to use host half class instead of main half class in the bitselect builtin.
