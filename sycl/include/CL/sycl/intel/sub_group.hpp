...
struct sub_group {
  ...
  SYCL_API_DEPRECATED("Use sycl::intel::any_of instead.")
  bool any(bool predicate) const {
    return __spirv_GroupAny(__spv::Scope::Subgroup, predicate);
  }

  SYCL_API_DEPRECATED("Use sycl::intel::all_of instead.")
  ...
  template <typename T>
  SYCL_API_DEPRECATED("Use sycl::intel::broadcast instead.")
  ...
  SYCL_API_DEPRECATED("Use sycl::intel::reduce instead.")
  ...
  template <typename T, class BinaryOperation>
  SYCL_API_DEPRECATED("Use sycl::intel::exclusive_scan instead.")
  ...
  template <typename T, class BinaryOperation>
  SYCL_API_DEPRECATED("Use sycl::intel::inclusive_scan instead.")
