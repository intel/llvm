...
private:
  ...
  void throwIfActionIsCreated() {
    if (detail::CG::__SYCL_NONE != getType())
  ...
  void parallel_for_lambda_impl(range<Dims> NumWorkItems,
       ...
       // SYCL_LANGUAGE_VERSION >= 202001
    {
      ...
      StoreLambda<NameT, KernelType, Dims, TransformedArgType>(
          std::move(KernelFunc));
      setType(detail::CG::__SYCL_KERNEL);
#endif
    }
  }
...
#define __SYCL_KERNEL_ATTR__
  ...
  host_task_impl(FuncT &&Func) {
    ...
    setType(detail::CG::__SYCL_CODEPLAY_HOST_TASK);
  }
...
public:
  ...
  template <typename FuncT> void run_on_host_intel(FuncT Func) {
    ...
    setType(detail::CG::__SYCL_RUN_ON_HOST_INTEL);
  }
...
#define _KERNELFUNCPARAM(a) const KernelType &a
  ...
  template <typename FuncT> void interop_task(FuncT Func) {
    ...
    setType(detail::CG::__SYCL_CODEPLAY_INTEROP_TASK);
  }
...
#undef _KERNELFUNCPARAM
...
#endif
    setType(detail::CG::__SYCL_COPY_ACC_TO_PTR);
...
#endif
    setType(detail::CG::__SYCL_COPY_PTR_TO_ACC);
  ...
  void copy(accessor<T_Src, Dims_Src, AccessMode_Src, AccessTarget_Src,
    ...
    if (copyAccToAccHelper(Src, Dst))
      return;
    setType(detail::CG::__SYCL_COPY_ACC_TO_ACC);
  ...
  update_host(accessor<T, Dims, AccessMode, AccessTarget, IsPlaceholder> Acc) {
    ...
    setType(detail::CG::__SYCL_UPDATE_HOST);
  ...
  void barrier() {
    throwIfActionIsCreated();
    setType(detail::CG::__SYCL_BARRIER);
  }
...
private:
  ...
  detail::CG::CGTYPE MCGType = detail::CG::__SYCL_NONE;
