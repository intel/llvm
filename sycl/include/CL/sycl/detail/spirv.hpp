...
template <> struct group_scope<__sycl_ns::ext::oneapi::sub_group> {
...
template <> struct GroupId<__sycl_ns::ext::oneapi::sub_group> {
  using type = uint32_t;
};
...
static inline constexpr
    typename std::enable_if<std::is_same<T, __sycl_ns::memory_order>::value,
