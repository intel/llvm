...
typedef enum {
  ...
  PI_EXT_ONEAPI_DEVICE_INFO_MAX_GLOBAL_NUMBER_WORK_GROUPS = 0x20000,
  PI_EXT_ONEAPI_DEVICE_INFO_MAX_NUMBER_WORK_GROUPS_1D = 0x20001,
  PI_EXT_ONEAPI_DEVICE_INFO_MAX_NUMBER_WORK_GROUPS_2D = 0x20002,
  PI_EXT_ONEAPI_DEVICE_INFO_MAX_NUMBER_WORK_GROUPS_3D = 0x20003
} _pi_device_info;
