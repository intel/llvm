...
#define EXT_INTEL_PCI_ADDRESS 0x5000
#define EXT_INTEL_GPU_EU_COUNT 0x5001
#define EXT_INTEL_GPU_EU_SIMD_WIDTH 0x5002
#define EXT_INTEL_GPU_SLICES 0x5003
#define EXT_INTEL_GPU_SUBSLICES_PER_SLICE 0x5004
#define EXT_INTEL_GPU_EU_COUNT_PER_SUBSLICE 0x5005
#define EXT_INTEL_MAX_MEM_BANDWIDTH 0x5006
...
typedef enum {
  ...
  PI_DEVICE_INFO_PCI_ADDRESS = EXT_INTEL_PCI_ADDRESS,
  PI_DEVICE_INFO_GPU_EU_COUNT = EXT_INTEL_GPU_EU_COUNT,
  PI_DEVICE_INFO_GPU_EU_SIMD_WIDTH = EXT_INTEL_GPU_EU_SIMD_WIDTH,
  PI_DEVICE_INFO_GPU_SLICES = EXT_INTEL_GPU_SLICES,
  PI_DEVICE_INFO_GPU_SUBSLICES_PER_SLICE = EXT_INTEL_GPU_SUBSLICES_PER_SLICE,
  PI_DEVICE_INFO_GPU_EU_COUNT_PER_SUBSLICE =
      EXT_INTEL_GPU_EU_COUNT_PER_SUBSLICE,
  PI_DEVICE_INFO_MAX_MEM_BANDWIDTH = EXT_INTEL_MAX_MEM_BANDWIDTH
} _pi_device_info;

#undef EXT_INTEL_PCI_ADDRESS
#undef EXT_INTEL_GPU_EU_COUNT
#undef EXT_INTEL_GPU_EU_SIMD_WIDTH
#undef EXT_INTEL_GPU_SLICES
#undef EXT_INTEL_GPU_SUBSLICES_PER_SLICE
#undef EXT_INTEL_GPU_EU_COUNT_PER_SUBSLICE
#undef EXT_INTEL_MAX_MEM_BANDWIDTH
