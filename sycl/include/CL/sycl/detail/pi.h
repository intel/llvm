...
typedef enum {
  ...
  PI_DEVICE_INFO_PCI_ADDRESS = 0x10000,
  PI_DEVICE_INFO_GPU_EU_COUNT = 0x10001,
  PI_DEVICE_INFO_GPU_EU_SIMD_WIDTH = 0x10002,
  PI_DEVICE_INFO_GPU_SLICES = 0x10003,
  PI_DEVICE_INFO_GPU_SUBSLICES_PER_SLICE = 0x10004,
  PI_DEVICE_INFO_GPU_EU_COUNT_PER_SUBSLICE = 0x10005,
  PI_DEVICE_INFO_MAX_MEM_BANDWIDTH = 0x10006
} _pi_device_info;
