...
pi_result cuda_piPlatformGetInfo(pi_platform platform,
  ...
  __sycl_internal::__v1::detail::pi::die(
      "Platform info request not implemented");
  return {};
}
...
pi_result cuda_piDeviceGetInfo(pi_device device, pi_device_info param_name,
  ...
  case PI_DEVICE_INFO_MAX_MEM_ALLOC_SIZE: {
    ...
    size_t global = 0;
    __sycl_internal::__v1::detail::pi::assertion(
        cuDeviceTotalMem(&global, device->get()) == CUDA_SUCCESS);
  ...
  case PI_DEVICE_INFO_GLOBAL_MEM_SIZE: {
    ...
    __sycl_internal::__v1::detail::pi::assertion(
        cuDeviceTotalMem(&bytes, device->get()) == CUDA_SUCCESS);
    return getInfo(param_value_size, param_value, param_value_size_ret,
                   pi_uint64{bytes});
  }
  ...
  case PI_DEVICE_INFO_ERROR_CORRECTION_SUPPORT: {
    ...
    __sycl_internal::__v1::detail::pi::assertion((ecc_enabled == 0) |
                                                 (ecc_enabled == 1));
...
pi_result cuda_piMemImageGetInfo(pi_mem, pi_image_info, size_t, void *,
                                 size_t *) {
  __sycl_internal::__v1::detail::pi::die(
      "cuda_piMemImageGetInfo not implemented");
  return {};
}
...
pi_result cuda_piProgramCreate(pi_context, const void *, size_t, pi_program *) {
  __sycl_internal::__v1::detail::pi::die(
      "cuda_piProgramCreate not implemented");
  return {};
}
...
pi_result cuda_piProgramGetInfo(pi_program program, pi_program_info param_name,
  ...
  __sycl_internal::__v1::detail::pi::die(
      "Program info request not implemented");
  return {};
}
...
pi_result cuda_piProgramGetBuildInfo(pi_program program, pi_device device,
  ...
  __sycl_internal::__v1::detail::pi::die(
      "Program Build info request not implemented");
  return {};
}
...
pi_result cuda_piEventCreate(pi_context, pi_event *) {
  __sycl_internal::__v1::detail::pi::die(
      "PI Event Create not implemented in CUDA backend");
}
...
pi_result cuda_piEventGetProfilingInfo(pi_event event,
  ...
  __sycl_internal::__v1::detail::pi::die(
      "Event Profiling info request not implemented");
  return {};
}

pi_result cuda_piEventSetCallback(pi_event, pi_int32, pfn_notify, void *) {
  __sycl_internal::__v1::detail::pi::die(
      "Event Callback not implemented in CUDA backend");
  return PI_SUCCESS;
}

pi_result cuda_piEventSetStatus(pi_event, pi_int32) {
  __sycl_internal::__v1::detail::pi::die(
      "Event Set Status not implemented in CUDA backend");
  return PI_INVALID_VALUE;
}
...
pi_result cuda_piEnqueueMemImageFill(pi_queue, pi_mem, const void *,
  ...
  __sycl_internal::__v1::detail::pi::die(
      "cuda_piEnqueueMemImageFill not implemented");
  return {};
}
