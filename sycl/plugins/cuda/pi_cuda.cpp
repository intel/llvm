...
std::string getKernelNames(pi_program program) {
  __sycl_ns::detail::pi::die("getKernelNames not implemented");
  return {};
}
...
pi_result cuda_piextDeviceSelectBinary(pi_device device,
  ...
  if (!binaries) {
    __sycl_ns::detail::pi::die("No list of device images provided");
  }
  if (num_binaries < 1) {
    __sycl_ns::detail::pi::die("No binary images in the list");
  }
...
pi_result cuda_piDeviceGetInfo(pi_device device, pi_device_info param_name,
  ...
  case PI_DEVICE_INFO_MAX_COMPUTE_UNITS: {
    ...
    __sycl_ns::detail::pi::assertion(compute_units >= 0);
    return getInfo(param_value_size, param_value, param_value_size_ret,
  ...
  case PI_DEVICE_INFO_MAX_WORK_GROUP_SIZE: {
    ...
    __sycl_ns::detail::pi::assertion(max_work_group_size >= 0);
  ...
  case PI_DEVICE_INFO_MAX_CLOCK_FREQUENCY: {
    ...
    __sycl_ns::detail::pi::assertion(
        cuDeviceGetAttribute(&clock_freq, CU_DEVICE_ATTRIBUTE_CLOCK_RATE,
                             device->get()) == CUDA_SUCCESS);
    __sycl_ns::detail::pi::assertion(clock_freq >= 0);
    return getInfo(param_value_size, param_value, param_value_size_ret,
  ...
  case PI_DEVICE_INFO_IMAGE2D_MAX_HEIGHT: {
    ...
    __sycl_ns::detail::pi::assertion(
        cuDeviceGetAttribute(&tex_height,
                             ...
                             device->get()) == CUDA_SUCCESS);
    __sycl_ns::detail::pi::assertion(tex_height >= 0);
    int surf_height = 0;
    __sycl_ns::detail::pi::assertion(
        cuDeviceGetAttribute(&surf_height,
                             CU_DEVICE_ATTRIBUTE_MAXIMUM_SURFACE2D_HEIGHT,
                             device->get()) == CUDA_SUCCESS);
    __sycl_ns::detail::pi::assertion(surf_height >= 0);
  ...
  case PI_DEVICE_INFO_IMAGE2D_MAX_WIDTH: {
    ...
    __sycl_ns::detail::pi::assertion(
        cuDeviceGetAttribute(&tex_width,
                             ...
                             device->get()) == CUDA_SUCCESS);
    __sycl_ns::detail::pi::assertion(tex_width >= 0);
    int surf_width = 0;
    __sycl_ns::detail::pi::assertion(
        cuDeviceGetAttribute(&surf_width,
                             CU_DEVICE_ATTRIBUTE_MAXIMUM_SURFACE2D_WIDTH,
                             device->get()) == CUDA_SUCCESS);
    __sycl_ns::detail::pi::assertion(surf_width >= 0);
  ...
  case PI_DEVICE_INFO_IMAGE3D_MAX_DEPTH: {
    ...
    __sycl_ns::detail::pi::assertion(
        cuDeviceGetAttribute(&tex_depth,
                             ...
                             device->get()) == CUDA_SUCCESS);
    __sycl_ns::detail::pi::assertion(tex_depth >= 0);
    int surf_depth = 0;
    __sycl_ns::detail::pi::assertion(
        cuDeviceGetAttribute(&surf_depth,
                             CU_DEVICE_ATTRIBUTE_MAXIMUM_SURFACE3D_DEPTH,
                             device->get()) == CUDA_SUCCESS);
    __sycl_ns::detail::pi::assertion(surf_depth >= 0);
  ...
  case PI_DEVICE_INFO_GLOBAL_MEM_CACHE_SIZE: {
    ...
    __sycl_ns::detail::pi::assertion(
        cuDeviceGetAttribute(&cache_size, CU_DEVICE_ATTRIBUTE_L2_CACHE_SIZE,
                             device->get()) == CUDA_SUCCESS);
    __sycl_ns::detail::pi::assertion(cache_size >= 0);
  ...
  case PI_DEVICE_INFO_MAX_CONSTANT_BUFFER_SIZE: {
    ...
    __sycl_ns::detail::pi::assertion(
        cuDeviceGetAttribute(&constant_memory,
                             ...
                             device->get()) == CUDA_SUCCESS);
    __sycl_ns::detail::pi::assertion(constant_memory >= 0);
  ...
  case PI_DEVICE_INFO_LOCAL_MEM_SIZE: {
    ...
    __sycl_ns::detail::pi::assertion(
        cuDeviceGetAttribute(&local_mem_size,
                             ...
                             device->get()) == CUDA_SUCCESS);
    __sycl_ns::detail::pi::assertion(local_mem_size >= 0);
    return getInfo(param_value_size, param_value, param_value_size_ret,
  ...
  case PI_DEVICE_INFO_ERROR_CORRECTION_SUPPORT: {
    ...
    __sycl_ns::detail::pi::assertion((ecc_enabled == 0) |
                                                 (ecc_enabled == 1));
  ...
  case PI_DEVICE_INFO_HOST_UNIFIED_MEMORY: {
    ...
    __sycl_ns::detail::pi::assertion((is_integrated == 0) |
                                                 (is_integrated == 1));
  ...
  __sycl_ns::detail::pi::die("Device info request not implemented");
  return {};
}
...
pi_result cuda_piMemGetInfo(pi_mem, cl_mem_info, size_t, void *, size_t *) {
  __sycl_ns::detail::pi::die("cuda_piMemGetInfo not implemented");
}
...
pi_result cuda_piQueueGetInfo(pi_queue command_queue, pi_queue_info param_name,
  ...
  __sycl_ns::detail::pi::die("Queue info request not implemented");
  return {};
}
...
pi_result cuda_piEnqueueNativeKernel(pi_queue, void (*)(void *), void *, size_t,
  ...
  __sycl_ns::detail::pi::die("Not implemented in CUDA backend");
  return {};
}
...
pi_result cuda_piextKernelCreateWithNativeHandle(pi_native_handle, pi_context,
                                                 pi_program, bool,
                                                 pi_kernel *) {
  __sycl_ns::detail::pi::die("Unsupported operation");
  return PI_SUCCESS;
}
...
static size_t imageElementByteSize(CUDA_ARRAY_DESCRIPTOR array_desc) {
  ...
  case CU_AD_FORMAT_FLOAT:
    return 4;
  default:
    __sycl_ns::detail::pi::die("Invalid image format.");
    return 0;
  }
}
