...
struct _pi_mem {
  ...
  _pi_mem(pi_context ctxt, pi_device dev, pi_mem parent,
          ...
          size_t size)
      : context_{ctxt}, device_{dev}, refCount_{1},
        mem_type_{mem_type::buffer} {
  ...
  CUcontext get_native_context() const noexcept {
    return context_->get(device_);
  }
