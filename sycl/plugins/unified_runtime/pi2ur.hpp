...
#define MAP(FROM, TO)                                                          \
  case FROM: {                                                                 \
    ...
    MAP(PI_DEVICE_INFO_TYPE, UR_DEVICE_INFO_TYPE)
    MAP(PI_DEVICE_INFO_PARENT_DEVICE, UR_DEVICE_INFO_PARENT_DEVICE)
    MAP(PI_DEVICE_INFO_PLATFORM, UR_DEVICE_INFO_PLATFORM)
    MAP(PI_DEVICE_INFO_VENDOR_ID, UR_DEVICE_INFO_VENDOR_ID)
    MAP(PI_DEVICE_INFO_UUID, UR_DEVICE_INFO_UUID)
    MAP(PI_DEVICE_INFO_ATOMIC_64, UR_DEVICE_INFO_ATOMIC_64)
    MAP(PI_DEVICE_INFO_EXTENSIONS, UR_DEVICE_INFO_EXTENSIONS)
    MAP(PI_DEVICE_INFO_NAME, UR_DEVICE_INFO_NAME)
    MAP(PI_DEVICE_INFO_COMPILER_AVAILABLE, UR_DEVICE_INFO_COMPILER_AVAILABLE)
    MAP(PI_DEVICE_INFO_LINKER_AVAILABLE, UR_DEVICE_INFO_LINKER_AVAILABLE)
    MAP(PI_DEVICE_INFO_MAX_COMPUTE_UNITS, UR_DEVICE_INFO_MAX_COMPUTE_UNITS)
    MAP(PI_DEVICE_INFO_MAX_WORK_ITEM_DIMENSIONS,
        UR_DEVICE_INFO_MAX_WORK_ITEM_DIMENSIONS)
    MAP(PI_DEVICE_INFO_MAX_WORK_GROUP_SIZE, UR_DEVICE_INFO_MAX_WORK_GROUP_SIZE)
    MAP(PI_DEVICE_INFO_MAX_WORK_ITEM_SIZES, UR_DEVICE_INFO_MAX_WORK_ITEM_SIZES)
    MAP(PI_DEVICE_INFO_MAX_CLOCK_FREQUENCY, UR_DEVICE_INFO_MAX_CLOCK_FREQUENCY)
    MAP(PI_DEVICE_INFO_ADDRESS_BITS, UR_DEVICE_INFO_ADDRESS_BITS)
    MAP(PI_DEVICE_INFO_MAX_MEM_ALLOC_SIZE, UR_DEVICE_INFO_MAX_MEM_ALLOC_SIZE)
    MAP(PI_DEVICE_INFO_GLOBAL_MEM_SIZE, UR_DEVICE_INFO_GLOBAL_MEM_SIZE)
    MAP(PI_DEVICE_INFO_LOCAL_MEM_SIZE, UR_DEVICE_INFO_LOCAL_MEM_SIZE)
    MAP(PI_DEVICE_INFO_IMAGE_SUPPORT, UR_DEVICE_INFO_IMAGE_SUPPORTED)
    MAP(PI_DEVICE_INFO_HOST_UNIFIED_MEMORY, UR_DEVICE_INFO_HOST_UNIFIED_MEMORY)
    MAP(PI_DEVICE_INFO_AVAILABLE, UR_DEVICE_INFO_AVAILABLE)
    MAP(PI_DEVICE_INFO_VENDOR, UR_DEVICE_INFO_VENDOR)
    MAP(PI_DEVICE_INFO_DRIVER_VERSION, UR_DEVICE_INFO_DRIVER_VERSION)
    MAP(PI_DEVICE_INFO_VERSION, UR_DEVICE_INFO_VERSION)
    MAP(PI_DEVICE_INFO_PARTITION_MAX_SUB_DEVICES,
        UR_DEVICE_INFO_PARTITION_MAX_SUB_DEVICES)
    MAP(PI_DEVICE_INFO_REFERENCE_COUNT, UR_DEVICE_INFO_REFERENCE_COUNT)
    MAP(PI_DEVICE_INFO_PARTITION_PROPERTIES,
        UR_DEVICE_INFO_SUPPORTED_PARTITIONS)
    MAP(PI_DEVICE_INFO_PARTITION_AFFINITY_DOMAIN,
        UR_DEVICE_INFO_PARTITION_AFFINITY_DOMAIN)
    MAP(PI_DEVICE_INFO_PARTITION_TYPE, UR_DEVICE_INFO_PARTITION_TYPE)
    MAP(PI_DEVICE_INFO_OPENCL_C_VERSION, UR_EXT_DEVICE_INFO_OPENCL_C_VERSION)
    MAP(PI_DEVICE_INFO_PREFERRED_INTEROP_USER_SYNC,
        UR_DEVICE_INFO_PREFERRED_INTEROP_USER_SYNC)
    MAP(PI_DEVICE_INFO_PRINTF_BUFFER_SIZE, UR_DEVICE_INFO_PRINTF_BUFFER_SIZE)
    MAP(PI_DEVICE_INFO_PROFILE, UR_DEVICE_INFO_PROFILE)
    MAP(PI_DEVICE_INFO_BUILT_IN_KERNELS, UR_DEVICE_INFO_BUILT_IN_KERNELS)
    MAP(PI_DEVICE_INFO_QUEUE_PROPERTIES, UR_DEVICE_INFO_QUEUE_PROPERTIES)
    MAP(PI_DEVICE_INFO_EXECUTION_CAPABILITIES,
    ...
    MAP(PI_DEVICE_INFO_PROFILING_TIMER_RESOLUTION,
        UR_DEVICE_INFO_PROFILING_TIMER_RESOLUTION)
    MAP(PI_DEVICE_INFO_LOCAL_MEM_TYPE, UR_DEVICE_INFO_LOCAL_MEM_TYPE)
    MAP(PI_DEVICE_INFO_MAX_CONSTANT_ARGS, UR_DEVICE_INFO_MAX_CONSTANT_ARGS)
    MAP(PI_DEVICE_INFO_MAX_CONSTANT_BUFFER_SIZE,
        UR_DEVICE_INFO_MAX_CONSTANT_BUFFER_SIZE)
    MAP(PI_DEVICE_INFO_GLOBAL_MEM_CACHE_TYPE,
        UR_DEVICE_INFO_GLOBAL_MEM_CACHE_TYPE)
    MAP(PI_DEVICE_INFO_GLOBAL_MEM_CACHELINE_SIZE,
        UR_DEVICE_INFO_GLOBAL_MEM_CACHELINE_SIZE)
    MAP(PI_DEVICE_INFO_GLOBAL_MEM_CACHE_SIZE,
        UR_DEVICE_INFO_GLOBAL_MEM_CACHE_SIZE)
    MAP(PI_DEVICE_INFO_MAX_PARAMETER_SIZE, UR_DEVICE_INFO_MAX_PARAMETER_SIZE)
    MAP(PI_DEVICE_INFO_MEM_BASE_ADDR_ALIGN, UR_DEVICE_INFO_MEM_BASE_ADDR_ALIGN)
    MAP(PI_DEVICE_INFO_MAX_SAMPLERS, UR_DEVICE_INFO_MAX_SAMPLERS)
    MAP(PI_DEVICE_INFO_MAX_READ_IMAGE_ARGS, UR_DEVICE_INFO_MAX_READ_IMAGE_ARGS)
    MAP(PI_DEVICE_INFO_MAX_WRITE_IMAGE_ARGS,
        UR_DEVICE_INFO_MAX_WRITE_IMAGE_ARGS)
    MAP(PI_DEVICE_INFO_SINGLE_FP_CONFIG, UR_DEVICE_INFO_SINGLE_FP_CONFIG)
    MAP(PI_DEVICE_INFO_HALF_FP_CONFIG, UR_DEVICE_INFO_HALF_FP_CONFIG)
    MAP(PI_DEVICE_INFO_DOUBLE_FP_CONFIG, UR_DEVICE_INFO_DOUBLE_FP_CONFIG)
    MAP(PI_DEVICE_INFO_IMAGE2D_MAX_WIDTH, UR_DEVICE_INFO_IMAGE2D_MAX_WIDTH)
    MAP(PI_DEVICE_INFO_IMAGE2D_MAX_HEIGHT, UR_DEVICE_INFO_IMAGE2D_MAX_HEIGHT)
    MAP(PI_DEVICE_INFO_IMAGE3D_MAX_WIDTH, UR_DEVICE_INFO_IMAGE3D_MAX_WIDTH)
    MAP(PI_DEVICE_INFO_IMAGE3D_MAX_HEIGHT, UR_DEVICE_INFO_IMAGE3D_MAX_HEIGHT)
    MAP(PI_DEVICE_INFO_IMAGE3D_MAX_DEPTH, UR_DEVICE_INFO_IMAGE3D_MAX_DEPTH)
    MAP(PI_DEVICE_INFO_IMAGE_MAX_BUFFER_SIZE,
        UR_DEVICE_INFO_IMAGE_MAX_BUFFER_SIZE)
    MAP(PI_DEVICE_INFO_NATIVE_VECTOR_WIDTH_CHAR,
        UR_DEVICE_INFO_NATIVE_VECTOR_WIDTH_CHAR)
    MAP(PI_DEVICE_INFO_PREFERRED_VECTOR_WIDTH_CHAR,
        UR_DEVICE_INFO_PREFERRED_VECTOR_WIDTH_CHAR)
    MAP(PI_DEVICE_INFO_NATIVE_VECTOR_WIDTH_SHORT,
        UR_DEVICE_INFO_NATIVE_VECTOR_WIDTH_SHORT)
    MAP(PI_DEVICE_INFO_PREFERRED_VECTOR_WIDTH_SHORT,
    ...
    MAP(PI_DEVICE_INFO_PREFERRED_VECTOR_WIDTH_INT,
        UR_DEVICE_INFO_PREFERRED_VECTOR_WIDTH_INT)
    MAP(PI_DEVICE_INFO_NATIVE_VECTOR_WIDTH_LONG,
        UR_DEVICE_INFO_NATIVE_VECTOR_WIDTH_LONG)
    MAP(PI_DEVICE_INFO_PREFERRED_VECTOR_WIDTH_LONG,
        UR_DEVICE_INFO_PREFERRED_VECTOR_WIDTH_LONG)
    MAP(PI_DEVICE_INFO_NATIVE_VECTOR_WIDTH_FLOAT,
        UR_DEVICE_INFO_NATIVE_VECTOR_WIDTH_FLOAT)
    MAP(PI_DEVICE_INFO_PREFERRED_VECTOR_WIDTH_FLOAT,
        UR_DEVICE_INFO_PREFERRED_VECTOR_WIDTH_FLOAT)
    MAP(PI_DEVICE_INFO_NATIVE_VECTOR_WIDTH_DOUBLE,
        UR_DEVICE_INFO_NATIVE_VECTOR_WIDTH_DOUBLE)
    MAP(PI_DEVICE_INFO_PREFERRED_VECTOR_WIDTH_DOUBLE,
        UR_DEVICE_INFO_PREFERRED_VECTOR_WIDTH_DOUBLE)
    MAP(PI_DEVICE_INFO_NATIVE_VECTOR_WIDTH_HALF,
        UR_DEVICE_INFO_NATIVE_VECTOR_WIDTH_HALF)
    MAP(PI_DEVICE_INFO_PREFERRED_VECTOR_WIDTH_HALF,
        UR_DEVICE_INFO_PREFERRED_VECTOR_WIDTH_HALF)
    MAP(PI_DEVICE_INFO_MAX_NUM_SUB_GROUPS, UR_DEVICE_INFO_MAX_NUM_SUB_GROUPS)
    MAP(PI_DEVICE_INFO_SUB_GROUP_INDEPENDENT_FORWARD_PROGRESS,
        UR_DEVICE_INFO_SUB_GROUP_INDEPENDENT_FORWARD_PROGRESS)
    MAP(PI_DEVICE_INFO_SUB_GROUP_SIZES_INTEL,
        UR_DEVICE_INFO_SUB_GROUP_SIZES_INTEL)
    MAP(PI_DEVICE_INFO_IL_VERSION, UR_DEVICE_INFO_IL_VERSION)
    MAP(PI_DEVICE_INFO_USM_HOST_SUPPORT, UR_DEVICE_INFO_USM_HOST_SUPPORT)
    MAP(PI_DEVICE_INFO_USM_DEVICE_SUPPORT, UR_DEVICE_INFO_USM_DEVICE_SUPPORT)
    MAP(PI_DEVICE_INFO_USM_SINGLE_SHARED_SUPPORT,
        UR_DEVICE_INFO_USM_SINGLE_SHARED_SUPPORT)
    MAP(PI_DEVICE_INFO_USM_CROSS_SHARED_SUPPORT,
    ...
    MAP(PI_DEVICE_INFO_PCI_ADDRESS, UR_DEVICE_INFO_PCI_ADDRESS)
    MAP(PI_DEVICE_INFO_GPU_EU_COUNT, UR_DEVICE_INFO_GPU_EU_COUNT)
    MAP(PI_DEVICE_INFO_GPU_EU_SIMD_WIDTH, UR_DEVICE_INFO_GPU_EU_SIMD_WIDTH)
    MAP(PI_DEVICE_INFO_GPU_SUBSLICES_PER_SLICE,
        UR_DEVICE_INFO_GPU_SUBSLICES_PER_SLICE)
    MAP(PI_EXT_ONEAPI_DEVICE_INFO_IP_VERSION, UR_DEVICE_INFO_IP_VERSION)
    MAP(PI_DEVICE_INFO_BUILD_ON_SUBDEVICE, UR_DEVICE_INFO_BUILD_ON_SUBDEVICE)
    MAP(PI_EXT_ONEAPI_DEVICE_INFO_MAX_WORK_GROUPS_3D,
        UR_DEVICE_INFO_MAX_WORK_GROUPS_3D)
    MAP(PI_DEVICE_INFO_IMAGE_MAX_ARRAY_SIZE,
        UR_DEVICE_INFO_IMAGE_MAX_ARRAY_SIZE)
    MAP(PI_DEVICE_INFO_DEVICE_ID, UR_DEVICE_INFO_DEVICE_ID)
    MAP(PI_EXT_INTEL_DEVICE_INFO_FREE_MEMORY, UR_DEVICE_INFO_GLOBAL_MEM_FREE)
    MAP(PI_EXT_INTEL_DEVICE_INFO_MEMORY_CLOCK_RATE,
        UR_DEVICE_INFO_MEMORY_CLOCK_RATE)
    MAP(PI_EXT_INTEL_DEVICE_INFO_MEMORY_BUS_WIDTH,
        UR_DEVICE_INFO_MEMORY_BUS_WIDTH)
    MAP(PI_EXT_INTEL_DEVICE_INFO_MAX_COMPUTE_QUEUE_INDICES,
        UR_DEVICE_INFO_MAX_COMPUTE_QUEUE_INDICES)
    MAP(PI_DEVICE_INFO_GPU_SLICES, UR_DEVICE_INFO_GPU_EU_SLICES)
    MAP(PI_DEVICE_INFO_GPU_EU_COUNT_PER_SUBSLICE,
        UR_DEVICE_INFO_GPU_EU_COUNT_PER_SUBSLICE)
    MAP(PI_DEVICE_INFO_GPU_HW_THREADS_PER_EU,
        UR_DEVICE_INFO_GPU_HW_THREADS_PER_EU)
    MAP(PI_DEVICE_INFO_MAX_MEM_BANDWIDTH, UR_DEVICE_INFO_MAX_MEMORY_BANDWIDTH)
    MAP(PI_EXT_ONEAPI_DEVICE_INFO_BFLOAT16_MATH_FUNCTIONS,
        UR_DEVICE_INFO_BFLOAT16)
    MAP(PI_EXT_DEVICE_INFO_ATOMIC_MEMORY_ORDER_CAPABILITIES,
        UR_DEVICE_INFO_ATOMIC_MEMORY_ORDER_CAPABILITIES)
    MAP(PI_EXT_DEVICE_INFO_ATOMIC_MEMORY_SCOPE_CAPABILITIES,
        UR_DEVICE_INFO_ATOMIC_MEMORY_SCOPE_CAPABILITIES)
    MAP(PI_EXT_DEVICE_INFO_ATOMIC_FENCE_ORDER_CAPABILITIES,
        UR_DEVICE_INFO_ATOMIC_FENCE_ORDER_CAPABILITIES)
    MAP(PI_EXT_DEVICE_INFO_ATOMIC_FENCE_SCOPE_CAPABILITIES,
    ...
    MAP(PI_DEVICE_INFO_IMAGE_SRGB, UR_DEVICE_INFO_IMAGE_SRGB)
    MAP(PI_DEVICE_INFO_BACKEND_VERSION, UR_DEVICE_INFO_BACKEND_RUNTIME_VERSION)
    MAP(PI_EXT_CODEPLAY_DEVICE_INFO_MAX_REGISTERS_PER_WORK_GROUP,
        UR_DEVICE_INFO_MAX_REGISTERS_PER_WORK_GROUP)
    MAP(PI_EXT_ONEAPI_DEVICE_INFO_BINDLESS_IMAGES_SUPPORT,
        UR_DEVICE_INFO_BINDLESS_IMAGES_SUPPORT_EXP)
    MAP(PI_EXT_ONEAPI_DEVICE_INFO_BINDLESS_IMAGES_1D_USM_SUPPORT,
    ...
    MAP(PI_EXT_ONEAPI_DEVICE_INFO_IMAGE_PITCH_ALIGN,
        UR_DEVICE_INFO_IMAGE_PITCH_ALIGN_EXP)
    MAP(PI_EXT_ONEAPI_DEVICE_INFO_MAX_IMAGE_LINEAR_WIDTH,
        UR_DEVICE_INFO_MAX_IMAGE_LINEAR_WIDTH_EXP)
    MAP(PI_EXT_ONEAPI_DEVICE_INFO_MAX_IMAGE_LINEAR_HEIGHT,
        UR_DEVICE_INFO_MAX_IMAGE_LINEAR_HEIGHT_EXP)
    MAP(PI_EXT_ONEAPI_DEVICE_INFO_MAX_IMAGE_LINEAR_PITCH,
        UR_DEVICE_INFO_MAX_IMAGE_LINEAR_PITCH_EXP)
    MAP(PI_EXT_ONEAPI_DEVICE_INFO_MIPMAP_SUPPORT,
        UR_DEVICE_INFO_MIPMAP_SUPPORT_EXP)
    MAP(PI_EXT_ONEAPI_DEVICE_INFO_MIPMAP_ANISOTROPY_SUPPORT,
        UR_DEVICE_INFO_MIPMAP_ANISOTROPY_SUPPORT_EXP)
    MAP(PI_EXT_ONEAPI_DEVICE_INFO_MIPMAP_MAX_ANISOTROPY,
        UR_DEVICE_INFO_MIPMAP_MAX_ANISOTROPY_EXP)
    MAP(PI_EXT_ONEAPI_DEVICE_INFO_MIPMAP_LEVEL_REFERENCE_SUPPORT,
        UR_DEVICE_INFO_MIPMAP_LEVEL_REFERENCE_SUPPORT_EXP)
    MAP(PI_EXT_ONEAPI_DEVICE_INFO_INTEROP_MEMORY_IMPORT_SUPPORT,
        UR_DEVICE_INFO_INTEROP_MEMORY_IMPORT_SUPPORT_EXP)
    MAP(PI_EXT_ONEAPI_DEVICE_INFO_INTEROP_MEMORY_EXPORT_SUPPORT,
        UR_DEVICE_INFO_INTEROP_MEMORY_EXPORT_SUPPORT_EXP)
    MAP(PI_EXT_ONEAPI_DEVICE_INFO_INTEROP_SEMAPHORE_IMPORT_SUPPORT,
        UR_DEVICE_INFO_INTEROP_SEMAPHORE_IMPORT_SUPPORT_EXP)
    MAP(PI_EXT_ONEAPI_DEVICE_INFO_INTEROP_SEMAPHORE_EXPORT_SUPPORT,
...
static void pi2urImageInfoFlags(const pi_image_info PiFlags,
  ...
  switch (PiFlags) {
  case PI_IMAGE_INFO_FORMAT:
    *UrFlags = UR_IMAGE_INFO_FORMAT;
    break;
  case PI_IMAGE_INFO_ELEMENT_SIZE:
    *UrFlags = UR_IMAGE_INFO_ELEMENT_SIZE;
    break;
  case PI_IMAGE_INFO_ROW_PITCH:
    *UrFlags = UR_IMAGE_INFO_ROW_PITCH;
    break;
  case PI_IMAGE_INFO_SLICE_PITCH:
    *UrFlags = UR_IMAGE_INFO_SLICE_PITCH;
    break;
  case PI_IMAGE_INFO_WIDTH:
    *UrFlags = UR_IMAGE_INFO_WIDTH;
    break;
  case PI_IMAGE_INFO_HEIGHT:
    *UrFlags = UR_IMAGE_INFO_HEIGHT;
    break;
  case PI_IMAGE_INFO_DEPTH:
    *UrFlags = UR_IMAGE_INFO_DEPTH;
    break;
  default:
