...
static pi_result ur2piResult(ur_result_t urResult) {
  ...
  //
  static std::unordered_map<ur_result_t, pi_result> ErrorMapping = {
      ...
      {UR_RESULT_ERROR_INVALID_WORK_GROUP_SIZE, PI_ERROR_INVALID_WORK_GROUP_SIZE},
...
inline pi_result piPlatformsGet(pi_uint32 num_entries, pi_platform *platforms,
  ...
  return ur2piResult(urPlatformGet(num_entries, phPlatforms, num_platforms));
}
