...
const int ZER_EXT_DEVICE_INFO_ATOMIC_FENCE_ORDER_CAPABILITIES =
    ZER_EXT_DEVICE_INFO_END - 16;
const int ZER_EXT_DEVICE_INFO_ATOMIC_FENCE_SCOPE_CAPABILITIES =
    ZER_EXT_DEVICE_INFO_END - 17;
