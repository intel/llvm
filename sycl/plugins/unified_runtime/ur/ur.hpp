...
const int UR_EXT_CONTEXT_INFO_REFERENCE_COUNT = UR_EXT_CONTEXT_INFO_END - 1;
...
const int UR_EXT_CONTEXT_INFO_USM_MEMCPY2D_SUPPORT =
    UR_EXT_CONTEXT_INFO_END - 4;
const int UR_EXT_CONTEXT_INFO_USM_FILL2D_SUPPORT = UR_EXT_CONTEXT_INFO_END - 5;
const int UR_EXT_CONTEXT_INFO_USM_MEMSET2D_SUPPORT =
    UR_EXT_CONTEXT_INFO_END - 6;
