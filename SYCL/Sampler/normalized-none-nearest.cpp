...
// Four pixels at low-boundary locations, sample: Normalized + None + Nearest
std::vector<pixelT> ref_boundary = {
    {1, 2, 3, 4}, {49, 48, 47, 46}, {59, 58, 57, 56}, {11, 12, 13, 14}};
// Four pixels at exact center locations, sample : Normalized + None + Nearest
std::vector<pixelT> ref_center = {
    {1, 2, 3, 4}, {49, 48, 47, 46}, {59, 58, 57, 56}, {11, 12, 13, 14}};
// four pixels at inexact upper boundary, sample : Normalized + None + Nearest
std::vector<pixelT> ref_upper = {
    {1, 2, 3, 4}, {49, 48, 47, 46}, {59, 58, 57, 56}, {11, 12, 13, 14}};
...
void test_normalized_none_nearest_sampler(image_channel_order ChanOrder,
  ...
  { // closure
    ...
    std::cout << "read four pixels at inexact upper boundary,  sample:   "
                 "Normalized +  None  + Nearest"
              << std::endl;
    check_pixels(test_acc, ref_upper, offset);
  }
} // ~image / ~buffer
