...
// RUN: %clangxx -DIMPL_SUBGROUP -fsycl -fno-sycl-device-code-split-esimd -Xclang -fsycl-allow-func-ptr %S/simd16.cpp -o %t.out
...
/*
 * This tests is the same as InvokeSimd/spec/simd_size/simd16.cpp, but
