...
#define __CLC_NVVM_ATOMIC_MIN_IMPL(                                                                                                                                                                              \
    ...
    ADDR_SPACE_MANGLED, SUBSTITUTION1, SUBSTITUTION2)                                                                                                                                                            \
  TYPE_INT                                                                                                                                                                                                       \
  _Z18__spirv_AtomicLoadP##ADDR_SPACE_MANGLED##K##TYPE_INT_MANGLED##N5__spv5Scope4FlagENS1_19MemorySemanticsMask4FlagE(                                                                                          \
      volatile ADDR_SPACE const TYPE_INT *, enum Scope,                                                                                                                                                          \
      enum MemorySemanticsMask);                                                                                                                                                                                 \
  TYPE_INT                                                                                                                                                                                                       \
  _Z29__spirv_AtomicCompareExchange##P##ADDR_SPACE_MANGLED##TYPE_INT_MANGLED##N5__spv5Scope4FlagENS##SUBSTITUTION1##_19MemorySemanticsMask4FlagES##SUBSTITUTION2##_##TYPE_INT_MANGLED##TYPE_INT_MANGLED(         \
  ...
  __attribute__((always_inline)) _CLC_DECL TYPE                                                                                                                                                                  \
      _Z21__spirv_Atomic##OP_MANGLED##P##ADDR_SPACE_MANGLED##TYPE_MANGLED##N5__spv5Scope4FlagENS##SUBSTITUTION1##_19MemorySemanticsMask4FlagE##TYPE_MANGLED(                                                     \
...
#define __CLC_NVVM_ATOMIC_MIN(TYPE, TYPE_MANGLED, TYPE_INT, TYPE_INT_MANGLED,  \
  ...
  __CLC_NVVM_ATOMIC_MIN_IMPL(TYPE, TYPE_MANGLED, TYPE_INT, TYPE_INT_MANGLED,   \
                             OP_MANGLED, , , 0, 4)                             \
  __CLC_NVVM_ATOMIC_MIN_IMPL(TYPE, TYPE_MANGLED, TYPE_INT, TYPE_INT_MANGLED,   \
                             OP_MANGLED, __global, U3AS1, 1, 5)                \
  __CLC_NVVM_ATOMIC_MIN_IMPL(TYPE, TYPE_MANGLED, TYPE_INT, TYPE_INT_MANGLED,   \
                             OP_MANGLED, __local, U3AS3, 1, 5)
