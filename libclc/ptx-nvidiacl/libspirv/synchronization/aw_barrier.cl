...
_CLC_OVERLOAD _CLC_DEF void __spirv_BarrierInvalidate(long *state) {
...
_CLC_OVERLOAD _CLC_DEF long __spirv_BarrierArriveNoComplete(long *state,
                                                            int count) {
  return __nvvm_mbarrier_arrive_noComplete(state, count);
}

_CLC_OVERLOAD _CLC_DEF long __spirv_BarrierArriveAndDropNoComplete(long *state,
                                                                   int count) {
...
_CLC_OVERLOAD _CLC_DEF _CLC_CONVERGENT void __spirv_BarrierWait(long *state,
                                                                long arrival) {
