...
test___spirv_ocl_u_mad24(__clc_uint32_t args_0, __clc_uint32_t args_1,
                         __clc_uint32_t args_2) {
  return __spirv_ocl_u_mad24(args_0, args_1, args_2);
}

__attribute__((overloadable)) __clc_vec2_uint32_t
test___spirv_ocl_u_mad24(__clc_vec2_uint32_t args_0, __clc_vec2_uint32_t args_1,
                         __clc_vec2_uint32_t args_2) {
  return __spirv_ocl_u_mad24(args_0, args_1, args_2);
}

__attribute__((overloadable)) __clc_vec3_uint32_t
test___spirv_ocl_u_mad24(__clc_vec3_uint32_t args_0, __clc_vec3_uint32_t args_1,
                         __clc_vec3_uint32_t args_2) {
  return __spirv_ocl_u_mad24(args_0, args_1, args_2);
}

__attribute__((overloadable)) __clc_vec4_uint32_t
test___spirv_ocl_u_mad24(__clc_vec4_uint32_t args_0, __clc_vec4_uint32_t args_1,
                         __clc_vec4_uint32_t args_2) {
  return __spirv_ocl_u_mad24(args_0, args_1, args_2);
}

__attribute__((overloadable)) __clc_vec8_uint32_t
test___spirv_ocl_u_mad24(__clc_vec8_uint32_t args_0, __clc_vec8_uint32_t args_1,
                         __clc_vec8_uint32_t args_2) {
  return __spirv_ocl_u_mad24(args_0, args_1, args_2);
}

__attribute__((overloadable)) __clc_vec16_uint32_t
test___spirv_ocl_u_mad24(__clc_vec16_uint32_t args_0,
