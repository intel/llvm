...
test___spirv_ocl_vload_half(__clc_size_t args_0,
                            __clc_fp16_t const __global *args_1) {
  return __spirv_ocl_vload_half(args_0, args_1);
}
...
#ifdef cl_khr_fp16
__attribute__((overloadable)) __clc_fp32_t
test___spirv_ocl_vload_half(__clc_size_t args_0, __clc_fp16_t const *args_1) {
  return __spirv_ocl_vload_half(args_0, args_1);
}
