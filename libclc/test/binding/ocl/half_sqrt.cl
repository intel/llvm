...
test___spirv_ocl_half_sqrt(__clc_fp32_t args_0) {
  return __spirv_ocl_half_sqrt(args_0);
}

__attribute__((overloadable)) __clc_vec2_fp32_t
test___spirv_ocl_half_sqrt(__clc_vec2_fp32_t args_0) {
  return __spirv_ocl_half_sqrt(args_0);
}

__attribute__((overloadable)) __clc_vec3_fp32_t
test___spirv_ocl_half_sqrt(__clc_vec3_fp32_t args_0) {
  return __spirv_ocl_half_sqrt(args_0);
}

__attribute__((overloadable)) __clc_vec4_fp32_t
test___spirv_ocl_half_sqrt(__clc_vec4_fp32_t args_0) {
  return __spirv_ocl_half_sqrt(args_0);
}

__attribute__((overloadable)) __clc_vec8_fp32_t
test___spirv_ocl_half_sqrt(__clc_vec8_fp32_t args_0) {
  return __spirv_ocl_half_sqrt(args_0);
}

__attribute__((overloadable)) __clc_vec16_fp32_t
test___spirv_ocl_half_sqrt(__clc_vec16_fp32_t args_0) {
  return __spirv_ocl_half_sqrt(args_0);
}
