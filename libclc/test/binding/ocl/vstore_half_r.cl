...
test___spirv_ocl_vstore_half_r(__clc_fp32_t args_0, __clc_size_t args_1,
                               __clc_fp16_t __global *args_2,
                               __clc_uint32_t args_3) {
  __spirv_ocl_vstore_half_r(args_0, args_1, args_2, args_3);
}
...
#ifdef cl_khr_fp64
__attribute__((overloadable)) void
test___spirv_ocl_vstore_half_r(__clc_fp64_t args_0, __clc_size_t args_1,
                               __clc_fp16_t __global *args_2,
                               __clc_uint32_t args_3) {
  __spirv_ocl_vstore_half_r(args_0, args_1, args_2, args_3);
}
