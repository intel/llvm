...
__clc_vec2_schar_t test___spirv_ConvertFToS_Rschar2(__clc_vec2_fp64_t args_0) {
  return __spirv_ConvertFToS_Rschar2(args_0);
}
...
#ifdef cl_khr_fp16
__attribute__((overloadable))
__clc_vec2_schar_t test___spirv_ConvertFToS_Rschar2(__clc_vec2_fp16_t args_0) {
  return __spirv_ConvertFToS_Rschar2(args_0);
}
