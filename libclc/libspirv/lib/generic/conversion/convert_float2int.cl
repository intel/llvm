...
#define __CLC_FUNCTION_S                                                       \
  __CLC_XCONCAT(__spirv_ConvertFToS_R, __CLC_S_GENTYPE_DST)
#define __CLC_FUNCTION_U                                                       \
  __CLC_XCONCAT(__spirv_ConvertFToU_R, __CLC_U_GENTYPE_DST)
