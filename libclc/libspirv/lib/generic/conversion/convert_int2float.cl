...
#define __CLC_FUNCTION_S __CLC_XCONCAT(__spirv_ConvertSToF_R, __CLC_GENTYPE)
#define __CLC_FUNCTION_U __CLC_XCONCAT(__spirv_ConvertUToF_R, __CLC_GENTYPE)
#define __CLC_IMPL_FUNCTION __CLC_XCONCAT(__clc_convert_, __CLC_GENTYPE)

#define __CLC_INT_TO_FLOAT
