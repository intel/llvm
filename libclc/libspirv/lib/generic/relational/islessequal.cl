...
#define __CLC_FUNCTION __spirv_FOrdLessThanEqual
#define __CLC_IMPL_FUNCTION(x) __clc_islessequal
...
#define __CLC_FUNCTION __spirv_FUnordLessThanEqual
#define __CLC_IMPL_FUNCTION(x) __CLC_REL_OP_BODY
#define __CLC_REL_OP_BODY(x, y)                                                \
  ((__clc_isunordered(x, y)) || (__clc_islessequal(x, y)))
#define __CLC_BODY "relational_binary_def.inc"
#include "clc/math/gentype.inc"
