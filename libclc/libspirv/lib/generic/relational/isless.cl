...
#define __CLC_FUNCTION __spirv_FOrdLessThan
#define __CLC_IMPL_FUNCTION(x) __clc_isless
...
#define __CLC_FUNCTION __spirv_FUnordLessThan
#define __CLC_IMPL_FUNCTION(x) __CLC_REL_OP_BODY
#define __CLC_REL_OP_BODY(x, y)                                                \
  ((__clc_isunordered(x, y)) || (__clc_isless(x, y)))
#define __CLC_BODY "relational_binary_def.inc"
#include "clc/math/gentype.inc"
