...
__CLC_NVVM_ATOMIC(unsigned int, unsigned int, ui, max,
                  __spirv_AtomicUMax)
__CLC_NVVM_ATOMIC(unsigned long, unsigned long, ul, max,
                  __spirv_AtomicUMax)
...
#define __CLC_NVVM_ATOMIC_MAX_IMPL(                                        \
    TYPE, TYPE_INT, OP_MANGLED, ADDR_SPACE)                                \
  ...
  __spirv_Atomic##OP_MANGLED(ADDR_SPACE TYPE *pointer, int scope,          \
    ...
    ADDR_SPACE TYPE_INT *pointer_int =                                     \
        (ADDR_SPACE TYPE_INT *)pointer;                                    \
