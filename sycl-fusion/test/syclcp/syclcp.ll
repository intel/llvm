...
define spir_kernel void @fused_0(ptr byval(%0) align 8 %KernelOne_accTmp3, ptr addrspace(1) align 4 %KernelOne_accIn1, ptr byval(%0) align 8 %KernelOne_accIn16, ptr addrspace(1) align 4 %KernelOne_accIn2, ptr addrspace(1) align 4 %KernelTwo_out, %2* byval(%2) align 4 %KernelTwo_coef) !kernel_arg_addr_space !16 !kernel_arg_access_qual !7 !kernel_arg_type !17 !kernel_arg_type_qual !9 !kernel_arg_base_type !17 !kernel_arg_name !18 !sycl.kernel.constants !19 {
...
entry:
  ...
  call spir_func void @__itt_offload_wi_start_wrapper() #4
  %7 = bitcast %3* %KernelTwo.i to ptr
