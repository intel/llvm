...
define spir_kernel void @fused_0(%0 addrspace(1)* align 16 %KernelOne_accTmp, ptr byval(%1) align 8 %KernelOne_accTmp3, %0 addrspace(1)* align 16 %KernelOne_accIn1, ptr byval(%1) align 8 %KernelOne_accIn16, %0 addrspace(1)* align 16 %KernelOne_accIn2, %0 addrspace(1)* align 16 %KernelTwo_accOut, %0 addrspace(1)* align 16 %KernelTwo_accIn3) !kernel_arg_addr_space !12 !kernel_arg_access_qual !13 !kernel_arg_type !14 !kernel_arg_type_qual !15 !kernel_arg_base_type !14 !kernel_arg_name !16 !sycl.kernel.promote !17 !sycl.kernel.promote.localsize !18 {
...
; CHECK-SAME: (ptr addrspace(3) align 16 [[KERNELONE_ACCTMP:%.*]], ptr byval([[TYPE1:%.*]]) align 8 [[KERNELONE_ACCTMP3:%.*]], ptr addrspace(1) align 16 [[KERNELONE_ACCIN1:%.*]], ptr byval([[TYPE1]]) align 8 [[KERNELONE_ACCIN16:%.*]], ptr addrspace(1) align 16 [[KERNELONE_ACCIN2:%.*]], ptr addrspace(1) align 16 [[KERNELTWO_ACCOUT:%.*]], ptr addrspace(1) align 16 [[KERNELTWO_ACCIN3:%.*]])
; CHECK:  entry:
; CHECK:    [[KERNELONE_ACCTMP31_SROA_0_0__SROA_IDX:%.*]] = getelementptr inbounds [[TYPE1]], ptr [[KERNELONE_ACCTMP3]], i64 0, i32 0, i32 0, i64 0
; CHECK:    [[KERNELONE_ACCTMP31_SROA_0_0_COPYLOAD:%.*]] = load i64, ptr [[KERNELONE_ACCTMP31_SROA_0_0__SROA_IDX]], align 1
; CHECK:    [[TMP0:%.*]] = urem i64 [[KERNELONE_ACCTMP31_SROA_0_0_COPYLOAD]], 16
; CHECK:    [[ADD_PTR_I_I:%.*]] = getelementptr inbounds [[TMP02:%.*]], ptr addrspace(3) [[KERNELONE_ACCTMP]], i64 [[TMP0]]
...
; CHECK:    [[ARRAYIDX_I13_I_I:%.*]] = getelementptr inbounds [[TMP02]], ptr addrspace(3) [[ADD_PTR_I_I]], i64 [[TMP10]]
; CHECK:    [[TMP11:%.*]] = add i64 0, [[TMP10]]
; CHECK:    [[TMP12:%.*]] = add i64 [[TMP11]], [[TMP0]]
; CHECK:    [[TMP13:%.*]] = urem i64 [[TMP12]], 16
; CHECK:    [[REF_TMP_SROA_0_0__SROA_IDX_I_I:%.*]] = getelementptr inbounds [[TMP02]], ptr addrspace(3) [[ARRAYIDX_I13_I_I]], i64 [[TMP13]], i32 0
...
; CHECK:    [[ADD_PTR_I39_I8:%.*]] = getelementptr inbounds [[TMP02]], ptr addrspace(3) [[KERNELONE_ACCTMP]], i64 [[TMP14]]
...
; CHECK:    [[ARRAYIDX_I_I_I11:%.*]] = getelementptr inbounds [[TMP02]], ptr addrspace(3) [[ADD_PTR_I39_I8]], i64 [[TMP22]]
; CHECK:    [[TMP23:%.*]] = add i64 0, [[TMP22]]
; CHECK:    [[TMP24:%.*]] = add i64 [[TMP23]], [[TMP14]]
; CHECK:    [[TMP25:%.*]] = urem i64 [[TMP24]], 16
; CHECK:    [[M_DATA_I_I_I15:%.*]] = getelementptr inbounds [[TMP02]], ptr addrspace(3) [[ARRAYIDX_I_I_I11]], i64 [[TMP25]], i32 0
