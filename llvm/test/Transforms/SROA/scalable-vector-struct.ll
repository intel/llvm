...
; RUN: opt -opaque-pointers=1 < %s -passes='sroa<preserve-cfg>' -S | FileCheck %s --check-prefixes=CHECK
; RUN: opt -opaque-pointers=1 < %s -passes='sroa<modify-cfg>' -S | FileCheck %s --check-prefixes=CHECK
