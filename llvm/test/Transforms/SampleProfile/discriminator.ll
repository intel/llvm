...
; pointers by default
; RUN: opt -opaque-pointers < %s -passes=sample-profile -sample-profile-file=%S/Inputs/discriminator.prof | opt -opaque-pointers -passes='print<branch-prob>' -disable-output 2>&1 | FileCheck %s
