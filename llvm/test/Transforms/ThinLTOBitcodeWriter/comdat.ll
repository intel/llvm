...
; FIXME: Align with the community code when project is ready to enable opaque
; pointers by default
; RUN: llvm-modextract -opaque-pointers -n 0 -o - %t | llvm-dis -opaque-pointers | FileCheck --check-prefix=THIN %s
; Added -opaque-pointers.
; FIXME: Align with the community code when project is ready to enable opaque
; pointers by default
; RUN: llvm-modextract -opaque-pointers -n 1 -o - %t | llvm-dis -opaque-pointers | FileCheck --check-prefix=MERGED %s
