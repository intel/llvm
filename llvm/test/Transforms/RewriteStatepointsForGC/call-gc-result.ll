...
; INTEL RUN: opt -opaque-pointers < %s -rewrite-statepoints-for-gc -S | FileCheck %s
; INTEL RUN: opt -opaque-pointers < %s -passes=rewrite-statepoints-for-gc -S | FileCheck %s
