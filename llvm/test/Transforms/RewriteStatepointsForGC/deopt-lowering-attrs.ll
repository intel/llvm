...
; INTEL RUN: opt -opaque-pointers -rewrite-statepoints-for-gc -S < %s | FileCheck %s
; INTEL RUN: opt -opaque-pointers -passes=rewrite-statepoints-for-gc -S < %s | FileCheck %s
