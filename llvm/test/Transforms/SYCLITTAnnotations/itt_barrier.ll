...
;; llvm-link kernel_and_program_optimized.bc -o kernel_and_program_optimized_link.bc --suppress-warnings
...
; CHECK: call void @__itt_spirv_wg_barrier_wrapper()
; CHECK-NEXT: tail call void @_Z22__spirv_ControlBarrierjjj
; CHECK-NEXT: call void @__itt_spirv_wi_resume_wrapper()
...
; CHECK: declare void @__itt_spirv_wg_barrier_wrapper()
; CHECK: declare void @__itt_spirv_wi_resume_wrapper()
