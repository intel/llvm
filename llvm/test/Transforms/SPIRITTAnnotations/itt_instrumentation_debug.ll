...
entry:
  ...
  %call = call spir_func i32 @_Z18__spirv_ocl_printfPU3AS2c(ptr addrspace(2) %0) #1, !dbg !17
  %1 = getelementptr inbounds [16 x i8], ptr addrspace(2) @.str.1, i64 0, i64 0
  %call1 = call spir_func i32 @_Z18__spirv_ocl_printfPU3AS2c(ptr addrspace(2) %1) #1, !dbg !18
  call spir_func void @_Z22__spirv_ControlBarrieriii(i32 2, i32 2, i32 528) #1, !dbg !19
  %2 = getelementptr inbounds [15 x i8], ptr addrspace(2) @.str.2, i64 0, i64 0
  %call2 = call spir_func i32 @_Z18__spirv_ocl_printfPU3AS2c(ptr addrspace(2) %2) #1, !dbg !20
  %3 = getelementptr inbounds [15 x i8], ptr addrspace(2) @.str.3, i64 0, i64 0
  %call3 = call spir_func i32 @_Z18__spirv_ocl_printfPU3AS2c(ptr addrspace(2) %3) #1, !dbg !21
  %4 = load ptr addrspace(1), ptr addrspace(1) @res, align 8, !dbg !22
  %call4 = call spir_func i32 @_Z18__spirv_AtomicIAddPU3AS1iiii(ptr addrspace(1) %4, i32 2, i32 0, i32 1) #1, !dbg !23
  %5 = getelementptr inbounds [14 x i8], ptr addrspace(2) @.str.4, i64 0, i64 0
  %call5 = call spir_func i32 @_Z18__spirv_ocl_printfPU3AS2c(ptr addrspace(2) %5) #1, !dbg !24
  %6 = getelementptr inbounds [6 x i8], ptr addrspace(2) @.str.5, i64 0, i64 0
  %call6 = call spir_func i32 @_Z18__spirv_ocl_printfPU3AS2c(ptr addrspace(2) %6) #1, !dbg !25
  ret void, !dbg !26
}
...
!14 = !DISubroutineType(cc: DW_CC_LLVM_DeviceKernel, types: !15)
!15 = !{null}
