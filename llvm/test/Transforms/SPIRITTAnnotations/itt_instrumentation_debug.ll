...
; CHECK: call spir_func void @__itt_offload_atomic_op_start(i8 addrspace(4)* [[AC1]], i32 2, i32 0), !dbg ![[D3:[0-9]+]]
...
; CHECK: call spir_func void @__itt_offload_atomic_op_finish(i8 addrspace(4)* [[AC2]], i32 2, i32 0), !dbg ![[D3]]
