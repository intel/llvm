...
; RUN: llvm-lto2 run -lto-opaque-pointers -relocation-model=static -opaque-pointers -save-temps %t2.bc -r=%t2.bc,b,pl -r=%t2.bc,a,pl \
...
; RUN: llvm-lto2 run -lto-opaque-pointers -relocation-model=pic -opaque-pointers -save-temps %t2.bc -r=%t2.bc,b,pl -r=%t2.bc,a,pl \
