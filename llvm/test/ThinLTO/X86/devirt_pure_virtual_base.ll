...
; RUN: llvm-lto2 run -lto-opaque-pointers -opaque-pointers %t1a.o -save-temps -pass-remarks=. \
...
; RUN: llvm-lto2 run -lto-opaque-pointers -opaque-pointers %t1b.o -save-temps -pass-remarks=. \
; RUN:   -whole-program-visibility \
; RUN:   -o %t3b \
...
;; Regular LTO WPD
; RUN: opt -o %t1c.o %s
; RUN: llvm-lto2 run -lto-opaque-pointers -opaque-pointers %t1c.o -save-temps -pass-remarks=. \
; RUN:   -whole-program-visibility \
; RUN:   -o %t3c \
