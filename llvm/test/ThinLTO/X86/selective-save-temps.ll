...
; RUN: llvm-lto2 run -lto-opaque-pointers -opaque-pointers 1.bc 2.bc -o all/a.out \
...
;; Check preopt
; RUN: llvm-lto2 run -lto-opaque-pointers -opaque-pointers 1.bc 2.bc -o build/a.out \
; RUN:    -import-constants-with-refs -r=1.bc,main,plx -r=1.bc,_Z6getObjv,l \
; RUN:    -r=2.bc,_Z6getObjv,pl -r=2.bc,val,pl -r=2.bc,outer,pl \
...
; RUN: llvm-lto2 run -lto-opaque-pointers -opaque-pointers 1.bc 2.bc -o subset/a.out \
; RUN:    -import-constants-with-refs -r=1.bc,main,plx -r=1.bc,_Z6getObjv,l \
; RUN:    -r=2.bc,_Z6getObjv,pl -r=2.bc,val,pl -r=2.bc,outer,pl \
...
; RUN: not llvm-lto2 run -lto-opaque-pointers -opaque-pointers 1.bc 2.bc -o build/a.out \
; RUN:    -import-constants-with-refs -r=1.bc,main,plx -r=1.bc,_Z6getObjv,l \
; RUN:    -r=2.bc,_Z6getObjv,pl -r=2.bc,val,pl -r=2.bc,outer,pl \
