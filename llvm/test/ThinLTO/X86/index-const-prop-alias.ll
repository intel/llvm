...
; RUN: llvm-lto2 run -lto-opaque-pointers -opaque-pointers %t1.bc -r=%t1.bc,main,plx -r=%t1.bc,ret_ptr,pl -r=%t1.bc,g.alias,l -r=%t1.bc,g,l \
...
; RUN: llvm-lto2 run -lto-opaque-pointers -opaque-pointers %t1.bc -r=%t1.bc,main,plx -r=%t1.bc,ret_ptr,plx -r=%t1.bc,g.alias,l -r=%t1.bc,g,l \
