...
define dso_local spir_func <16 x i16>  @FUNC_8() {
  %a_1 = alloca <16 x i16>
  %1 = load <16 x i16>, ptr %a_1
  %a_2 = alloca  <16 x i16>
  %2 = load  <16 x i16>,  ptr %a_2
...
define dso_local spir_func <16 x i32>  @FUNC_23() {
  %ret_val = call spir_func <16 x i32> @_Z13__esimd_vloadIiLi16EEN2cm3gen13__vector_typeIT_XT0_EE4typeEPKS5_(ptr addrspace(4) addrspacecast (ptr @vg to ptr addrspace(4)))
; CHECK: %{{[0-9a-zA-Z_.]+}} = load <16 x i32>, ptr addrspace(4) addrspacecast (ptr @vg to ptr addrspace(4)), align 64
; TODO: testcase to generate this:
; CxHECK: %{{[0-9a-zA-Z_.]+}} = call <16 x i32> @llvm.genx.vload.v16i32.p4(ptr addrspace(4) {{.*}})
  ret <16 x i32>  %ret_val
}

define dso_local spir_func void  @FUNC_28(<32 x i32> %0) {
  call spir_func void @_Z14__esimd_vstoreIiLi32EEvPN2cm3gen13__vector_typeIT_XT0_EE4typeES5_(ptr addrspace(4) addrspacecast (ptr addrspace(1) @vc to ptr addrspace(4)), <32 x i32> %0)
; CHECK:  store <32 x i32> %0, ptr addrspace(4) addrspacecast (ptr addrspace(1) @vc to ptr addrspace(4)), align 128
...
define dso_local spir_func void  @FUNC_29() {
  %a_1 = alloca <32 x i32>
  %1 = addrspacecast ptr %a_1 to ptr  addrspace(4)
  %a_2 = alloca  <32 x i32>
  %2 = load  <32 x i32>,  ptr %a_2
  call spir_func  void  @_Z14__esimd_vstoreIiLi32EEvPN2cm3gen13__vector_typeIT_XT0_EE4typeES5_(ptr addrspace(4) %1,  <32 x i32> %2)
...
define dso_local spir_func <16 x i32>  @FUNC_32() {
  %a_1 = alloca <16 x i32>
  %1 = load <16 x i32>, ptr %a_1
  %a_2 = alloca  <16 x i32>
  %2 = load  <16 x i32>,  ptr %a_2
  %a_3 = alloca  <16 x i32>
  %3 = load  <16 x i32>,  ptr %a_3
...
define dso_local spir_func <32 x half>  @FUNC_52() {
  ...
  %a = load <32 x half>, ptr %ptr_a
  %b = load <32 x half>, ptr %ptr_b
  %c = load <32 x i16>, ptr %ptr_c
...
define dso_local spir_func void @FUNC_54() {
%ptr_a = alloca <16 x float>
%ptr_b = alloca <16 x float>
%ptr_c = alloca <16 x float>
%a = load <16 x float>, ptr %ptr_a
%b = load <16 x float>, ptr %ptr_b
%c = load <16 x float>, ptr %ptr_c
%ret = call spir_func noundef <16 x float> @_Z11__esimd_fmaddIfLi16EEN4sycl3_V13ext5intel5esimd6detail15raw_vector_typeINS5_19element_type_traitsIT_vE4RawTEXT0_EE4typeESC_SC_SC_(<16 x float> noundef %a, <16 x float> noundef %b, <16 x float> noundef %c)
; CHECK: %1 = call <16 x float> @llvm.fma.v16f32(<16 x float> %a, <16 x float> %b, <16 x float> %c)
ret void
}
...
declare dso_local spir_func <16 x i32> @_Z13__esimd_vloadIiLi16EEN2cm3gen13__vector_typeIT_XT0_EE4typeEPKS5_(ptr addrspace(4) %0)
declare dso_local spir_func void @_Z14__esimd_vstoreIiLi32EEvPN2cm3gen13__vector_typeIT_XT0_EE4typeES5_(ptr addrspace(4) %0, <32 x i32> %1)
declare dso_local spir_func void @_Z14__esimd_vstoreIyLi32EEvPN2cm3gen13__vector_typeIT_XT0_EE4typeES5_(ptr addrspace(4) %0, <32 x i64> %1)
declare dso_local spir_func <32 x i64> @_Z13__esimd_vloadIyLi32EEN2cm3gen13__vector_typeIT_XT0_EE4typeEPKS5_(ptr addrspace(4) %0)
declare dso_local spir_func <32 x i16> @_Z13__esimd_vloadItLi32EEN2cm3gen13__vector_typeIT_XT0_EE4typeEPKS5_(ptr addrspace(4) %0)
declare dso_local spir_func void @_Z14__esimd_vstoreIjLi32EEvPN2cm3gen13__vector_typeIT_XT0_EE4typeES5_(ptr addrspace(4) %0, <32 x i32> %1)
declare dso_local spir_func <32 x i32> @_Z13__esimd_vloadIjLi32EEN2cm3gen13__vector_typeIT_XT0_EE4typeEPKS5_(ptr addrspace(4) %0)
declare dso_local spir_func <16 x i16> @_Z13__esimd_vloadIsLi16EEN2cm3gen13__vector_typeIT_XT0_EE4typeEPKS5_(ptr addrspace(4) %0)
declare dso_local spir_func void @_Z14__esimd_vstoreIsLi16EEvPN2cm3gen13__vector_typeIT_XT0_EE4typeES5_(ptr addrspace(4) %0, <16 x i16> %1)
declare dso_local spir_func <1 x float> @_Z13__esimd_vloadIfLi1EEN2cm3gen13__vector_typeIT_XT0_EE4typeEPKS5_(ptr addrspace(4) %0)
declare dso_local spir_func void @_Z14__esimd_vstoreIfLi1EEvPN2cm3gen13__vector_typeIT_XT0_EE4typeES5_(ptr addrspace(4) %0, <1 x float> %1)
declare dso_local spir_func <16 x float> @_Z13__esimd_vloadIfLi16EEN2cm3gen13__vector_typeIT_XT0_EE4typeEPKS5_(ptr addrspace(4) %0)
declare dso_local spir_func void @_Z14__esimd_vstoreIfLi8EEvPN2cm3gen13__vector_typeIT_XT0_EE4typeES5_(ptr addrspace(4) %0, <8 x float> %1)
declare dso_local spir_func <8 x float> @_Z13__esimd_vloadIfLi8EEN2cm3gen13__vector_typeIT_XT0_EE4typeEPKS5_(ptr addrspace(4) %0)
declare dso_local spir_func <32 x i32> @_Z13__esimd_vloadIiLi32EEN2cm3gen13__vector_typeIT_XT0_EE4typeEPKS5_(ptr addrspace(4) %0)
declare dso_local spir_func void @_Z14__esimd_vstoreIfLi16EEvPN2cm3gen13__vector_typeIT_XT0_EE4typeES5_(ptr addrspace(4) %0, <16 x float> %1)
...
declare dso_local spir_func <16 x float> @_Z11__esimd_fmaddIfLi16EEN4sycl3_V13ext5intel5esimd6detail15raw_vector_typeINS5_19element_type_traitsIT_vE4RawTEXT0_EE4typeESC_SC_SC_(<16 x float> %a, <16 x float> %b, <16 x float> %c)

attributes #0 = { "genx_byte_offset"="192" "genx_volatile" }

!genx.kernels = !{!0}

!0 = !{ptr @"FUNC_30", !"FUNC_30", !1, i32 0, i32 0, !1, !2, i32 0, i32 0}
!1 = !{i32 0, i32 0}
!2 = !{}
