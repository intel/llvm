...
entry:
  ...
  ; CHECK: [[C:%[0-9]+]] = sext i8 %2 to i32
  ; CHECK-NEXT: [[S:%[0-9]+]] = sext i16 %3 to i32
...
entry:
  ...
  %call = call spir_func i32 (i8 addrspace(4)*, ...) @_Z18__spirv_ocl_printfPKcz(i8 addrspace(4)* %0, i32 %conv, i32 %conv3) #8
  ret i32 %call
}
