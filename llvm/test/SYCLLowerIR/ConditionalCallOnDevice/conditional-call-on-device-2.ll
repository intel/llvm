...
entry:
  %agg.tmp = alloca %class.anon, align 8
  %fn.ascast = addrspacecast ptr %fn to ptr addrspace(4)
  call spir_func void @_ZN4sycl3_V13ext6oneapi12experimental6detail31call_if_on_device_conditionally1(ptr noundef byval(%class.anon) align 8 %agg.tmp, i32 noundef -2, i32 noundef 251660032) #9
  ret void
}
