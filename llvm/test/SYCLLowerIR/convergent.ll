...
; CHECK-PTX:   call i64 @_Z33__spirv_BuiltInLocalInvocationIdi(i32 0)
; CHECK-PTX:   call i64 @_Z33__spirv_BuiltInLocalInvocationIdi(i32 1)
; CHECK-PTX:   call i64 @_Z33__spirv_BuiltInLocalInvocationIdi(i32 2)
; CHECK:   call void @_Z22__spirv_ControlBarrieriii(i32 2, i32 2, i32 272)
  ret void
}

; CHECK-PTX: declare i64 @_Z33__spirv_BuiltInLocalInvocationIdi(i32)
