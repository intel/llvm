...
%"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd" = type { <16 x i32> }
...
@0 = dso_local global %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd" zeroinitializer, align 64 #0
...
entry:
  %vc.i = alloca %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd", align 64
  %agg.tmp.i = alloca %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd", align 64
  ...
  %0 = bitcast %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd"* %agg.tmp.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 64, i8* nonnull %0)
  %1 = bitcast %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd"* %vc.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 64, i8* nonnull %1) #5
  %conv.i = trunc i64 %add.i5.i.i.i.i to i32
  %2 = addrspacecast %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd"* %vc.i to %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd" addrspace(4)*
  ...
  %M_data.i13.i = getelementptr inbounds %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd", %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd" addrspace(4)* %2, i64 0, i32 0
...
; CHECK: store <16 x i32> <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>, <16 x i32> addrspace(4)* addrspacecast (<16 x i32>* getelementptr inbounds ({{.+}}, {{.+}}* bitcast (<16 x i32>* [[NEWGLOBAL]] to {{.+}}*), i64 0, i32 0) to <16 x i32> addrspace(4)*), align 64, !tbaa.struct !16
  store <16 x i32> <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>, <16 x i32> addrspace(4)* addrspacecast (<16 x i32>* getelementptr inbounds (%"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd", %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd"* @0, i64 0, i32 0) to <16 x i32> addrspace(4)*), align 64, !tbaa.struct !16
  ...
  %3 = addrspacecast %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd"* %agg.tmp.i to %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd" addrspace(4)*
  %call.esimd.i.i.i = call <16 x i32> @llvm.genx.vload.v16i32.p4v16i32(<16 x i32> addrspace(4)* %M_data.i13.i) #5
  %M_data.i2.i.i = getelementptr inbounds %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd", %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd" addrspace(4)* %3, i64 0, i32 0
  call void @llvm.genx.vstore.v16i32.p4v16i32(<16 x i32> %call.esimd.i.i.i, <16 x i32> addrspace(4)* %M_data.i2.i.i) #5
  call spir_func void @_Z3fooPiN2cl4sycl3ext5intel3gpu4simdIiLi16EEE(i32 addrspace(4)* %add.ptr.i, %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd"* nonnull %agg.tmp.i) #5
  store <16 x i32> <i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2>, <16 x i32> addrspace(4)* addrspacecast (<16 x i32>* getelementptr inbounds (%"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd", %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd"* @0, i64 0, i32 0) to <16 x i32> addrspace(4)*), align 64, !tbaa.struct !16
...
define dso_local spir_func void @_Z3fooPiN2cl4sycl3ext5intel3gpu4simdIiLi16EEE(i32 addrspace(4)* %C, %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd"* %v) local_unnamed_addr #3 {
entry:
  %agg.tmp = alloca %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd", align 64
  %0 = addrspacecast %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd"* %v to %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd" addrspace(4)*
  %1 = addrspacecast %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd"* %agg.tmp to %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd" addrspace(4)*
  %M_data.i.i = getelementptr inbounds %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd", %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd" addrspace(4)* %0, i64 0, i32 0
...
; CHECK: {{.+}} = call <16 x i32> @llvm.genx.vload.v16i32.p4v16i32(<16 x i32> addrspace(4)* getelementptr ({{.+}}, {{.+}} addrspace(4)* addrspacecast ({{.+}}* bitcast (<16 x i32>* [[NEWGLOBAL]] to {{.+}}*) to {{.+}} addrspace(4)*), i64 0, i32 0)), !noalias !17
  %call.esimd.i8.i = call <16 x i32> @llvm.genx.vload.v16i32.p4v16i32(<16 x i32> addrspace(4)* getelementptr (%"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd", %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd" addrspace(4)* addrspacecast (%"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd"* @0 to %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd" addrspace(4)*), i64 0, i32 0)), !noalias !17
  %add.i = add <16 x i32> %call.esimd.i8.i, %call.esimd.i.i
  %M_data.i.i.i = getelementptr inbounds %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd", %"class._ZTSN2cl4sycl3ext5intel3gpu4simdIiLi16EEE.cl::sycl::ext::intel::gpu::simd" addrspace(4)* %1, i64 0, i32 0
...
!16 = !{i64 0, i64 64, !13}
!17 = !{!18}
!18 = distinct !{!18, !19, !"_ZNK2cl4sycl3ext5intel3gpu4simdIiLi16EEplERKS4_: %agg.result"}
!19 = distinct !{!19, !"_ZNK2cl4sycl3ext5intel3gpu4simdIiLi16EEplERKS4_"}
!20 = !{i32 8275}
!21 = !{i32 8268}
!22 = !{i32 8269}
!23 = !{i32 8166}
