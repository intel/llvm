...
@.str.4 = private unnamed_addr constant [73 x i8] c"{params:5}{cache-size:0}{anchor-id:-1}{target-anchor:0}{type:0}{cycle:0}\00", section "llvm.metadata"
@.str.5 = private unnamed_addr constant [14 x i8] c"<invalid loc>\00", section "llvm.metadata"
