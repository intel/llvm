; PR2463
; RUN: llvm-as -opaque-pointers %s -o %t1.bc
; RUN: llvm-as -opaque-pointers %p/2008-07-06-AliasWeakDest2.ll -o %t2.bc
; RUN: llvm-link -opaque-pointers %t1.bc %t2.bc -o %t3.bc
; RUN: llvm-link -opaque-pointers %t2.bc %t1.bc -o %t4.bc
