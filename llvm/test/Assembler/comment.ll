; INTEL RUN: llvm-as -opaque-pointers < %s | llvm-dis -show-annotations | FileCheck -check-prefix=ANNOT %s
; INTEL RUN: llvm-as -opaque-pointers < %s | llvm-dis | FileCheck -check-prefix=BARE %s
