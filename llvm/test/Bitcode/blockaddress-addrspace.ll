...
@global1 = constant ptr addrspace(2) blockaddress(@fn_in_prog_as_implicit, %bb)
@global2 = constant ptr addrspace(2) blockaddress(@fn_in_prog_as_explicit, %bb)
@global3 = constant ptr addrspace(1) blockaddress(@fn_in_other_as, %bb)
