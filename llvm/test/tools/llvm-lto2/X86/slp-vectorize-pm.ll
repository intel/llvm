...
; RUN: llvm-lto2 run -lto-opaque-pointers -opaque-pointers %t1.bc -o %t2.o -O0 -r %t1.bc,foo,plx -debug-pass-manager \
...
; RUN: llvm-lto2 run -lto-opaque-pointers -opaque-pointers %t1.bc -o %t3.o -O1 -r %t1.bc,foo,plx -debug-pass-manager \
...
; RUN: llvm-lto2 run -lto-opaque-pointers -opaque-pointers %t1.bc -o %t4.o -O2 -r %t1.bc,foo,plx -debug-pass-manager \
...
; RUN: llvm-lto2 run -lto-opaque-pointers -opaque-pointers %t1.bc -o %t5.o -O3 -r %t1.bc,foo,plx -debug-pass-manager \
