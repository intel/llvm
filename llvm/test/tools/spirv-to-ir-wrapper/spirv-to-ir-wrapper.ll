...
; CHECK-NEXT: define spir_kernel void @foo(ptr addrspace(1) %a)
; CHECK-NEXT: entry:
; CHECK-NEXT: %a.addr = alloca ptr addrspace(1), align 4
; CHECK-NEXT: store ptr addrspace(1) %a, ptr %a.addr, align 4
; CHECK-NEXT: ret void
