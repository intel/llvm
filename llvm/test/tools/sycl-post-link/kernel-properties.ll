...
; CHECK-IR-DAG: ![[WGSizeMD0]] = !{i64 1, i64 1, i64 1}
; CHECK-IR-DAG: ![[WGSizeHintMD0]] = !{i64 2, i64 1, i64 1}
; CHECK-IR-DAG: ![[WGSizeMD1]] = !{i64 5, i64 4, i64 1}
; CHECK-IR-DAG: ![[WGSizeHintMD1]] = !{i64 7, i64 6, i64 1}
; CHECK-IR-DAG: ![[WGSizeMD2]] = !{i64 10, i64 9, i64 8}
; CHECK-IR-DAG: ![[WGSizeHintMD2]] = !{i64 13, i64 12, i64 11}
