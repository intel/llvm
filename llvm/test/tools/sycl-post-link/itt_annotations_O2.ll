...
; CHECK: @__spirv_BuiltInWorkgroupId = external dso_local addrspace(1) constant <3 x i64>, align 32
; CHECK: @__spirv_BuiltInGlobalLinearId = external dso_local addrspace(1) constant i32, align 32
; CHECK: @__spirv_BuiltInWorkgroupSize = external dso_local addrspace(1) constant <3 x i64>, align 32
...
entry:
; CHECK: _ZTSZ4mainE10SingleTask
; CHECK-NEXT: entry:
; CHECK-NEXT: %[[CAST_WG_ID_1:[0-9a-zA-Z._]+]] = addrspacecast <3 x i64> addrspace(1)* @__spirv_BuiltInWorkgroupId to i64 addrspace(4)*
; CHECK-NEXT: %[[CAST_WI_ID_1:[0-9a-zA-Z._]+]] = addrspacecast i32 addrspace(1)* @__spirv_BuiltInGlobalLinearId to i64 addrspace(4)*
; CHECK-NEXT: %[[LOAD_WI_ID_1:[0-9a-zA-Z._]+]] = load i64, i64 addrspace(4)* %[[CAST_WI_ID_1]], align 8
; CHECK-NEXT: %[[CAST_WG_SIZE_1:[0-9a-zA-Z._]+]] = addrspacecast <3 x i64> addrspace(1)* @__spirv_BuiltInWorkgroupSize to <3 x i32> addrspace(4)*
; CHECK-NEXT: %[[LOAD_WG_SIZE_1:[0-9a-zA-Z._]+]] = load <3 x i32>, <3 x i32> addrspace(4)* %[[CAST_WG_SIZE_1]], align 16
; CHECK-NEXT: %[[EXTRACT_WG_SIZE_1:[0-9a-zA-Z._]+]] = extractelement <3 x i32> %[[LOAD_WG_SIZE_1]], i32 0
...
; CHECK: call void @__itt_offload_wi_finish(i64 addrspace(4)* %[[CAST_WG_ID_1]], i64 %[[LOAD_WI_ID_1]]
; CHECK-NEXT: ret void
  ret void
}
...
entry:
; CHECK: _ZTSZ4mainE11ParallelFor
; CHECK-NEXT: entry:
; CHECK-NEXT: %[[CAST_WG_ID_2:[0-9a-zA-Z._]+]] = addrspacecast <3 x i64> addrspace(1)* @__spirv_BuiltInWorkgroupId to i64 addrspace(4)*
; CHECK-NEXT: %[[CAST_WI_ID_2:[0-9a-zA-Z._]+]] = addrspacecast i32 addrspace(1)* @__spirv_BuiltInGlobalLinearId to i64 addrspace(4)*
; CHECK-NEXT: %[[LOAD_WI_ID_2:[0-9a-zA-Z._]+]] = load i64, i64 addrspace(4)* %[[CAST_WI_ID_2]], align 8
; CHECK-NEXT: %[[CAST_WG_SIZE_2:[0-9a-zA-Z._]+]] = addrspacecast <3 x i64> addrspace(1)* @__spirv_BuiltInWorkgroupSize to <3 x i32> addrspace(4)*
; CHECK-NEXT: %[[LOAD_WG_SIZE_2:[0-9a-zA-Z._]+]] = load <3 x i32>, <3 x i32> addrspace(4)* %[[CAST_WG_SIZE_2]], align 16
; CHECK-NEXT: %[[EXTRACT_WG_SIZE_2:[0-9a-zA-Z._]+]] = extractelement <3 x i32> %[[LOAD_WG_SIZE_2]], i32 0
; CHECK-NEXT: call void @__itt_offload_wi_start(i64 addrspace(4)* %[[CAST_WG_ID_2]], i64 %[[LOAD_WI_ID_2]], i32 %[[EXTRACT_WG_SIZE_2]])
  %0 = getelementptr inbounds %"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range", %"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range"* %_arg_3, i64 0, i32 0, i32 0, i64 0
  %1 = addrspacecast i64* %0 to i64 addrspace(4)*
  %2 = load i64, i64 addrspace(4)* %1, align 8
  %add.ptr.i = getelementptr inbounds i32, i32 addrspace(1)* %_arg_, i64 %2
...
; CHECK: call void @__itt_offload_wi_finish(i64 addrspace(4)* %[[CAST_WG_ID_2]], i64 %[[LOAD_WI_ID_2]]
; CHECK-NEXT: ret void
  ret void
}
...
entry:
; CHECK: _ZTSZ4mainE13ParallelForND
; CHECK-NEXT: entry:
; CHECK-NEXT: %[[CAST_WG_ID_3:[0-9a-zA-Z._]+]] = addrspacecast <3 x i64> addrspace(1)* @__spirv_BuiltInWorkgroupId to i64 addrspace(4)*
; CHECK-NEXT: %[[CAST_WI_ID_3:[0-9a-zA-Z._]+]] = addrspacecast i32 addrspace(1)* @__spirv_BuiltInGlobalLinearId to i64 addrspace(4)*
; CHECK-NEXT: %[[LOAD_WI_ID_3:[0-9a-zA-Z._]+]] = load i64, i64 addrspace(4)* %[[CAST_WI_ID_3]], align 8
; CHECK-NEXT: %[[CAST_WG_SIZE_3:[0-9a-zA-Z._]+]] = addrspacecast <3 x i64> addrspace(1)* @__spirv_BuiltInWorkgroupSize to <3 x i32> addrspace(4)*
; CHECK-NEXT: %[[LOAD_WG_SIZE_3:[0-9a-zA-Z._]+]] = load <3 x i32>, <3 x i32> addrspace(4)* %[[CAST_WG_SIZE_3]], align 16
; CHECK-NEXT: %[[EXTRACT_WG_SIZE_3:[0-9a-zA-Z._]+]] = extractelement <3 x i32> %[[LOAD_WG_SIZE_3]], i32 0
; CHECK-NEXT: call void @__itt_offload_wi_start(i64 addrspace(4)* %[[CAST_WG_ID_3]], i64 %[[LOAD_WI_ID_3]], i32 %[[EXTRACT_WG_SIZE_3]])
...
; CHECK: call void @__itt_offload_wg_barrier(i8* null)
; CHECK-NEXT: tail call void @_Z22__spirv_ControlBarrierjjj
; CHECK-NEXT: call void @__itt_offload_wi_resume(i64 addrspace(4)* %[[CAST_WG_ID_3]], i64 %[[LOAD_WI_ID_3]])
...
; CHECK: call void @__itt_offload_wi_finish(i64 addrspace(4)* %[[CAST_WG_ID_3]], i64 %[[LOAD_WI_ID_3]]
; CHECK-NEXT: ret void
  ret void
}
