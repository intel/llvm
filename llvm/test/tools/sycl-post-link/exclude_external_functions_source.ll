; Test that when the -allow-device-dependencies option is used with source splitting,
...
; RUN: sycl-post-link -properties -symbols -allow-device-dependencies -split=source -S < %s -o %t.table
