...
define weak_odr spir_kernel void @SpirKernel4(float %arg1) #1 !reqd_work_group_size !2 {
  call void @foo(float %arg1)
  ret void
}

define weak_odr spir_kernel void @SpirKernel5(float %arg1) !reqd_work_group_size !3 {
  call void @foo(float %arg1)
  ret void
}

define weak_odr spir_kernel void @SpirKernel6(float %arg1) #2 !reqd_work_group_size !4 {
  call void @foo(float %arg1)
  ret void
}
