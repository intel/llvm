...
; CHECK-IR2: %{{[0-9]+}} = call i1 @_Z20__spirv_SpecConstantib(i32 1, i1 false)
...
; CHECK-IR2: %{{[0-9]+}} = call i1 @_Z20__spirv_SpecConstantib(i32 0, i1 false)
  ret void
}
...
; CHECK-IR0: define{{.*}}spir_kernel void @KERNEL_CCC
  ret void
}

; CHECK-IR2: !sycl.specialization-constants = !{![[#MD0:]], ![[#MD1:]]}
; CHECK-IR2: ![[#MD0:]] = !{!"SpecConst2", i32 0, i32 0, i32 1}
; CHECK-IR2: ![[#MD1:]] = !{!"SpecConst", i32 1, i32 0, i32 1}
;
; CHECK-IR1: !sycl.specialization-constants = !{![[#MD0:]]}
; CHECK-IR1: ![[#MD0:]] = !{!"SpecConst", i32 0, i32 0, i32 1}
;
; CHECK-IR0: !sycl.specialization-constants = !{}

; CHECK-PROP2: [SYCL/specialization constants]
; CHECK-PROP2-DAG: SpecConst=2|
; CHECK-PROP2-DAG: SpecConst2=2|
;
; CHECK-PROP1: [SYCL/specialization constants]
; CHECK-PROP1: SpecConst=2|
; CHECK-PROP1-NOT: SpecConst2
;
; CHECK-PROP0-NOT: [SYCL/specialization constants
