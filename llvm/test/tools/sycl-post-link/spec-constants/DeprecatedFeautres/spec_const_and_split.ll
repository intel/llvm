...
; RUN: sycl-post-link -split=kernel -spec-const=rt -reduce-memory-usage=true -S %s -o %t-red.files.table
; RUN: FileCheck %s -input-file=%t-red.files_0.ll --check-prefixes CHECK-IR0
; RUN: FileCheck %s -input-file=%t-red.files_1.ll --check-prefixes CHECK-IR1
; RUN: FileCheck %s -input-file=%t-red.files_2.ll --check-prefixes CHECK-IR2
; RUN: FileCheck %s -input-file=%t-red.files_0.prop --check-prefixes CHECK-PROP0
; RUN: FileCheck %s -input-file=%t-red.files_1.prop --check-prefixes CHECK-PROP1
; RUN: FileCheck %s -input-file=%t-red.files_2.prop --check-prefixes CHECK-PROP2
