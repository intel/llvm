...
; RUN: sycl-post-link -split=per_kernel %s -o %t.table
...
; CHECK-PROP-KERNEL-SPLIT-0: joint_matrix_mad=2|wKAAAAAAAAQbhRncph3X0lHclpjOzlmb0hDLtFGdylGefRXewVmO6MXauRHOs0WY0JXa49Fd5BXZ6ozcp5GdzIDLtFGdylGefRXewVmO6MXauR3MywSMywCN4wSMyA
