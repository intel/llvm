...
; RUN: FileCheck %s -input-file=%t-red_0.ll --check-prefixes CHECK-SYCL-IR
; RUN: FileCheck %s -input-file=%t-red_esimd_0.ll --check-prefixes CHECK-ESIMD-IR
; RUN: FileCheck %s -input-file=%t-red_0.prop --check-prefixes CHECK-SYCL-PROP
; RUN: FileCheck %s -input-file=%t-red_esimd_0.prop --check-prefixes CHECK-ESIMD-PROP
