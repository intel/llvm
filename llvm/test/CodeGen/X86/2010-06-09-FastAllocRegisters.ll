; RUN: llc -opaque-pointers < %s -O0 -frame-pointer=all -relocation-model=pic
; PR7313
;
...
entry:
  ...
  call void @snapshot(i64 32, i64 33, i64 34, i64 35, i64 36, i64 37, i64 38, i64 39, i64 40, i64 41, i64 42, i64 43) nounwind
  ret void
}
