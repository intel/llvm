; RUN: llc -mtriple=amdgcn -mcpu=gfx1030 -filetype=obj < %s | llvm-objdump --triple=amdgcn-amd-amdhsa --mcpu=gfx1030 -d - | FileCheck -check-prefix=OBJ %s
...
; OBJ: v_permlane16_b32 v0, v0, s1, s2 op_sel:[1,0]

; ASM-LABEL: permlane_op_sel:
; ASM: v_permlane16_b32 v0, v0, s1, s2 op_sel:[1,0] ; encoding: [0x00,0x08,0x77,0xd7,0x00,0x03,0x08,0x00]
