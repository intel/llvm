...
; CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr addrspace(3) [[A]], align 4
; CHECK-NEXT:    [[TMP2:%.*]] = load i32, ptr addrspace(1) [[B]], align 4
; CHECK-NEXT:    [[TMP3:%.*]] = add i32 [[C]], [[C]]
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:    call void @_ZTS14other_function(ptr addrspace(3) [[A]], ptr addrspace(1) [[B]], i32 [[C]])
; CHECK-NEXT:    ret void
;
entry:
