...
define amdgpu_kernel void @_ZTS12third_kernel() {
entry:
  ret void
}
...
define amdgpu_kernel void @_ZTS12first_kernel() {
entry:
...
define amdgpu_kernel void @_ZTS13second_kernel() {
entry:
...
; CHECK-LABEL: define amdgpu_kernel void @_ZTS12third_kernel() {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    ret void
;
;
; CHECK-LABEL: define i64 @_ZTS15common_function() {
; CHECK-NEXT:    [[TMP1:%.*]] = zext i32 0 to i64
; CHECK-NEXT:    ret i64 [[TMP1]]
;
;
; CHECK-LABEL: define i64 @_ZTS15common_function_with_offset(
...
;
;
; CHECK-LABEL: define i64 @_ZTS14first_function() {
; CHECK-NEXT:    [[TMP1:%.*]] = call i64 @_ZTS15common_function()
; CHECK-NEXT:    ret i64 [[TMP1]]
;
;
; CHECK-LABEL: define i64 @_ZTS14first_function_with_offset(
; CHECK-SAME: ptr addrspace(5) [[TMP0:%.*]]) {
; CHECK-NEXT:    [[TMP2:%.*]] = call i64 @_ZTS15common_function_with_offset(ptr addrspace(5) [[TMP0]])
; CHECK-NEXT:    ret i64 [[TMP2]]
;
;
; CHECK-LABEL: define amdgpu_kernel void @_ZTS12first_kernel() {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP0:%.*]] = call i64 @_ZTS14first_function()
; CHECK-NEXT:    ret void
;
;
; CHECK-LABEL: define amdgpu_kernel void @_ZTS12first_kernel_with_offset(
...
; CHECK-NEXT:    [[TMP3:%.*]] = call i64 @_ZTS14first_function_with_offset(ptr addrspace(5) [[TMP1]])
; CHECK-NEXT:    ret void
;
;
; CHECK-LABEL: define i64 @_ZTS15second_function() {
; CHECK-NEXT:    [[TMP1:%.*]] = call i64 @_ZTS15common_function()
; CHECK-NEXT:    ret i64 [[TMP1]]
;
;
; CHECK-LABEL: define i64 @_ZTS15second_function_with_offset(
; CHECK-SAME: ptr addrspace(5) [[TMP0:%.*]]) {
; CHECK-NEXT:    [[TMP2:%.*]] = call i64 @_ZTS15common_function_with_offset(ptr addrspace(5) [[TMP0]])
; CHECK-NEXT:    ret i64 [[TMP2]]
;
;
; CHECK-LABEL: define amdgpu_kernel void @_ZTS13second_kernel() {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP0:%.*]] = call i64 @_ZTS15second_function()
; CHECK-NEXT:    ret void
;
;
; CHECK-LABEL: define amdgpu_kernel void @_ZTS13second_kernel_with_offset(
; CHECK-SAME: ptr byref([3 x i32]) [[TMP0:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP1:%.*]] = alloca [3 x i32], align 4, addrspace(5)
; CHECK-NEXT:    [[TMP2:%.*]] = addrspacecast ptr [[TMP0]] to ptr addrspace(4)
; CHECK-NEXT:    call void @llvm.memcpy.p5.p4.i64(ptr addrspace(5) align 4 [[TMP1]], ptr addrspace(4) align 1 [[TMP2]], i64 12, i1 false)
; CHECK-NEXT:    [[TMP3:%.*]] = call i64 @_ZTS15second_function_with_offset(ptr addrspace(5) [[TMP1]])
; CHECK-NEXT:    ret void
;
;
; CHECK-LABEL: define i64 @_ZTS15no_entry_point() {
; CHECK-NEXT:    [[TMP1:%.*]] = zext i32 0 to i64
; CHECK-NEXT:    ret i64 [[TMP1]]
;
;
; CHECK-LABEL: define i64 @_ZTS15no_entry_point_with_offset(
; CHECK-SAME: ptr addrspace(5) [[TMP0:%.*]]) {
; CHECK-NEXT:    [[TMP2:%.*]] = getelementptr inbounds i32, ptr addrspace(5) [[TMP0]], i64 2
; CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr addrspace(5) [[TMP2]], align 4
; CHECK-NEXT:    [[TMP4:%.*]] = zext i32 [[TMP3]] to i64
