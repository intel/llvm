...
; CHECK-NEXT:    [[TMP5:%.*]] = getelementptr inbounds i32, ptr addrspace(5) [[TMP0]], i64 2
; CHECK-NEXT:    [[TMP6:%.*]] = load i32, ptr addrspace(5) [[TMP5]], align 4
...
; CHECK-NEXT:    [[TMP4:%.*]] = call i64 @_ZTS14other_function_with_offset(ptr addrspace(5) [[TMP1]])
; CHECK-NEXT:    ret void
;
;.
