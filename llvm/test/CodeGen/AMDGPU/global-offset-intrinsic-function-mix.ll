...
define i64 @_ZTS14mixed_function() {
...
define amdgpu_kernel void @_ZTS12some_kernel() {
entry:
...
; CHECK-LABEL: define i64 @_ZTS15other_function() {
; CHECK-NEXT:    [[TMP1:%.*]] = zext i32 0 to i64
; CHECK-NEXT:    ret i64 [[TMP1]]
;
;
; CHECK-LABEL: define i64 @_ZTS15other_function_with_offset(
...
;
;
; CHECK-LABEL: define i64 @_ZTS14mixed_function() {
; CHECK-NEXT:    [[TMP1:%.*]] = call i64 @_ZTS15other_function()
; CHECK-NEXT:    [[TMP2:%.*]] = zext i32 0 to i64
; CHECK-NEXT:    ret i64 [[TMP1]]
;
;
; CHECK-LABEL: define i64 @_ZTS14mixed_function_with_offset(
; CHECK-SAME: ptr addrspace(5) [[TMP0:%.*]]) {
; CHECK-NEXT:    [[TMP2:%.*]] = call i64 @_ZTS15other_function_with_offset(ptr addrspace(5) [[TMP0]])
; CHECK-NEXT:    [[TMP3:%.*]] = getelementptr inbounds i32, ptr addrspace(5) [[TMP0]], i64 2
; CHECK-NEXT:    [[TMP4:%.*]] = load i32, ptr addrspace(5) [[TMP3]], align 4
; CHECK-NEXT:    [[TMP5:%.*]] = zext i32 [[TMP4]] to i64
; CHECK-NEXT:    ret i64 [[TMP2]]
;
;
; CHECK-LABEL: define amdgpu_kernel void @_ZTS12some_kernel() {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP0:%.*]] = call i64 @_ZTS14mixed_function()
; CHECK-NEXT:    ret void
;
;
; CHECK-LABEL: define amdgpu_kernel void @_ZTS12some_kernel_with_offset(
...
; CHECK-NEXT:    [[TMP3:%.*]] = call i64 @_ZTS14mixed_function_with_offset(ptr addrspace(5) [[TMP1]])
; CHECK-NEXT:    ret void
;
;.
