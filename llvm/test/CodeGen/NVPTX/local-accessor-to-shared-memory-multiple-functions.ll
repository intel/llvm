...
define weak_odr dso_local void @_ZTS14other_function(ptr addrspace(3) %a, ptr addrspace(1) %b, i32 %c) {
; CHECK: define weak_odr dso_local void @_ZTS14other_function(ptr addrspace(3) %a, ptr addrspace(1) %b, i32 %c) {
...
; CHECK: %a = bitcast ptr addrspace(3) %1 to ptr addrspace(3)
