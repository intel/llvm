...
; RUN: llvm-lto2 run -lto-opaque-pointers -opaque-pointers --pass-remarks-output=%t4.yaml --pass-remarks-filter=. --pass-remarks-with-hotness \
...
; RUN: llvm-lto2 run -lto-opaque-pointers -opaque-pointers %t -r %t,main,px -r %t,live1, -r %t,live2,p -r %t,dead2,p \
; RUN:               %t2 -r %t2,live1,p -r %t2,live2, -r %t2,dead1,p -r %t2,dead2, -r %t2,odr, \
