...
; RUN: llvm-lto2 run -lto-opaque-pointers -opaque-pointers -o %to1 -save-temps %t1 %t2 \
; RUN:  -r %t1,foo,px \
; RUN:  -r %t2,foo, \
; RUN:  -r %t2,bar,pl
...
; RUN: llvm-lto2 run -lto-opaque-pointers -opaque-pointers -o %to2 -save-temps %t2 %t3 \
; RUN:  -r %t2,foo, \
; RUN:  -r %t2,bar,pl \
; RUN:  -r %t3,foo,px
...
; RUN: llvm-lto2 run -lto-opaque-pointers -opaque-pointers -o %to3 -save-temps %t4 \
; RUN:  -r %t4,bar, \
; RUN:  -r %t4,foo, \
