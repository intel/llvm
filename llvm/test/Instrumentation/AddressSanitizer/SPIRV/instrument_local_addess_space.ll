; RUN: opt < %s -passes=asan -asan-instrumentation-with-call-threshold=0 -asan-globals=0 -asan-constructor-kind=none -asan-spir-locals=1 -asan-spir-privates=0 -S | FileCheck %s
