...
define void @_Z3foov() {
  ...
  ; CHECK: %pgocount.addr = load ptr addrspace(1), ptr addrspace(1) @__profc_foo, align 8
...
define dso_local void @_Z3barv(ptr nocapture nonnull align 8 %0) unnamed_addr #0 align 2 {
  ...
  ; CHECK: %pgocount.addr = load ptr addrspace(1), ptr addrspace(1) @__profc_bar, align 8
  ; CHECK: store i8 0, ptr addrspace(1) %pgocount.addr, align 1
  ret void
}
