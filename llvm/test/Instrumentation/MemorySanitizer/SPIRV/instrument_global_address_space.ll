...
entry:
  ...
  ; CHECK-NEXT: call void @__msan_maybe_warning_4(i32 zeroext %_msld, i32 zeroext 0, ptr addrspace(2) null, i32 0, ptr addrspace(2) @__msan_kernel)
  %call = call spir_func i32 @foo(i32 %0)
  ; CHECK:      %3 = ptrtoint ptr addrspace(1) %_arg_array to i64
  ; CHECK-NEXT: %4 = call ptr addrspace(1) @__msan_get_shadow(i64 %3, i32 1)
