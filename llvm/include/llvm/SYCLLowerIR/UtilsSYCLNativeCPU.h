...
const constexpr char NativeCPULocalId[] =
    "__dpcpp_nativecpu_get_local_id";
const constexpr char NativeCPUNumGroups[] =
...
const constexpr char NativeCPUSetNumSubgroups[] = "__dpcpp_nativecpu_set_num_sub_groups";
const constexpr char NativeCPUSetSubgroupId[] = "__dpcpp_nativecpu_set_sub_group_id";
const constexpr char NativeCPUSetMaxSubgroupSize[] = "__dpcpp_nativecpu_set_max_sub_group_size";
