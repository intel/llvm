...
LLVM_ABI void initializeDAESYCLPass(PassRegistry &);
...
LLVM_ABI void initializeFPBuiltinFnSelectionLegacyPassPass(PassRegistry &);
...
LLVM_ABI void initializeSYCLLowerWGScopeLegacyPassPass(PassRegistry &);
LLVM_ABI void initializeSYCLLowerESIMDLegacyPassPass(PassRegistry &);
LLVM_ABI void initializeSYCLLowerInvokeSimdLegacyPassPass(PassRegistry &);
LLVM_ABI void initializeSYCLMutatePrintfAddrspaceLegacyPassPass(PassRegistry &);
LLVM_ABI void initializeSPIRITTAnnotationsLegacyPassPass(PassRegistry &);
LLVM_ABI void initializeESIMDLowerLoadStorePass(PassRegistry &);
LLVM_ABI void initializeESIMDVerifierPass(PassRegistry &);
LLVM_ABI void initializeSYCLLowerWGLocalMemoryLegacyPass(PassRegistry &);
