...
macro(append_common_extra_security_flags)
  ...
  if(CMAKE_BUILD_TYPE MATCHES "Release")
    if(is_gcc
       OR is_clang
       OR (is_icpx AND MSVC))
      # FIXME: need to address these warnings first, otherwise the build fails.
  ...
  # On Linux the project should be configured with the
  # -DCMAKE_POSITION_INDEPENDENT_CODE=ON flag.
  if(is_msvc)
