...
if ( EXTRA_SECURITY_OPTSET )
    if (EXTRA_SECURITY_OPTSET STREQUAL "none")
    # No actions.
    elseif (EXTRA_SECURITY_OPTSET STREQUAL "default")
      append_common_extra_security_flags()
    elseif (EXTRA_SECURITY_OPTSET STREQUAL "sanitize")
      append_common_extra_security_flags()
      ...
      message(FATAL_ERROR "Unsupported value of EXTRA_SECURITY_OPTSET: ${EXTRA_SECURITY_OPTSET}")
    endif()
endif()
