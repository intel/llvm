...
/// Return a pass that generate amx intrinsics for matrix operations.
FunctionPass *createX86LowerMatrixOperationPass();
...
void initializeX86LowerMatrixOperationPassPass(PassRegistry &);
