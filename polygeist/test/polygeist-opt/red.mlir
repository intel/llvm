...
module  {
  // COM: Ensure array reductions are detected.
  func.func @detect_reduction1(%arg0: memref<?xf32>) -> f32 {
    // CHECK-LABEL:   func.func @detect_reduction1
  ...
  func.func @no_detect_reduction1(%arg0: memref<?xi32>)  {
    // CHECK-LABEL:   func.func @no_detect_reduction1
  ...
  func.func @no_detect_reduction2(%arg0: memref<1xmemref<?xi32>>)  {
    // CHECK-LABEL:   func.func @no_detect_reduction2
    // CHECK:         affine.for %arg1 = 0 to 8 {
