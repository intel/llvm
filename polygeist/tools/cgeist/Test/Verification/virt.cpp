...
// CHECK-NEXT:      %[[VAL_3:.*]] = llvm.alloca %[[VAL_2]] x !polygeist.struct<(!polygeist.struct<(i32)>, !polygeist.struct<(f32)>, f64)> : (i64) -> !llvm.ptr
...
// CHECK-NEXT:      %[[VAL_3:.*]] = llvm.getelementptr inbounds %[[VAL_0]][0, 0] : (!llvm.ptr) -> !llvm.ptr, !polygeist.struct<(!polygeist.struct<(i32)>, !polygeist.struct<(f32)>, f64)>
// CHECK-NEXT:      call @_ZN4RootC1Ei(%[[VAL_3]], %[[VAL_1]]) : (!llvm.ptr, i32) -> ()
// CHECK-NEXT:      %[[VAL_4:.*]] = llvm.getelementptr inbounds %[[VAL_0]][0, 1] : (!llvm.ptr) -> !llvm.ptr, !polygeist.struct<(!polygeist.struct<(i32)>, !polygeist.struct<(f32)>, f64)>
// CHECK-NEXT:      call @_ZN5FRootC1Ev(%[[VAL_4]]) : (!llvm.ptr) -> ()
// CHECK-NEXT:      %[[VAL_5:.*]] = llvm.getelementptr inbounds %[[VAL_0]][0, 2] : (!llvm.ptr) -> !llvm.ptr, !polygeist.struct<(!polygeist.struct<(i32)>, !polygeist.struct<(f32)>, f64)>
...
// CHECK-NEXT:      %[[VAL_2:.*]] = llvm.getelementptr inbounds %[[VAL_0]][0, 0] : (!llvm.ptr) -> !llvm.ptr, !polygeist.struct<(f32)>
