...
// RUN: clang++ -Xcgeist -w -fsycl -fsycl-device-only -fsycl-targets=spir64-unknown-unknown-syclmlir %s -S -emit-llvm -o - 2>&1 | FileCheck %s --implicit-check-not="{{warning|Warning}}:"
