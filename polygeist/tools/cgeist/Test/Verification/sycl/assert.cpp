...
// CHECK:               %[[VAL_157:.*]] = llvm.mlir.addressof @str0 : !llvm.ptr<1>
// CHECK:               %[[VAL_158:.*]] = llvm.mlir.addressof @str1 : !llvm.ptr<1>
// CHECK:               %[[VAL_159:.*]] = llvm.mlir.addressof @str2 : !llvm.ptr<1>
// CHECK:               %[[VAL_160:.*]] = "polygeist.pointer2memref"(%[[VAL_157]]) : (!llvm.ptr<1>) -> memref<?xi8, 1 : i32>
// CHECK:               %[[VAL_161:.*]] = memref.memory_space_cast %[[VAL_160]] : memref<?xi8, 1 : i32> to memref<?xi8, 4>
// CHECK:               %[[VAL_162:.*]] = "polygeist.pointer2memref"(%[[VAL_158]]) : (!llvm.ptr<1>) -> memref<?xi8, 1 : i32>
// CHECK:               %[[VAL_163:.*]] = memref.memory_space_cast %[[VAL_162]] : memref<?xi8, 1 : i32> to memref<?xi8, 4>
// CHECK:               %[[VAL_164:.*]] = "polygeist.pointer2memref"(%[[VAL_159]]) : (!llvm.ptr<1>) -> memref<?xi8, 1 : i32>
// CHECK:               %[[VAL_165:.*]] = memref.memory_space_cast %[[VAL_164]] : memref<?xi8, 1 : i32> to memref<?xi8, 4>
