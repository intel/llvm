...
// CHECK-DAG:         %[[VAL_739:.*]] = llvm.alloca %[[VAL_738]] x !polygeist.struct<(i8)> : (i64) -> !llvm.ptr
// CHECK-DAG:         %[[VAL_740:.*]] = llvm.alloca %[[VAL_738]] x !polygeist.struct<(i8)> : (i64) -> !llvm.ptr
// CHECK-DAG:         %[[VAL_741:.*]] = llvm.alloca %[[VAL_738]] x !polygeist.struct<(i8)> : (i64) -> !llvm.ptr
// CHECK-DAG:         %[[VAL_742:.*]] = llvm.alloca %[[VAL_738]] x !polygeist.struct<(i8)> : (i64) -> !llvm.ptr
// CHECK-NEXT:        %[[VAL_743:.*]] = llvm.addrspacecast %[[VAL_740]] : !llvm.ptr to !llvm.ptr<4>
// CHECK-NEXT:        %[[VAL_744:.*]] = llvm.load %[[VAL_741]] : !llvm.ptr -> !polygeist.struct<(i8)>
// CHECK-NEXT:        llvm.store %[[VAL_744]], %[[VAL_743]] : !polygeist.struct<(i8)>, !llvm.ptr<4>
...
// CHECK-NEXT:        %[[VAL_749:.*]] = llvm.load %[[VAL_742]] : !llvm.ptr -> !polygeist.struct<(i8)>
// CHECK-NEXT:        llvm.store %[[VAL_749]], %[[VAL_739]] : !polygeist.struct<(i8)>, !llvm.ptr
