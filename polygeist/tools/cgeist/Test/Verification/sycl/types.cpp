...
// CHECK: func.func @_Z7range_1N4sycl3_V15rangeILi1EEE(%arg0: !sycl_range_1_) attributes {llvm.linkage = #llvm.linkage<external>}

SYCL_EXTERNAL void range_1(sycl::range<1> range) {}

// CHECK: func.func @_Z7range_2N4sycl3_V15rangeILi2EEE(%arg0: !sycl_range_2_) attributes {llvm.linkage = #llvm.linkage<external>}

SYCL_EXTERNAL void range_2(sycl::range<2> range) {}

// CHECK: func.func @_Z5arr_1N4sycl3_V16detail5arrayILi1EEE(%arg0: !sycl_array_1_) attributes {llvm.linkage = #llvm.linkage<external>}

SYCL_EXTERNAL void arr_1(sycl::detail::array<1> arr) {}

// CHECK: func.func @_Z5arr_2N4sycl3_V16detail5arrayILi2EEE(%arg0: !sycl_array_2_) attributes {llvm.linkage = #llvm.linkage<external>}

SYCL_EXTERNAL void arr_2(sycl::detail::array<2> arr) {}

// CHECK: func.func @_Z11item_1_trueN4sycl3_V14itemILi1ELb1EEE(%arg0: !sycl_item_1_1_) attributes {llvm.linkage = #llvm.linkage<external>}

SYCL_EXTERNAL void item_1_true(sycl::item<1, true> item) {}

// CHECK: func.func @_Z12item_2_falseN4sycl3_V14itemILi2ELb0EEE(%arg0: !sycl_item_2_0_) attributes {llvm.linkage = #llvm.linkage<external>}

SYCL_EXTERNAL void item_2_false(sycl::item<2, false> item) {}

// CHECK: func.func @_Z9nd_item_1N4sycl3_V17nd_itemILi1EEE(%arg0: !sycl_nd_item_1_) attributes {llvm.linkage = #llvm.linkage<external>}

SYCL_EXTERNAL void nd_item_1(sycl::nd_item<1> nd_item) {}

// CHECK: func.func @_Z9nd_item_2N4sycl3_V17nd_itemILi2EEE(%arg0: !sycl_nd_item_2_) attributes {llvm.linkage = #llvm.linkage<external>}

SYCL_EXTERNAL void nd_item_2(sycl::nd_item<2> nd_item) {}

// CHECK: func.func @_Z7group_1N4sycl3_V15groupILi1EEE(%arg0: !sycl_group_1_) attributes {llvm.linkage = #llvm.linkage<external>}

SYCL_EXTERNAL void group_1(sycl::group<1> group) {}

// CHECK: func.func @_Z7group_2N4sycl3_V15groupILi2EEE(%arg0: !sycl_group_2_) attributes {llvm.linkage = #llvm.linkage<external>}
