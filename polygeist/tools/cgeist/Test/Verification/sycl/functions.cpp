...
// CHECK-MLIR-DAG: !sycl_accessor_1_i32_rw_gb = !sycl.accessor<[1, i32, read_write, global_buffer], (!sycl_accessor_impl_device_1_, !polygeist.struct<(memref<?xi32, 1>)>)>
// CHECK-MLIR-DAG: !sycl_accessor_2_i32_rw_gb = !sycl.accessor<[2, i32, read_write, global_buffer], (!sycl_accessor_impl_device_2_, !polygeist.struct<(memref<?xi32, 1>)>)>
// CHECK-MLIR-DAG: ![[ACC_STRUCT:.*]] = !sycl.accessor<[1, !polygeist.struct<(i32)>, read_write, global_buffer], (!sycl_accessor_impl_device_1_, !polygeist.struct<(!llvm.ptr<1>)>)>
