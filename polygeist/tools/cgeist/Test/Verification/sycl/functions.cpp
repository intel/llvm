...
// CHECK-MLIR-SAME: [[ATTRS:{llvm.cconv = #llvm.cconv<spir_funccc>, llvm.linkage = #llvm.linkage<external>, passthrough = \["norecurse", "nounwind", "convergent", "mustprogress"\]}]]
...
// CHECK-MLIR-SAME: attributes [[ATTRS]]
