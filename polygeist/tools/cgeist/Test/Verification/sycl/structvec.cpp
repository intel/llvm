...
// CHECK-SAME:          %[[VAL_151:.*]]: !llvm.ptr {llvm.align = 2 : i64, llvm.byval = !polygeist.struct<(vector<2xi8>)>, llvm.noundef}, 
// CHECK-SAME:          %[[VAL_152:.*]]: i32 {llvm.noundef}, %[[VAL_153:.*]]: i8 {llvm.noundef, llvm.signext}) -> !polygeist.struct<(vector<2xi8>)>
// CHECK-NEXT:        %[[VAL_154:.*]] = arith.constant 1 : i64
// CHECK-NEXT:        %[[VAL_155:.*]] = llvm.alloca %[[VAL_154]] x !polygeist.struct<(vector<2xi8>)> : (i64) -> !llvm.ptr
// CHECK-NEXT:        %[[VAL_156:.*]] = llvm.getelementptr inbounds %[[VAL_151]][0, 0] : (!llvm.ptr) -> !llvm.ptr, !polygeist.struct<(vector<2xi8>)>
...
// CHECK-NEXT:        %[[VAL_161:.*]] = llvm.load %[[VAL_155]] : !llvm.ptr -> !polygeist.struct<(vector<2xi8>)>
// CHECK-NEXT:        return %[[VAL_161]] : !polygeist.struct<(vector<2xi8>)>
// CHECK-NEXT:      }
...
// CHECK-NEXT:        %[[VAL_164:.*]] = llvm.getelementptr inbounds %[[VAL_163]][0, 0] : (!llvm.ptr<4>) -> !llvm.ptr<4>, !polygeist.struct<(vector<2xi8>)>
// CHECK-NEXT:        %[[VAL_165:.*]] = llvm.load %[[VAL_164]] : !llvm.ptr<4> -> vector<2xi8>
// CHECK-NEXT:        %[[VAL_166:.*]] = llvm.getelementptr inbounds %[[VAL_162]][0, 0] : (!llvm.ptr<4>) -> !llvm.ptr<4>, !polygeist.struct<(vector<2xi8>)>
...
// CHECK-LABEL:     func.func @_Z9test_initv() -> !polygeist.struct<(vector<2xi8>)>
...
// CHECK-DAG:         %[[VAL_171:.*]] = llvm.alloca %[[VAL_170]] x !polygeist.struct<(vector<2xi8>)> : (i64) -> !llvm.ptr
// CHECK-DAG:         %[[VAL_172:.*]] = llvm.alloca %[[VAL_170]] x !polygeist.struct<(vector<2xi8>)> : (i64) -> !llvm.ptr
// CHECK-DAG:         %[[VAL_173:.*]] = llvm.alloca %[[VAL_170]] x !polygeist.struct<(memref<?xi8, 4>, i64)> : (i64) -> !llvm.ptr
// CHECK-DAG:         %[[VAL_174:.*]] = llvm.alloca %[[VAL_170]] x !polygeist.struct<(memref<?xi8, 4>, i64)> : (i64) -> !llvm.ptr
...
// CHECK-DAG:         %[[VAL_177:.*]] = llvm.alloca %[[VAL_170]] x !polygeist.struct<(vector<2xi8>)> : (i64) -> !llvm.ptr
...
// CHECK-NEXT:        %[[VAL_183:.*]] = llvm.getelementptr inbounds %[[VAL_174]][0, 0] : (!llvm.ptr) -> !llvm.ptr, !polygeist.struct<(memref<?xi8, 4>, i64)>
// CHECK-NEXT:        llvm.store %[[VAL_182]], %[[VAL_183]] : memref<?xi8, 4 : i32>, !llvm.ptr
// CHECK-NEXT:        %[[VAL_184:.*]] = llvm.getelementptr inbounds %[[VAL_174]][0, 1] : (!llvm.ptr) -> !llvm.ptr, !polygeist.struct<(memref<?xi8, 4>, i64)>
// CHECK-NEXT:        llvm.store %[[VAL_167]], %[[VAL_184]] : i64, !llvm.ptr
// CHECK-NEXT:        %[[VAL_185:.*]] = llvm.load %[[VAL_174]] : !llvm.ptr -> !polygeist.struct<(memref<?xi8, 4>, i64)>
// CHECK-NEXT:        %[[VAL_186:.*]] = llvm.addrspacecast %[[VAL_177]] : !llvm.ptr to !llvm.ptr<4>
// CHECK-NEXT:        llvm.store %[[VAL_185]], %[[VAL_173]] : !polygeist.struct<(memref<?xi8, 4>, i64)>, !llvm.ptr
// CHECK-NEXT:        call @_ZN9structvecC1ESt16initializer_listIcE(%[[VAL_186]], %[[VAL_173]]) : (!llvm.ptr<4>, !llvm.ptr) -> ()
// CHECK-NEXT:        %[[VAL_187:.*]] = llvm.load %[[VAL_177]] : !llvm.ptr -> !polygeist.struct<(vector<2xi8>)>
// CHECK-NEXT:        llvm.store %[[VAL_187]], %[[VAL_172]] : !polygeist.struct<(vector<2xi8>)>, !llvm.ptr
...
// CHECK-NEXT:        %[[VAL_190:.*]] = llvm.load %[[VAL_171]] : !llvm.ptr -> !polygeist.struct<(vector<2xi8>)>
// CHECK-NEXT:        return %[[VAL_190]] : !polygeist.struct<(vector<2xi8>)>
// CHECK-NEXT:      }
...
// CHECK-SAME:          %[[VAL_192:.*]]: !llvm.ptr {llvm.align = 8 : i64, llvm.byval = !polygeist.struct<(memref<?xi8, 4>, i64)>, llvm.noundef})
...
// CHECK-NEXT:        %[[VAL_197:.*]] = llvm.getelementptr inbounds %[[VAL_191]][0, 0] : (!llvm.ptr<4>) -> !llvm.ptr<4>, !polygeist.struct<(vector<2xi8>)>
