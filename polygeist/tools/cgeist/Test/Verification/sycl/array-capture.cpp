...
// CHECK:             %[[VAL_326:.*]] = memref.alloca() : memref<1x!polygeist.struct<(!sycl_accessor_1_f32_rw_gb, !llvm.array<8 x f32>)>>
// CHECK-NEXT:        %[[VAL_327:.*]] = memref.cast %[[VAL_326]] : memref<1x!polygeist.struct<(!sycl_accessor_1_f32_rw_gb, !llvm.array<8 x f32>)>> to memref<?x!polygeist.struct<(!sycl_accessor_1_f32_rw_gb, !llvm.array<8 x f32>)>>
// CHECK:             %[[VAL_331:.*]] = "polygeist.subindex"(%[[VAL_327]], %[[VAL_305]]) : (memref<?x!polygeist.struct<(!sycl_accessor_1_f32_rw_gb, !llvm.array<8 x f32>)>>, index) -> memref<?x!llvm.array<8 x f32>>
// CHECK-NEXT:        %[[VAL_332:.*]] = "polygeist.memref2pointer"(%[[VAL_331]]) : (memref<?x!llvm.array<8 x f32>>) -> !llvm.ptr
// CHECK-NEXT:        %[[VAL_333:.*]] = llvm.getelementptr inbounds %[[VAL_303]][0, 0] : (!llvm.ptr) -> !llvm.ptr, !polygeist.struct<(!llvm.array<8 x f32>)>
...
// CHECK-SAME:                                                                                               %[[VAL_358:.*]]: memref<?x!polygeist.struct<(!sycl_accessor_1_f32_rw_gb, !llvm.array<8 x f32>)>, 4>
...
// CHECK-NEXT:        %[[VAL_366:.*]] = "polygeist.subindex"(%[[VAL_358]], %[[VAL_360]]) : (memref<?x!polygeist.struct<(!sycl_accessor_1_f32_rw_gb, !llvm.array<8 x f32>)>, 4>, index) -> memref<?x!llvm.array<8 x f32>, 4>
...
// CHECK-NEXT:        %[[VAL_372:.*]] = "polygeist.subindex"(%[[VAL_358]], %[[VAL_361]]) : (memref<?x!polygeist.struct<(!sycl_accessor_1_f32_rw_gb, !llvm.array<8 x f32>)>, 4>, index) -> memref<?x!sycl_accessor_1_f32_rw_gb, 4>
