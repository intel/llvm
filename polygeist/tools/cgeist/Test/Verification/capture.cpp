...
// CHECK-NEXT:     %4 = llvm.getelementptr %1[0, 0] : (!llvm.ptr<!llvm.struct<(memref<?xf32>, i32)>>) -> !llvm.ptr<memref<?xf32>>
// CHECK-NEXT:     llvm.store %3, %4 : !llvm.ptr<memref<?xf32>>
// CHECK-NEXT:     %5 = llvm.getelementptr %1[0, 1] : (!llvm.ptr<!llvm.struct<(memref<?xf32>, i32)>>) -> !llvm.ptr<i32>
