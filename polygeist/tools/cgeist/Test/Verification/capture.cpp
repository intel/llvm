...
// CHECK-NEXT:      %[[VAL_3:.*]] = llvm.alloca %[[VAL_2]] x !polygeist.struct<(memref<?xf32>, i32)> : (i64) -> !llvm.ptr
// CHECK-NEXT:      %[[VAL_4:.*]] = llvm.alloca %[[VAL_2]] x !polygeist.struct<(memref<?xf32>, i32)> : (i64) -> !llvm.ptr
...
// CHECK-NEXT:      %[[VAL_8:.*]] = llvm.getelementptr inbounds %[[VAL_4]][0, 0] : (!llvm.ptr) -> !llvm.ptr, !polygeist.struct<(memref<?xf32>, i32)>
// CHECK-NEXT:      llvm.store %[[VAL_7]], %[[VAL_8]] : memref<?xf32>, !llvm.ptr
// CHECK-NEXT:      %[[VAL_9:.*]] = llvm.getelementptr inbounds %[[VAL_4]][0, 1] : (!llvm.ptr) -> !llvm.ptr, !polygeist.struct<(memref<?xf32>, i32)>
// CHECK-NEXT:      llvm.store %[[VAL_0]], %[[VAL_9]] : i32, !llvm.ptr
// CHECK-NEXT:      %[[VAL_10:.*]] = llvm.load %[[VAL_4]] : !llvm.ptr -> !polygeist.struct<(memref<?xf32>, i32)>
// CHECK-NEXT:      llvm.store %[[VAL_10]], %[[VAL_3]] : !polygeist.struct<(memref<?xf32>, i32)>, !llvm.ptr
...
// CHECK-NEXT:      %[[VAL_1:.*]] = llvm.getelementptr inbounds %[[VAL_0]][0, 1] : (!llvm.ptr) -> !llvm.ptr, !polygeist.struct<(memref<?xf32>, i32)>
// CHECK-NEXT:      %[[VAL_2:.*]] = llvm.load %[[VAL_1]] : !llvm.ptr -> i32
// CHECK-NEXT:      %[[VAL_3:.*]] = arith.sitofp %[[VAL_2]] : i32 to f32
// CHECK-NEXT:      %[[VAL_4:.*]] = llvm.getelementptr inbounds %[[VAL_0]][0, 0] : (!llvm.ptr) -> !llvm.ptr, !polygeist.struct<(memref<?xf32>, i32)>
