...
// CHECK-DAG:     llvm.mlir.global internal constant @str7("==END   DUMP_ARRAYS==\0A\00") {addr_space = 0 : i32, alignment = 1 : i64}
// CHECK-DAG:     llvm.mlir.global internal constant @str6("\0Aend   dump: %[[VAL_0:.*]]\0A\00") {addr_space = 0 : i32, alignment = 1 : i64}
// CHECK-DAG:     llvm.mlir.global internal constant @str5("%[[VAL_1:.*]] \00") {addr_space = 0 : i32, alignment = 1 : i64}
// CHECK-DAG:     llvm.mlir.global internal constant @str4("\0A\00") {addr_space = 0 : i32, alignment = 1 : i64}
// CHECK-DAG:     llvm.mlir.global internal constant @str3("table\00") {addr_space = 0 : i32, alignment = 1 : i64}
// CHECK-DAG:     llvm.mlir.global internal constant @str2("begin dump: %[[VAL_0]]\00") {addr_space = 0 : i32, alignment = 1 : i64}
// CHECK-DAG:     llvm.mlir.global internal constant @str1("==BEGIN DUMP_ARRAYS==\0A\00") {addr_space = 0 : i32, alignment = 1 : i64}
// CHECK-DAG:     llvm.func @fprintf(!llvm.ptr, !llvm.ptr, ...) -> i32
// CHECK-DAG:     llvm.mlir.global external @stderr() {addr_space = 0 : i32} : !llvm.ptr
// CHECK-DAG:     llvm.mlir.global internal constant @str0("\00") {addr_space = 0 : i32, alignment = 1 : i64}
