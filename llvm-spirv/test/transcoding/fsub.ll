...
; CHECK-LLVM: fsub float %a, %b
; CHECK-LLVM: fsub nnan float %a, %b
; CHECK-LLVM: fsub ninf float %a, %b
; CHECK-LLVM: fsub nsz float %a, %b
; CHECK-LLVM: fsub arcp float %a, %b
; CHECK-LLVM-DEFAULT: fsub fast float %a, %b
; CHECK-LLVM-FC2: fsub reassoc nnan ninf nsz arcp contract float %a, %b
; CHECK-LLVM: fsub nnan ninf float %a, %b
; CHECK-LLVM-DEFAULT: fsub float %a, %b
; CHECK-LLVM-FC2: fsub contract float %a, %b
; CHECK-LLVM-DEFAULT: fsub float %a, %b
; CHECK-LLVM-FC2: fsub reassoc contract float %a, %b
