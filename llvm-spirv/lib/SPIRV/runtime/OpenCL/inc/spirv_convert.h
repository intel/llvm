...
SYCL_EXTERNAL int __spirv_ConvertFToS_Rint_rtz(float);
SYCL_EXTERNAL int __spirv_ConvertFToS_Rint_rte(float);
SYCL_EXTERNAL int __spirv_ConvertFToS_Rint_rtp(float);
SYCL_EXTERNAL int __spirv_ConvertFToS_Rint_rtn(float);
